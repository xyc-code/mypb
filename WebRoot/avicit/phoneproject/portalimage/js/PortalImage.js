 ...
 * 
 */
function PortalImage(datagrid,url,searchD,form){
...
PortalImage.prototype.insert=function(){
	this.nData = new CommonDialog("insert","600","300",this.getUrl()+'Add/null',"添加",false,true,false);
	this.nData.show();
};
//修改页面
PortalImage.prototype.modify=function(){
	...
	this.nData = new CommonDialog("edit","600","300",this.getUrl()+'Edit/'+rows[0].id,"修改",false,true,false);
	this.nData.show();
};
//详细页
PortalImage.prototype.detail=function(id){
	this.nData = new CommonDialog("edit","600","300",this.getUrl()+'Detail/'+id,"详情",false,true,false);
	this.nData.show();
};
//保存功能
PortalImage.prototype.save=function(form,id){
	var _self = this;
	$.ajax({
...
//打开查询框
PortalImage.prototype.openSearchForm =function(){
...
//隐藏查询框
PortalImage.prototype.hideSearchForm =function(){
	this.searchDialog.dialog('close',true);
};
/*清空查询条件*/
PortalImage.prototype.clearData =function(){
	this.searchForm.find('input').val('');
	this.searchData();
};
PortalImage.prototype.formate=function(value){
	if(value){
		return new Date(value).format("yyyy-MM-dd");
	}
	return '';
};
PortalImage.prototype.formateDateTime=function(value){
	if(value){
