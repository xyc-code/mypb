...
<!-- ControllerPath = "phoneproject/programmanage/portalskin/portalskin/PortalSkinController/operation/Edit/id" -->
<title>修改</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false"
		...
		<form id='form'>
			<input type="hidden" name="id" value='${portalSkinDTO.id}' />
			<table width="100%" style="padding-top: 10px;">
				...
				<tr>
					...
					<!-- <td><input title="应用程序状态(0 启用；1 禁用)"
						...
						type="radio" name="skinState" id="skinState" value="0"/>启用
					<input title="应用程序状态" class="inputbox easyui-validatebox"
						type="radio" name="skinState" id="skinState" value="1"/>禁用</td>	</td>
				</tr>
				<tr>
					...
					<td colspan="3"><textarea title="应用程序描述" class="inputbox easyui-validatebox"
						data-options="validType:'maxLength[2000]'" style="width: 466px;height:150px"
						 name="skinDesc" id="skinDesc">${portalSkinDTO.skinDesc}</textarea></td>
				</tr>
				<tr>
				</tr>
			</table>
	...
	<script type="text/javascript">
		...
		$(function() {
			var doc = document;
			var usersAndId = '${portalSkinDTO.skinResponsibles}';
			var strs=usersAndId.split(";");
			
			doc.getElementById('skinResponsibleShow').value=strs[0];
			doc.getElementById('skinResponsibles').value=strs[1];
		})
					...
					$('#ImgForm').form('submit',{
						...
						success : function(data) {
							...
							if (json.flag == "success") {
								file = json.file;
								parent.portalSkin.save(serializeObject($('#form')), "#edit",file);
							}
