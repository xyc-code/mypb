 ...
 */
function DaCareMedicine(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DaCareMedicine.prototype.init=function(){
	var _self = this;
	//初始化流程帮助类
	flowListEditor = new FlowListEditor(this._formCode);
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDaCareMedicinesByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DaCareMedicine.prototype.insert=function(){
	flowListEditor.addFlow();
};
/**
 * 编辑页面
 */
DaCareMedicine.prototype.modify=function(){
 ...
 * 详情页面
 */
DaCareMedicine.prototype.detail=function(id,value){
	flowUtils.detail(id); 
};
/**
 * 打开高级查询框
 */
DaCareMedicine.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DaCareMedicine.prototype.formValidate=function(form){
	form.validate({
		rules: {
			autoCode:{
			},
 ...
 * 删除方法
 */
DaCareMedicine.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DaCareMedicine.prototype.reLoad=function(){
	var searchdata = {
		keyWord: null,
 ...
 * 关闭对话框
 */
DaCareMedicine.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DaCareMedicine.prototype.searchData =function(){
 ...
 * 快速查询
 */
DaCareMedicine.prototype.searchByKeyWord =function(){
 ...
 * 根据流程状态查询
 */
DaCareMedicine.prototype.initWorkFlow = function(status){
	$('#bpmState').val(status);
	if(status == "start"){
		$("#daCareMedicine_modify").show();
		$("#daCareMedicine_del").show();
	}else{
		$("#daCareMedicine_modify").hide();
		$("#daCareMedicine_del").hide();
	}
	this.searchData();
};
/**
 * 隐藏查询框
 */
DaCareMedicine.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DaCareMedicine.prototype.clearData =function(){
