...
<!-- ControllerPath = "identifyingcode/mobileidentifycode/MobileIdentifyCodeController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
					<tr>
															...
															<th width="10%">
																...
																用户id:</th>
								 <td width="40%">
																											<input title="用户id" class="easyui-validatebox" data-options="required:true,validType:'maxLength[50]'" style="width: 180px;" type="text" name="userId" id="userId"/>
																									</td>								
															...
															<th width="10%">
																...
																验证码:</th>
								 <td width="40%">
																											<input title="验证码" class="easyui-validatebox" data-options="required:true,validType:'maxLength[50]'" style="width: 180px;" type="text" name="identifyCode" id="identifyCode"/>
																									</td>								
																	</tr>
									<tr>
																																																																																																																																																																																																															</tr>
	...
	function closeForm(){
		parent.mobileIdentifyCode.closeDialog("#insert");
	}
	function saveForm(){
	...
	$('#saveButton').linkbutton('disable').unbind("click");
		parent.mobileIdentifyCode.save(serializeObject($('#form')),"#insert");
	}
	</script>
</body>
</html>