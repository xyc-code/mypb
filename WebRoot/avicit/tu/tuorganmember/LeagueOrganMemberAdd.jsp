	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					<th>
						<label for="userPost">所在工会职务:</label>
					</th>
					<td>
					<pt6:h5checkbox css_class="radio-inline"  name="userPost" id="userPost" title="所在工会职务" canUse="0" 
                 lookupCode="TU_ORGAN_POST" defaultValue='1'/>
