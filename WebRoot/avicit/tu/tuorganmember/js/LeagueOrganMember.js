 ...
 * @param pid
 * @param searchNames
 * @param LeagueOrganMember_KeyWord
 */
function LeagueOrganMember(datagrid, url, form, dataGridColModel,searchD, pid, searchSubNames, leagueOrganMember_KeyWord){
	...
	this._keyWordId="#" + leagueOrganMember_KeyWord;
 ...
 * 回车查询
 */
LeagueOrganMember.prototype.init=function(pid){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getLeagueOrganMember',
 ...
 * 添加页面
 */
LeagueOrganMember.prototype.insert=function(pid){
 ...
 * 编辑页面
 */
LeagueOrganMember.prototype.modify=function(){
	if(this.pid == null || this.pid == ""){
		 layer.alert('请选择一个主表节点！', {
				  icon: 7,
				  area: ['400px', ''], //宽高
 ...
 * 详情页面
 */
LeagueOrganMember.prototype.detail=function(id){
	debugger;
 ...
 */
LeagueOrganMember.prototype.formValidate=function(form){
	form.validate({
		rules: {
			       userIdAlias:{
						required:true,
 ...
 * 保存方法
 */
LeagueOrganMember.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
LeagueOrganMember.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
LeagueOrganMember.prototype.reLoad=function(pid){
	if(pid != undefined){
		this.pid = pid;
	}
 ...
 * 关闭对话框
 */
LeagueOrganMember.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 打开高级查询框	
 */
LeagueOrganMember.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
 ...
 * 去后台查询
 */
LeagueOrganMember.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
LeagueOrganMember.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
LeagueOrganMember.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
LeagueOrganMember.prototype.clearData =function(){
