...
<%
String psu=request.getParameter("name");
%>
</head>
<body>
...
<div id="tableToolbar" class="toolbar">
    ...
    <div class="toolbar-right"   style="display: none">
	    <div class="input-group form-tool-search">
     		<input type="text" name="dynTuModelWorkerF_keyWord" id="dynTuModelWorkerF_keyWord" style="width:240px;" class="form-control input-sm" placeholder="请输入查询条件" value=<%=psu%>>
	...
	<form id="form" style="padding: 10px;">
		<table class="form_commonTable">
			...
			<tr>
				...
				<td>
					<pt6:h5select css_class="form-control input-sm" name="modelLevel" id="modelLevel" title="" isNull="true" lookupCode="MODELNAMELEVEL" defaultValue="2"/>
				</td>
				<th>
...
$(document).ready(function () {
	...
	searchNames.push("modelLevel");
	searchTips.push("新增荣誉层级");
	...
	dynTuModelWorkerF= new DynTuModelWorkerF('dynTuModelWorkerFjqGrid','platform/avicit/tu/dynTuModelWorkerF/dynTuModelWorkerFController/operation/',null,null,'dynTuModelWorkerF_keyWord',searchNames,dataGridColModel);
