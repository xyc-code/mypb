...
<div id="tableToolbar" class="toolbar">
	<div class="toolbar-left">
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_dynTuModelWorkerF_button_add" permissionDes="添加">
	  		<a id="dynTuModelWorkerF_insert" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point" role="button" title="添加"><i class="fa fa-plus"></i> 添加</a>
		</sec:accesscontrollist>
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_dynTuModelWorkerF_button_edit" permissionDes="编辑">
			<a id="dynTuModelWorkerF_modify" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="编辑"><i class="fa fa-file-text-o"></i> 编辑</a>
		</sec:accesscontrollist>
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_dynTuModelWorkerF_button_delete" permissionDes="删除">
			<a id="dynTuModelWorkerF_del" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="删除"><i class="fa fa-trash-o"></i> 删除</a>
		</sec:accesscontrollist>
	...
	<form id="form" style="padding: 10px;">
		<table class="form_commonTable">
			...
			<tr>
				...
				<td>
					<div class="input-group input-group-sm">
						<input class="form-control date-picker" type="text" name="data10Begin" id="data10Begin" />
			...
			<tr>
				...
				<td>
					<div class="input-group input-group-sm">
						<input class="form-control date-picker" type="text" name="data10End" id="data10End" />
						<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
					</div>
				</td>
...
<script src="avicit/tu/dyntumodelworkerf/js/DynTuModelWorkerF.js?v=${jsversion}" type="text/javascript"></script>
...
$(document).ready(function () {
	var dataGridColModel =  [
		...
		{ label : '申请人_ID', name : 'requestUserId',formatter:formatValue, width: 150, align: 'left'},
		{ label : '申请单位', name : 'deptName', width: 150, align: 'left'},
		{ label : 'DATA_11', name : 'data11', width: 150, align: 'right'},
		{ label : 'DATA_10', name : 'data10', formatter : format, width: 150, align: 'center'},
		...
		{ label : '劳模姓名ID', name : 'data1', width: 150, align: 'left'},
		{ label : '字段_2', name : 'data2', width: 150, align: 'left'},
		{ label : '荣誉名称', name : 'honorName', width: 150, align: 'left'},
		{ label : '字段_3', name : 'data3', width: 150, align: 'left'},
		{ label : 'DATA_4', name : 'data4', width: 150, align: 'left'},
		{ label : '申请单位ID', name : 'deptId', width: 150, align: 'left'},
		{ label : 'DATA_9', name : 'data9', width: 150, align: 'left'},
		{ label : '劳模姓名', name : 'modelName', width: 150, align: 'left'},
		{ label : '照片文件2', name : 'clob', width: 150, align: 'left', sortable:false},
		{ label : 'DATA_5', name : 'data5', width: 150, align: 'left'},
		{ label : '表单编号', name : 'autoCode', width: 150, align: 'left'},
		{ label : 'DATA_6', name : 'data6', width: 150, align: 'left'},
		{ label : 'DATA_7', name : 'data7', width: 150, align: 'left'},
		{ label : 'DATA_8', name : 'data8', width: 150, align: 'left'},
		...
		{ label : '新增荣誉层级', name : 'modelLevelName', width: 150, align: 'center'},
	...
	dynTuModelWorkerF= new DynTuModelWorkerF('dynTuModelWorkerFjqGrid','${url}','searchDialog','form','dynTuModelWorkerF_keyWord',searchNames,dataGridColModel);
	//添加按钮绑定事件
	...
	$('#dynTuModelWorkerF_export').bind('click',function(){
		...
		new SysExcelExport("dynTuModelWorkerF",true,"${url}/exportExcel",JSON.stringify(selectIds),selectConditions);
	});
