...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="data11" id="data11" data-min="-99999999999999999999" data-max="99999999999999999999" data-step="1" data-precision="0" value="<c:out value='${dynTuModelWorkerFDTO.data11}'/>">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="tel" id="tel" data-min="-99999999999999999999" data-max="99999999999999999999" data-step="1" data-precision="0" value="<c:out value='${dynTuModelWorkerFDTO.tel}'/>">
							<span class="input-group-addon">
								<a href="javascript:;" class="spin-up" data-spin="up"><i class="glyphicon glyphicon-triangle-top"></i></a>
								<a href="javascript:;" class="spin-down" data-spin="down"><i class="glyphicon glyphicon-triangle-bottom"></i></a>
							</span>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynTuModelWorkerF.closeDialog("edit");
		}
		function saveForm(){
			...
			parent.dynTuModelWorkerF.save($('#form'),"edit");
		}
		//清空日期值
