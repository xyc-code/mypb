 ...
 */
function DynTuModelWorkerF(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
	...
	this._keyWordId2="#dynTuModelWorkerF_keyWord2";
 ...
 * 初始化操作
 */
DynTuModelWorkerF.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynTuModelWorkerFsByPage.json',
        mtype: 'POST',
        datatype: "local",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynTuModelWorkerF.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynTuModelWorkerF.prototype.modify=function(){
 ...
 * 详情页面
 */
DynTuModelWorkerF.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynTuModelWorkerF.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynTuModelWorkerF.prototype.formValidate=function(form){
	form.validate({
		rules: {
			requestUserId:{
                maxlength: 255
 ...
 * 保存方法
 */
DynTuModelWorkerF.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynTuModelWorkerF.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynTuModelWorkerF.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynTuModelWorkerF.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynTuModelWorkerF.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynTuModelWorkerF.prototype.searchByKeyWord =function(){
	debugger;
	var keyWord = $(this._keyWordId).val()==$(this._keyWordId).attr("placeholder") ? "" :  $(this._keyWordId).val();
	var keyWord2 = $(this._keyWordId2).val()==$(this._keyWordId2).attr("placeholder") ? "" :  $(this._keyWordId2).val();
	...
	//for(var i in names){
		...
		//param[name] = keyWord;
	//}
	param[data10Begin] = keyWord;
	param[data10End] = keyWord2;
	var searchdata = {
 ...
 * 隐藏查询框
 */
DynTuModelWorkerF.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynTuModelWorkerF.prototype.clearData =function(){
