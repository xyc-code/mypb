...
$(document).ready(function () {
	var dataGridColModel =  [
		...
		{ label : 'DATA_11', name : 'data11', formatter : formatDateForHref, width: 150, align: 'center'},
		{ label : '流程ID', name : 'data10', width: 150, align: 'left'},
		{ label : 'DATA_12', name : 'data12', width: 150, align: 'right'},
		...
		{ label : 'DATA_2', name : 'data2', width: 150, align: 'left'},
		{ label : 'DATA_3', name : 'data3', width: 150, align: 'left'},
		...
		{ label : 'DATA_14', name : 'data14', width: 150, align: 'left', sortable:false},
