...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="data12" id="data12" data-min="-99999" data-max="99999" data-step="1" data-precision="0" value="<c:out value='${dynTuModelWorkerDTO.data12}'/>">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="tel" id="tel" data-min="-99999" data-max="99999" data-step="1" data-precision="0" value="<c:out value='${dynTuModelWorkerDTO.tel}'/>">
							<span class="input-group-addon">
								<a href="javascript:;" class="spin-up" data-spin="up"><i class="glyphicon glyphicon-triangle-top"></i></a>
								<a href="javascript:;" class="spin-down" data-spin="down"><i class="glyphicon glyphicon-triangle-bottom"></i></a>
							</span>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynTuModelWorker.closeDialog("edit");
		}
		function saveForm(){
			...
			parent.dynTuModelWorker.save($('#form'),"edit");
		}
		//清空日期值
