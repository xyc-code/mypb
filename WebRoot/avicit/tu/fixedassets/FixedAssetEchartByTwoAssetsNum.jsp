	...
	<table class="form_commonTable">
	    <tr>
	        <td colspan="3">
	            ...
	            <div id="assetTypeBar" style="height:450px;width:100%;overflow: hidden;border: 1px solid #ccc"></div>
	        </td>
	    </tr>
	</table>
</body>
<script type="text/javascript">
    ...
    function initAssetTypeBar() {
        $.ajax({
            url: "avicit/tu/fixedassets/dynFixedAssetsLedger/dynFixedAssetsLedgerController/operation/getEchartTwoByAssetsNum",
            data: {
            	year : currentYear,
            	typeName : typeName
            },
