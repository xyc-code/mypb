...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/nodesTaskKPI.jpg"  alt="指定流程节点任务KPI绩效分析" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
	 	<p>
			<span>维度X：所选流程节点</span>
		</p>
		<p>
