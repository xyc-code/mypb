...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/userTaskEfficiency.jpg"  alt="基于用户的任务效率分析" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Z：(1)流程最大用时  (2)流程最小用时  (3)流程平均用时</span>
	    </p>
	    <p>
			<span>描   述  ：任务处理时间=结束时间-到达时间</span>
	    </p>
	</div>
</body>
<jsp:include
