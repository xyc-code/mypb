...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/taskProcessKPI.jpg"  alt="基于岗位的任务KPI绩效分析" />
    </div>
