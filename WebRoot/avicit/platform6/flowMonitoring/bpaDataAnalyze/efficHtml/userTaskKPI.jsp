...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/userTaskKPI.jpg"  alt="基于部门的任务KPI绩效详情分析" />
    </div>
