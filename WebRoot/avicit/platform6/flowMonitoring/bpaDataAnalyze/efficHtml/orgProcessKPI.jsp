...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/orgProcessKPI.jpg"  alt="基于部门的流程KPI绩效详情分析" />
    </div>
