...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/orgTaskEfficiency.jpg"  alt="基于部门的任务效率分析" />
    </div>
