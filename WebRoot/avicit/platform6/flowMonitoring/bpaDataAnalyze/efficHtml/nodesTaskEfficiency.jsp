...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/nodesTaskEfficiency.jpg"  alt="指定流程节点任务效率分析" />
    </div>
