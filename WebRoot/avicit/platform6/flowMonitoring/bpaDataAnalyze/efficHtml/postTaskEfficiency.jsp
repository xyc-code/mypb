...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/postTaskEfficiency.jpg"  alt="基于岗位的任务效率分析" />
    </div>
