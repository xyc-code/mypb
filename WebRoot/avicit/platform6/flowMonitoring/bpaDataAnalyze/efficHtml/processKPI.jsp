...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/processKPI.jpg"  alt="流程KPI绩效分析" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Z：(1)流程合理完成 (2)流程警告范围内 (3)流程警告范围外</span>
	    </p>
	    <p>
