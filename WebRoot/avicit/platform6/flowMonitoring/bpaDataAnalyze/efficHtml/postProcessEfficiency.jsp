...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/postProcessEfficiency.jpg"  alt="基于岗位的流程效率分析" />
    </div>
