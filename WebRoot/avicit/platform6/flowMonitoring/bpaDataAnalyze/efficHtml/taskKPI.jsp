...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/taskKPI.jpg"  alt="任务KPI绩效分析" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：流程任务完成数量</span>
		</p>
		<p>
			<span>维度Z：(1)任务合理完成  (2)任务警告范围内  (3)任务警告范围外</span>
	    </p>
	    <p>
			<span>描   述  ：结束时间发生在当前选定的时间范围之内</span>
	    </p>
	</div>
</body>
<jsp:include
