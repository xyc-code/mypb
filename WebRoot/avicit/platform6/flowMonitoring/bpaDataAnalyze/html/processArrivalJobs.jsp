...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/processArrivalJobs.jpg"  alt="流程到达岗位覆盖率详情分析" />
    </div>
