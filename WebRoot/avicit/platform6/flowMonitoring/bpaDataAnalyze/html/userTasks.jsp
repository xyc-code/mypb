...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/userTasks.jpg"  alt="用户办结任务吞吐量分析" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：任务完成数量</span>
	    </p>
	    <p>
			<span>描   述  ：1.任务的结束时间 < 选定时间范围内   </span><br>
			<span>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp2.选择员工时，对员工分析</span>
	    </p>
	</div>
</body>
<jsp:include
