...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/processArrivalDepartment.jpg"  alt="流程到达部门覆盖率分析" />
    </div>
