...
<body>
 	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/departmentCompletesTask.jpg"  alt="部门办结任务吞吐量分析" />
    </div>
