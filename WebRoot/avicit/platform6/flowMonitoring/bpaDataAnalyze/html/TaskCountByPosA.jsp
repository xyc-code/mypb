...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/TaskCountByPosA.jpg"  alt="岗位办结流程吞吐量分析" />
    </div>
