...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/processNodeDepartment.jpg"  alt="流程指定节点到达部门覆盖率" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：参与部门的数量</span>
	    </p>
	    <p>
			<span>描   述  ：选定流程在指定时间范围内部门的参与情况分析</span>
	    </p>
	</div>
</body>
<jsp:include
