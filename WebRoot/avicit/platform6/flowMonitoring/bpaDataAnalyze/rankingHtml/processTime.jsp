...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/processTime.jpg"  alt="流程办理时间排名" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：办理时间(h)</span>
		</p>
	   <p>
			<span>描   述  ：流程办理时间=结束时间-开始时间   </span><br>
	    </p>
	</div>
</body>
<jsp:include
