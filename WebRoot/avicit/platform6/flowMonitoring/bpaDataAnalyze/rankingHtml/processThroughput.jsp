...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/process.jpg"  alt="流程吞吐量排名" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：流程实例的数量</span>
		</p>
	   <p>
			<span>描   述  ：已办结的流程   </span><br>
	    </p>
	</div>
</body>
<jsp:include
