...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/positionTime.jpg"  alt="岗位任务平均办理时间最长排名" />
    </div>
	<div id="customText" class="text" style="visibility: visible;">
		...
		<p>
			<span>维度Y：任务平均办理时间(h)</span>
		</p>
	   <p>
			<span>描   述  ：任务办理时间=任务结束时间-任务开始时间 </span><br>
	    </p>
	</div>
</body>
<jsp:include
