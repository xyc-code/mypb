...
<body>
	<div>
        <img style="height: 287px;width:  900px;" src="avicit/platform6/flowMonitoring/bpaDataAnalyze/photo/positionThroughput.jpg"  alt="岗位参与任务吞吐量排名" />
    </div>
