 ...
 * @returns
 */
function SysLookupHiberarchy(ztreeId, url, form, searchD, searchbtn, appid) {
...
SysLookupHiberarchy.prototype.init = function() {
	...
	_self.setting = {
		...
		async : {
			enable : true,
			url : _self.getUrl() + "gettree/2/" + appid,
			autoParam : [ "id" ],
