...
<script type="text/javascript">
    ...
    $(function(){
        ...
        sysAppTree.setOnSelect(function(appId){
            ...
            if(!$('#'+appId+'Frm').length){
                var src="platform/console/datamanagement/data${type}?appid="+appId;
                _map[appId]=src;
                var frame=$("<iframe id='"+appId+"Frm' class='frame' src="+src+" scrolling='no' frameborder='0' style='width:100%;height:98%;overflow-y: hidden'></iframe>");
