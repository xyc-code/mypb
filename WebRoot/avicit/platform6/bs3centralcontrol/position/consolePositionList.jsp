...
<div id="tableToolbarPosition" class="toolbar">
	<div class="toolbar-left">
		...
		<a id="consolePosition_save" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="编辑"><i class="icon icon-save"></i>保存</a>
...
$(document).ready(function () {
	...
	var dataGridUserColModel =  [
 	  ...
 	  ,{ label: '状态', name: 'status', width: 100,align:'center',formatter:formatStatus}
      ,{ label: '用户姓名', name: 'name', width: 200 ,align:'center'}
      ,{ label: '登录名', name: 'loginName', width: 200,align:'center'}
      ,{ label: '密级', name: 'secretLevel', width: 150,align:'center',formatter:formatLevel}
      ,{ label: '后台用户', name: 'consoleType', width: 150 ,align:'center',formatter:formatConsole}
      ,{ label: '部门', name: 'deptName', width: 150 ,align:'center'}
	];
