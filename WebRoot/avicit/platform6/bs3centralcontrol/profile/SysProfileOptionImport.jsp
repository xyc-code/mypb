...
<div id="tableToolbar" class="toolbar">
    <div class="toolbar-left">
        <a id="import" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point" role="button" onclick="doImport();"     href="javascript:void(0);" title="导入"><i class="icon icon-daoru"></i>导入</a>
