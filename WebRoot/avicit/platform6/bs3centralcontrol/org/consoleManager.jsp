	...
	<div data-options="region:'center',onResize:function(a){$('#jqGrid').setGridWidth(a);$(window).trigger('resize');}">
		<div id="tableToolbar" class="toolbar">
			<div class="toolbar-left">
				...
				<div class="dropdown">
					<a class="btn btn-primary form-tool-btn btn-sm" role="button"  href="javascript:void(0);" data-toggle="dropdown" id="dropdownMenu"><i class="icon icon-daoru"></i>导入<span class="caret"></span></a>
...
var fmtOpt=function(cellvalue, options, rowObject){
	 if(rowObject.type=="org"){
		 return "<img src='avicit/platform6/console/org/images/edit.png' onclick='orgList.showEditOrg(\""+ rowObject.id +"\",\""+ rowObject.type +"\",\""+ rowObject.name +"\");' />";
	 }else{
		 return "<img src='avicit/platform6/console/org/images/edit.png' onclick='orgList.showEditDept(\""+ rowObject.id +"\",\""+ rowObject.type +"\",\""+ rowObject.name +"\");' />";
	 }
}
...
$(function(){
	...
	{ label: '编辑', name: '_d', width: 50,sortable:false,align:'center',formatter:fmtOpt}
	];
