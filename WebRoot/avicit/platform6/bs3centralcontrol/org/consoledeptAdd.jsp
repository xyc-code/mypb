...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%">
		                <input class="form-control input-sm" type="text" name="deptCode" id="deptCode" />
					</td>
				...
				<tr>
					...
					<td width="39%">
		                <input class="form-control input-sm" type="text" name="orderBy" id="orderBy" />
					</td>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="parentDeptName">上级部门:</label></th>
					<td width="39%">
						<input class="form-control input-sm" type="text" name="parentDeptName" disabled="disabled" id="parentDeptName" value='${parentDeptName}'/>
					</td>
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="deptAlias">部门别名:</label></th>
					<td width="39%">
		                <input class="form-control input-sm" type="text" name="deptAlias" id="deptAlias" />
					</td>
				...
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="tel">手机号码:</label></th>
					<td width="39%">
					...
					<td width="39%">
						<input class="form-control input-sm" type="text" name="fax" id="fax"/>
					</td>
				</tr>
				<tr>
					...
					<td width="39%">
						<input class="form-control input-sm" type="text" name="deptPlace" id="deptPlace"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="39%">
						<pt6:h5radio css_class="radio-inline"  name="validFlag" title="" canUse="0" lookupCode="PLATFORM_VALID_FLAG" defaultValue='1'/>
					</td>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="deptType">部门类型:</label></th>
					<td width="39%">
						<pt6:h5radio css_class="radio-inline"  name="deptType" title="" canUse="0" lookupCode="PLATFORM_DEPT_TYPE" defaultValue='1'/>
					</td>
				</tr>
				
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="deptDesc">描述:</label></th>
					<td width="39%" colspan="3"><textarea class="form-control input-sm" rows="3"  name="deptDesc" id="orgDesc"></textarea></td>
				</tr>
			...
			<table class="tableForm" style="border:0;cellspacing:1;width:100%">
				<tr>
					<td width="50%" style="padding-right:4%;float:right;display:block;" align="right">
						...
						<a href="javascript:void(0)" class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回" id="deptcloseForm">返回</a>
					</td>
				</tr>
			</table>
		</div>
	...
	<script type="text/javascript">
		function closeForm(){
			parent.orgList.closeDialog("insertIndexDept");
        }
        function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.orgList.savedept($('#form'),"insertIndexDept");
        }
        $(function(){
		...
		jQuery.validator.addMethod("isZipCode", function(value, element) {    
			...
			//返回按钮绑定事件
			$('#deptcloseForm').bind('click', function(){
				closeForm();
			});
		});
	</script>
