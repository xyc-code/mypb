...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%">
		                <input class="form-control input-sm" type="text" name="orgCode" id="orgCode" />
					</td>
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="orgName">组织名称:</label></th>
					<td width="39%">
						<input class="form-control input-sm" type="text" name="orgName" id="orgName"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="39%">
						<input class="form-control input-sm" type="text" name="orgPlace" id="orgPlace"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td width="39%">
						<pt6:h5radio css_class="radio-inline"  name="isMulOrg" title="" canUse="0" lookupCode="PLATFORM_YES_NO_FLAG" defaultValue='N'/>
					</td>
				</tr>
				
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="orgDesc">描述:</label></th>
					<td width="39%" colspan="3"><textarea class="form-control input-sm" rows="3"  name="orgDesc" id="orgDesc"></textarea></td>
				</tr>
	...
	<script type="text/javascript">
		function closeForm(){
			parent.orgList.closeDialog("insertIndexOrg");
        }
        function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.orgList.saveorg($('#form'),"insertIndexOrg");
        }
        $(function(){
