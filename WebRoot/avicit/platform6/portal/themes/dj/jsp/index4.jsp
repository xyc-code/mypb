		...
		<div class="main">
			<div id="tabs-panel" class="mainbody easyui-tabs" data-options="tools:'#tab-tools',fit:true,border:false,tabHeight:30">
				<div title="首页" data-options="fit:true,border:false">
					<iframe src=""  scrolling="yes" frameborder="0" id="mainFrame" name="mainFrame" ></iframe>
				</div>
			</div>
		</div>
		<!-- 页面内容区 End -->
...
<script type="text/javascript" src="avicit/platform6/portal/themes/${_theme}/js/effect.js"></script>
<%--<script type="text/javascript" src="avicit/platform6/portal/portlet/js/portletUserDefined.js"></script>--%>
<script type="text/javascript" src="avicit/platform6/portal/themes/${_theme}/js/portletUserDefined.js"></script>
