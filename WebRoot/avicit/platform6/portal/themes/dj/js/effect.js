            ...
            if(r.flag=='success'){
                ...
                if(data.length > 0){
                    var html = '<div style="position:relative; height:auto; min-height:100%;overflow-y: hidden;">' +
                        '<div class="right-down-massage-list" style="height: 300px;width: 100%;">';
                    var html = '';
                    for(var i=0;i<data.length;i++){
                    ...
                    // html += '<div>'
                    html += '</div>'
                    html += '<footer style="position:absolute; bottom:0;" data-position="fixed" data-tap-toggle="false"><div class="more-massage-btn" style="width: 100%;padding: 10px;font-size: 13px;cursor:pointer;" onclick="rightDownMoreMessage();">查看全部消息</div></footer>';
                    html +=  '<div>';
                    $.ajax({
                        ...
                        success: function (a) {
                            layer.open({
                                type: 1,
                                area: ['240px', '200px'],
                                title: ['消息通知(' + dataSize + ')', 'font-size:13px;padding-left: 10px;'],
                                shade: 0,
                                time: a,
                                maxmin: false,
                                offset: 'rb',
