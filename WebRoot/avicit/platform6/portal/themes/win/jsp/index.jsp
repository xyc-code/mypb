			...
			<div class="header">
				<div class="logoDom">
					...
					<div id="wrapper">
						...
						<div class="searchBox">
							<input type="text" class="searchclass"  id="search" placeholder="请输入关键字"> <i class="icon icon-guanbi1 clear searchclass" id="searchClear"></i><i class="icon icon-search_ query searchclass" id="searchQuery"></i>
						</div>
						${menus}
						</div>
						</ul>
