...
<style type="text/css">
	...
	.form_commonTable tr td .radio-inline{
		margin-right: 6px;
	}
</style>
						...
						<table class="form_commonTable">
							<tr>
								...
								<td width="49%" valign="top" style="padding-bottom: 6px;" rowspan="6">
											<div style="margin-left:100px; position: relative; width: 180px; height: 180px;">
												...
												<img title='上传个人头像文件' id="sysUserHeadPhotoImg" src="avicit/platform6/console/user/images/touxiang.png"
													width="180px" height="180px" name="sysUserHeadPhotoImg" style="cursor:pointer;vertical-align:top" onclick="chooseUserPhoto();" />
