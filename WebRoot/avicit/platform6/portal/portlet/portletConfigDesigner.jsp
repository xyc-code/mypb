...
<div class="navbar navbar-inverse navbar-fixed-top" style='display:block'>
   <div class="navbar-inner" >
    <div class="container-fluid" >
    	<div id="tableToolbar" class="toolbar" style="padding: 7px 2px 6px 0px;z-index:99999;position:absolute;">
           ...
           <!--  portal入口进入,只有用户自定义的才可以编辑 -->
			...
			<div class="toolbar-right" style="margin-top: -5px;padding-right: 30px;">
...
<div id="setting" style='display:none;'>
	<table border='0' width="276" style="border-collapse:separate; border-spacing:0px 4px;">
		...
		<tr> 
			...
			<td valign="top"><input style="width:20px\9!important;height:20px\9!important;margin-top:3px\9!important;" type='checkbox' name='isDisplayPortletTitle'/></td>
		</tr> 
	<!-- 	<tr> 
		...
		<tr> 
			...
			<input id='sliderValue' type='text' style='width:60px;'/>&nbsp;PX
		   </td>
		</tr>
        <tr>
