...
<div id="tableToolbar" class="toolbar">
	<div class="toolbar-left">
  	...
  	<a id="sysMessage_insert" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point" role="button" title="添加"><i class="icon icon-add"></i> 添加</a>
	...
	<form id="form" style="padding: 10px;">
		<table class="form_commonTable">
			<tr>
				...
				<th width="10%">内容:</th>
				<td width="39%"><input class="form-control input-sm" type="text" title="内容" name="content" id="content" />
				</td>
			</tr>
			<tr>
				<th width="10%">发送人:</th>
