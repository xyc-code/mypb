...
<script type="text/javascript">
    ...
    function setFontCssBySearch(treeId, treeNode) {
        if($("#searchTreeInput").val()!="" && $("#searchTreeInput").val()!=null && $("#searchTreeInput").val()!="undefined"){
            if ($("#searchStatus").val() == "1" && treeNode.type == "form" && treeNode.name.indexOf($("#searchTreeInput").val()) > -1) {
                return {color: "red"};
            }
        }
    }
