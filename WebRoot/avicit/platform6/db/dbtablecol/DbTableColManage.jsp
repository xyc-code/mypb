		...
		<div class="tab-pane fade in active" id="home">
			<div id="tableToolbar" class="toolbar">
				...
				<div class="toolbar-right">
					<div class="searchBox">
						<input type="text" id="search" placeholder="请输入列英文名称"> <i class="icon icon-guanbi1 clear" id="searchClear"></i><i class="icon icon-search_ query" id="searchQuery"></i>
					</div>
				</div>
			</div>
	...
	$(document).ready(
			function() {
				...
				if (dbtype != "1"){
					if(dbtype == "2"){
						$("#tableToolbar").show();
						$("#dbTableCol_insert").hide();
						$("#dbTableCol_copytable").hide();
						$("#dbTableCol_copyrow").hide();
						$("#dbTableCol_commoncol").hide();
						$("#dbTableCol_del").hide();
					}else{
						$("#tableToolbar").hide();
					}
