...
<body class="easyui-layout" fit="true">
		...
		<div id="sysRoleTabs" class="easyui-tabs" data-options="fit:true,plain:true,border:false">   
		    <div title="业务角色" fit="true">   
		    ...
		    <div title="三员角色" fit="true" >   
		        <iframe id="homeFrm" class='frame' src="platform/sysrole/sanyanroleinfo" scrolling="no" frameborder="0" style="width:100%;height:100%;"></iframe>   
		    </div>   
