...
function loadRoleList(){
	...
	$('#roleList').datagrid({
		url:'platform/commonSelection/commonSelectionController/getSysRole?type=role&extParameter='+encodeURI(extParameter)+"&multipleOrg="+multipleOrg,
		idField:'id',
		width: '100%',
	    nowrap: false,
	    striped: true,
		...
		columns:[[
			{field:'roleName',title:'角色名称',width:40,align:'left'},
			{field:'desc',title:'角色描述',width:40,align:'left'},
