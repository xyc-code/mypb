...
$(function(){
	$('#deptQueryText').searchbox({
        ...
        searcher: function (value) {
            ...
            var param="selectType=dept&deptKeyWord="+encodeURI(value)+"&extParameter="+encodeURI(extParameter);
		 ...
		 $('#orgTree_dept').tree({
	 		...
	 		onCheck :function(node, checked){
	 			...
	 			if(nodeType=='dept'){
		 			...
		 			var selectionData = {"deptId":node.id,"deptName":currNodeName, "orgIdentity" : node.attributes.orgIdentity};
	 				if(checked){
...
function removeGridAllSelectedData(){
	...
	//当前页数据为空时将表头复选框取消选中状态
    var currentPageDatas = $('#selectDeptTargetDataGrid').datagrid('getRows');
