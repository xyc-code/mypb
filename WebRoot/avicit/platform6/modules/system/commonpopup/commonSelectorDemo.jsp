...
<head>
    ...
    jQuery(function(){
    	  //选择人员
		   var commonSelector = new CommonSelector("user","userSelectCommonDialog","receptUserId","receptUserName","receptDeptId","receptDeptName","{\"secretL\":1, \"deptId\":\"8a58ab4d4c2141fd014c217cdc5102b6\"}",2);
		   commonSelector.init(null,null,'n',null, "Y"); //选择人员  回填部门
		 //综合选择人员
		   var commonSelector2 = new CommonSelector("user2","userSelectCommonDialog2","receptUserId2","receptUserName2","receptDeptId2","receptDeptName2","{\"secretL\":1, \"deptId\":\"8a58ab4d4c2141fd014c217cdc5102b6\"}",2,null,null,null,null, {"dept":"true","role":"true"});
		   commonSelector2.init(null,null,'n',null, "Y"); //选择人员  回填部门
		 //选择部门
		   var deptCommonSelector = new CommonSelector("dept","deptSelectCommonDialog","selectDeptId","selectDeptName",null,null,'{"onlyLeafCheck":"true", "deptId":"8a58ab4d4c2141fd014c217cdc5102b6"}');
		   deptCommonSelector.init(null,null,'n',null, "Y"); //选择部门
		 //选择组织
       ...
       <form id="commonSelectionForm" method="post">
         <div class="formExtendBase">
       	<fieldset>
			...
			<fieldset>
				<legend>综合选择人员和部门</legend>
				  <table class="tableForm" width="100%" border=0>
				<tr>
					<td >人员ID</td>
					<td><input name="receptUserId2" id="receptUserId2"  style="display:block;" readOnly="readOnly"  /><input class="easyui-validatebox"  name="UserName2"   id="UserName2"  style="display:none;" ></input>

					</td>
					<td>人员姓名</td>
					<td><div class="formUnit column"><div class="inputContainer"><input class="easyui-validatebox"  name="receptUserName2"   id="receptUserName2"  readOnly="readOnly" style="width:200px" ></input> </div></div>
					</td>
				</tr>
				<tr>
					<td>人员归属部门ID</td>
					<td><input name="receptDeptId2" id="receptDeptId2"  style="display:block;" readOnly="readOnly"  /></input>
					</td>
					<td>人员归属部门名称</td>
					<td><div class="formUnit column"><div class="inputContainer"><input class="easyui-validatebox"  name="receptDeptName2"   id="receptDeptName2"  readOnly="readOnly" style="width:200px;" ></input></div></div>
					   <!-- <img  src="<%=request.getContextPath()%>/avicit/platform6/component/js/jQuery/jquery-easyui-1.3.4/themes/icons_ext/addUserDept.gif " title="选择人员部门" onclick=" selectUserClick();" style="align:center;"/> -->
					</td>
				</tr>
			</table>
