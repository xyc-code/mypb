...
function loadpositionList(){
	...
	$('#positionList').datagrid({
		url:'platform/commonSelection/commonSelectionController/getSysPosition?type=position&extParameter='+encodeURI(extParameter)+"&multipleOrg="+multipleOrg,
		idField:'id',
		width: '100%',
	    nowrap: false,
	    striped: true,
		...
		columns:[[
			{field:'positionName',title:'岗位名称',width:40,align:'left'},
			{field:'positionDesc',title:'岗位描述',width:40,align:'left'},
			{field:'orgIdentityName',title:'所属组织',width:40,align:'left'}
