		...
		$(function(){
			...
			myDatagrid =$('#dgTestPermission').datagrid({
				...
				onClickCell:function(rowIndex, field, value){
					...
					if(field == "zh_bzPeople") {   
						   var userSelect = new GridCommonSelector("user2","dgTestPermission",rowIndex,"zh_bzPeople",{userId:'isNeedCar',userName:'zh_bzPeople'});//
						   var rows = $('#dgTestPermission').datagrid("getRows");
						   userSelect.init(rows[rowIndex]);
					   } 
    ...
    <div data-options="region:'center',title:'',border:'false'" style="padding:0px;">
		...
		<thead>
			<tr>
				...
				<th data-options='field:"bzPeople", halign:"center"' width='220' editor='{type:"CommonSelector",options:{selectType:"user",width:220,dataGridId:"dgTestPermission",dialogShowField:"bzPeople",userId:"isNeedCar",userName:"bzPeople",selectCount:false,extParameter:"{\"secretL\":1}"}}'>选人</th>
				<th data-options='field:"zh_bzPeople", halign:"center"' width='220' editor='{type:"CommonSelector",options:{selectType:"user2",width:220,dataGridId:"dgTestPermission",dialogShowField:"zh_bzPeople",userId:"isNeedCar",userName:"zh_bzPeople",selectCount:false,multipleOrg:"n",extParameter:"{\"secretL\":1}",showTabsList:"{\"dept\":\"true\",\"role\":\"true\"}"}}'>综合选人</th>
