...
{
	$("#dgUser").datagrid("options").url ="platform/sysgroup/getUserListByPage/"+groupId;
	...
	<div data-options="region:'center',split:false,title:''" style="height:0; overflow:hidden; font-size:0;">				
		<table id="dgUser" class="easyui-datagrid"
			data-options=" 
				...
				checkOnSelect: false,
				selectOnCheck: true,
				queryParams: {filter_EQ_status:'1'},
				pagination:true,
				pageSize:dataOptions.pageSize,
				pageList:dataOptions.pageList,
				
				striped:true,
				url: 'platform/sysgroup/getUserListByPage/<%=request.getParameter("groupId")%>'
				">
			<thead>
				<tr>
