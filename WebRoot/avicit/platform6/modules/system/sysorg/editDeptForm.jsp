			...
			<form id="deptEditForm" name="deptEditForm" method="post">
				...
				<table class="form_commonTable">
					<tr>
	                    ...
	                    <td width="40%" >
	                        <input title="部门编码" class="easyui-validatebox" data-options="required:true"  type="text" name="DEPT_CODE" id="DEPT_CODE"/>
	                    </td>
	                ...
	                <tr>
	                    ...
	                    <th width="10%">上级部门:</th>
	                    <td>
	                        <input title="上级部门" class="easyui-text" readonly="readonly" type="text" name="PARENT_DEPT_NAME" id="PARENT_DEPT_NAME"/>
	                    </td>
	                </tr>
					<tr>
	                    <th width="10%">邮编:</th>
