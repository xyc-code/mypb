           ...
           if(col) {   
               ...
               //普通列   
                   ...
                   //操，这是最简单的简况了，将值直接放到td>div里面。   
                	   ...
                	   if(field=="extra")
                	   {
                		   value="<a onclick='deleteSession(\""+rowData.sessionId+"\"" +"," + "\""+rowData.name+"\")' href='javascript: void(0);'>踢出</a>";
                	   }
			...
			<table id="dgSession" class="easyui-datagrid"
				...
				<thead>
					<tr>
						...
						<th data-options="field:'name',hidden:'true',required:true,halign:'center',align:'center'" editor="{type:'text'}" width="220">用户名</th>
