...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<table class="form_commonTable">
				...
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="displayUrl">文档路径:</label></th>
					<td width="39%">
						<input title="" class="form-control input-sm" type="text" name="docPath" id="docPath" style="height:60px" value='<c:out value='${searchDatasourcesDTO.docPath}'/>'/>
					</td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		...
		function saveForm(){
			...
			parent.searchIndex.saveEdit($('#form'),"eidtDoc");
		}
