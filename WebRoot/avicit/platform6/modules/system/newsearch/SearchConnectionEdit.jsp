...
<html>
<head>
<!-- ControllerPath = "platfrom6/tablecol/searchconnection/searchConnectionController/operation/Edit/id" -->
<title>编辑</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="88%"><input class="form-control input-sm"
						type="text" name="connectionName" id="connectionName"
						value='<c:out  value='${searchConnectionDTO.connectionName}'/>' />
					</td>
				</tr>
				<tr>
					...
					<td width="88%"><input class="form-control input-sm"
						...
						value='<c:out  value='${searchConnectionDTO.connectionUrl}'/>' />
					</td>
				</tr>
				<tr>
					...
					<td width="88%"><input class="form-control input-sm"
						...
						value='<c:out  value='${searchConnectionDTO.connectionUsername}'/>' />
					</td>
				</tr>
				<tr>
					<th width="10%"><label for="connectionPassword">数据库密码:</label></th>
					<td width="88%"><input class="form-control input-sm"
						type="password" name="connectionPassword" id="connectionPassword"
						value='<c:out  value='${searchConnectionDTO.connectionPassword}'/>' />
					</td>
				</tr>
				<tr>
					<th width="10%"><label for="connectionDriver">数据库驱动:</label></th>
					<td width="88%" colspan="3">
	                    <pt6:h5select css_class="form-control input-sm" name="connectionDriver" id="connectionDriver" title="" isNull="true" lookupCode="PLATFORM_DATASOURCE_DRIVER" defaultValue="${searchConnectionDTO.connectionDriver}"/>
	                </td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		function closeForm(){
			parent.searchConnection.closeDialog("edit");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.searchConnection.saveEdit($('#form'),"eidt");
		}
