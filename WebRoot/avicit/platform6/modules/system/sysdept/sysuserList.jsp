...
function showPermisstionMenu(){
	...
	if(rows.length===0){
		...
		__uid=user.ID;
		var path="platform/ShowPermissController/permissControllerInfo/"+__uid;
	...
	<div id="toolbarUser" >
						<table >
							...
							<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_insertUser" permissionDes="添加">
								...
								<sec:accesscontrollist hasPermission="3" domainObject="sysuser_toolbar_resetPassword" permissionDes="密码管理">
