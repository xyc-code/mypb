...
<body class="easyui-layout">
	...
	<div id="toolbar" class="datagrid-toolbar datagrid-toolbar-extend">
		<table class="tableForm" border="0" cellspacing="1" width='100%'>
			<tr>	
				<td width="80%" align="right"><a title="确定" id="okButton"  class="easyui-linkbutton" plain="false" onclick="okForm();" href="javascript:void(0);">确定</a></td>
				<td align="left"><a title="返回" id="returnButton"  class="easyui-linkbutton" plain="false" onclick="closeForm();" href="javascript:void(0);">返回</a></td>
			</tr>
		</table>
	</div>
