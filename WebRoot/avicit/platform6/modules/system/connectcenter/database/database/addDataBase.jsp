...
<script type="text/javascript">
    ...
    function getURL(driver){
		...
		}else if(driver=="oracle.jdbc.driver.OracleDriver.group"){
			$('#urlValue').val("jdbc:oracle:thin:@(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=127.0.0.1)(PORT=1521))(CONNECT_DATA=(SERVER=DEDICATED)(SERVICE_NAME=RACDB)))");
		}else{
    		$('#urlValue').val("请输入...");
    	}
    }
