	...
	<form id="formSubRest">
		<table class="form_commonTable" >
			...
			<tr>
				<th width="15%">URL: </th>
				<td width="30%">
					<input title="URL" class="form-control input-sm" type="text" name="url" id="restUrlInput"/>
				</td>
			</tr>
		</table>
	</form>
		...
		<table class="form_commonTable" >
			<tr>
				...
				<td width="30%">
					<input title="标识"
					class="form-control input-sm" type="text" name="id"
					id="servletIdInput" /></td>
				</td>
				<th width="15%">名称：</th>
				<td width="30%"><input title="名称"
					class="form-control input-sm" type="text" name="name"
					id="servletNameInput"/></td>
			</tr>
			<tr>
				<th width="15%">URL: </th>
				<td width="30%">
					<input title="URL" class="form-control input-sm" type="text" name="url" id="servletUrlInput"/>
				</td>
			</tr>
		</table>
	</form>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
		...
		$('#DBModel_keyWord').on('keydown', function(e) {
			if(e.keyCode == '13'){
				dataBaseModel.searchByKeyWord();
			}
		});
		...
		$('#WSModel_keyWord').on('keydown', function(e) {
			if(e.keyCode == '13'){
				soapwebservice.searchByKeyWord();
			}
		});
		...
		$('#RestModel_keyWord').on('keydown', function(e) {
			if(e.keyCode == '13'){
				restful.searchByKeyWord();
			}
		});
		...
		$('#ServletModel_keyWord').on('keydown', function(e) {
			if(e.keyCode == '13'){
				servlet.searchByKeyWord();
			}
		});
