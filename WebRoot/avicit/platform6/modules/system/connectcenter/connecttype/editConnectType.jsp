...
<div data-options="region:'center',split:true,border:false">
    <form id='editForm'>
        <input type="hidden" id="id" name="id" value="${connectType.id}">
        <input type="hidden" id="parentId" name="parentId" value="${connectType.parentId}">
            ...
            <tr>
                ...
                <td width="35%">
                    <input title="名称" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="name" id="name" value="${connectType.name}"/>
                </td>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                ...
                <td width="35%">
                    <input title="编码" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="code" id="code" value="${connectType.code}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td width="35%">
                    <input title="排序" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="orderBy" id="orderBy" value="${connectType.orderBy}"/>
                </td>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                    &nbsp;
                </th>
            ...
            <tr>
                ...
                <td width="35%" colspan="3">
                	<textarea rows="3" title="描述" class="form-control input-sm" 
                           name="description" id="description">${connectType.description}</textarea>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    document.ready = function () {
        ...
        parent.connectType.formValidate($('#editForm'));
        $('#saveForm').bind('click', function () {
            parent.connectType.subEdit($("#editForm"));
        });
        $('#closeForm').bind('click', function () {
            parent.connectType.closeDialog("edit");
        });
    };
</script>
</body>
