...
<script type="text/javascript">
    document.ready = function () {
        ...
        $("#parentId").val(parent.connectTypeTree.selectedNodeId);

        parent.connectType.formValidate($('#addForm'));
        $('#saveForm').bind('click', function () {
            parent.connectType.subAdd($("#addForm"));
        });
        $('#closeForm').bind('click', function () {
            parent.connectType.closeDialog("add");
        });
    };
</script>
</body>
