...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		...
		<input type="hidden" id="classId" name="classId">
			<table class="form_commonTable" id="restFulTable">
				<tr>
				...
				<tr>
					...
					<td colspan="3" width="85%">
						<select class="form-control" name="requestMethod" id="requestMethod" title="" isNull="true" onChange="changeMethod(this)">
			...
			<table class="form_commonTable" id="paramTypeTable">
				<tr>
					...
					<td colspan="3" width="85%">
						<select class="form-control" name="paramType" id="paramType" title="" isNull="true" onChange="changeParamType(this)">
			...
			<table class="form_commonTable" id="paramTextTable">
				<tr>
					<th width="15%"><label for="name">请求参数：</label></th>
					<td colspan="3" width="85%"><input class="form-control input-sm"
						type="text" name="paramText" id="paramText" /></td>
				</tr>
			</table>
			...
			<table class="tableForm"
				...
				<tr>
					<td width="50%" style="padding-right: 4%;" align="right"><a
						...
						title="保存" id="restFul_saveForm">保存</a> <a
						href="javascript:void(0)"
						class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回"
						id="restFul_closeForm">返回</a></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function saveForm(classId){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.restful.save($('#form'),"insert",classId);
			  parent.layer.close(parent.layer.getFrameIndex(window.name));
		}
