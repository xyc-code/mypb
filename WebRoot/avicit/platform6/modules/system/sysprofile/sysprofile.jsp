...
<body class="easyui-layout" fit="true">
	...
	<div data-options="region:'east',title:'配置文件值'" style="height:0; overflow:hidden; font-size:0;width:550px;background:#f5fafe;">
	...
	<!--*****************************搜索*********************************  -->
	<div id="searchDialog" data-options="iconCls:'icon-search',resizable:false,modal:false,buttons:'#searchBtns'" style="width: 600px;height:200px;display: none;">
		<form id="form1">
