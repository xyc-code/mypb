...
//	var dataGridHeight = $(".easyui-layout").height()-73;
	$('#roleList').datagrid({
		...
		fitColumns: true,
		queryParams: {currentComId: currentReportId},
...
function selectUserDialogCallBack(data){
	...
	for(;l--;){
	 ...
	 $.ajax({
		 url:'platform/sysAccessControlController/insertComponentResourceAuth/U/'+encodeURIComponent(currentReportId).replace(".","%2E")+'.json',
		 data:	JSON.stringify(ids),
		 contentType : 'application/json',
		 type : 'post',
		 dataType : 'json',
 ...
 */
function insertRole(){
	var path="platform/fineReportAuthorityController/toAddRoleJsp";
...
function insertGroup(){
	var path="platform/fineReportAuthorityController/toAddGroupJsp";
...
function insertPosition(){
	var path="platform/fineReportAuthorityController/toAddPositionJsp";
...
function selectDeptDialogCallBack(data){
	...
	$.ajax({
		 url:'platform/sysAccessControlController/insertComponentResourceAuth/D/'+encodeURIComponent(currentReportId).replace(".","%2E")+'.json',
		 data:	JSON.stringify(ids),
		 contentType : 'application/json',
		 type : 'post',
		 dataType : 'json',
