 ...
 * 
 */
function SysAc(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//添加页面
SysAc.prototype.insert=function(){
...
//编辑页面
SysAc.prototype.modify=function(){
...
//详细页
SysAc.prototype.detail=function(id){
...
//打开高级查询框
SysAc.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
SysAc.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   				   resourceId:{
						required:true,
...
//保存功能
SysAc.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//重载数据
SysAc.prototype.reLoad=function(){
...
//关闭对话框
SysAc.prototype.closeDialog=function(id){
	if(id == "insert"){
...
//高级查询
SysAc.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//关键字段查询
SysAc.prototype.searchByKeyWord =function(){
...
//隐藏查询框
SysAc.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/*清空查询条件*/
SysAc.prototype.clearData =function(){
