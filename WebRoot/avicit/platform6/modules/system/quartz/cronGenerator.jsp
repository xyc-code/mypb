...
<div region="north" border="false" style="height: 160px;">
 	<div id="tab-tools" class="messager-button" style="padding-top: 0px;">
        <a href="javascript:void(0)" class="easyui-linkbutton primary-btn"  onclick="generateCronExpr()" style="margin: 0px;">生成表达式</a>
    </div>
	...
	<form id="formSelectCron">	
		<table class="form_commonTable" style="width: 550px;">
			<tr>
				...
				<td width="180px"><input id="cronExpr" name="cronExpr" class="easyui-validatebox" required="true" style="width: 150px" value=""/></td>
				<td>
					<span class="messager-button" style="padding-top: 0px;">
					<a class="easyui-linkbutton" plain="false" onclick="validateCron();" href="javascript:void(0);" style="margin: 0px;">验证表达式</a>
					<a class="easyui-linkbutton" plain="false" onclick="parseCronExpr();" href="javascript:void(0);" style="margin: 0px;">解析表达式</a>
					</span>
				</td>
			</tr>
			<t>
				...
				<td>
					...
					<a class="easyui-linkbutton" plain="false" onclick="showRunTime();" href="javascript:void(0);" style="margin: 0px;">预演执行时间</a>
					</span>
				</td>
			</tr>
			<tr>
				<th align="right">执行时间</th>
				<td colspan="2" style="padding-right: 30px;"><textarea class="textareabox" id="executionTimes" name="executionTimes" readonly="readonly" style="height: 100px" ></textarea></td>
			</tr>
		</table>
	</form>
</div>
...
<div data-options="region:'south'" split="false" style="height:40px;">
	<div id="toolbar" class="datagrid-toolbar datagrid-toolbar-extend foot-formopera">
		<table class="tableForm" border="0" cellspacing="1" width='100%'>
           <tr>
               <td align="center">
                 	<a class="easyui-linkbutton primary-btn" plain="false" id="submitButton" onclick="doSubmit();" href="javascript:void(0);">确定</a>
					<a class="easyui-linkbutton" plain="false" onclick="doCancel();" href="javascript:void(0);">取消</a>
				</td>
			</tr>
		</table>
	</div>
