				...
				<table id="dgGroup" class="easyui-datagrid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'sysGroupName',halign:'center',align:'left'" editor="{type:'validatebox', options:{required:true, validType: 'length[0,50]'}}" width="110"><span style="color:red;">*</span>群组名称</th> 
		    ...
		    <div title="常用审批意见" >   
				...
				<table id="dgApproval" class="easyui-datagrid"
					...
					<thead>
						<tr>
							<th data-options="field:'id', halign:'center' ,checkbox:true" >id</th>
							<th data-options="field:'value',halign:'center',align:'left'" editor="{type:'validatebox', options:{}}" width="220"><span style="color:red;">*</span>审批意见</th>
						</tr>
					</thead>
				</table>	 
		    </div>   
				...
				<table id="dgOther" class="easyui-datagrid"
					...
					<thead>
						<tr>
							...
							<th data-options="field:'isDefault',halign:'center',align:'center',formatter:formatteDefault" width="220">是否默认</th>
						</tr>
					</thead>
				</table>  
		    </div>   
