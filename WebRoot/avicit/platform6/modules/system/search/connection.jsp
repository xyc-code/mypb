...
<div data-options="region:'center',split:true,border:false" style="padding:0px;overflow:hidden;">
	...
	<div id="dlg" class="easyui-dialog" style="width: 400px; height: 280px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="post" novalidate>
				<div class="fitem"><span class="remind">*</span><label>数据库名称:</label> <input name="connectionName" class="easyui-validatebox" required="true"></div>
			    <div class="fitem"><span class="remind">*</span><label>数据库地址:</label> <input name="connectionUrl" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><span class="remind">*</span><label>数据库用户:</label> <input name="connectionUsername" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><span class="remind">*</span><label>数据库密码:</label> <input name="connectionPassword" class="easyui-validatebox" required="true"></div>
				<div class="fitem"><span class="remind">*</span><label>数据库驱动:</label> <input name="connectionDriver" class="easyui-validatebox" required="true"></div>
		</form>
	</div>
	<div id="dlg-buttons">
