...
<div data-options="region:'center',split:true,border:false" style="padding:0px;overflow:hidden;">
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				...
				<div class="fitem"><label>展示路径:</label> <input name="docPath" class="easyui-validatebox"  data-options="multiline:true" style="height:60px" required="true"></div>
		</form>
	...
	$.post('platform/search/connection/listAuth.html', {
		...
		url = 'platform/search/editdoc.html?id=${id}';
	});
