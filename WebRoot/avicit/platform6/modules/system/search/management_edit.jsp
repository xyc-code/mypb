...
<div data-options="region:'center',split:true,border:false" style="padding:0px;overflow:hidden;">
		<form id="fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>数据库连接:</label> 
				<select id="orgId" name="connectionFk" class="easyui-combobox"   data-options="valueField:'id', textField:'connectionName', width:260,editable:false,panelHeight:'auto'"></select>
			</div>	
			...
			<div class="fitem">
				...
				<div class="fitem"><label>SQL语句:</label> <input name="sqlStatement" class="easyui-validatebox"  data-options="multiline:true" style="height:60px" required="true"></div>
				<div class="fitem"><label>展示路径:</label> <input name="displayUrl" class="easyui-validatebox"  data-options="multiline:true" style="height:60px" required="true"></div>
		</form>
	...
	$(function(){
		...
		url = 'platform/search/editdb.html?id=${id}';
