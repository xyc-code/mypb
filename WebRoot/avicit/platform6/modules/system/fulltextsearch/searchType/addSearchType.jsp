...
<script type="text/javascript">
    document.ready = function () {
        ...
        $("#parentId").val(parent.searchTypeTree.selectedNodeId);
        parent.searchType.formValidate($('#addForm'));
    };
    $('#saveForm').bind('click', function () {
        parent.searchType.subAdd($("#addForm"));
    });
    $('#closeForm').bind('click', function () {
        parent.searchType.closeDialog("add");
    });
</script>
</body>
</html>
