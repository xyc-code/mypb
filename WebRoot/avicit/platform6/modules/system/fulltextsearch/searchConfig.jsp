    ...
    <div data-options="region:'north',split:false" style="height:50px;overflow:visible">
	    	<div class="toolbar">
	    		<div class="toolbar-left">
					...
					<a id="buildIndex" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="重建索引"><i class="icon iconfont icon-guanximoxing"></i>重建索引</a>
    			</div>
	    	</div>
    	</div>
