...
<script src="avicit/platform6/modules/system/fulltextsearch/js/Guid.js"></script>

<script type="text/javascript">
    $(function () {
        $("#myTabContent").css('height',$(document).innerHeight() -30);
        var guid = new GUID();
        var newId = guid.newGUID();
        var url = "avicit/platform6/modules/system/fulltextsearch/searchConfig/addBaseInfoConfig.jsp?infoId="+newId;
        setTimeout(function(){
        ...
        var ifrm={'iframe1':url,
            'iframe2':'avicit/platform6/modules/system/fulltextsearch/searchConfig/indexConfig.jsp?infoId='+newId,
            'iframe3':'avicit/platform6/modules/system/fulltextsearch/searchConfig/searchEvent.jsp?infoId='+newId};
