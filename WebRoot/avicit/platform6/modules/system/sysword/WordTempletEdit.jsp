...
<body onload="doEdit();">
	...
	<script type="text/javascript">
		...
		//提交
		function doSave(){
			var formUrl = "<%=path%>/platform/bpm/sysWordAction/updateSysWordTempletBody?wordId=<%=wordId%>";
		...
		function TANGER_OCX_OpenDoc(wordId) {
			...
			if(wordId != ""){	
				TANGER_OCX_OBJ.BeginOpenFromURL("<%=path%>/platform/bpm/sysWordAction/getSysWordTempletBody?wordId="+wordId);
			}else{
