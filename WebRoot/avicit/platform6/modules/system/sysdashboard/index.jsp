...
<%
	...
	SysMenuAPImpl sysMenuAPI = CacheSpringFactory.getInstance().getBean(SysMenuAPImpl.class);
    ...
    String indexElement = sysMenuAPI.getIndexElementVlign(SessionHelper.getCurrentUserLanguageCode(request), null, menu,appId,session.getAttribute(AfterLoginSessionProcess.SESSION_CURRENT_ORG).toString());
    
    //假单点时以{loginname}为标识，替换成动态用户登录名
    indexElement = indexElement.replaceAll("\\{loginname\\}", SessionHelper.getLoginName(request));
		...
		<div id="divBodyWidth">
			<div id="header">
				...
				<ul class="info" style="*width:auto;">
					...
					<!-- <li>
						<a href="javascript:void(0);" style="cursor:hand;">组织</a>
					</li> -->
