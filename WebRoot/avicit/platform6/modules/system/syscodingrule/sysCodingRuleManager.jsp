...
function toComSegment(){
	var usd = new CommonDialog("comSegmentDialog", 800, 450,"avicit/platform6/modules/system/syscodingcomsegment/sysCodingComSegmentManager.jsp","通用码段管理",true,true,false);
	usd.show();
}
</script>
</head>
	...
	<form id="formSearch">
		<table class="form_commonTable">
			...
			<tr>
				...
				<th width="50px;">状态</th>
				<td width="35%">
					<input class="easyui-combobox" id="searchStatus" name="searchStatus" data-options="editable:false,panelHeight:'auto',valueField:'code',textField:'name',url:'platform/sysCodingRuleController/getSegmentStatus.json'" value=""/>
				</td>
			</tr>
		</table>
	</form>
