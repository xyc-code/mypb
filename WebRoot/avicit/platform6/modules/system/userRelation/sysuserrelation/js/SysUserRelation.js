 ...
 */
function SysUserRelation(datagrid, url, searchDialogId, form, keyWordId, searchNames, dataGridColModel) {
 ...
 * 初始化操作
 */
SysUserRelation.prototype.init = function () {
    var _self = this;
    $(_self._datagridId).jqGrid({
        url: this.getUrl() + 'getSysUserRelationsByPage.json',
        mtype: 'POST',
        datatype: "json",
        ...
        loadComplete: function () {
            ...
            $("#set_jqGridPager").hide();
            $("#exportExcel_jqGridPager").hide();
        },
    ...
    //初始化校验字段
    _self.notnullFiled.push("user1Id");
    _self.notnullFiledComment.push("用户1");
    _self.lengthValidFiled.push("user1Id");
    _self.lengthValidFiledSize.push(50);
    _self.notnullFiled.push("user2Id");
    _self.notnullFiledComment.push("用户2");
    _self.lengthValidFiled.push("user2Id");
    _self.lengthValidFiledSize.push(50);
    _self.notnullFiled.push("relation");
    _self.notnullFiledComment.push("关系");
    _self.lengthValidFiled.push("relation");
    _self.lengthValidFiledSize.push(50);
    _self.notnullFiled.push("validFlag");
    _self.notnullFiledComment.push("状态");
    _self.lengthValidFiled.push("validFlag");
    _self.lengthValidFiledSize.push(1);
};
/**
 * 添加页面
 */
...
SysUserRelation.prototype.insert = function () {
    var _self = this;
 ...
 * @param
 */
SysUserRelation.prototype.nullvalid = function (data, item, nullfiled, notnullFiledComment) {
    var msg = "";
 ...
 * @param
 */
SysUserRelation.prototype.lengthvalid = function (data, item, lengthValidFiled, lengthValidFiledComment, lengthValidFiledSize) {
    var msg = "";
    $.each(data, function (i, dataitem) {
 ...
 * @param callback
 */
SysUserRelation.prototype.save = function () {
    var _self = this;
 ...
 * @param id
 */
SysUserRelation.prototype.detail = function (id) {
 ...
 * 删除
 */
SysUserRelation.prototype.del = function () {
 ...
 * 重载数据
 */
SysUserRelation.prototype.reLoad = function () {
    var searchdata = {
        keyWord: null,
 ...
 */
SysUserRelation.prototype.openSearchForm = function (searchDiv) {
    var _self = this;
 ...
 * 高级查询
 */
SysUserRelation.prototype.searchData = function () {
    var searchdata = {
        keyWord: null,
        param: JSON.stringify(serializeObject($(this._formId)))
    }
 ...
 * 关键字查询
 */
SysUserRelation.prototype.searchByKeyWord = function () {
