			...
			<!-- <input type="hidden" name="sid" value=""/> -->
				...
				<table class="form_commonTable">
					<tr>
						...
						<td width="40%">
							<input title="模板编号" class="easyui-validatebox" type="text" name="tempCode" id="tempCode" value="${cbbTempletInfo.tempCode}"/>
						</td>
						<th width="10%">节点类型:</th>
					...
					<tr>
						...
						<td>
							<input title="模板名称" class="easyui-validatebox" type="text" name="tempName" id="tempName" value="${cbbTempletInfo.tempName}"/>
						</td>
					</tr>
					<tr>
						<th>描述:</th>
						<td colspan="3"><input title="描述" class="easyui-validatebox" type="text" name="remark" id="remark" value="${cbbTempletInfo.remark}"/></td>
					</tr>
				</table>
		</form>
	</div>
