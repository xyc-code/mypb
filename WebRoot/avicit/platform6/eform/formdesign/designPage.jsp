            ...
            <div class="modal-body">
                <form method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div id="eformTypeSelect" class="input-group input-group-sm avicselect col-sm-8 required">
                                <input type="hidden" id="templateTypeId" name="templateTypeId" value="">
                                <input type="text" class="form-control" name="typeName" id="typeName"  value='' readonly="readonly">
...
<script type="text/javascript">
    ...
    formEditor.formName = '${eformFormInfo.formName}';
    //集成模型系统start
