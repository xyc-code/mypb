            ...
            <div id="collapse1" class="panel-collapse collapse in">
				...
				<table><tr><td>
                        ...
                        <div class="form-group" style="display: none" style="width:99%">
                            ...
                            <input type="text" name="colLength" id="colLength" value="10" class="input-medium" style="width:100%">
                        </div>
                       </td></tr>
                       <tr><td>
                        <div class="form-group" style="width:99%">
                            <label class="control-label">小数位数：</label>
                            <input type="text" name="attribute02" id="attribute02" value="0" class="input-medium" style="width:100%">
                        </div>
                        </td></tr>
                        <tr><td>
                        <div class="form-group" style="width:99%">
                            <label class="control-label">最小值：</label>
                            <input type="text" name="minValue" id="minValue" class="input-medium" style="width:100%">
                        </div>
                        </td></tr>
                        <tr><td>
                        <div class="form-group" style="width:99%">
