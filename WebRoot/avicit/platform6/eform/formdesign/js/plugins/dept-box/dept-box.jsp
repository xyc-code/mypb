...
<form class="form">
    ...
    <input type="hidden" name="colRuleName" id="colRuleName" value="dept">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <table>
					<tr>
                        <label class="control-label">选择属性：</label></tr>
                    <tr><td>
                            <label>
                    ...
                    <div class="form-group">
                        <label>
                            <input name="defaultDept" type="checkbox" class="ace" value="Y">
                            <span class="lbl">&nbsp;默认部门</span>
                        </label>
                    </div>
                    <div class="form-group"  id="defaultDeptTypeDiv">
                        <label class="control-label">与登录人关系：</label>
                            <select name="defaultDeptType" id="defaultDeptType" class="input-medium" style="width:100%">
                                <option value="dept">所在部门</option>
                                <option value="upDept">上级部门</option>
                                <option value="upUpDept">上上级部门</option>
                                <option value="topDept">顶级部门</option>
                            </select>
                    </div>
                        <div class="form-group">
                            <label class="control-label">部门层级：</label>
                            <input type="text" name="deptlevel" id="deptlevel" class="input-medium">
                        </div>
                    <div class="form-group" style="width:99%">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label">部门范围：<a title="部门范围" id="propertyBtn"><i
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            选择框回调事件：
                            <%--<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  data-original-title="提示"
                                  data-content="参数：dept 选中的部门对象</br>dept.deptids:部门ID</br>dept.deptnames:部门名称</br>dept.orgIdentitys:部门所属组织分类"
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  data-content="参数：dept 选中的部门对象</br>dept.deptids:部门ID</br>dept.deptnames:部门名称</br>dept.orgIdentitys:部门所属组织分类"></i>
                        </label>
...
<script>
    ...
    $('input[name=defaultDept]').click(function(event){
        var flag = $(this).is(":checked")
        if (flag) {
            $("#defaultDeptType").val("dept");
            $("#defaultDeptTypeDiv").css("display","block");
        }else{
            $("#defaultDeptType").val("");
            $("#defaultDeptTypeDiv").css("display","none");
        }
    });
