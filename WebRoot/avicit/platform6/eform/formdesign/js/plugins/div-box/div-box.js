var MyElement = {
    ...
    dragElement: function () {
    	var dragelement = {};
    	dragelement.name = "div控件";
    	dragelement.icon = "fa fa-square-o";
    	return dragelement;
    },
    dropElement: function () {
        return '<input type="text" value="div控件">';
    },
    ...
    validateForm:function(eleattr){
        ...
        {
            layer.msg('div控件页面元素ID属性不能为空', {icon: 7});
            return false;
        }else{
            ...
            if(regEn.test(value) || regCn.test(value) ||regCh.test(value)) {
                layer.msg('div控件页面元素ID属性不能含有特殊字符或中文', {icon: 7});
                return false;
            }
        }
        return true;
