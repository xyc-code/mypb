                ...
                <table>
                  ...
                  <tr><td>
                    ...
                    <table style="width:100%"><tr>
                        <td><label class="control-label" >格式校验：</label></td>
                        <td><select name="formatValidate" id="formatValidate" style="width:100%">
                            <option value="">请选择</option>
                            <option value="email">邮箱</option>
                            <option value="phone">手机</option>
                            <option value="idcard">身份证</option>
                            <option value="zipcode">邮编</option>
                            <option value="customset">自定义</option>
                        </select></td>
                     </tr>
                    ...
                    <tr><td>
                        <div class="form-group" id="regExpDiv" style="width:99%">
                            <label class="control-label">正则表达式：</label>
                            <input type="text" name="regExpTxt" id="regExpTxt" class="input-medium" style="width:100%">
                        </div>
                    </td></tr>
                    <tr>
                        <td>
