...
<form class="form">
    ...
    <input type="hidden" name="colRuleName" id="colRuleName" value="group">
                    ...
                    <div class="form-group">
                     <table><tr>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label">群组范围：<a title="群组范围" id="propertyBtn"><i
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            ...
                            <%--<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  ...
                                  data-content="参数：group 选中的群组对象</br>group.groupids:群组ID</br>group.groupNames:群组名称</br>group.orgIdentitys:群组所属组织分类"
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  data-content="参数：group 选中的群组对象</br>group.groupids:群组ID</br>group.groupNames:群组名称</br>group.orgIdentitys:群组所属组织分类"></i>
                        </label>
