            ...
            <div id="collapse1" class="panel-collapse collapse in">
                ...
                <table>
                    <tr><td>
                        ...
                        <div class="form-group">
                            <label class="control-label">偏移高度：</label>
                            <input type="text" name="fixheight" id="fixheight" class="input-medium" value="" style="width:100%">
                        </div>
                    </td></tr>
                    <tr><td>
                        <div class="form-group">
                            <label class="control-label">标签编辑：<a title="标签编辑" id="lableEdit"><i
                                    class="fa fa-fw fa-lg fa-pencil-square-o"></i></a></label>
                            <input type="hidden" name="labelListValue" id="labelListValue" class="input-medium" style="width:99%">
                        </div>
                    </td></tr>
                </table>
                </div>
