                    ...
                    <div class="form-group">
                        <label class="control-label">
                            ...
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover"
                               ...
                               data-content="参数：user 选中的用户对象</br>user.loginNames:登录名</br>user.usernames:用户姓名</br>user.userids:用户ID</br>user.userdeptnames:用户所属部门</br>user.userdeptids:用户所属部门ID</br>user.orgIdentitys:用户所属组织分类"></i>
                            <%--<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  data-original-title="提示"
                                  data-content="参数：user 选中的用户对象</br>user.loginNames:登录名</br>user.usernames:用户姓名</br>user.userids:用户ID</br>user.userdeptnames:用户所属部门</br>user.userdeptids:用户所属部门ID</br>user.orgIdentitys:用户所属组织分类"
                            >?</span>--%>
                        </label>
