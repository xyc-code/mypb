            ...
            <div id="collapse1" class="panel-collapse collapse in">
				...
				<table>
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <input type="text" name="colLength" id="colLength" value="10" class="input-medium">
                    </div>
                    </td></tr>
                    <tr><td>
                    <div class="form-group" style="width:99%">
                        <label class="control-label">小数位数：</label>
                        <input type="text" name="attribute02" id="attribute02" value="2" class="input-medium" style="width:100%">
                    </div>
                    </td></tr>
                    <tr><td>
                    <div class="form-group" style="width:99%">
                        <label class="control-label">最小值：</label>
                        <input type="text" name="minValue" id="minValue" class="input-medium" value="0"  style="width:100%">
                    </div>
                    </td></tr>
                    <tr><td>
                    <div class="form-group" style="width:99%">
                        <label class="control-label">最大值：</label>
                        <input type="text" name="maxValue" id="maxValue" class="input-medium" style="width:100%">
                    </div>
                    </td></tr>
                    <tr><td>
                    <div class="form-group" style="width:99%">
			        ...
			        <td>
                        <select id="selectCurrency" name="selectCurrency"  placeholder="请选择币种" class="SlectBox 4col active" style="width:100%">
