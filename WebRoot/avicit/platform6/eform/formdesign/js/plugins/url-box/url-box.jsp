			...
			<table>
				<tr><td>
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <input type="text" name="colLength" id="colLength" value="255" class="input-medium">
                    </div>
                </td></tr>
                <tr><td>
				...
				<tr><td>
                    <div class="form-group" style="width:99%">
                        <label class="control-label">宽：</label><input type="text" name="width" id="width" class="input-medium" style="width:30%"><label class="control-label">高：</label><input type="text" name="height" id="height" class="input-medium" style="width:30%">
                    </div>
                </td></tr>
                <tr><td>
                    <div class="form-group" style="width:99%">
                ...
                <tr><td>
                    <div class="form-group" id="feedbackSet">
                        <label class="control-label">回填配置：<a title="回填配置" id="addpara"><i
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            ...
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-trigger="hover" data-placement="left"
                                  data-content="参数：jsonData-用户选择的回填数据"></i>
                        </label>
