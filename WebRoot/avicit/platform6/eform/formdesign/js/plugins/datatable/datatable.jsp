            ...
            <div id="collapse1" class="panel-collapse collapse in">
                ...
                <table>
                    ...
                    <tr><td>
                        <div class="form-group">
                            <label>
                                <input name="fkChk" id="fkChk" type="checkbox" class="ace" value="Y">
                                <span class="lbl">&nbsp;启用外键配置</span>
                            </label>
                        </div>
                    </td></tr>

					<tr><td>
                    <div class="form-group" id="singleFk" style="display: none;">
                   ...
                   <tr><td>
                        <div class="form-group" id="multiFk" style="display: none">
                            <label class="control-label">外键配置：<a title="外键配置" id="addpara"><i
                    ...
                    <div class="form-group">
                        <label>
                            <input name="orderChk" id="orderChk" type="checkbox" class="ace" value="Y">
                            <span class="lbl">&nbsp;启用表头排序</span>
                        </label>
                    </div>
                    ...
                    <%--2.添加当前元素特定"事件属性"--%>
                        ...
                        <tr><td>
                            <div class="form-group">
                                ...
                                <i class="tips-iconhelp icon iconfont icon-question-circle" id="onCellSelectSpan" data-rel="popover" data-trigger="hover" data-placement="left" 
                                   data-content="触发此方法时行点击事件失效。参数：rowid、iCol、cellcontent、e"></i>
