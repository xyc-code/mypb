...
<script src="avicit/platform6/eform/formdesign/js/plugins/datatable/selectcolumnfk.js"></script>
<style type="text/css">
	.add-button-group{
		float: right;
    	padding: 1px;
        ...
        <ul class="content-wrap" style="visibility: visible;">
            <form id="property_form">
                ...
                <li class="property-list dbpara urlpara">
                    <span class="property-title">子表字段</span>
                ...
                <li class="property-list urlpara dbpara">
					<span class="property-title">字段类型</span>
					<select type="text" name="paracoltype" id="paracoltype">
                ...
                <li class="property-list dbpara">
                    <span class="property-title">主表字段</span>
