						...
						<input type="hidden" name="detailpagefileName" id="detailpagefileName">
							...
							<li class="notRedundance" id = 'formatDiv' style="width:90%;padding-left:10px;float: left;">
								<span style="height: 30px;padding-top:5px;display: inline-block" >
									...
									<%--<span id="formatSpan" class="help-button" data-rel="popover" data-trigger="hover" data-placement="left"
										...
										<i class="tips-iconhelp icon iconfont icon-question-circle" id="formatSpan" data-rel="popover" data-trigger="hover" data-placement="left"
										  data-content="参数：cellvalue、options,、rowObject 如： if(cellvalue == 1){return '<span style='font-color:red'>'+ cellvalue +'</span>';} else {return '<span style='font-color:gray'>'+ cellvalue +'</span>';}"></i>
								</span>
							...
							<li class="notRedundance" id = 'unformatDiv' style="width:90%;padding-left:10px;float: left;">
								<span style="height: 30px;padding-top:5px;display: inline-block" >
									...
									<%--<span id="unformatSpan" class="help-button" data-rel="popover" data-trigger="hover" data-placement="left"
										...
										<i class="tips-iconhelp icon iconfont icon-question-circle" id="unformatSpan" data-rel="popover" data-trigger="hover" data-placement="left"
										  data-content="用于在编辑或保存时，将已经格式化的值还原。参数：cellvalue、options 如： cellvalue.replace('$','');"></i>
								</span>
								<textarea rows=3  name="unformatEvent"  id="unformatEvent"  style="width: 100%;"></textarea>
							</li>
							<li id = 'callB' class="hidden notRedundcallBance" style="width:90%;padding-left:10px;float: left;">
								<span style="height: 30px;padding-top:5px;display: inline-block" >
									选择框回调事件：
									...
									>?</span>--%>
									<i class="tips-iconhelp icon iconfont icon-question-circle" id="callSpan" data-rel="popover" data-trigger="hover" data-placement="left"></i>
									</span>
							...
							<li id = 'onchangeDiv' style="width:90%;padding-left:10px;float: left;">
								<span style="height: 30px;padding-top:5px;display: inline-block" >
									...
									>?</span>--%>
									<i class="tips-iconhelp icon iconfont icon-question-circle" id="changeSpan" data-rel="popover" data-trigger="hover" data-placement="left"></i>
								</span>
