...
<form class="form">
    ...
    <input type="hidden" name="colRuleName" id="colRuleName" value="position">
                ...
                <div class="panel-body">
                    ...
                    <table>
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label">岗位范围：<a title="岗位范围" id="propertyBtn"><i
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            选择框回调事件：
                            <%--<span class="help-button" data-html="true" data-rel="popover" data-trigger="hover" data-placement="left"
                                  data-original-title="提示"
                                  data-content="参数：position 选中的岗位对象</br>position.positionids:岗位ID</br>position.positionName:岗位名称</br>position.orgIdentitys:岗位所属组织分类"
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-html="true" data-rel="popover" data-trigger="hover" data-placement="left"
                                  data-content="参数：position 选中的岗位对象</br>position.positionids:岗位ID</br>position.positionName:岗位名称</br>position.orgIdentitys:岗位所属组织分类"></i>
                        </label>
