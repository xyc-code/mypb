                    ...
                    <div class="form-group">
                        <label class="control-label">
                            ...
                            <%--<span class="help-button" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  ...
                                  data-content="参数：role 选中的角色对象</br>role.roleids:角色ID</br>role.roleNames:角色名称</br>role.roleType:角色类型</br>role.orgIdentitys:角色所属组织分类"
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-html="true" data-trigger="hover" data-placement="left"
                                  data-content="参数：role 选中的角色对象</br>role.roleids:角色ID</br>role.roleNames:角色名称</br>role.roleType:角色类型</br>role.orgIdentitys:角色所属组织分类"></i>
                        </label>
