                ...
                <div class="panel-body">
                    ...
                    <tr><td>
                        ...
                        <div class="form-group" style="width:99%">
                            ...
                            <select name="showType" id="showType" style="width:100%">
                                <option value="span" selected>卡片式</option>
                                <option value="table" >列表式</option>
                            </select>
                        </div>
                    </td></tr>
					<tr><td>
                    ...
                    <div class="form-group" id="formSecretDiv" style="width:99%">
                        ...
                        <tr><td>
                            <div class="form-group" style="width:99%">
                                <label class="control-label">对应表单业务ID：
                                    <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover"
                                       data-html="true" data-trigger="hover" data-placement="left"
                                       data-content="提示：默认不填，附件挂载在本表单。如需显示其他表单附件，请填写对应的表单字段名称（例如DATA_1）或者页面变量（例如pageParams.urlParam.formId）"></i>
                                </label>
                    ...
                    <div class="form-group" style="width:100%">
                        <label class="control-label">
                            单个附件大小限制：
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-trigger="hover" data-placement="left"
                                  data-content="可带单位包括B、KB、MB、GB，如果省略则默认为KB；属性为0或大于0小于1的小数均表示不限制文件大小；"></i>
                        </label>
                    ...
                    <div class="form-group" style="width:100%">
                        <label class="control-label">
                            ...
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-trigger="hover" data-placement="left"
                                  data-content="样例：{title: 'Images', extensions: 'gif,jpg,jpeg,bmp,png',mimeTypes: 'image/*'}；格式：title文字描述，extensions允许的文件后缀，不带点，多个用逗号分割，mimeTypes多个用逗号分割；"></i>
                        </label>
...
<script>
    ...
    $('input[type=radio][name=allowSecret]').change(function() {
        if (this.value == 'true') {
            ...
            //$("#formSecret").val("");
            $('#formSecret').select2('val', null);
            $("#formSecretDiv").css("display","none");
            $("input[name='allowEncry'][value='false']").prop("checked",true);
        }
    });
    $('input[type=radio][name=allowEncry]').change(function() {
        if (this.value == 'true') {
            $("input[name='allowSecret'][value='true']").prop("checked",true).change();
        }
    });
</script>