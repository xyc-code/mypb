...
<form class="form">
    ...
    <input type="hidden" name="colRuleName" id="colRuleName" value="org">
        ...
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label>
                            <input name="defaultOrg" type="checkbox" class="ace" value="Y">
                            <span class="lbl">&nbsp;默认值（登录人所在组织）</span>
                        </label>
                    </div>
                </td></tr></table>
                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label">
                            选择框回调事件：
                            <%--<span class="help-button" data-rel="popover" data-html="true" data-html="true" data-trigger="hover" data-placement="left"
                                  data-original-title="提示"
                                  data-content="参数：org 选中的组织对象</br>org.orgids:组织ID</br>org.orgnames:组织名称</br>org.orgIdentitys:组织所属组织分类"
                            >?</span>--%>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" data-rel="popover" data-html="true" data-html="true" data-trigger="hover" data-placement="left"
                                  data-content="参数：org 选中的组织对象</br>org.orgids:组织ID</br>org.orgnames:组织名称</br>org.orgIdentitys:组织所属组织分类"></i>
                        </label>
