        ...
        <div class="panel panel-default">
            ...
            <div id="collapse1" class="panel-collapse collapse in">
                ...
                <table>
                    ...
                    <tr><td>
                        <div class="form-group" id="showLabelDiv" style="display:none;">
                            <label>
                                <input name="showLabel" type="checkbox" class="ace" value="Y">
                                <span class="lbl">显示意见标签</span>
                            </label>
                        </div>
                    </td></tr>
					<tr><td>
                    <div class="form-group" id="drawClassDiv" style="width:99%">
                        ...
                        <select id="drawClass" name="drawClass" isnull="false" class="input-medium">	</select>
                    </div>
					</td></tr></table>
                        <%--1.添加公共"基本属性"--%>
                        <jsp:include page="../attr-jsp/base-attr.jsp">
...
<script>
    ...
    $("#bpmopinionTexts").click(function () {
        var bpmIdeaStyleSelect = new BpmIdeaStyleSelect(formEditor.formCode);
