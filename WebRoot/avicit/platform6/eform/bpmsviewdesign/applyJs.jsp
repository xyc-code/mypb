...
<script tpye="text/javascript">
    ...
    */
	...
	//JS字符串转换为Json
	function toJson(viewJsList){
		var list = viewJsList.split(",");
		var viewJs = "";
		for(var i=0;i<list.length;i++){
			viewJs = viewJs + ",{\"jsFile\":\""+list[i]+"\"}";
		}
		viewJs = viewJs.substr(1);
		viewJs = "[" + viewJs + "]";
		return $.parseJSON(viewJs);
	}
