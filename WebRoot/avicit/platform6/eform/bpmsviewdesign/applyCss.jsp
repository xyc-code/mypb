...
<script tpye="text/javascript">
    ...
    */
	...
	//JS字符串转换为Json
	function toJson(viewCssList){
		var list = viewCssList.split(",");
		var viewCss = "";
		for(var i=0;i<list.length;i++){
			viewCss = viewCss + ",{\"cssFile\":\""+list[i]+"\"}";
		}
		viewCss = viewCss.substr(1);
		viewCss = "[" + viewCss + "]";
		return $.parseJSON(viewCss);
	}
