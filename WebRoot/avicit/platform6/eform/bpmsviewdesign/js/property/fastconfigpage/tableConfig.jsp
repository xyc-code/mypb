...
<div id="tableConfigDiv" style="overflow-y: auto; height:100%" data-options="region:'center',split:true,border:false,width:fixwidth(1.0,e),height:fixheight(1.0,e),onResize:function(a){$('#dbCols').setGridHeight(getJgridTableHeight($('#tableConfigDiv')));$('#dbCols').jqGrid('resizeGrid');} ">
    <form>
        ...
        <table class="form_commonTable">
            ...
            <tr>
                ...
                <td width="83%" colspan="3">
                    <div class="input-group input-group-sm" style="display: flex">
                        <input name="Pagingbar" id="Pagingbar" type="checkbox" class="ace" checked
                                                         value="Y" style="line-height: 14px">
                    </div>
                </td>
            </tr>
            <tr class="Pagingbar">
