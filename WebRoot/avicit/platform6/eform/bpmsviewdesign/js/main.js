...
ViewEditor.prototype = {
    ...
    setLayout: function (obj) {
        ...
        $(".eform-layout").find("div").each(function () {
            if (!$(this).children().length > 0) {
                _this.drawAddArea(this, true, true);
            }
        });
    },
    ...
    drawAddArea: function (obj, initDraw, setFlag) {
        var _this = this;
        ...
        if(setFlag != undefined && setFlag){
            //如果add-button区域高度太小，重新设计按钮位置
            var buttonHeight = $(obj).find(".add-area").height();
            if(buttonHeight > 25 && buttonHeight < 70){
                $(obj).find(".add-button").css("margin-top",(buttonHeight-25)/2);
            }else if(buttonHeight <= 25 && buttonHeight > 0){
                $(obj).find(".add-button").css("margin-top",0);
            }
            //如果add-button区域宽度太小，重新设计按钮位置
            var buttonWidth = $(obj).find(".add-area").width();
            if(buttonWidth < 85 && buttonWidth > 0){
                $(obj).find(".add-button").css("width",25);
                $(obj).find(".add-button").css("margin-left",(buttonWidth - 25)/2);
            }
        }else{
            //如果add-button区域高度太小，重新设计按钮位置
            var buttonHeight = $(obj).find(".add-area").height();
            ...
            //如果add-button区域宽度太小，重新设计按钮位置
            var buttonWidth = $(obj).find(".add-area").width();
            if(buttonWidth < 112 && buttonWidth > 0){
                $(obj).find(".add-button").css("width",25);
                $(obj).find(".add-button").css("margin-left",(buttonWidth - 52)/2);
            }
        }
