...
BpmsFormInfo.prototype.shareorg = function(formInfoId) {
    var _this = this;
    layer.confirm("提示1：共享到其他组织后，其他组织对该表单具有同等支配权；<br/>提示2：共享模板不区分版本，即同一表单的各个版本将一并共享出去。<br/>确定继续共享？", function(index){
        _this.doShare(formInfoId);
        layer.close(index);
    });
};

BpmsFormInfo.prototype.doShare = function (formInfoId) {
    var _this = this;
