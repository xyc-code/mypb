...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id="addFormViewActionSettting" role="form">
、
				<input type="hidden" name="id" id="columnId">
				<table class="form_commonTable">
					<tr>
						<th width="10%" style="word-break: break-all; word-warp: break-word;">
							<label for="tableId">关联表单</label>
						</th>
						<td width="40%">
					...
					<tr>
						<th width="10%" style="word-break: break-all; word-warp: break-word;">
							<label for="actionTarget">行为目标</label>
						</th>
						<td width="40%">
							<select class="form-control input-sm" id="actionTarget" name="actionTarget" title="行为目标">
					...
					<tr>
						<th width="10%" style="word-break: break-all; word-warp: break-word;">
							<label for="eventClass">java增强</label>
						</th>
						<td width="40%">
							<input class="form-control input-sm" type="text" name="eventClass" id="eventClass" title="java增强"/>
						</td>
						<td width="5%"></td>
					</tr>
				</table>	
