...
<body>
        ...
        <div data-options="region:'north',split:false" style="height:43px;overflow:visible">
            <div class="toolbar">
                <div class="toolbar-left">
                    ...
                    <a id="eformClassConfig" href="javascript:void(0);" class="btn btn-default form-tool-btn btn-sm" role="button" title="表单事件管理"><i class="icon icon-edit"></i> 表单事件管理</a>
                    <div class="input-group form-tool-search" style="width:200px;float:right">
                        <input type="text" id="searchInput" class="form-control input-sm" placeholder="请输入表单,视图的名称或编码">
                ...
                <div class="formArea" style="display: none;height:100%;">
                    ...
                    <div class="twoTabNav" style="height: 100%">
                        ...
                        <ul class="tab-cont">
                            <li class="eformCont">
                                <div class="demoCont">
                                    ...
                                    <div id="toolbar_formViewModel" class="toolbar">
                                        <div class="toolbar-right">
                                            <div id="commonSearch" class="input-group form-tool-search">
                                                <input type="text" name="formViewModel_keyWord" id="formViewModel_keyWord" class="form-control input-sm" placeholder="请输入名称或编码">
                            ...
                            <li class="noEformCont">
                                <div class="demoCont" class="">
                                    <div id="toolbar_bpmFormModel" class="toolbar">
                                        <div class="toolbar-right">
                                            <div id="bpmcommonSearch" class="input-group form-tool-search">
                                                <input type="text" name="formViewModel_keyWord" id="bpmFormModel_keyWord" class="form-control input-sm" placeholder="请输入名称或编码">
    ...
    $(document).ready(function() {
        ...
        //自定义类维护
        $("#eformLog").click(function(){
            eformFormInfo.toEformLog();
        });
        //试图事件
