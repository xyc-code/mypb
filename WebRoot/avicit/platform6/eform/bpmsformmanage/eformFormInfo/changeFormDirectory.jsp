                                ...
                                $.ajax({
                                    ...
                                    success: function (backData) {
                                        if (backData.flag == "OK") {
                                            ...
                                            if(isForm == "1"){
                                                var formInfo = parent.$('#' + parent.eformFormInfo.formInfoDiv).find("#${param.changeId}");
                                                formInfo.remove();
                                            }else{
                                                var ViewInfo = parent.$('#' + parent.eformFormView.formViewDiv).find("#${param.changeId}");
                                                ViewInfo.remove();
                                            }
                                            ...
                                            if(isForm == "1"){
                                                ...
                                                parent.eformFormView.closeDialog("changeDirectory");
                                            }
