...
<div data-options="region:'center',split:true,border:false">
    <form id='editForm'>
        <input type="hidden" id="id" name="id" value="${eformComponent.id}">
        <input type="hidden" id="eformTypeId" name="eformTypeId" value="${eformComponent.eformTypeId}">
            ...
            <tr>
                ...
                <td width="35%">
                    <input title="名称" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="componentName" id="componentName" value="${eformComponent.componentName}"/>
                </td>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                    <label for="componentCode">编码：</label>
                </th>
                <td width="35%">
                    <input title="编码" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="componentCode" id="componentCode" value="${eformComponent.componentCode}"/>
                </td>
            </tr>
            <tr>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                ...
                <td width="35%">
                    <input title="排序" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="orderBy" id="orderBy" value="${eformComponent.orderBy}"/>
                </td>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                </th>
                <td width="35%">
            ...
            <tr>
                ...
                <td colspan="3" width="85%">
                    <textarea title="描述" rows="3" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="componentDesc" id="componentDesc">${eformComponent.componentDesc}</textarea>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    document.ready = function () {
        ...
        parent.eformComponent.formValidate($('#editForm'));
        $('#saveForm').bind('click', function () {
            parent.eformComponent.subEdit($("#editForm"));
        });
        $('#closeForm').bind('click', function () {
            parent.eformComponent.closeDialog("edit");
        });
    };
</script>
</body>
