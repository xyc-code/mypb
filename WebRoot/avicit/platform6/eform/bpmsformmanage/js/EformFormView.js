    ...
    var template = $(
          '<div class="eform-item" id="">'
            ...
            + '<div class="eform-item-tools" style="display: none;">'
                ...
                + '<div class="copyViewInfo"><i class="glyphicon glyphicon-copy"></i>复制视图</div>'
...
//页面新建一个EformFormView
EformFormView.prototype.setViewInfo = function (data, searchFormViewDiv, initFlag) {
    var _this = this;
...
/*			+'<tr><td width="40%" height="25"><lable>创建时间:</lable></td><td>'+data.creationDate+'</td></tr>'*/
    ...
    viewInfo.find(".copyViewInfo").click(function () {
        _this.copyData(data.id);
        return false;
    });

    viewInfo.find(".changeDirectory").click(function () {
...
//复制
EformFormView.prototype.copyData = function (EformFormViewId) {
    var _this = this;
    ...
    editDialog = layer.open({
        ...
        area: ['100%', '100%'],
        maxmin: false,
        content: "platform/eform/eformViewInfoController/copyEformViewInfo?id=" + EformFormViewId
    });
};

//切换目录
EformFormView.prototype.changeDirectory = function (EformFormViewId) {
    var _this = this;
    ...
    changeDirectoryDialog = layer.open({
        ...
        area: ['30%', '60%'],
        maxmin: false,
        content: "avicit/platform6/eform/bpmsformmanage/eformFormInfo/changeFormDirectory.jsp?changeId=" + EformFormViewId + "&isForm=0"
    });
};
//删除
    ...
    $.ajax({
        ...
        success: function (backData) {
            ...
            for (var i = 0; i < formViewList.length; i++) {
                _this.setViewInfo(formViewList[i], undefined, true);
            }
        }
    });
};
...
//提交复制
EformFormView.prototype.subCopy = function (form, oldViewCode) {
    var _this = this;
    ...
    var parm = "formDataJson=" + formDataJson + "&oldViewCode=" + oldViewCode;
    $.ajax({
        url: "platform/eform/eformViewInfoController/subCopyEformViewInfo",
        data: parm,
        type: "post",
        async: false,
        dataType: "json",
...
EformFormView.prototype.reImportViewXml = function (data) {
    ...
    uploadDialog = layer.open({
        ...
        area: ['400px', '200px'],
        maxmin: false,
        content: "avicit/platform6/eform/bpmsformmanage/eformFormView/reImportView.jsp?formId=" + data.id+"&currentVersion=" + data.currentVersion+"&eformComponentId=" + data.eformComponentId +"&publishStatus=" + data.publishStatus
    });
};
...
EformFormView.prototype.reloadGrid = function () {
    if (eformFormViewModel!=null && typeof(eformFormViewModel)!="undefined"){
        eformFormViewModel.reLoad(eformComponent.selectedEformComponentId);
    }
}