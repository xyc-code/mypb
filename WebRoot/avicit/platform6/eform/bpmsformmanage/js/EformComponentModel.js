function EformComponentModel(datagrid, url, formSub, dataGridColModel, searchDialogSub, nodeId, nodeType,searchSubNames, bpmHistProcinst_KeyWord) {
...
//初始化操作
EformComponentModel.prototype.init = function() {
	var _self = this;
	$(_self._datagridId).jqGrid({
		...
		height : $(window).height() - 120 - 50-20,
...
EformComponentModel.prototype.formValidate = function(form) {
	form.validate({
		rules : {
...
//重载数据
EformComponentModel.prototype.reLoad = function(nodeId) {
	if (nodeId != undefined) {
		this.nodeId = nodeId;
	}
...
//关闭对话框
EformComponentModel.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
EformComponentModel.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
EformComponentModel.prototype.searchData = function() {
	var searchdata = {
		keyWord :'',
		nodeId : this.nodeId,
...
//关键字段查询
EformComponentModel.prototype.searchByKeyWord = function() {
...
//隐藏查询框
EformComponentModel.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
EformComponentModel.prototype.clearData = function() {
