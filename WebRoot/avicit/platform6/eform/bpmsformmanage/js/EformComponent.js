...
EformComponent.prototype.setComponent = function (data) {
    ...
    var formCount = (data.formCount ==null?0:data.formCount)+(data.bpmFormCount==null?0:data.bpmFormCount);
    ...
    _formContent = '<table width="180px" border="0" style="font-size:12px;"  align="center">'
        +'<tr><td width="40%" height="25"><lable>模块名称:</lable></td><td><span class="eform-item-popover" title="'+data.componentName+'">'+data.componentName+'</span></td></tr>'
        +'<tr><td width="40%" height="25"><lable>表单数量:</lable></td><td><span class="eform-item-popover" title="'+formCount+'">'+formCount+'</span></td></tr>'
        +'<tr><td width="40%" height="25"><lable>视图数量:</lable></td><td><span class="eform-item-popover" title="'+viewCount+'">'+viewCount+'</span></td></tr>'
        +'<tr><td width="40%" height="25"><lable>排序:</lable></td><td>'+data.orderBy+'</td></tr>'
        +'</table>';
    component.find(".eform-item-title").attr("data-content", _formContent);
    ...
    component.find(".changeDirectory").click(function () {
        _this.changeDirectory(data.id,data.eformTypeId);
        return false;
    });
...
EformComponent.prototype.clickTitle = function (id){
    ...
    if(showType=="1"){	
    	...
    	if(eformFormViewModel==null || eformFormViewModel==undefined){
            ...
            searchSubNames.push("code");
            searchSubTips.push("编码");
			$('#formViewModel_keyWord').attr('placeholder', '请输入' + searchSubTips[0] + '或' + searchSubTips[1]);
			var module = [
				{
					label : 'id',
					name : 'id',
        ...
        if (bpmsformInfoModel==null || bpmsformInfoModel==undefined){
            ...
            searchBpmTips.push("编码");
            $('#bpmFormModel_keyWord').attr('placeholder', '请输入' + searchBpmTips[0] + '或' + searchSubTips[1]);
...
EformComponent.prototype.changeDirectory = function (eformComponentId,eformTypeId) {
    var _this = this;
    ...
    changeDirectoryDialog = layer.open({
        ...
        area: ['30%', '60%'],
        maxmin: false,
        content: "avicit/platform6/eform/bpmsformmanage/eformFormInfo/changeEformTypeDirectory.jsp?eformTypeId=" + eformTypeId + "&eformComponentId=" + eformComponentId
    });
};
...
function getformviewButtons(cellvalue, options, rowObject) {
	if (rowObject.type != "view"){
		if (rowObject.publishStatus == "0"){
            ...
            +'  <a href="javascript:void(0)" class="glyphicon glyphicon-copy"'
            +'   title="复制表单" onClick="eformFormInfo.copyData(\''+rowObject.id+'\')"></a>&nbsp;&nbsp;'
		...
		if (rowObject.publishStatus == "0"){
            ...
            +'  <a href="javascript:void(0)" class="glyphicon glyphicon-copy"'
            +'   title="复制视图" onClick="eformFormView.copyData(\''+rowObject.id+'\')"></a>&nbsp;&nbsp;'
			+'  <a href="javascript:void(0)" class="glyphicon glyphicon-upload"'
            ...
            +'  <a href="javascript:void(0)" class="glyphicon glyphicon-transfer"'
            +'   title="切换目录" onClick="eformFormView.changeDirectory(\''+rowObject.id+'\')"></a>';
		}else if(rowObject.enabled == "Y"){
			return '<a href="javascript:void(0)" class="glyphicon glyphicon-pencil"'
			+'  title="编辑视图" onClick="eformFormView.editData(\''+rowObject.id+'\')"></a>&nbsp;&nbsp;'
			+'  <a href="javascript:void(0)" class="glyphicon glyphicon-trash"'
			...
			+'   title="重新生成页面" onClick="eformFormView.doCreate(\''+rowObject.id+'\')"></a>&nbsp;&nbsp;'
            +'  <a href="javascript:void(0)" class="glyphicon glyphicon-list"'
            +'   title="挂载菜单" onClick="eformFormView.sendMenu(\''+rowObject.id+'\',\''+rowObject.name+'\',\''+rowObject.code+'\',\''+rowObject.style+'\',\''+rowObject.currentVersion+'\')"></a>&nbsp;&nbsp;'
            +'  <a href="javascript:void(0)" class="glyphicon glyphicon-floppy-save"'
            +'   title="覆盖导入" onClick="eformFormView.reImportViewXml('+JSON.stringify(rowObject).replace(/\"/g,"'")+')"></a>&nbsp;&nbsp;'
			+'  <a href="javascript:void(0)" class="glyphicon glyphicon-floppy-open"'
			+'   title="导出" onClick="eformFormView.exportViewXml('+JSON.stringify(rowObject).replace(/\"/g,"'")+')"></a>'
...
function getOptButtons(cellvalue, options, rowObject) {
	...
	return '<a href="javascript:void(0)" class="glyphicon glyphicon-pencil"'
        ...
        +'  <a href="javascript:void(0)" class="glyphicon glyphicon-transfer"'
        +'   title="切换目录" onClick="eformComponent.changeDirectory(\''+rowObject.id+'\',\''+rowObject.eformTypeId+'\')"></a>&nbsp;&nbsp;'
        +'  <a href="javascript:void(0)" class="glyphicon glyphicon-book"'
        +'   title="模块导出记录" onClick="eformComponent.exportLog(\''+rowObject.id+'\')"></a>';
