    ...
    var setting = {
        ...
        callback: {
            ...
            onClick: function (event, treeId, treeNode) {
                ...
                if(typeof eformComponent != 'undefined'){
                ...
                }else if(typeof eformDesignTemplate != 'undefined'){
                    $("." + eformDesignTemplate.designTemplateArea).css("display", "");
                    $("#searchInput").val("");
                    eformDesignTemplate.selectedEformComponentId = null;
                    //获取该分类下电子表单模块列表
                    eformDesignTemplate.getComponentList(_this.selectedNodeId);
                }
...
EformTypeTree.prototype.onseach = function(ecode, value){
    var _self = this;
    if(ecode == 13){
        ...
        $.ajax({
            cache: true,
            type: "post",
            url: "platform/eform/bpmsManageController/getEformTypeTree/search",
            dataType:"json",
            ...
            success: function(data) {
                var rootNode=_self.tree.getNodeByParam("pId",null,null)
