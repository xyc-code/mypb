function EformFormViewModel(datagrid, url, formSub, dataGridColModel, searchDialogSub, nodeId, nodeType,searchSubNames, bpmHistProcinst_KeyWord) {
...
//初始化操作
EformFormViewModel.prototype.init = function() {
	var _self = this;
	$(_self._datagridId).jqGrid({
		...
		height : $(window).height() - 120 - 50 - 34,
...
EformFormViewModel.prototype.formValidate = function(form) {
	form.validate({
		rules : {
...
//重载数据
EformFormViewModel.prototype.reLoad = function(nodeId) {
	if (nodeId != undefined) {
		this.nodeId = nodeId;
	}
...
//关闭对话框
EformFormViewModel.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
EformFormViewModel.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
EformFormViewModel.prototype.searchData = function() {
	//解决jqGrid查询累加问题
	var postData = $(this._datagridId).jqGrid("getGridParam", "postData");
...
//关键字段查询
EformFormViewModel.prototype.searchByKeyWord = function(value) {
...
//隐藏查询框
EformFormViewModel.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
EformFormViewModel.prototype.clearData = function() {
