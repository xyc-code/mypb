...
<div id="tableToolbar" class="toolbar">
    <div class="toolbar-left">
        ...
        <a id="button_import" href="javascript:void(0)"
           class="btn btn-primary form-tool-btn btn-sm" role="button"
           title="导入"><i class="icon icon-daoru"></i> 导入</a>
        <a id="button_export" href="javascript:void(0)"
           class="btn btn-primary form-tool-btn btn-sm" role="button"
           title="导出"><i class="icon icon-daochu"></i> 导出</a>
        <a id="button_explain" href="javascript:void(0)"
           class="btn btn-primary form-tool-btn btn-sm" role="button"
           title="事件说明"><i class="icon icon-banben1"></i> 事件说明</a>
...
<script type="text/javascript">
    ...
    $('#button_explain').bind('click', function () {
        editEformClassConfig.openExplain();
    });

    $('#button_export').bind('click', function () {
        editEformClassConfig.doExport();
    });

    $('#button_import').bind('click', function () {
        editEformClassConfig.openImport();
    });
