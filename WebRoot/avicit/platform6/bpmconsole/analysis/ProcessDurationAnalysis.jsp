			...
			<div title="流程平均耗时最长TOP10" style="padding:10px;width:auto">
				...
				<fieldset>
					...
					<table class="tableForm" width='100%' align="left">
						<tr>
							<td style="width:90px" align="left">&nbsp;开始时间：</td>
							<td style="width:140px" align="left"><input name="startDateBegin" id="processDurationTop10_startDateBegin" class="easyui-datebox" editable="false" style="width:130px;" /></td>
							<td style="width:90px" align="left">&nbsp;结束时间：</td>
							<td style="width:140px" align="left"><input name="startDateEnd" id="processDurationTop10_startDateEnd"  class="easyui-datebox" editable="false" style="width: 130px;" /></td>
							<td  align="left">
							...
							<td>
							<!-- <img src="static/images/platform/common/icons/table.png" title="列表统计" onclick="openProcessInstanceDurationList()" style="cursor:pointer"/> -->
							</td>
						</tr>
					</table>
				</fieldset>
			...
			<div title="流程启动实例最多TOP10" style="padding:10px;width:auto">
				<div class="datagrid-toolbar" style="height:auto;display: block;">
					...
					<table class="tableForm"  width='100%' align="left">
						<tr>
							<td style="width:90px" align="left">&nbsp;开始时间：</td>
							<td style="width:140px" align="left"><input name="startDateBegin" id="processStartInstanceTop10_startDateBegin" class="easyui-datebox" editable="false" style="width:130px;" /></td>
							<td style="width:90px" align="left">&nbsp;结束时间：</td>
							<td style="width:140px" align="left"><input name="startDateEnd" id="processStartInstanceTop10_startDateEnd"  class="easyui-datebox" editable="false" style="width: 130px;" /></td>
							<td  align="left">
							...
							<td>
							<!-- <img src="static/images/platform/common/icons/table.png" title="列表统计" onclick="openProcessStartInstanceList()" style="cursor:pointer"/> -->
							</td>
						</tr>
					</table>
					</fieldset>
			...
			<div title="流程人工活动耗时最长TOP10" style="padding:10px;width:auto">
				<div class="datagrid-toolbar" style="height:auto;display: block;">
					...
					<table class="tableForm"  width='100%' align="left">
						<tr>
							<td style="width:90px" align="left">&nbsp;开始时间：</td>
							<td style="width:140px" align="left"><input name="startDateBegin" id="taskActDurationTop10_startDateBegin" class="easyui-datebox" editable="false" style="width:130px;" /></td>
							<td style="width:90px" align="left">&nbsp;结束时间：</td>
							<td style="width:140px" align="left"><input name="startDateEnd" id="taskActDurationTop10_startDateEnd"  class="easyui-datebox" editable="false" style="width: 130px;" /></td>
							<td  align="left">
			...
			<div title="流程自动活动耗时最长TOP10" style="padding:10px;width:auto">
				<div class="datagrid-toolbar" style="height:auto;display: block;">
					...
					<table class="tableForm"  width='100%' align="left">
						<tr>
							<td style="width:90px" align="left">&nbsp;开始时间：</td>
							<td style="width:140px" align="left"><input name="startDateBegin" id="autoActDurationTop10_startDateBegin" class="easyui-datebox" editable="false" style="width:130px;" /></td>
							<td style="width:90px" align="left">&nbsp;结束时间：</td>
							<td style="width:140px" align="left"><input name="startDateEnd" id="autoActDurationTop10_startDateEnd"  class="easyui-datebox" editable="false" style="width: 130px;" /></td>
							<td  align="left">
    		...
    		<div title="流程异常统计" style="padding:10px;width:auto">
    			<div id="d1" class="datagrid-toolbar" style="height:auto;display: block;">
					...
					<table class="tableForm"  width='100%' align="left">
						<tr>
							<td style="width:90px" align="left">&nbsp;开始时间：</td>
							<td style="width:140px" align="left"><input name="startDateBegin" id="processException_startDateBegin" class="easyui-datebox" editable="false" style="width:130px;" /></td>
							<td style="width:90px" align="left">&nbsp;结束时间：</td>
							<td style="width:140px" align="left"><input name="startDateEnd" id="processException_startDateEnd"  class="easyui-datebox" editable="false" style="width: 130px;" /></td>
							<td  align="left">
    			...
    			<div id="processExceptionInfoDiv" style="width:700px;height:400px;" title="异常详细信息"></div>
