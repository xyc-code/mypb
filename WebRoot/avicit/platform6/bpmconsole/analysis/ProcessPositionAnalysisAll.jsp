...
function loadProcessEntry(){
	...
	$('#processDeptAnalysisAll').datagrid({
		url: 'platform/bpm/bpmconsole/processPositionAnalysisAction/get<%=tab%>.json?startDate=<%=startDate%>&endDate=<%=endDate%>&querySign=<%=querySign%>&positionId=<%=positionId%>',
		width: '100%',
		nowrap: false,
	    striped: true,
	    autoRowHeight:false,
		...
		loadMsg:' 处理中，请稍候…',
		columns:[[
			{field:'name',title:'岗位名',width:50,align:'left'},
