...
$(function(){
	...
	$('#processForm').datagrid({
		url: 'platform/bpm/bpmPublishAction/getProcessForms.json?ifMobile=no',
		width: '100%',
        nowrap: true,
        ...
        columns:[[
				  ...
				  {field:'formCode',title:'表单编码',width:120,rowspan:2},
				  {field:'formName',title:'表单名称',width:150,rowspan:2},
                  {field:'formUrl',title:'PC表单URL',width:380},
                  /*{field:'formType',title:'表单类型',width:65,rowspan:2},*/
                  {field:'proxyPage',title:'是否代理',width:70, align: 'center',formatter: typeformatter, editor: { type: 'combobox', options: { data: proxyValue, valueField: "value", textField: "text",editable:false,onSelect:endEdit}}}
              ]]
	});
});
