 ...
 * @param resourceId
 */
function SysPrint(datagrid,url,dataGridColModel,resourceId, eformName, eformCode){
...
SysPrint.prototype.insert=function(){
	...
	this.insertIndex = layer.open({
        ...
        success: function(layero, index){
			...
			iframeWin.$('#printTempName').val(_self.eformName);
			iframeWin.$('#printTempCode').val(_self.eformCode);
    	}
	});
};
/**
 ...
 * 保存方法
 */
SysPrint.prototype.save=function(form,id,saveButton){
	var _self = this;
