		...
		success : function(r) {
			if (r.flag == "success") {
                if(r.typeKeyExist != null && r.typeKeyExist != "" && r.typeKeyExist != undefined){
                    layer.msg('系统代码值【' + r.typeKeyExist + "】已存在，请重新填写！");
                    return false;
                }else if(r.typeValueExist != null && r.typeValueExist != "" && r.typeValueExist != undefined){
                    layer.msg('系统代码名称【' + r.typeValueExist + "】已存在，请重新填写！");
                    return false;
