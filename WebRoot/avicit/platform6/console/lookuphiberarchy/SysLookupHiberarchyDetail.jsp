...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="id" value="<c:out value='${sysLookupHiberarchyDTO.id}'/>" />
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td>
						<input class="form-control input-sm" type="text" name="uniqueKey"  id="uniqueKey" value="<c:out value='${sysLookupHiberarchyDTO.uniqueKey}'/>">
					</td>
					<th>
				...
				<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="treeSort" id="treeSort"  data-min="-999999999999" data-max="999999999999" data-step="1" data-precision="0" value="<c:out value='${sysLookupHiberarchyDTO.treeSort}'/>">
	...
	<script type="text/javascript">
		function closeForm(){
			parent.newSysLookupHiberarchy.closeDialog("detail");
		}
