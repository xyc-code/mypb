...
<div id="tableToolbargroup" class="toolbar">
	<div class="toolbar-left">
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleGroup_button_add" permissionDes="添加">
	  		<a id="consolegroup_insert" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point" role="button" title="添加群组"><i class="icon icon-add"></i> 添加群组</a>
		</sec:accesscontrollist>
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleGroup_button_edit" permissionDes="编辑">
		...
		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleGroup_button_delete" permissionDes="删除">
...
$(document).ready(function () {
	...
	var dataGridUserColModel =  [
      ...
      ,{ label: '部门', name: 'deptName',sortable : false, width: 150 ,align:'center', hidden:true}
	];
