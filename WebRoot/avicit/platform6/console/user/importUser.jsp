...
<div id="tableToolbar" class="toolbar">
	<div class="toolbar-left">
	  	<a id="consoleUser_insert" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point" role="button" onclick="downLoadTemplater();" href="javascript:void(0);" title="模板下载"><i class="icon icon-download"></i>模板下载</a>
