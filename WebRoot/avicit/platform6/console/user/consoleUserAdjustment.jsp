...
<%
    ...
    String adjustTab = request.getParameter("adjustTab");
%>
<!DOCTYPE html>
<html>
<head>
    <title>批量修改用户角色</title>
    ...
    <style type="text/css">
        ...
        /*.templateUserTips1{
            width: 16px;
            height: 16px;
            background: url(static/images/platform/common/tips.png) no-repeat;
            position: absolute;
            top: 34px;
            margin-left:10px;
...
<BODY class=" easyui-layout" style="padding-top:5px;padding-left: 10px;padding-right: 10px;">
<div class="eform-tab">
    <%--<div class="tab-parent" style="position: relative;"><ul class="nav nav-tabs eform-nav-tabs" role="tablist">
        <li role="presentation" onclick="if (window.jQuery){$(window).trigger('resize');$('#userDeptId').val('');$('#userDeptName').val('');}" class="presentation eform-form-tab active"><a href="#g9zfQi30WYz1TO4SOHYYPyNFPqrNGVYr" aria-controls="g9zfQi30WYz1TO4SOHYYPyNFPqrNGVYr" role="tab" data-toggle="tab">调整角色</a></li>
        <li role="presentation" onclick="if (window.jQuery){$(window).trigger('resize');$('#userName').val('');$('#userId').val('');$('#roleDetail').text('角色详情(0)');}" class="presentation eform-form-tab"><a href="#oCm5PZfR9Tpu2xMwSvo32NDoRvivPD5S" aria-controls="oCm5PZfR9Tpu2xMwSvo32NDoRvivPD5S" role="tab" data-toggle="tab">调整部门</a></li>
    </ul></div>--%>
    <c:set value="<%=adjustTab%>" var="adjustTab"/>
    <c:choose>
        <c:when test="${adjustTab=='role'}">
            <div class="boader-quarantine" style="height: 100%">
                <table class="form_commonTable" style="table-layout: fixed;">


                    <tr>
                        <td style="word-break: break-all; word-warp: break-word; width:160px;"><i class="required">*</i><label
                                for="userName">选择模版用户：</label></td>
                        <td style="width: 250px;">
                            <div class="input-group input-group-sm " style="width:100%;">
                                <input type="hidden" id="userId" name="userId" title="模版人员">
                                <input type="text" class="form-control" id="userName" name="userName" style=""
                                       title="模版用户">
                                <span class="input-group-addon user-box-act" id="userButton"> <i
                                        class="glyphicon glyphicon-user"></i> </span>
                            </div>
                        </td>
                        <td style="width: 80px;"><a id="roleDetail" class="text-link" onclick="havePartRole()"
                                                    role="button">角色详情(0) </a></td>
                        <td style="width: 160px; text-align: right">
                            <label class="checkbox-inline"><input style="float:left;margin-top:4px;" id="defMethodRole"
                                                                  type="checkbox" name="defMethod">覆盖</label>
                            <i class="tips-iconhelp icon iconfont icon-question-circle" id="templateUserTips1"></i>
                        </td>
                    </tr>
                    <tr>

                        <td style="width: 672px;" colspan="4">
                                <%--<i class="glyphicon glyphicon-bullhorn" style="color: #0f75e1;font-size: 13px;"><span style="color: red;"> 提示:默认新增所选角色，三员及平台管理员不做复制，如果勾选“删除用户已有角色”，则会删除用户原有的角色，设置最新选中的角色。</span></i>--%>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <c:otherwise>
            <div class="boader-quarantine">
                <table class="form_commonTable" style="table-layout: fixed;">


                    <tr>
                        <td style="word-break: break-all; word-warp: break-word; width:160px;"><i class="required">*</i><label
                                for="userName">选择目标主部门：</label></td>
                        <td style="width: 250px;">
                            <div class="input-group input-group-sm " style="width:100%;">
                                <input type="hidden" id="userDeptId" name="userDeptId" title="目标人员">
                                <input type="text" class="form-control" id="userDeptName" name="userDeptName" style=""
                                       title="目标主部门">
                                <span class="input-group-addon user-box-act" id="deptUserButton"> <i
    ...
    <%-- <div role="tabpanel" class="tab-pane active" contenteditable="false" id="g9zfQi30WYz1TO4SOHYYPyNFPqrNGVYr" style="height: 100%; min-height: 40px;">--%>
    <%--<div class="boader-quarantine">
        <table class="form_commonTable" style="table-layout: fixed;">


            <tr>
                <td  style="word-break: break-all; word-warp: break-word; width:160px;"><i class="required">*</i><label for="userName">选择模版用户：</label></td>
                <td style="width: 250px;">
                    <div class="input-group input-group-sm " style="width:100%;">
                        <input type="hidden" id="userId" name="userId" title="模板人员" >
                        <input type="text" class="form-control" id="userName" name="userName" style="" title="模板用户" >
                        <span class="input-group-addon user-box-act" id="userButton"> <i class="glyphicon glyphicon-user"></i> </span>
                    </div>
                </td>
                <td style="width: 80px;"><a id="roleDetail" class="text-link" onclick="havePartRole()" role="button">角色详情(0) </a></td>
                <td style="width: 160px; text-align: right" >
                    <label class="checkbox-inline"><input style="float:left;margin-top:4px;" id="defMethodRole" type="checkbox" name="defMethod">覆盖</label>
                    <i class="tips-iconhelp icon iconfont icon-question-circle" id="templateUserTips1"></i>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 672px;" colspan="4" >
                    &lt;%&ndash;<i class="glyphicon glyphicon-bullhorn" style="color: #0f75e1;font-size: 13px;"><span style="color: red;"> 提示:默认新增所选角色，三员及平台管理员不做复制，如果勾选“删除用户已有角色”，则会删除用户原有的角色，设置最新选中的角色。</span></i>&ndash;%&gt;
                </td>
            </tr>
        </table>
    </div>--%>
    <%--</div>--%>
    <%--<div role="tabpanel" class="tab-pane" contenteditable="false" id="oCm5PZfR9Tpu2xMwSvo32NDoRvivPD5S" style="height: 100%; min-height: 40px;">
        &lt;%&ndash;<div class="boader-quarantine">
            <table class="form_commonTable" style="table-layout: fixed;">


                <tr>
                    <td  style="word-break: break-all; word-warp: break-word; width:160px;"><i class="required">*</i><label for="userName">选择目标主部门：</label></td>
                    <td style="width: 250px;">
                        <div class="input-group input-group-sm " style="width:100%;">
                            <input type="hidden" id="userDeptId" name="userDeptId" title="目标人员" >
                            <input type="text" class="form-control" id="userDeptName" name="userDeptName" style="" title="目标主部门" >
                            <span class="input-group-addon user-box-act" id="deptUserButton"> <i class="glyphicon glyphicon-user"></i> </span>
                        </div>
                    </td>
&lt;%&ndash;                        <td style="width: 80px;"><a id="roleDetail" class="text-link" onclick="havePartRole()" role="button">角色详情(0) </a></td>&ndash;%&gt;
&lt;%&ndash;                        <td style="width: 160px; text-align: right" >&ndash;%&gt;
&lt;%&ndash;                            <label class="checkbox-inline"><input style="float:left;margin-top:4px;" id="defMethodRole" type="checkbox" name="defMethod">覆盖调整</label>&ndash;%&gt;
&lt;%&ndash;                            <span class="templateUserTips1"></span>&ndash;%&gt;
&lt;%&ndash;                        </td>&ndash;%&gt;
                </tr>
                <tr>
...
<div class="easyui-layout boader-quarantine style-down" fit="true" style="overflow: hidden;margin-top: 5px;">
    ...
    <div id="_platform-userselect-userview" data-options="region:'center',split:false"
         style="overflow: hidden;padding:0 14px;height: 360px;">
...
<script type="text/javascript">
        ...
        setting = {
            ...
            callback: {
                ...
                onAsyncSuccess: function (event, treeId, treeNode, msg) {
                    ...
                    var firstEle = $('#selectUserTree li span.roots_docu');
                    if (firstEle) {
                        firstEle.removeClass("roots_docu");
                    }
                },
    ...
    function formatOp(cellvalue, options, rowObject) {
        return '<span class="icon icon-close" aria-hidden="true" title="移除" onclick="deleteSelectedCascade(\'' + rowObject.id + '\');"></span>';
    }
    ...
    function initTips() {
        var tipsIndex;
        $("#templateUserTips1").mouseover(function () {
            var message = "<span style='color:#333333;'>默认不勾选则新增所选模版用户的所有角色，如果勾选则会删除用户原有的角色，设置为模版用户的所有角色。<br/>" +
                "三员及平台管理员角色不能被批量调整。</span>";
    ...
    document.ready = function () {
        ...
        $('#userName').on('focus',function(e){
            ...
            new H5CommonSelect({secretLevel:secretLevelValue,type:'userSelect', idFiled:'userId',textFiled:'userName',viewScope:'currentOrg',selectModel:'single'
                ,hidTab:[], callBack:function(user){
                                changeRoleCount(user);
                                $('#deptId').val(user.userdeptids);
                                $('#deptName').val(user.userdeptnames);
                            }
            });
            this.blur();
        });
        $('#userDeptName').on('focus',function(e){
            var secretLevelValue = '';
            new H5CommonSelect({type:'deptSelect', idFiled:'userDeptId',textFiled:'userDeptName',viewScope : 'currentOrg',
                callBack:function(dept){
                    $('#deptId').val(dept.userdeptids);
                    $('#deptName').val(dept.userdeptnames);
                }
            });
            this.blur();
        });
        ...
        userframe.consoleUser.formValidate($('#form'));

    };
    /**
     * 角色详情数量
     */
    function changeRoleCount(user){
        if (user.userids == '' || user.userids == null) {
            $("#roleDetail").text("角色详情(0)");
        } else {
            avicAjax.ajax({
                url: "platform/console/user/getMapUserRole?id="+user.userids,
                data: {"userids": JSON.stringify(useridArrays), "deptids": JSON.stringify(userDeptidsArrays)},
                type: 'post',
                dataType: 'json',
                success: function (r) {
                    $("#roleDetail").text("角色详情("+r.rows.length+")");
                }
            });
        }
    }
    ...
    function havePartRole() {
        deptIndex = parent.layer.open({
            ...
            content: 'platform/console/user/toDetailRoleList?id=' + $("#userId").val()
        });
    }
    /**
     * 提示信息
    ...
    var tipsIndex;
    $(".templateUserTips1").mouseover(function(){
        var message="默认不勾选则新增所选模版用户的所有角色，如果勾选则会删除用户原有的角色，设置为<span style='color:#ff0000'>模版用户的所有角色。三员及平台管理员角色不能被批量调整。</sapn>";
        tipsIndex= layer.tips(message, $(this), {
            tips: [1, '#3595CC'],
            area: ['500px', 'auto'],
            time: 0
