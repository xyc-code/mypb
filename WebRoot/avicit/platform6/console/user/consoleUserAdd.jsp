		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%"><input title="用户编号" class="form-control input-sm" type="text" name="no" id="no" /></td>
					...
					<td width="50%" valign="top" style="padding-bottom: 6px;"
						...
						<div style="margin-left:100px; position: relative; width: 130px; height: 180px;">
									<img title='上传个人头像文件' id="sysUserHeadPhotoImg"
										...
										style="cursor:pointer;vertical-align:bottom" onclick="chooseUserPhoto();" />
				...
				<tr>
					...
					<td width="39%"><input title="用户姓名" class="form-control input-sm" type="text" name="name" id="name" /></td>
					
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="mobile">手机:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="mobile" id="mobile" /></td>
			...
			<table class="form_commonTable">
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="applyDeptidAlias">部门:</label></th>
							<td width="39%" >
								<div class="input-group  input-group-sm">
							   	  <input type="hidden"  id="deptId" name="deptId" value="${deptId}">
							      <input class="form-control" placeholder="请选择部门" type="text" id="applyDeptidAlias" name="applyDeptidAlias" value="${deptCode}">
					...
					<td width="35%"  colspan="3">
						<pt6:h5select css_class="form-control input-sm" name="secretLevel" id="secretLevel" title="" isNull="true" lookupCode="PLATFORM_USER_SECRET_LEVEL" />
					</td>
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="applyPositionidAlias">岗位:</label></th>
							<td width="39%" >
								<div class="input-group  input-group-sm">
					...
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="email" id="email" /></td>
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="applyRoleidAlias">角色:</label></th>
							<td width="39%" >
								<div class="input-group  input-group-sm">
							   	  <input type="hidden"  id="ruleId" name="ruleId">
							      <input class="form-control" placeholder="请选择角色" type="text" id="applyRoleidAlias" name="applyRoleidAlias" >
							      <span class="input-group-btn">
					...
					<td width="39%"  colspan="3">
						<pt6:h5radio css_class="radio-inline"  name="type" title="" canUse="0" lookupCode="USER_TYPE" defaultValue='0'/>
					</td>
				...
				<tr>
					...
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="satisfactionSurvey">性别:</label></th>
					<td width="39%"  colspan="3">
						<pt6:h5radio css_class="radio-inline"  name="sex" title="" canUse="0" lookupCode="PLATFORM_SEX" defaultValue='1'/>
					</td>
				...
				<tr>
					...
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="unitCode" id="unitCode" /></td>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="status">状态:</label></th>
					<td width="39%" >
						<pt6:h5radio css_class="radio-inline"  name="status" title="" canUse="0" lookupCode="PLATFORM_USER_STATUS" defaultValue='1'/>
					</td
				...
				<tr>
					...
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="orderBy" id="orderBy" /></td>
					...
					<td width="39%" >
						<pt6:h5radio css_class="radio-inline"  name="consoleType" title="" canUse="0" lookupCode="PLATFORM_CONSOLE" defaultValue='1'/>
					</td>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%" >
						<pt6:h5select css_class="form-control input-sm" name="polity" id="polity" title="" isNull="true" lookupCode="PLATFORM_POLITICAL" />
					</td>
					...
					<td width="50%" valign="top" style="padding-bottom: 6px;"
								...
								<div style="margin-left:100px; position: relative; width: 130px; height: 180px;">
									...
									<span class="img-delete" title="删除签名" id="deleteUpdateQM">x</span>
								</div>
					</td>
				...
				<tr>
					...
					<td width="39%">
						<div class="input-group input-group-sm">
		                	<input class="form-control date-picker" type="text" name="workDate" id="workDate" /><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
		              	</div>
					</td>
				</tr>
				<tr>
					...
					<td width="39%">
						<div class="input-group input-group-sm">
		                	<input class="form-control date-picker" type="text" name="birthday" id="birthday" /><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
		              	</div>
					</td>
				...
				<tr>
					...
					<td width="39%" >
						<pt6:h5select css_class="form-control input-sm" name="degree" id="degree" title="" isNull="true" lookupCode="PLATFORM_DEGREE" />
					</td>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="education" id="education" /></td>
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="nation">民族:</label></th>
					<td width="39%" >
						<pt6:h5select css_class="form-control input-sm" name="nation" id="nation" title="" isNull="true" lookupCode="PLATFORM_FOLK" />
					</td>
					
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="officeTel">办公电话:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="officeTel" id="officeTel" /></td>
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="fax">传真:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="fax" id="fax" /></td>
					
					
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="isManager">是否主管:</label></th>
						<td width="39%" >
						<label class="radio-inline" id="satisfactionSurvey" title=""> <input name="isManager" title="" type="radio" value="1"  />是</label><label class="radio-inline" id="isManager" title=""> <input name="isManager" title="" type="radio" value="2"  />否</label>
						</td>
					</td>
					
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="workSpace">工作地点:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="workSpace" id="workSpace" /></td>
					
					
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="roomNo">房间号:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="roomNo" id="roomNo" /></td>
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="homeAddress">家庭住址:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="homeAddress" id="homeAddress" /></td>
					
					
				</tr>
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="homeZip">家庭邮编:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="homeZip" id="homeZip" /></td>
					
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="homeTel">家庭电话:</label></th>
					<td width="39%"><input title="" class="form-control input-sm" type="text" name="homeTel" id="homeTel" /></td>
				...
				<tr>
					...
					<td width="39%"><input title="英文名" class="form-control input-sm" type="text" name="nameEn" id="nameEn" /></td>
					
				</tr>
				
				<tr>
				<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="remark">其他:</label></th>
					<td width="39%" colspan="3"><textarea class="form-control input-sm" rows="3" title="" name="remark" id="remark"></textarea></td>
				</tr>
			</table>
					</div>
...
<script type="text/javascript" src="static/h5/jquery-form/jquery.form.js"></script>
	...
	var viewScopeType='';
        ...
        var uploadUserSign = {   
            ...
            success:function(r){
            	if(r=="1"){
            		layer.alert('文件大小超出范围！用户签名只能上传'+ maxSize +'KB以内的图片！',{
					  icon: 7,
					  title:'提示',
					  area: ['400px', ''], //宽高
					  closeBtn: 0
    ...
    function deleteUpdateQM() {
        $.ajax({
            type: "post",
            data: {},
            url : "platform/console/userupload/deletesignphoto?sysUserId="+'${userId}'+"&o=" + Math.random(),
            success:function(r){
                document.getElementById("sysUserSignPhotoImg").src="platform/console/userupload/signphoto?sysUserId="+'${userId}'+"&o=" + Math.random();
            },
        });
		...
		function closeForm(frame){
			frame.consoleUser.closeDialog("insert");
		}
		function saveForm(frame){
	        ...
	        frame.consoleUser.save($('#form'),"insert");
		}
		...
		jQuery.validator.addMethod("isMobile", function(value, element) {  
    		...
    		var regPhone = /^0?(13[0-9]|15[012356789]|16[6]|17[013678]|18[0-9]|19[89]|14[57])[0-9]{8}$/;  
...
jQuery.validator.addMethod("tel", function(value, element) {  
    ...
    return this.optional(element) || (tel.test(value));  
            ...
            //签名删除按钮绑定事件
            $('#deleteUpdateQM').bind('click', function(){
                deleteUpdateQM();
            });

		    $('#deptbtn').on('click',function(){
		    	 if(deptId==""){
		               new H5CommonSelect({type:'deptSelect', idFiled:'deptId',viewScope:viewScopeType,textFiled:'applyDeptidAlias',callBack:deptSelectCallback});
		            }else{
...
//部门选择的回调框，用户改变部门后的排序编号更新
function deptSelectCallback(deptObj){
	var userframe = $('iframe#iframeUserList', window.parent.document)[0].contentWindow;
	$("#orderBy").val("");
	$.ajax({
		 url:userframe.consoleUser.getUrl()+"/operation/setOrderby",
		 data : {deptId :deptObj.deptids},
		 type : 'post',
		 dataType : 'json',
		 success : function(r){
			 $("#orderBy").val(r.orderBy);
		 }
	 });
}
