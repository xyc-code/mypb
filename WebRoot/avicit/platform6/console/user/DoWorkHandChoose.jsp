        ...
        <div class="toolbar form-inline">
            <div class="toolbar-left form-group">
                ...
                <div class="input-group">
                    <input type="text" id="flowName" class="form-control" placeholder="请选择流程模板" readonly style="width: 200px;"/>
                    <input type="hidden" id="flowId">
                    <span class="input-group-addon" onclick="document.getElementById('flowName').click()"><i class="glyphicon glyphicon-list"></i></span>
                </div>
            </div>
        </div>
