...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form' enctype="multipart/form-data">
			...
			<table class="form_commonTable">
				...
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="userPinYin">全拼/简拼:</label></th>
					<td width="39%"><input disabled="disabled" title="全拼/简拼" class="form-control input-sm" type="text" name="userPinYin" id="userPinYin" value='<c:out  value='${consoleUser.userPinYin}'/>'/></td>
    ...
    function resetUpdate() {
		...
		function closeForm(frame){
        	resetUpdate();//恢复头像文件，删除缓存中上传的图片
			frame.consoleUser.closeDialog("edit");
		}
		function saveForm(frame){
	        ...
	        frame.consoleUser.save($('#form'),"edit");
		}
...
function checkfiletype(id){
 ...
 /*   function checkfilesize(id){
        ...
        var maxfilesize = maxSize * 1024;//kb转成b
