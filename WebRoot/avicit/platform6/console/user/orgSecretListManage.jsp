    ...
    $(document).ready(
        function () {
            var dataGridColModel = [
                ...
                {
                    label: '<span class="remind">*</span>'+'多组织应用',
                    name: 'orgName',
                    width: 150,
                    editable: true,
                    sortable: false,
                ...
                {
                    label: '<span class="remind">*</span>'+'密级',
            ...
            orgSecretList = new OrgSecretList('orgSecretListjqGrid', 'platform/console/user/getUserOrgSecret?id=' + '<c:out value="${id}"/>', dataGridColModel, '<c:out value="${id}"/>');
            //添加按钮绑定事件
