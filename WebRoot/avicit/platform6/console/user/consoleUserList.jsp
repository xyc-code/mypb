...
<div id="tableToolbar" class="toolbar">
    <div class="toolbar-left">
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_add" permissionDes="添加">
            <a id="consoleUser_insert" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm btn-point"
        ...
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_edit" permissionDes="编辑">
            <a id="consoleUser_modify" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm"
               role="button" title="编辑"><i class="icon icon-edit"></i> 编辑</a>
        </sec:accesscontrollist>
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_delete" permissionDes="删除">
            <a id="consoleUser_del" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button"
               title="删除"><i class="icon icon-delete"></i> 删除</a>
        </sec:accesscontrollist>
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_passwordmgr"
                               permissionDes="密码管理">
            <div class="dropdown">
                <a class="btn btn-primary form-tool-btn btn-sm" role="button" href="javascript:void(0);"
                   data-toggle="dropdown" id="dropdownMenu">密码管理 <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <!-- role = "presentation"表示陈述 -->
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_resetPassword"
                                           permissionDes="重置密码">
                        <li role="presentation"><a href="javascript:void(0);" onclick="resetPassword();">重置密码</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_changePassword"
                                           permissionDes="修改密码">
                        <li role="presentation"><a href="javascript:void(0);"
                                                   onclick="changePassword('<%=ViewUtil.getRequestPath(request)%>');">修改密码</a>
                        </li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <sec:accesscontrollist hasPermission="3"
                                           domainObject="formdialog_consoleUser_button_resetAllPassword"
                                           permissionDes="密码全部重置">
                        <li role="presentation"><a href="javascript:void(0);" onclick="resetAllPassword();">密码全部重置</a>
                        </li>
                    </sec:accesscontrollist>
        ...
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_userStatus"
                               permissionDes="用户状态设置">
            <div class="dropdown">
                <a class="btn btn-primary form-tool-btn btn-sm" role="button" href="javascript:void(0);"
                   data-toggle="dropdown" id="dropdownMenu">用户状态设置<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <!-- role = "presentation"表示陈述 -->
                    <sec:accesscontrollist hasPermission="3"
                                           domainObject="formdialog_consoleUser_button_doUnLockSysUser"
                                           permissionDes="解锁">
                        <li role="presentation"><a href="javascript:void(0);" onclick="doUnLockSysUser();">解锁</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_toLockLog"
                                           permissionDes="用户锁定日志">
                    ...
                    <li role="presentation">
                        <a href="javascript:void(0);"  id="showUnValidUser">展示无效用户</a>
                    </li>
                </ul>
            </div>
        </sec:accesscontrollist>
        ...
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_toolbar_tool" permissionDes="工具">
            <div class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <!-- role = "presentation"表示陈述 -->
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_importUser"
                                           permissionDes="导入用户">
                        <li role="presentation"><a href="javascript:void(0);" onclick="importUser();">导入用户</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <sec:accesscontrollist hasPermission="3"
                                           domainObject="formdialog_consoleUser_button_exportClientData"
                                           permissionDes="导出客户端">
                        <li role="presentation"><a href="javascript:void(0);"
                                                   onclick="exportClientData();">EXCEL导出（当前页）</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <sec:accesscontrollist hasPermission="3"
                                           domainObject="formdialog_consoleUser_button_exportServerData"
                                           permissionDes="导出服务端">
                        <li role="presentation"><a href="javascript:void(0);"
                                                   onclick="exportServerData();">EXCEL导出（所有页）</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    ...
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_changeTodo"
                                           permissionDes="移交待办">
                        <li role="presentation"><a href="javascript:void(0);" onclick="doworkhand();">移交待办</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                   <%-- <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_showauth"
                                           permissionDes="查看权限">
                        <li role="presentation"><a href="javascript:void(0);"
                                                   onclick="showPermisstionMenu('<%=ViewUtil.getRequestPath(request)%>');">查看权限</a>
                        </li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>--%>
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_initPinYin"
                                           permissionDes="初始化用户拼音">
                        <li role="presentation"><a href="javascript:void(0);"
                                                   onclick="initPinYin('<%=ViewUtil.getRequestPath(request)%>');">初始化用户拼音</a>
                        </li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>
                    <li id="activationPassword" style="display:none" role="presentation"><a href="javascript:void(0);"
                                                                                            onclick="activationPassword();">激活密码</a>
                    </li>
                </ul>
            </div>
        </sec:accesscontrollist>
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_toolbar_jianzhi"
                               permissionDes="兼职信息">
            <div class="dropdown">
                <a class="btn btn-primary form-tool-btn btn-sm" role="button" href="javascript:void(0);"
                   data-toggle="dropdown" id="dropdownMenu">兼职信息<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_havePartDept"
                                           permissionDes="兼职部门">
                        <li role="presentation"><a href="javascript:void(0);" onclick="havePartDept();">兼职部门</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>

                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_org_secret"
                                           permissionDes="组织密级">
                        <li role="presentation"><a href="javascript:void(0);" onclick="doOrgSecret();">组织密级</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>

                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_havePartRole"
                                           permissionDes="角色列表">
        ...
        <!-- 批量调整用户 -->
        <%-- <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_edit" permissionDes="编辑">
            <a id="consoleUserRole_adjustment" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm"
               role="button" title="批量调整用户"><i class="icon icon-edit"></i> 批量调整</a>
        </sec:accesscontrollist>--%>
        <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_toolbar_adjustment" permissionDes="批量调整">
            <div class="dropdown">
                <a href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm"
                   role="button" title="批量调整用户" data-toggle="dropdown" ><i class="icon icon-edit"></i> 批量调整<span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_roleAdjust"
                                           permissionDes="调整角色">
                        <li role="presentation"><a id="consoleUser_role_adjustment" href="javascript:void(0);" onclick="">批量调整角色</a></li>
                        <li role="separator" class="divider"></li>
                    </sec:accesscontrollist>

                    <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleUser_button_deptAdjust"
                                           permissionDes="调整部门">
                        <li role="presentation"><a id="consoleUser_dept_adjustment" href="javascript:void(0);" onclick="">批量调整部门</a></li>
                    </sec:accesscontrollist>
                </ul>
            </div>
        </sec:accesscontrollist>
...
<table id="jqGrid" datapermission='jqSysUser'></table>
<div id="jqGridPager"></div>
</body>
<!-- 高级查询 -->
<div id="searchDialog" style="overflow: auto;display: none;height: 278px!important;">
        ...
        <table class="form_commonTable">
            <tr>
                ...
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label
                        for="loginName">登录名:</label></th>
                <td width="39%"><input title="登录名" class="form-control input-sm" type="text" name="loginName"
                                       id="loginName"/></td>
            </tr>
            <tr>
                <th>用户姓名:</th>
                <td><input title="用户姓名" class="form-control input-sm" type="text" name="name" id="name"/></td>
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="title">职称:</label>
                </th>
                <td width="39%">
                    <pt6:h5select css_class="form-control input-sm" name="title" id="title" title="" isNull="true"
                                  lookupCode="PLATFORM_USER_TITLE"/>
                </td>
            </tr>
            <tr>
                <th>手机:</th>
                ...
                <td>
                    <pt6:h5select css_class="form-control input-sm" name="secretLevel" id="secretLevel" title="密级"
                                  isNull="true" lookupCode="PLATFORM_USER_SECRET_LEVEL"/>
                </td>
            </tr>
            <tr>
                <th>邮箱地址:</th>
                ...
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label
                        for="consoleType">前后台:</label></th>
                <td width="39%">
                    <pt6:h5select css_class="form-control input-sm" name="consoleType" id="title" title="" isNull="true"
                                  lookupCode="PLATFORM_CONSOLE"/>
                </td>
            </tr>


            <tr>
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="status">状态:</label>
                </th>
                <td width="39%">

                    <select id="status" name="status" class="form-control input-sm" title="状态">
                ...
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label
                        for="positionbtn">选择岗位:</label></th>
                <td width="39%">
                    <div class="input-group  input-group-sm">
                        <input type="hidden" id="positionId" name="positionId" value=''>
                        <input class="form-control" placeholder="请选择岗位" type="text" id="applyPositionidAlias"
                               name="applyPositionidAlias" readonly="readonly">
                        <span class="input-group-btn">
							        <button class="btn btn-default" type="button" id="positionbtn"><span
            ...
            <%--<tr>
                <th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="userLocked">锁定状态:</label>
                </th>
                <td width="39%">
                    <select id="userLocked" name="userLocked" class="form-control input-sm" title="userLocked">
                        <option value="" selected="selected">无</option>
                        <option value="0">未锁定</option>
                        <option value="lock">已锁定</option>
                    </select>
...
<script type="text/javascript">
    ...
    // 表头高25px，为Pager余下10px
    function checkHeight() {
        if ($("#tableToolbar").outerHeight() != initHeight) {
            var height = document.documentElement.clientHeight;
            height = height - $("#tableToolbar").outerHeight() - $('#jqGridPager').outerHeight() - 45;
            $('#jqGrid').jqGrid('setGridHeight', height);
    ...
    $(function () {
        $(window).on('resize', function () {
            initHeight = $("#tableToolbar").outerHeight();
            timerCount = 10;
            var height = document.documentElement.clientHeight;
            height = height - $("#tableToolbar").outerHeight() - $('#jqGridPager').outerHeight() - 45;
            $('#jqGrid').jqGrid('setGridHeight', height);
    ...
    function formatStatus(cellvalue, options, rowObject) {
        ...
        }else if (rowObject.userLocked != "0") {
    ...
    function formatChiefDept(cellvalue, options, rowObject) {
        if (cellvalue === "1") {
            return "主部门";
        } else {
            return "兼职部门";
    ...
    function unformatChiefDept(cellvalue, options, rowObject) {
        if (cellvalue === "主部门") {
            return "1";
        } else {
            return "0";
    ...
    function loadUserData(treeNode) {
        var param = {};
        if ($("#showUnValidUser").text() == '展示无效用户') {
            param['status'] = 1
        }

        var keyWord = $(consoleUser._keyWordId).val();
        if (keyWord) {
            ...
            var searchdata = {
                ...
                'searchdatapara' : JSON.stringify(param)
            };
    ...
    function loadUserDataRoot() {
        var param = {};
        if ($("#showUnValidUser").prop("checked") == false) {
            param['status'] = 1;
        }
    ...
    $(document).ready(function () {
        ...
        searchUserMainNames.push("userPinYin");
        searchUserMainTips.push("拼音");
        ...
        var dataGridColModel = [
            ...
            , {label: '状态', name: 'status11', sortable: false,width: 100, align: 'center', formatter: formatStatus}
            , {label: '状态', name: 'status', hidden: true}
            , {label: '锁定状态', name: 'userLocked', hidden: true,align: 'center'}
            ...
            , {label: '是否主部门', name: 'isChiefDept', hidden: true,align: 'center',formatter: formatChiefDept,unformat:unformatChiefDept},
            {
                label: '组织',
        ...
        consoleUser = new ConsoleUser('jqGrid', '<%=ViewUtil.getRequestPath(request)%>' + '${'console/user'}', 'searchDialog', 'form', 'sysUser_keyWord', searchUserMainNames, dataGridColModel);
        //添加按钮绑定事件
        ...
        $('#showUnValidUser').bind('click', function () {
            if ($("#showUnValidUser").text() !== '展示无效用户') {
                $("#showUnValidUser").text('展示无效用户');
            }else{
                $("#showUnValidUser").text('隐藏无效用户')
            }
            consoleUser.searchByKeyWord();
        });
        //编辑按钮绑定事件
        ...
        //批量调整用户
        /*$('#consoleUserRole_adjustment').bind('click',function() {
            consoleUser.adjustment();
        });*/
        $('#consoleUser_role_adjustment').bind('click',function () {
            consoleUser.roleAdjustment();
        });
        $('#consoleUser_dept_adjustment').bind('click',function () {
            consoleUser.deptAdjustment();
        });
    ...
    function havePartRole() {
        ...
        deptIndex = parent.layer.open({
            ...
            skin: 'bs-modal', // bootstrap 风格皮肤 需加载skin
            maxmin: false, //开启最大化最小化按钮
            content: 'platform/console/user/toRoleList?id=' + rows[0]
        });
    ...
    function doworkhand() {
        ...
        parent.layer.open({
            ...
            title : '移交待办',
            btn: ['确定','关闭'],
            content : "avicit/platform6/console/user/DoWorkHandChoose.jsp?userId=" + rows[0],
            yes : function(index,layero){
                var iframeWin = layero.find('iframe')[0].contentWindow;
                var workHandData = iframeWin.getWorkHandData();
                if(!workHandData){
                    return;
                }
                ...
                new H5CommonSelect({
                    ...
                    callBack: function (user) {
                        ...
                        if (user.userids == rows[0]) {
                            parent.layer.alert('不能移交给所选用户自己！', {
                                title: '提示',
                                icon: 0,
                                area: ['400px', ''], //宽高
                                closeBtn: 0
                            ...
                            function (index) {
                                avicAjax.ajax({
                                    ...
                                    data: {
                                        ...
                                        workHandType: workHandData.workHandType,
                                        workHandData: workHandData.workHandData
                                    },
                                    type: 'post',
                                    dataType: 'json',
                                    success: function (r) {
                                        if (r.result == true) {
                                            parent.layer.msg('移交成功！', {
                                                icon: 1,
                                                area: ['200px', ''],
                                                closeBtn: 0
                                            });
                                        } else {
                                            parent.layer.alert('移交过程出错！', {
                                                icon: 2,
                                                area: ['400px', ''],
                                                closeBtn: 0
                                            });
