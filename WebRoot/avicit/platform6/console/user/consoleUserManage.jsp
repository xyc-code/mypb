...
<div class="easyui-layout" fit="true" >
		<div data-options="region:'west',split:true" style="width:300px;padding:0px;overflow:auto;">
			<div class="row" style="margin: 5px;">
				...
				<div id="userdiv" style="overflow:auto;">
					<ul id="treeDemo" class="ztree" style="height: 100%"></ul>
				</div>
			</div>
		</div>
		<div data-options="region:'center'" >
			<div id="userlist" style="width: 100%; height: 100%; overflow: hidden">
			</div>
		</div>
	</div>
...
<script type="text/javascript">
    ...
    $('#userdiv').height(document.documentElement.clientHeight-46);
     

	var isNotSafeManager = '${isNotSaveManager}';
	$(function(){
		setTimeout(function(){
			$('<iframe id="iframeUserList" src="avicit/platform6/console/user/consoleUserList.jsp" scrolling="no" frameborder="0" style="width:100%;height:100%;"></iframe>').appendTo($('#userlist'));
		},10);
	});
