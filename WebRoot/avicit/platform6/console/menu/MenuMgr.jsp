...
<body class="easyui-layout" fit="true">
	<div data-options="region:'west',split:false" style="width: 250px;border-top-style: hidden;  border-right: 1px solid; border-color: #D4D4D4;overflow: hidden;">
...
function fmtMenuAuth(cellvalue, options, rowObject) {
    //已配置3项   未配置
    if(rowObject.menuAuth !== 0){
      return '<a href="javascript:void(0);" style="font-size: 13px; color: #0066cc;text-decoration:none;"  onclick="menuList.addAuth(\''+rowObject.id+'\',\'已配置'+rowObject.menuAuth+'项\');">已配置'+rowObject.menuAuth+'项</a>';

    }else{
    	return '<a href="javascript:void(0);" style="font-size: 13px; color: #0066cc;text-decoration:none;"  onclick="menuList.addAuth(\''+rowObject.id+'\', \'未配置\' );">未配置</a>';
       }
   }
...
function initTips() {
	...
	$("#iconTips").mouseover(function () {
		var message = "<span style='color:#333333;'>配置模块后台方法权限</span>";
...
$(function(){
	...
	searchNames.push("menuName");//用户可自定义查询条件，修改参数。
  	var dataGridColModel =  [
		                     	...
		                     	{ label: '权限<i class="tips-iconhelp icon iconfont icon-question-circle" id = "iconTips"></i>', name: 'MENU_AUTH', width: 100,sortable:false ,align:'center',formatter:fmtMenuAuth},
		                     	...
		                     	{ label: '是否显示', name: 'isShow', width: 40,sortable:false,align:'center',formatter:fmtShow},
