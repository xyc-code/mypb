...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<div class="input-group input-group-sm spinner" data-trigger="spinner">
					   <input title="" type="text" class="form-control" name="menuOrder" id="menuOrder"  data-min="0" data-max="999999" value='${orderBy}' data-step="1" data-precision="0">
                ...
                <tr>
					...
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="menuIcon">菜单图标:
						<i class="tips-iconhelp icon iconfont icon-question-circle" id="iconTips"></i></label>
					</th>
                    <td width="39%" style="position: relative">
				...
				<c:if test="${type eq '1'}">
					...
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="markEndDate">失效日期:</label></th>
					<td width="39%">
	...
	<script type="text/javascript">
		...
		function saveForm(){
			...
			$.ajax({
				url: parent.menuList.getUrl() + "/validateUrl/null",
				type: 'post',
				...
				success: function (r) {
					...
					if(r!==null&&r.length>0){
						...
						layer.confirm('当前菜单URL已存在与菜单'+title+'中，是否继续添加？', {icon: 3, title:'提示'}, function(index){
		...
		function initTips() {
			...
			$("#iconTips").mouseover(function () {
				var message = "<span style='color:#333333;'>三级及以下菜单不显示菜单图标</span>";
