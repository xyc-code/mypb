...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="39%"  nowrap="nowrap"><input type="number" class="form-control input-sm" style="width: 88%;display:inherit;" rows="3" title="刷新频率" name="refresh" id="refresh" value="5"></input><span>--单位：分</span></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
		...
		function saveForm(){
			...
			$.ajax({
				url: parent.menuPortal.getUrl() + "/validatePortletUrl/null",
				type: 'post',
