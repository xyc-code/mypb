...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<div class="input-group input-group-sm spinner" data-trigger="spinner">
					   <input title="" type="text" class="form-control" name="menuOrder" id="menuOrder"  data-min="0" data-max="999999" data-step="1" data-precision="0" value='${menu.menuOrder}'>
		...
		<c:if test="${type eq '1'}">
				...
				<th width="10%" style="word-break: break-all; word-warp: break-word;">失效日期:</th>
					<td width="39%">
	...
	var lay_select_menu;
      ...
      /*  console.info($('#menuName'));
		...
		function saveForm(){
			...
			$.ajax({
				url: parent.menuList.getUrl() + "/validateUrl/"+serializeObject($('#form'))["id"],
				type: 'post',
