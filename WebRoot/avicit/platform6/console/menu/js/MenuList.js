...
//添加权限
MenuList.prototype.addAuth=function(pid,param){
	var title = "权限"+"<span style ='color:blue;font-weight: 500;'>("+param+")</span>";
   this.insertIndex = layer.open({
        type: 2,
        area: ['100%', '100%'],
        title: title,
        skin: 'bs-modal', // bootstrap 风格皮肤 需加载skin
        maxmin: false, //开启最大化最小化按钮
        content: this.getUrl()+'/menuAuthList/'+pid,
        end : function() {
			reloadAuthData();
		}
