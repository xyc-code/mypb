 ...
 * 
 */
function SysPasswordTempletLevel(datagrid, url, searchForm, dataGridColModel,
...
//初始化操作
SysPasswordTempletLevel.prototype.init = function() {
	var _self = this;
	var issubinit = false;
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getSysPasswordTempletLevelsByPage.json',
		mtype : 'POST',
		multiselect : true,
		datatype : "json",
		toolbar : [ true, 'top' ],
...
//添加页面
SysPasswordTempletLevel.prototype.insert = function() {
...
//编辑页面
SysPasswordTempletLevel.prototype.modify = function() {
	var ids = $(this._datagridId).jqGrid('getGridParam', 'selarrrow');
	if (ids.length == 0) {
		layer.alert('请选择要编辑数据！', {
			icon : 7,
			area : [ '400px', '' ], //宽高
			title : '提示',
			closeBtn : 0
...
//详细页
SysPasswordTempletLevel.prototype.detail = function(id) {
...
SysPasswordTempletLevel.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			sysApplicationId : {
				maxlength : 50
...
//保存功能
SysPasswordTempletLevel.prototype.save = function(form, id) {
	var _self = this;
	avicAjax.ajax({
...
//删除
SysPasswordTempletLevel.prototype.del = function() {
...
//重载数据
SysPasswordTempletLevel.prototype.reLoad = function() {
	var searchdata = {
...
//关闭对话框
SysPasswordTempletLevel.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
SysPasswordTempletLevel.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
SysPasswordTempletLevel.prototype.searchData = function() {
	var searchdata = {
		keyWord : null,
		param : JSON.stringify(serializeObject($(this.searchForm)))
	};
...
//关键字段查询
SysPasswordTempletLevel.prototype.searchByKeyWord = function() {
...
//隐藏查询框
SysPasswordTempletLevel.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
SysPasswordTempletLevel.prototype.clearData = function() {
