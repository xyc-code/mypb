...
<html>
<head>
<!-- ControllerPath = "demo/syspasswordtempletlevel/sysPasswordTempletLevelController/operation/sub/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<input type="hidden" name="templetType" id="templetType"/>
			<table class="form_commonTable">
				<tr>
																																				   									 																							 													<th width="10%">
						    						  	<label for="templetKey">密码规则KEY:</label></th>
						    							<td width="39%">
														    <input class="form-control input-sm" type="text" name="templetKey"  id="templetKey" />
													   </td>
																														    					   									 																							 													<th width="10%">
						    						  	<label for="templetValue">密码规则值:</label></th>
						    							<td width="39%">
														    <input class="form-control input-sm" type="text" name="templetValue"  id="templetValue" />
													   </td>
															</tr>
								<tr>
																														    					   									 																							 													<th width="10%">
						    							...
						    							<td width="39%">
															<pt6:h5select css_class="form-control input-sm" name="templetState" id="templetState" title="" isNull="true" lookupCode="DEPT_TYPE" />
						    						   </td>
																														    					   									 																				 									 									 									 									 									 									 						</tr>
					</table>
			</form>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.sysPasswordTemplet.closeDialog("insert");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.sysPasswordTemplet.save($('#form'),"insert");
		}
