		...
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="39%">
						<pt6:h5radio css_class="radio-inline" name="validFlag" title="有效标识" canUse="0" defaultValue='1' lookupCode="PLATFORM_VALID_FLAG" />
					</td>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="90%">
						<p>SQL验证:</p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;•自定义查询SQL，可以从其他表中获取数据作为配置文件的值，SQL语句固定返回3个字段：id (唯一标识位)，code (代码值)，name (显示名称)，示例如下：</p>
						<p>&nbsp;&nbsp;&nbsp;&nbsp;select t.id as id,t.lookup_code as code,t.lookup_name as name from sys_lookup_v t where t.lookup_type='PLATFORM_USER_TITLE'</p>
					</td>
				</tr>
			</table>
			</fieldset>
