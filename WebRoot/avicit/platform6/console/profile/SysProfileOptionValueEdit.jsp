		...
		<form id='form'>
				...
				<table class="form_commonTable">
					...
					<tr>
						...
						<td width="39%"><input class="form-control input-sm" type="text" name="profileOptionValue" id="profileOptionValue" autocomplete="off" value='<c:out  value='${sysProfileOptionValueDTO.profileOptionValue}'/>'/>
						</td>
					</tr>
				</table>
			</form>
