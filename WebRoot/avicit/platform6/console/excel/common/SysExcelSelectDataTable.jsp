	...
	<div class="toolbar-right">
		<div class="input-group form-tool-search" style="width: 220px;margin-left: 15px;" >
			<input type="text" name="searchTable_keyWord"
				   id="searchTable_keyWord" class="form-control input-sm" placeholder="请输入英文表名"> <label
	...
	$(document) .ready(
		function() {
			...
			$('#testCurrencyjqGrid').jqGrid({
				url : "platform6/msystem/excel/template/sysImpExcelTemplateController/operation/getTableDatasBypage",
				mtype : 'POST',
				datatype : "json",
