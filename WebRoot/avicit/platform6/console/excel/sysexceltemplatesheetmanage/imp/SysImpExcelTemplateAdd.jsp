...
<body class="easyui-layout">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<th width="10%">
                        <label for="name">名称:<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysTemplateNameTips"></i></label>
                    </th>
					<td width="39%">
				...
				<tr>
					...
					<td width="39%">
						<label class="radio-inline"> <input name="manageStyle" title="Excel模板" type="radio" value="1" checked>Excel模板</label>
						<label class="radio-inline"> <input name="manageStyle" title="DTO实体类" type="radio" value="2">DTO实体类</label>
					</td>

				</tr>
				<tr class="dtoClazzTr" style="display: none;">
					<th width="10%"><label for="dtoClazz">实体类:</label></th>
					<td width="39%">
						<div class="input-group input-group-sm" id="dtoClazzDiv">
							<input class="form-control input-sm" type="text" name="dtoClazz" id="dtoClazz"/>
				...
				<tr>
					...
					<td width="39%" colspan="3"><textarea rows="2" maxlength="300" class="form-control input-sm"
										   type="text" name="bz" id="bz" ></textarea></td>
				</tr>
			...
			<table class="tableForm"
				...
				<tr>
					<td width="50%" style="padding-right: 4%;" align="right"><a
						href="javascript:void(0);" title="保存" id="saveButtonAdd"
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			//限制保存按钮多次点击
			parent.sysImpTemplate.save($('#form'), callback, "saveButtonAdd");
		}
		...
		$(document).ready(function() {
			...
			//保存按钮绑定事件
			$('#saveButtonAdd').bind('click', function() {
				saveForm();
			});
		...
		$("#clazzselect").bind("click", function() {
			var url = "platform6/msystem/excel/template/sysImpExcelTemplateController/operation/getDtoList";
