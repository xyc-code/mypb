...
<body class="easyui-layout">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
                ...
                <tr class="titleTr">
                    ...
                    <td width="39%">
                        <label class="radio-inline"> <input name="isShowTitle" title="是" type="radio" value="1" checked>是</label>
                    ...
                    <td width="39%"><input class="form-control input-sm"  type="text" name="title" id="title" /></td>
                </tr>
                <tr>
					<th width="10%"><label for="bz">描述:</label></th>
					<td width="39%" colspan="3"><textarea class="form-control input-sm" rows="5"  type="text" name="bz" id="bz"> </textarea></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<script type="text/javascript">
		// 关闭Dialog
		function closeForm() {
			parent.sysExpTemplate.closeDialog('insert');
		}
		...
		function saveForm() {
			...
			//限制保存按钮多次点击
			parent.sysExpTemplate.save($('#form'),"insert", "saveButtonAdd");
		}
