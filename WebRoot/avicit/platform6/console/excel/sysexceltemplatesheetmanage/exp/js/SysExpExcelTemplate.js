 ...
 */
function SysExpExcelTemplate(datagrid, url, searchDialogId, form, keyWordId,
...
// 初始化操作
SysExpExcelTemplate.prototype.init = function() {
	var _self = this;
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getSysExpTemplatesByPage.json',
        postData : {
            param : JSON.stringify({"type":"1"})
        },
		mtype : 'POST',
		datatype : "json",
		toolbar : [ true, 'top' ],
...
// 添加页面
SysExpExcelTemplate.prototype.insert = function() {
...
// 编辑页面
SysExpExcelTemplate.prototype.modify = function() {
...
// 详细页
SysExpExcelTemplate.prototype.detail = function(id) {
...
// 属性设置
SysExpExcelTemplate.prototype.config = function(id) {
    this.configIndex = layer.open({
        type : 2,
        area : [ '100%', '100%' ],
        title : '导出配置',
        skin : 'bs-modal', // bootstrap 风格皮肤 需加载skin
        maxmin : false, // 开启最大化最小化按钮
        content : this.getUrl() + 'Config/' + id
    });
};
// 验证
SysExpExcelTemplate.prototype.formValidate = function(form) {
	var _self = this;
	form.validate({
		rules : {
			code : {
...
// 保存功能
SysExpExcelTemplate.prototype.save = function(form, type, eleId) {
	var _self = this;
...
// 删除
SysExpExcelTemplate.prototype.del = function() {
...
// 重载数据
SysExpExcelTemplate.prototype.reLoad = function() {
	var searchdata = {
		keyWord : null,
...
// 关闭对话框
SysExpExcelTemplate.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
// 打开查询框
SysExpExcelTemplate.prototype.openSearchForm = function(searchDiv) {
	var _self = this;
	var _resizeFunc;
...
// 去后台查询
SysExpExcelTemplate.prototype.searchData = function() {
	var searchdata = {
		keyWord : null,
		param : JSON.stringify(serializeObject($(this._formId)))
	}
...
// 关键字查询
SysExpExcelTemplate.prototype.searchByKeyWord = function() {
