		...
		<div class="toolbar-right">
			<div  class="col-xs-6">
				<div class="input-group  input-group-sm" style="width:230px;padding-top:2px;margin-right:0px;">
			      <input  class="form-control" placeholder="输入组织名称查询" type="text" id="search_text" name="search_text"  onkeyup="orgtree.onSeach(event.keyCode, this.value)">
...
OrgTree.prototype.init=function(){
	...
	_self.tree = $.fn.zTree.init($(_self._ztreeId),_self.setting1, []);
};
OrgTree.prototype.onSeach = function(ecode, value){
    ...
    if(ecode == 13){
        if(value==null || value==""){
            ...
            $.fn.zTree.init($("#treeDemo"),_self.setting1, []);
            return;
        }
        $.ajax({
            cache: true,
...
function zTreeBeforeClick(treeId, treeNode, clickFlag) {
	return treeNode.nodeType == 'org';//只有当节点类型为org时,可以选取
}
