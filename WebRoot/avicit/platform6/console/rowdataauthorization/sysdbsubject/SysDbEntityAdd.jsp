...
<html>
<head>
<!-- ControllerPath = "shujushouquan/sysdbsubject/sysDbSubjectController/operation/sub/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form' autocomplete="off">
			...
			<table class="form_commonTable">
				...
				<tr>
					<th><label for="tableName">表名称:</label></th>
					<td>
				...
				<tr>
					<th><label for="tableComments">表描述:</label></th>
					<td><input class="form-control input-sm"
						type="text" name="tableComments" id="tableComments" /></td>
				</tr>
				<tr>
					<th><label for="mapperForTab">表对应mapper.xml:</label></th>
					<td><input class="form-control input-sm"
						type="text" name="mapperForTab" id="mapperForTab" /></td>
				</tr>
				<tr>
					<th><label for="exemethods">执行方法:</label></th>
					<td><input class="form-control input-sm"
						type="text" name="exemethods" id="exemethods" /></td>
				</tr>
			</table>
		</form>
	</div>
	...
	<script type="text/javascript">
		function closeForm() {
			parent.sysDbEntity.closeDialog("insert");
		}
		function saveForm() {
			...
			parent.sysDbEntity.save($('#form'), "insert");
		}
