...
<body class="easyui-layout" fit="true" style="overflow: hidden;">
	<div data-options="region:'west',split:false,border:true,collapsible:false" id="west" style="width: 250px;">
			<div id="tableToolbarM" class="toolbar">
				<div class="toolbar-left" style="width:98%">
		...
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane fade in active" id="role">
				<div id="tableToolbarR" class="toolbar">
					<div class="toolbar-left" style="width: 70%">
						...
						<span class="remind-text">◆ 提示：当您授权后，需<a id="authRefresh"  href="javascript:void(0)"
																 class="text-link" role="button"
																 title="刷新菜单授权缓存"> 刷新授权缓存</a>才能生效</span>
					</div>
					<div class="toolbar-right">
						<div class="input-group form-tool-search">
							<input type="text" name="keyWord" id="keyWordR" style="width:240px;" class="form-control input-sm" placeholder="输入角色名称查询">
...
$('#mdiv').height(parent.document.documentElement.clientHeight-76);
$(function(){
