		...
		<form id="form" fit="true">
			...
			<table class="form_commonTable">
				<tr>
                	...
                	<td width="40%">
                        <pt6:h5select css_class="form-control input-sm" name="group" id="group" title="任务分组" isNull="false" lookupCode="PLATFORM_QUARTZ_JOB_GROUP" />
	...
	<div data-options="region:'center'" split="false"  border="false" >
	   ...
	   <div id="myTabContent" class="tab-content" style="height: calc(100% - 33px);border-bottom: 1px solid #e8e8e8;">
		 <div class="tab-pane fade in active" id="home" style="height: 100%">
			<iframe frameborder="0" id="paramifr" src="avicit/platform6/console/quartz/SysJobVariablesManage.jsp" style="height:100%;width:100%;"></iframe>
		 </div>
		 <!-- 排除日期 -->
