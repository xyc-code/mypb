...
<script type="text/javascript">
	$(document).ready(function(){
		$('#portal_ifrm').css("height",document.documentElement.clientHeight - 40);
		$('#console_ifrm').css("height",document.documentElement.clientHeight - 40);
	});

    $(function(){
		document.getElementById('portal_ifrm').src = 'platform/console/auth/unified';
        var ifrm={'console_ifrm':'platform/console/auth/unified/admin',
                  'portlet_ifrm':'platform/console/auth/unified'};
    ...
    $(window).resize(function(){
        $('#portal_ifrm').css("height",document.documentElement.clientHeight-50);
        $('#console_ifrm').css("height",document.documentElement.clientHeight-50);
    });
</script>
