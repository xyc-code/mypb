...
<body class="easyui-layout" fit="true" style="overflow:hidden;">
	...
	<div id="tableToolbarGroup" style="height: 12%;padding-top: 5px;">
		<div class="toolbar-left">
			...
			<i class="tips-iconhelp icon iconfont icon-question-circle" id="iconTips"></i>
	...
	<div id='mdiv' style="overflow:auto; height: 83%">
...
function initTips() {
	...
	$("#iconTips").mouseover(function () {
		var message = "<span style='color:#333333;'>给当前菜单及其子菜单授权</span>";
