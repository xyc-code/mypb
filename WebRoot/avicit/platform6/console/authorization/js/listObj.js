...
ListObj.prototype.init=function(){
	...
	$(_self._datagridId).jqGrid({
        ...
        gridComplete: function () {
            $(_self._datagridId).jqGrid('setGridHeight',parent.document.documentElement.clientHeight-180);
            $(_self._datagridId).jqGrid('setGridWidth','460');
        },
		loadComplete:function() {
			...
			if (rowdata != null && rowdata.length > 0) {
				...
				_self._selectId = rowdata[0].id;
				_self.getOnClick()(rowdata[0].id, _self._type);
			}
		}
