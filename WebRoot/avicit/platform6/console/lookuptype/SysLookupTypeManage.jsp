...
<body class="easyui-layout" fit="true">
	<div
		data-options="region:'center',onResize:function(a){$('#sysLookupType').setGridWidth(a);$(window).trigger('resize');}">
		<div id="toolbar_sysLookupType" class="toolbar">
			...
			<div class="toolbar-right">
				<div class="input-group form-tool-search" style="width: 220px">
	...
	<div
		data-options="region:'east',split:true,width:fixwidth(.4),onResize:function(a){$('#sysLookup').setGridWidth(a);$(window).trigger('resize');}">
...
<script src="avicit/platform6/console/lookuptype/js/SysLookupType.js" type="text/javascript"></script>
	...
	$(document).ready(
			function() {
				...
				sysLookupType = new SysLookupType('sysLookupType', '${url}',
						...
						function(pid) {
							sysLookup = new SysLookup('sysLookup', '${surl}',
									...
									'searchDialogSub', pid, subSearchMainNames,
									"subSysLookupType_keyWord");
						}, function(pid) {
							$("#subSysLookupType_keyWord").val("");
							sysLookup.reLoad(pid);
						}, searchMainNames, "sysLookupType_keyWord");
				//主表操作
				//添加按钮绑定事件
				...
				$('#sysLookup_save').bind('click', function() {
					...
					//编码唯一性校验
					//校验地址
					var validateUrl = sysLookupType.getUrl() + "validateSubLookupType";
                    //主表数据
