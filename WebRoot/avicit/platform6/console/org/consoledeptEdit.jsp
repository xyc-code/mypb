...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
        ...
        //部门选择的回调框，改变部门后的排序编号更新
		 function deptSelectCallback(deptObj){
			//$("#orderBy").val("");
			$.ajax({
				 url:"console/dept/operation/setOrderBy",
        ...
        $('#deptbtn').on('click',function(){
			new H5CommonSelect({type:'deptSelect', idFiled:'parentDeptId',viewScope:'currentOrg',textFiled:'parentDeptName',callBack: deptSelectCallback});
        });
