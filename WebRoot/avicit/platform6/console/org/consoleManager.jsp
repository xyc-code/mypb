	...
	<div data-options="region:'center',onResize:function(a){$('#jqGrid').setGridWidth(a);$(window).trigger('resize');}">
		<div id="tableToolbar" class="toolbar">
			<div class="toolbar-left">
				...
				<div class="dropdown">
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_add" permissionDes="添加">
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_addOrg" permissionDes="添加组织">
								<a id="orgInsert" href="javascript:void(0)"  title="添加组织">添加组织</a></li>
							</sec:accesscontrollist>

						<li role="separator" class="divider"></li>
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_addDept" permissionDes="添加部门">
				...
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_edit" permissionDes="编辑">
				...
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_del" permissionDes="删除">
				...
				<div class="dropdown">
					<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_tool" permissionDes="工具">
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
					   <li role="presentation">
						   <sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_stat" permissionDes="有无效设置">
							   <a id="statConfig" href="javascript:void(0)"  title="有无效设置">有无效设置</a></li>
						   </sec:accesscontrollist>

						<li role="separator" class="divider"></li>
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_exportOrg" permissionDes="导入组织">
								<a id="exportOrg" href="javascript:void(0)"  title="导入组织">导入组织</a></li>
						</sec:accesscontrollist>

						<li role="separator" class="divider"></li>
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_exportDept" permissionDes="导入部门">
						...
						<li role="separator" class="divider"></li>
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_initPinYin" permissionDes="初始化部门拼音">
								<a id="initPinYin" href="javascript:void(0)"  title="初始化部门拼音">初始化部门拼音</a>
							</sec:accesscontrollist>

						</li>
						<li role="presentation">
							<sec:accesscontrollist hasPermission="3" domainObject="formdialog_consoleOrg_button_initIndex" permissionDes="初始化部门索引">
...
$(function(){
	...
	{ label: '排序编号', name: 'orderBy', width: 80,sortable:false,align:'center' },
