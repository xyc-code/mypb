...
<jsp:include page="/avicit/platform6/h5component/common/h5uiinclude-css.jsp">
	...
	<script type="text/javascript" src="avicit/platform6/console/onlineuser/js/userOnlineInfo.js"></script>
<style type="text/css">
   #gview_dgSession{
      padding-top:43px;
   }
...
<body class="easyui-layout" fit="true">
   <div id="panelnorth" data-options="region:'north'"   style="height:210px;">
		   ...
		   <div class="row animated fadeInRight" style="width:100%;">
			   <div class="col-sm-12">
				   <div >
					   ...
					   <div class="panel-body" style="border: 1px solid #3399cc">
...
$(document).ready(function () {
	var dgOnlineColModel =  [
      { label: 'Session ID', name: 'sessionId', key : true,width: 200,hidden:true , sortable: false}
	...
	$("#dgOnline").jqGrid({
    	url: 'platform/onlineuser/h5OnlineUserController/getOnlineUserListByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
        colModel: dgOnlineColModel,
        height:$(window).height()-$('#panelnorth').height()-115,//120:顶部工具栏高+表头高+底部翻页模块高，17：顶部toolbar的内边距高度
       ...
       /* //pager: "#jqGridPager",*/
       	onSelectRow:function(rowid){
			...
			$("#dgSession").jqGrid('setGridParam', {
				url:'platform/onlineuser/h5OnlineUserController/getPrinciplSessions.json',
				datatype : 'json',
...
function deleteSession(sessionId,userName) {
	layer.confirm('确定禁止本session?',  {icon: 3, title:"提示", area: ['400px', '']}, function(index){
		 avicAjax.ajax({
			 url:'platform/onlineuser/h5OnlineUserController/deleteSession.json',
