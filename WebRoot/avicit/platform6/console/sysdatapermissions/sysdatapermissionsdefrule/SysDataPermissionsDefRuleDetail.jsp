...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<h3 style="text-align: center; font-weight: 600;">默认规则详情</h3>
	    <form id='form'>
	        <table class="form_commonTable">
				<tr>
					...
					<td width="23%">
						<div class="input-group input-group-sm spinner"
							...
							<input class="form-control" type="text" name="orderBy" disabled="disabled"
				...
				<tr>
					...
					<td width="23%" colspan="3">
						<textarea rows="3" class="form-control input-sm" disabled="disabled" name="ruleRemarks" id="ruleRemarks">${sysDataPermissionsDefRuleDTO.ruleRemarks}</textarea>
					</td>
				</tr>
				<tr>
					...
					<td width="23%">
						<label class="radio-inline">
							<input type="radio" id="matchSymbol0" name="matchSymbol" value="0" disabled="disabled"/>或（or）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="matchSymbol1"name="matchSymbol" value="1" disabled="disabled"/>且（and）
						</label>
					</td>
					<th width="10%"><label for="status">状态:</label></th>
					<td width="23%">
						<label class="radio-inline">
							<input type="radio" id="state0" name="state" value="0" disabled="disabled"/>有效&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="state1" name="state" value="1" disabled="disabled"/>无效
						</label>
					</td>
				</tr>
				<tr>
					<th width="10%"><label for="columnName">字段:
						<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysdatapermissionTips2"></i></label>
					</th>
					<td width="23%" colspan="3" style="padding-left: 0px;">
						<table>
							<tr>
								<td>
									<select class="js-example-basic-multiple" id="columnName" name="columnName" style="width: 200px" disabled="disabled">
										<option value="CREATED_BY">CREATED_BY（创建人）</option>
										<option value="CREATED_DEPT">CREATED_DEPT（部门）</option>
								...
								<td>
									<select class="js-example-basic-multiple" id="columnSymbol" name="columnSymbol" style="width: 100px" disabled="disabled">
								...
								<td>
									...
									<select class="js-example-basic-multiple" id="columnType" name="columnType" style="width: 100px;" disabled="disabled">
								...
								<td style="padding: 0px;width: 263px;">
									<input class="form-control input-sm" type="text" name="columnValue" id="columnValue" style="padding: 5px 12px;display: none;"
										disabled="disabled" value="<c:out  value='${sysDataPermissionsDefRuleDTO.columnValue}'/>" />
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td width="23%" colspan="3">
						<textarea class="form-control input-sm" name="filterConditionSql" disabled="disabled" id="filterConditionSql" rows="3">${sysDataPermissionsDefRuleDTO.filterConditionSql}</textarea>
					</td>
				</tr>
				<tr>
					<th width="10%"><label for="filterCondition">过滤条件:</label></th>
					<td width="23%" colspan="3">
						<textarea class="form-control input-sm" name="filterCondition" disabled="disabled" id="filterCondition" rows="2">${sysDataPermissionsDefRuleDTO.filterCondition}</textarea>
					</td>
				</tr>
	        </table>
	    </form>
	...
	<script type="text/javascript">
		function initTips() {
			...
			$("#sysdatapermissionTips2").mouseover(function () {
				var message = "<span style='color:#333333;'>要求对应的业务表中存在该字段。<br/>" +
						"注：使用变量时大括号左右两侧不能带有空格，且注意大小写。<br/>" +
						"目前可使用的变量包含：<br/>" +
						"{t}：解析时将替换成主表别名/表名<br/>" +
			...
			/*$("#sysdatapermissionTips2").mouseover(function () {
                var message = "<span style='color:#333333;'>要求对应的业务表中存在该字段</span>";
                tipsIndex = layer.tips(message, $(this), {
                    tips: [2, '#e8f2fe'],
                    time: 0
                });
