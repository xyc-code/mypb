...
<html>
<head>
<!-- ControllerPath = "platform6/msystem/sysdatapermissions/sysdatapermissionsdefrule/sysDataPermissionsDefRuleController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<h3 style="text-align: center; font-weight: 600;">添加默认规则</h3>
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="23%" colspan="3">
						<textarea rows="3" class="form-control input-sm" name="ruleRemarks" id="ruleRemarks"></textarea>
					</td>
				</tr>
				<tr>
							...
							<tr>
								<td>
									<select class="js-example-basic-multiple" id="columnName" name="columnName" style="width: 200px">
										...
										<option value=''>其他字段（其他表字段）</option>
									</select>
								</td>
								<td>
								...
								<td>
									...
									<select class="js-example-basic-multiple" id="columnType" name="columnType" style="width: 110px;">
				...
				<tr>
					...
					<td width="23%" colspan="3">
						<textarea class="form-control input-sm" name="filterConditionSql" id="filterConditionSql" rows="3"></textarea>
					</td>
				</tr>
				<tr>
					<th width="10%"><label for="filterCondition">过滤条件:</label></th>
					<td width="23%" colspan="3">
						<textarea class="form-control input-sm" name="filterCondition" id="filterCondition" rows="2"></textarea>
					</td>
				</tr>
			</table>
		</form>
			...
			<table class="tableForm"
				...
				<tr>
					<td width="50%" style="padding-right: 4%;" align="right"><a
						...
						title="保存" id="sysDataPermissionsDefRule_saveForm">保存</a> <a
						href="javascript:void(0)"
						class="btn btn-grey form-tool-btn btn-sm" role="button" title="返回"
						id="sysDataPermissionsDefRule_closeForm">返回</a></td>
				</tr>
			</table>
		</div>
	</div>
...
<%--	<script type="text/javascript" src="avicit/platform6/console/sysdatapermissions/plugins/select2/js/select2.js"></script>--%>
	...
	<script type="text/javascript">
		function closeForm() {
			parent.sysDataPermissionsDefRule.closeDialog("insert");
		}
		function saveForm() {
			...
			parent.sysDataPermissionsDefRule.save($('#form'), "insert");
		}
