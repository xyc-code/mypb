 ...
 */
function SysDataPermissionsDefRule(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
SysDataPermissionsDefRule.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getSysDataPermissionsDefRulesByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
SysDataPermissionsDefRule.prototype.insert=function(){
 ...
 * 编辑页面
 */
SysDataPermissionsDefRule.prototype.modify=function(){
 ...
 * 详情页面
 */
SysDataPermissionsDefRule.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
SysDataPermissionsDefRule.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
SysDataPermissionsDefRule.prototype.formValidate=function(form){
	form.validate({
		rules : {
			ruleName : {
				maxlength : 50,
 ...
 * 保存方法
 */
SysDataPermissionsDefRule.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
SysDataPermissionsDefRule.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
SysDataPermissionsDefRule.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
SysDataPermissionsDefRule.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
SysDataPermissionsDefRule.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
SysDataPermissionsDefRule.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
SysDataPermissionsDefRule.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
SysDataPermissionsDefRule.prototype.clearData =function(){
