 ...
 */
function SysDataPermissionsAuth(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
SysDataPermissionsAuth.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getSysDataPermissionsAuthsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
SysDataPermissionsAuth.prototype.insert=function(){
 ...
 * 编辑页面
 */
SysDataPermissionsAuth.prototype.modify=function(){
 ...
 * 详情页面
 */
SysDataPermissionsAuth.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
SysDataPermissionsAuth.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
SysDataPermissionsAuth.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					roleId:{
						maxlength: 50
 ...
 * 保存方法
 */
SysDataPermissionsAuth.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
SysDataPermissionsAuth.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
SysDataPermissionsAuth.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
SysDataPermissionsAuth.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
SysDataPermissionsAuth.prototype.searchData =function(){
 ...
 * 关键字段查询
 */
SysDataPermissionsAuth.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
SysDataPermissionsAuth.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
SysDataPermissionsAuth.prototype.clearData =function(){
