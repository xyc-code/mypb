...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<h3 style="text-align: center; font-weight: 600;">编辑方法</h3>
		<form id='form' style="width: 96%;">
			<input type="hidden" name="version" value="<c:out  value='${sysDataPermissionsMethodDTO.version}'/>" />
			...
			<table class="form_commonTable">
				...
				<tr class="selectTr" style="display: none;">
					<th width="10%"><label for="selectType">选择页面类型:
						<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysdatapermissionTips3"></i></label>
					</th>
					<td width="23%">
						<label class="radio-inline">
					...
					<th width="10%"><label for="selectId"><i class="required">*</i>选择页唯一标识:
				...
				<tr class="selectCustomTr" style="display: none;">
					...
					<th width="10%"><label><i class="required">*</i>执行方法:
						<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysdatapermissionTips4"></i></label>
					</th>
					<td width="23%">
				...
				<tr class="defaultTr">
					<th width="10%"><label for="mapperName"><i class="required">*</i>mapper名称:
						<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysdatapermissionTips1"></i></label>
					</th>
					<td width="23%">
						<div class="input-group input-group-sm">
