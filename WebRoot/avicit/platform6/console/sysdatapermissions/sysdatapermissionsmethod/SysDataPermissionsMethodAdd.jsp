		...
		<form id='form' style="width: 96%;">
			...
			<table class="form_commonTable">
				...
				<tr class="defaultTr">
					...
					<td width="23%">
						<div class="input-group input-group-sm">
							<input class="form-control input-sm" type="text" name="mapperName" id="mapperName" autocomplete="off"/>
				...
				<tr class="defaultTr">
					<th width="10%"><label for="method"><i class="required">*</i>执行方法:
					<i class="tips-iconhelp icon iconfont icon-question-circle" id="sysdatapermissionTips7"></i></label></th>
					<td width="23%">
