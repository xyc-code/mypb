...
$(function(){
    ...
    $('#console').css("height",document.documentElement.clientHeight-35);
	$('#portal').css("height",document.documentElement.clientHeight-35);

	setTimeout(function(){
			var $frame=$('<iframe id="portal_ifrm" scrolling="no" frameborder="0" style="width:100%;height:100%;"></iframe>');
			$frame.attr("src","platform6/sysdatapermissionsmethod/sysDataPermissionsMethodController/portal/"+appid);
			$frame.appendTo($('#portal'));
		},10);

	var ifrm={'console_ifrm':'platform6/sysdatapermissionsmethod/sysDataPermissionsMethodController/console/'+appid};
