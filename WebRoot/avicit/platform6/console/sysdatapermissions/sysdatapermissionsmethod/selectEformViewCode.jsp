	...
	$(document) .ready(function() {
		...
		$('#eformViewCodeJqGrid').jqGrid({
            ...
            ondblClickRow:function (rowid,iRow,iCol,e) {
                var rowData = $("#eformViewCodeJqGrid").jqGrid('getRowData',rowid);
                $(window.parent.document).find("#viewCode").val(rowData.VIEW_CODE);
                $(window.parent.document).find("#viewName").val(rowData.VIEW_NAME);
