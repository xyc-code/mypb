...
$(function(){
	...
	function ajaxSysCount(){
		$.ajax({
			...
			type :'get',*/
			//解决sysLogCount方法获取的数据量未根据appId过滤
			url: 'platform/console/log/getSysLogDataByPage/'+APPLICATION+'/'+logTable+'.json',
			type: 'POST',
			dataType :'json',
			success :function(r){
				//total=r.total;
				total=r.records;
				if(r.records>r.threshold){
