 ...
 * 
 */
function SysImpColumnFiledRes(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//初始化操作
SysImpColumnFiledRes.prototype.init=function(){
	var _self = this;
...
//添加页面
SysImpColumnFiledRes.prototype.insert=function(){
...
//编辑页面
SysImpColumnFiledRes.prototype.modify=function(){
...
//详细页
SysImpColumnFiledRes.prototype.detail=function(id){
...
//打开高级查询框
SysImpColumnFiledRes.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
SysImpColumnFiledRes.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					sheetid:{
						maxlength: 2
...
//保存功能
SysImpColumnFiledRes.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//删除
SysImpColumnFiledRes.prototype.del=function(){
...
//重载数据
SysImpColumnFiledRes.prototype.reLoad=function(){
...
//关闭对话框
SysImpColumnFiledRes.prototype.closeDialog=function(id){
	if(id == "insert"){
...
//高级查询
SysImpColumnFiledRes.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//关键字段查询
SysImpColumnFiledRes.prototype.searchByKeyWord =function(){
...
//隐藏查询框
SysImpColumnFiledRes.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/*清空查询条件*/
SysImpColumnFiledRes.prototype.clearData =function(){
