...
<div class="easyui-layout" fit="true" >
	<ul id="myTab" class="nav nav-tabs">
		<li class="active" id = "portalAndPortletConfig_portal_id"><a rel='portal_ifrm' href="#portal" data-toggle="tab">主题皮肤</a></li>
		<li id = "portalAndPortletConfig_portlet_id"><a rel='portlet_ifrm' href="#portlet" data-toggle="tab">多栏目门户</a></li>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		if (!'${type}' == '' && '${type}' == 'jump') {
			document.getElementById('portletFrame').src = 'platform/portal/portlet/toPortletConfig?resourceType=default&appId=${appId}&orgIdentity=${orgIdentity}';
			$("#portalAndPortletConfig_portal_id").removeAttr("class");
			$("#portalAndPortletConfig_portlet_id").attr("class", "active");
			$("#portal").attr("class", "tab-pane fade");
			$("#portlet").attr("class", "tab-pane fade in active");
		} else {
		...
		$('#myTab a').click(function (e) {
			...
			}else if($(this).attr('rel') == 'portal_ifrm'){
				if($('#themeSkinsFrame').attr('src') == ''){
					$('#themeSkinsFrame').attr('src','platform/console/portal/toPortalConfig?appId=${appId}');
				}
			}
		});
	});
