 ...
 * @returns
 */
function ExtDataTree(ztreeId, url, form, searchD, searchbtn){
...
//初始化树节点
ExtDataTree.prototype.init=function(){
	var _self = this;
...
//查询框查询
ExtDataTree.prototype.onseach = function(ecode, value){
	var _self = this;
	if(ecode == 13){
