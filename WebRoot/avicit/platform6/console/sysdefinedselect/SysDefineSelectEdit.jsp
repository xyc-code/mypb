...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="version" value='<c:out  value='${sysDefineSelectDTO.version}'/>' /> <input type="hidden" name="id" id="id" value='<c:out  value='${sysDefineSelectDTO.id}'/>' />
			<table class="form_commonTable">
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="code_">编码:</label></th>
					<td width="39%"><input class="form-control input-sm" type="text" name="code_" id="code_"  value='<c:out  value='${sysDefineSelectDTO.code_}'/>' /></td>
				...
				<tr>
					...
					<td width="39%" colspan="4"><textarea class="form-control input-sm" rows="3"  name="sql_" id="sql_"><c:out value='${sysDefineSelectDTO.sql_}' /></textarea></td>
					
				</tr>
				<tr>
				<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="des_">描述:</label></th>
					<td width="39%" colspan="4"><textarea class="form-control input-sm" rows="3" type="text" name="des_" id="des_"  /><c:out value='${sysDefineSelectDTO.des_}' /></textarea></td>
				</tr>
				<tr>
				<th width="10%">说明：</th>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.sysDefineSelect.closeDialog("edit");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.sysDefineSelect.save($('#form'),"eidt");
		}
		...
		$(document).ready(function () {
			...
			if($("#ext_datasourceUrl").val().length >0){
				$("#inputClear").show();
			}
