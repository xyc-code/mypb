...
<%
	...
	int totalCreatedConnections = boneCP.getTotalCreatedConnections();
	if (totalCreatedConnections < 0) {
		totalCreatedConnections = 0;
	}
	int totalLeased = boneCP.getTotalLeased();
	if (totalLeased < 0) {
		totalLeased = 0;
	}
	int totalFree = boneCP.getTotalFree();
	if (totalFree < 0) {
		totalFree = 0;
	}
