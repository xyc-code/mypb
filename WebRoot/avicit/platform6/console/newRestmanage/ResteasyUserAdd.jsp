...
<html>
<head>
<!-- ControllerPath = "platfrom6/tablecol/resteasysystem/resteasySystemController/operation/sub/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%"><input class="form-control input-sm"
						type="text" name="userPassword" id="userPassword" /></td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
			function closeForm(){
			parent.resteasyUser.closeDialog("insert");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.resteasyUser.save($('#form'),"insert");
		}
