function ResteasyUser(parentdatagrid,datagrid, url, formSub, dataGridColModel,
	...
	this.getUrl = function() {
		return 'platform/platform6/newrestmanage/controller/resteasySystemController/operation/sub/';
	}
...
//初始化操作
ResteasyUser.prototype.init = function(pid) {
	var _self = this;
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getResteasyUser',
		postData : {
			pid : _self.pid
		},
		mtype : 'POST',
		...
		height : $('#north2').height() - $("#toolbar_resteasyUser").innerHeight() -36  -40,//120:顶部工具栏高+表头高+底部翻页模块高，17：顶部toolbar的内边距高度
...
//添加页面
ResteasyUser.prototype.insert = function() {
...
//修改页面
ResteasyUser.prototype.modify = function() {
	...
	this.eidtIndex = layer.open({
		...
		area : [ '60%', '60%' ],
		maxmin : false,
		content : this.getUrl() + 'Edit/' + rowData.id + '/'+parentId
	});
};
//详细页
ResteasyUser.prototype.detail = function(id) {
...
ResteasyUser.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			userName : {
				maxlength : 50,
...
//保存功能
ResteasyUser.prototype.save = function(form, id) {
	var _self = this;
	avicAjax.ajax({
...
//删除
ResteasyUser.prototype.del = function() {
...
//重载数据
ResteasyUser.prototype.reLoad = function(pid) {
	if (pid != undefined) {
		this.pid = pid;
	}
	var searchdata = {
...
//关闭对话框
ResteasyUser.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
ResteasyUser.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
ResteasyUser.prototype.searchData = function() {
	var searchdata = {
		keyWord : null,
		pid : this.pid,
...
//关键字段查询
ResteasyUser.prototype.searchByKeyWord = function() {
...
//隐藏查询框
ResteasyUser.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
ResteasyUser.prototype.clearData = function() {
