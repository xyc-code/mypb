...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="version"
				value='<c:out  value='${resteasySystemDTO.version}'/>' /> <input
				type="hidden" name="id"
				value='<c:out  value='${resteasySystemDTO.id}'/>' />
			<table class="form_commonTable">
				<tr>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="systemName">系统名称:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="systemName" id="systemName"
						value='<c:out  value='${resteasySystemDTO.systemName}'/>' /></td>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="orgId">所属单位:</label></th>
				...
				<tr>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
						for="systemDesc">系统描述:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="systemDesc" id="systemDesc"
						value='<c:out  value='${resteasySystemDTO.systemDesc}'/>' /></td>
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;"><label
	...
	<script type="text/javascript">
			function closeForm(){
			parent.resteasySystem.closeDialog("edit");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.resteasySystem.save($('#form'),"eidt");
		}
		...
		document.ready = function () {
			$.ajax({  
	            ...
	            success: function (data) {  
	                ...
	                $('#orgId').val('${resteasySystemDTO.orgId}');
	            },  
			...
			$("#status").val('${resteasySystemDTO.status}');
