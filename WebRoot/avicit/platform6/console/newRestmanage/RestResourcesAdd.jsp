...
<html>
<head>
<!-- ControllerPath = "platfrom6/tablecol/resteasyresources/resteasyResourcesController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
			function closeForm(){
			parent.restResourceManage.closeDialog("insert");
		}
		function saveForm(){
	        ...
	        if (!isValidate.checkForm()) {
			  ...
			  parent.restResourceManage.save($('#form'),"insert");
		}
