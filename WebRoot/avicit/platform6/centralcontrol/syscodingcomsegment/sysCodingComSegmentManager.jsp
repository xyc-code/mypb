...
function updateComSegmentValues(){
	...
	var usd = new CommonDialog("updateComSegmentValuesDialog","600","330","avicit/platform6/centralcontrol/syscodingcomsegment/sysCodingComSegmentValues.jsp?id="+id,"通用码段码值管理",true,true,false);
	usd.show();
}
