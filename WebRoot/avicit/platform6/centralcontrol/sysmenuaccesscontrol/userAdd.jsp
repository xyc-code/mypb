			...
			var l =rows.length;
			  ...
			  $.messager.confirm('请确认','您确定要授权当前所选的用户？',function(b){
				 if(b){
					 ...
					 $.ajax({
						 url:'platform/cc/sysaccesscontrol/insertComponentResourceAuth/U/'+parent.currentMenuId+"/<%=request.getParameter("appId")%>.json",
...
<div id="toolbarTableMap" class="datagrid-toolbar">
	 	...
	 	<table id="dgUser" class="easyui-datagrid" datapermission="sysSyncTableMapgrid"
							data-options=" 
								...
								striped:true,
								url:'platform/cc/sysdept/getUserDataByPage.json'">
							<thead>
								<tr>
		...
		<table width="100%">
			<tr>
				<td style="float:right">
					<a class="easyui-linkbutton" onclick="saveUser()" href="javascript:void(0);">添加</a>
