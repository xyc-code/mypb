			...
			var l =rows.length;
			  ...
			  $.messager.confirm('请确认','您确定要授权当前所选的角色？',function(b){
				 if(b){
					 ...
					 $.ajax({
						 url:'platform/cc/sysaccesscontrol/insertComponentResourceAuth/R/'+parent.currentMenuId+"/<%=request.getParameter("appId")%>.json",
...
<div id="toolbarTableMap" class="datagrid-toolbar">
	 	...
	 	<table id="dgRole" class="easyui-treegrid" datapermission="sysSyncTableMapgrid"
							data-options=" 
								...
								autoRowHeight: false,
								height: 400,
								url: 'platform/cc/centralizedauthorization/getOrgDepts.json?multipleOrg=n&selectType=dept_Comprehensive',
								method: 'post',
								idField: 'ID',
								treeField: 'NAME',
							    fit: true,
