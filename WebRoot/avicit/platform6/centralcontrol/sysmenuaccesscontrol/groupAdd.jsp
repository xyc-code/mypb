			...
			var l =rows.length;
			  ...
			  $.messager.confirm('请确认','您确定要授权当前所选的群组？',function(b){
				 if(b){
					 ...
					 $.ajax({
						 url:'platform/cc/sysaccesscontrol/insertComponentResourceAuth/G/'+parent.currentMenuId+"/<%=request.getParameter("appId")%>.json",
...
<div id="toolbarTableMap" class="datagrid-toolbar">
	 	...
	 	<table id="dgGroup" class="easyui-datagrid" datapermission="sysSyncTableMapgrid"
							data-options=" 
								...
								striped:true,
								url:'platform/cc/centralizedauthorization/getSysGroup.json?type=group'">
							<thead>
								<tr>
