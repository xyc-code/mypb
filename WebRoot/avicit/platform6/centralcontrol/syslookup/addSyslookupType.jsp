				...
				<table width="100%" style="padding-top: 10px;">
					<tr>
						...
						<td><span style="padding:0px;margin: 0px;">
							  	<input title="系统代码类型" class="inputbox" style="width: 180px;" type="text" name="lookupType" id="lookupType" value="${prefix}"/>
							</span></td>
					...
					<tr>
						...
						<td><select name="sysApplicationId" class="easyui-combobox" <c:if test="${m}">readonly='readonly'</c:if>  data-options="width:183,editable:false,panelHeight:'auto'">
					...
					<tr>
						...
						<td colspan="3"><input title="系统代码类型名称" class="inputbox" style="width: 503px;" type="text" name="description" id="description"/></td>
					</tr>
				</table>
		</form>
