...
<div data-options="region:'west',split:true,title:'应用列表',collapsible:false" style="width:200px;height:0; overflow:hidden; font-size:0;">
 ...
 <div data-options="region:'center',split:true" style="padding:0px;height:0; overflow:hidden; font-size:0;">   
		...
		<div id="toolbarSysLookupType" class="datagrid-toolbar">
		 	<table>
		 		<tr>
					...
					<td><a class="easyui-linkbutton" iconCls="icon-tools" plain="true" onclick="sysLookupType.openLanguageForm();" href="javascript:void(0);">语言设置</a></td>
	...
	<div data-options="region:'east',title:'通用代码值'" style="width:450px;background:#f5fafe;height:0; overflow:hidden; font-size:0;">
		<div id="toolbarSysLookup" class="datagrid-toolbar">
		 	<table>
		 		<tr>
					...
					<td><a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="sysLookup.del(sysLookupType._selectId);" href="javascript:void(0);">删除</a></td>
					<td><a class="easyui-linkbutton" iconCls="icon-tools" plain="true" onclick="sysLookup.openLanguageForm();" href="javascript:void(0);">语言设置</a></td>
				</tr>
		 	</table>
	 	</div>
	...
	<script src="avicit/platform6/centralcontrol/syslookup/js/SysLookupType.js" type="text/javascript"></script>
	<script src="avicit/platform6/centralcontrol/syslookup/js/SysLookup.js" type="text/javascript"></script>
	<script type="text/javascript">
		...
		$(function(){
			...
			sysAppTree.setOnSelect(function(_sysAppTree,node){
				sysLookupType.loadByAppId(node.id);
			});
		...
		function closeLook(){
			//'#chooseL'
			sysLookup.closeLdialog('#chooseL');
		};
