				...
				<table width="100%" style="padding-top: 10px;">
					<tr>
						...
						<td><span style="padding:0px;margin: 0px;">
								<span style="padding:1px;margin: 0px;width: 5px;display: inline-block;">
									<span class="required-icon"></span>
								</span>
							  	<input title="配置文件代码" class="inputbox" style="width: 180px;" type="text" name="profileOptionCode" id="profileOptionCode" value="${prefix}"/>
							</span></td>
						<th align="right">应用程序名称:</th>
						<td><select name="sysApplicationId" class="easyui-combobox" <c:if test="${m}">readonly='readonly'</c:if>  data-options="width:173,editable:false,panelHeight:'auto'">
