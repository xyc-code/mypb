...
function deleteSession(sessionId)
{
		...
		function(b){
			if(b){
				...
				$.ajax({
					 ...
					 url:'platform/cc/onlineuser/deleteSession/'+appId,
	...
	$("#dgSession").datagrid("options").url ="platform/cc/onlineuser/getPrinciplSessions";
	$('#dgSession').datagrid("reload", {});
}
...
function loadOnlineInfo(){
	...
	$("#dgOnline").datagrid("options").url ="platform/cc/onlineuser/getOnlineUserListByPage/"+appId
...
function loadSessionInfo(loginName)
{
	...
	{
		$("#dgSession").datagrid("options").url ="platform/cc/onlineuser/getPrinciplSessions";
		$('#dgSession').datagrid("reload", {loginName: loginName,appId: appId});
	}
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'west',split:true,title:'应用列表',collapsible:false" style="width:200px">
		...
		<div data-options="region:'center',split:true,title:''" style="height: 350px; padding:0px;">
			...
			<div class="easyui-layout" data-options="fit:true">
				...
				<div data-options="region:'center',split:true,title:''" style="height: 297px;padding:0px;">	
			    ...
			    <div data-options="region:'south',split:true,title:''" style="height: 237px;padding:0px;">	
...
<script type="text/javascript">
	...
	$(function(){
		...
		sysAppTree.setOnSelect(function(_sysAppTree,node){
			appId = node.id;
			$("#dgOnline").datagrid("options").url ="platform/cc/onlineuser/getOnlineUserListByPage/"+node.id;
			$('#dgOnline').datagrid("reload", {});
