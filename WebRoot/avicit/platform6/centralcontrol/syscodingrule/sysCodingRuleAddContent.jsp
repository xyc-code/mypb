...
<form id="formRuleSegment_${param.index}" method="post" style="padding: 15px 25px 0 0;">
	<table id="tableRuleSegment_${param.index}" class="form_commonTable">
		...
		<tr id="tdCount_${param.index}" style="display: none">
			...
			<td colspan="3">
				<input id="format_${param.index}" name="format" class="easyui-combobox" data-options="editable:false,panelHeight: 100,valueField:'code',textField:'name',url:'platform/cc/sysCodingRule/getCountFormatDate.json'" />
			</td>
