...
function addSegmentValue(segmentIndex){
	var baseId = $('#baseId').val();
	var usd = new CommonDialog("addSegmentValueDialog","450","265","platform/cc/sysCodingRule/toAddSegmentValueJsp?baseId="+ baseId +"&segmentIndex=" + segmentIndex,"添加码值",true);
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		iconCls : '',
...
function updateSegmentValue(segmentIndex){
	...
	var baseId = $('#baseId').val();
	var usd = new CommonDialog("updateSegmentValueDialog","450","265","platform/cc/sysCodingRule/toUpdateSegmentValueJsp?id="+ id +"&baseId="+ baseId +"&segmentIndex=" + segmentIndex,"编辑码值",true);
	var buttons = [{
		text:'提交',
		id : 'formSubimt',
		iconCls : '',
