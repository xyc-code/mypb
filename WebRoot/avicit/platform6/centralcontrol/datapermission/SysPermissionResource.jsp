...
function showDept(rowIndex, field, value){
	...
	var userSelect = new GridCommonSelector("dept","datarole",rowIndex,"dept",{targetId:'accessDept'},"selectDialogCallBack",null,null,null,false,null,null,"1");//
	 var rows = $('#datarole').datagrid("getRows");
	 userSelect.init(rows[rowIndex]);
};
function showUser(rowIndex, field, value){
	var userSelect = new GridCommonSelector("user","datarole",rowIndex,"dept",{targetId:'accessUser'},"selectDialogCallBack",null,null,null,false,null,null,"1");//
	 var rows = $('#datarole').datagrid("getRows");
	 userSelect.init(rows[rowIndex]);
};
function showRole(rowIndex, field, value){
	var userSelect = new GridCommonSelector("role","datarole",rowIndex,"dept",{targetId:'accessRole'},"selectDialogCallBack",'{"appId":"'+_appId+'"}',null,null,false,null,null,"1");//
	 var rows = $('#datarole').datagrid("getRows");
	 userSelect.init(rows[rowIndex]);
};
function showgroup(rowIndex, field, value){
	var userSelect = new GridCommonSelector("group","datarole",rowIndex,"dept",{targetId:'accessGroup'},"selectDialogCallBack",null,null,null,false,null,null,"1");//
	 var rows = $('#datarole').datagrid("getRows");
	 userSelect.init(rows[rowIndex]);
};
function showPosition(rowIndex, field, value){
	var userSelect = new GridCommonSelector("position","datarole",rowIndex,"dept",{targetId:'accessPosition'},"selectDialogCallBack",null,null,null,false,null,null,"1");//
	 var rows = $('#datarole').datagrid("getRows");
	 userSelect.init(rows[rowIndex]);
};
//部门选择回调
