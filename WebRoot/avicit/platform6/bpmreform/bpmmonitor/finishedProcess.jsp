...
<body class="easyui-layout" fit="true">
	<div style="border-top-style: hidden;width:300px;"
		data-options="region:'west',split:true,onResize:function(a){$('#demoSubUser').setGridWidth(a);$(window).trigger('resize');}">
	...
	<div
		...
		<div id="toolbar_bpmProcinst" class="toolbar">
			<div class="toolbar-left">
				...
				<sec:accesscontrollist hasPermission="3"
									   domainObject="bpmProcinst_button_del_part" permissionDes="仅删除流程实例，保留业务实例">
					<a id="bpmProcinst_button_del_part" href="javascript:void(0)"
					   class="btn btn-primary form-tool-btn typeb btn-sm" role="button"
					   title="仅删除流程实例，保留业务实例"><i class="icon icon-delete"></i> 仅删除流程实例，保留业务实例</a>
				</sec:accesscontrollist>
			</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		//删除按钮绑定事件
		$('#bpmProcinst_button_del_part').bind('click', function() {
			bpmProcinst.delPart();
		});
		//打开高级查询
