...
$(function () {
    ...
    $('.setting-btn').on('click', function () {
        ...
        layer.open({
            ...
            success: function (layero, index) {
                ...
                var _end_track_display = 0;
                var _start_idea_display = 0;
                var _start_pic_display = 0;
                var _start_track_display = 0;
                for (var i = 0; i < _endOrderData.length; i++) {
                    ...
                    if(_endOrderData[i].code == "bpm_track_tab" && _endOrderData[i].display == "1"){
                        _end_track_display = 1;
                    }
                ...
                for (var i = 0; i < _startOrderData.length; i++) {
                    ...
                    if(_startOrderData[i].code == "bpm_track_tab" && _startOrderData[i].display == "1"){
                        _start_track_display = 1;
                    }
                }
                ...
                if (_tempOrderFlg || _tempDisplayFlg) {
                    $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            if(_start_track_display == 0 && _end_track_display == 1 && _flow_editor.needRefreshTrack){
                                _flow_editor.refreshTrack();
                            }
                            if (_tempOrderFlg) {
    ...
    // 视图切换按钮事件
    $('.track-btns>div').on('click', function() {
