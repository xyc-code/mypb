...
<div id="main">
    ...
    <div class="nav-body">
        ...
        <%} else if (bpmTab.getCode().equals("bpm_track_tab")) {%>
        <div id="bpm_track_tab"
             class="section-content" <%=!bpmTab.getDisplay().equals("1") ? "style='display:none'" : ""%>>
            ...
            <div class="section-iframe">
                <div class="track-body">
                    ...
                    <div class="switch-panel list">
                        <table class="table table-condensed track-table">
                            <thead>
                            <tr>
                                <td width="8%">节点</td>
                                <td width="5%">处理人</td>
        ...
        <%}%>
        <%}%>
        <div style="height: 600px;background: #f3f4f9;"></div>
    </div>
</div>
