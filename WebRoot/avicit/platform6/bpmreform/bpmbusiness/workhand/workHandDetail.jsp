		...
		<table class="form_commonTable">
			...
			<tr>
				...
				<td width="39%" colspan="3">
					<input type="checkbox" id="cancleAutoWithdraw" name="cancleAutoWithdraw" value="1" disabled="disabled" <c:if test="${workHand.cancleAutoWithdraw=='1'}">checked="checked"</c:if> />
				</td>
			</tr>
            <tr>
