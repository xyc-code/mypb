...
String importlibs = "common,table,form";
	String secretLevel = SpringFactory.getBean(SysProfileAPI.class).getProfileValueByCodeByAppId("PLATFORM_V6_WORKHAND_USER", SessionHelper.getApplicationId());
	boolean flg = "true".equals(secretLevel);
	String userSecretLevel = null;
	if(flg){
		userSecretLevel = SpringFactory.getBean(SysUserAPI.class).getUserSecretLevel(SessionHelper.getLoginSysUser(request).getId(), SessionHelper.getCurrentOrgIdentity());
	}
%>
<!DOCTYPE html>
<html>
...
<div data-options="region:'center',split:true,border:false">
	<form id='form' enctype="multipart/form-data">
		...
		<table class="form_commonTable">
			<tr>
				<th width="15%" style="word-break: break-all; word-warp: break-word;"><label for="workOwnerName">委托人:</label></th>
				<td width="34%">
				...
				<th width="15%" style="word-break: break-all; word-warp: break-word;"><label for="workOwnerDeptName">委托人部门:</label></th>
				<td width="34%">
			...
			<tr>
				<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="cancleAutoWithdraw">注销后自动拿回所有委托:</label></th>
				<td width="39%" colspan="3">
					<input type="checkbox" id="cancleAutoWithdraw" name="cancleAutoWithdraw" value="1" <c:if test="${workHand.cancleAutoWithdraw=='1'}">checked="checked"</c:if> />
				</td>
			</tr>
            <tr>
    ...
    $(document).ready(function () {
		...
		$('#receptUserName').on('focus', function(e) {
			new H5CommonSelect({
				...
				textFiled : 'receptUserName',callBack:function(data){
