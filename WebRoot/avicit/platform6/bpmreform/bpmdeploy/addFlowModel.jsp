...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='addForm'>
			<input type="hidden" name="selectedNodeId" id="selectedNodeId" value="<c:out value='${selectedNodeId}'/>"/>
			<input type="hidden" name="location" id="location" value="<c:out value='${location}'/>"/>
