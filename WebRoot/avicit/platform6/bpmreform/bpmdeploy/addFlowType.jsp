...
<script type="text/javascript">
    document.ready = function () {
        ...
        $("#parentId").val(parent.flowTypeTree.selectedNodeId);

        parent.flowType.formValidate($('#addForm'));
        $('#saveForm').bind('click', function () {
            parent.flowType.subAdd($("#addForm"));
        });
        $('#closeForm').bind('click', function () {
            parent.flowType.closeDialog("add");
        });

        $.ajax({
            url:"bpm/deploy/getCatalogLastNumber",
            type : "POST",
            dataType : "TEXT",
