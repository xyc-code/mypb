...
<script src="avicit/platform6/bpmreform/bpmdeploy/js/ShareTypeTree.js"></script>
...
<script type="text/javascript">
	...
	function zTreeOnClick(event, treeId, treeNode) {
        shareTypeTree = new ShareTypeTree("flowTypeTreeUL",treeNode.id); 
	};
	
	$(document).ready(function () {
	        $.post('bpm/deploy/getOrgTree',
					function(r) {
