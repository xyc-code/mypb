...
<div id="tableToolbar" class="toolbar">
    <div class="toolbar-left">
        ...
        <input type="checkbox" id="isOverride" style="height: 11px !important; margin-right: 4px;">是否覆盖
    ...
    <form  role="form"  id='uploadForm' method="post" enctype="multipart/form-data"  style="padding-top:20px;" >
        ...
        <div class="form-group">
            <label for="eventFile">导入的文件</label>
            <input type = "file" id = 'eventFile' name = 'eventFile' accept=".xml" />
            <input type="hidden" id="currentNodeId" name="currentNodeId" />
        </div>
    </form>
</div>
...
<script>
    ...
    function doImport() {
        ...
        if($("#eventFile").val() == ""){
            ...
            var pathFileName = $("#eventFile").val();
            var isOverride = $('#isOverride').prop('checked');
