...
FlowComponent.prototype.setComponent = function (data) {
    ...
    var _dataContent = '';
    if('2'==data.type){
        _dataContent = '<table width="180px" border="0" style="font-size:12px;word-break: break-all;"  align="center">'
            ...
            +'<tr ><td width="40%" height="25" >部署ID:</td><td >'+data.deployId+'</td></tr>'
            ...
            +'<tr><td width="40%" height="25">排序:</td><td>'+(typeof data.order != 'undefined' && data.order != null ? data.order : '')+'</td></tr>'
            +'</table>';
    }else{
...
FlowComponent.prototype.fileDown = function(id, type, pdId, deployId, flowName) {
    flowName = encodeURI(encodeURI(flowName));
