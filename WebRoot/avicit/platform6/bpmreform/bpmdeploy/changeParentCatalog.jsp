...
<script src="avicit/platform6/bpmreform/bpmdeploy/js/ParentCatalogTree.js"></script>
<script type="text/javascript" src="avicit/platform6/bpmreform/bpmcommon/flowUtils.js"></script>

<script type="text/javascript">
    var catalogTree;
    document.ready = function () {
        var enableSelectRoot = flowUtils.getUrlQuery("enableSelectRoot");
    	catalogTree = new ParentCatalogTree("catalogTree",enableSelectRoot);
    	//返回按钮绑定事件
		$('#closeForm').bind('click', function() {
			parent.closeCatalogDialog();
		});
    };
</script>
</body>
