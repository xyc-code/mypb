...
<div data-options="region:'center',split:true,border:false">
	<form id='form'>
		<input type="hidden"
			   name="dbid" id="dbid" value="${dto.dbid}"/>
		<input type="hidden"
			   name="thirdPartyDbid" id="thirdPartyDbid" value="${dto.thirdPartyDbid}"/>
		<table class="form_commonTable">
			<tr>
				<th width="15%"><label for="name">常量名:</label></th>
				<td width="85%"><input class="form-control input-sm"
									   type="text" name="name" id="name" value="${dto.name}"/></td>
			</tr>
			<tr>
				<th width="15%"><label for="initExpr">常量值:</label></th>
				<td width="85%"><input class="form-control input-sm"
									   type="text" name="initExpr" id="initExpr" value="${dto.initExpr}"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td width="85%"><input class="form-control input-sm"
									   type="text" name="remark" id="remark" value="${dto.remark}"/></td>
			</tr>
		</table>
	</form>
</div>
...
<script type="text/javascript">
	function closeForm(){
		parent.bpmEventProperties.closeDialog("eidt");
	}
	function saveForm(){
		...
		parent.bpmEventProperties.save($('#form'),"eidt");
	}
