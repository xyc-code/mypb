...
$(function(){
	...
	setTimeout(function(){
		var url = "avicit/platform6/bpmreform/bpmdomain/myDraft.jsp?nodeId="+nodeId+"&nodeType="+nodeType+"&pdId="+pdId;
		$('<iframe id="iframe1" name="iframe1" src="'+url+'" style="width: 100%;height: 100%; border: 0;"></iframe>').appendTo($('#myDraft'));
	},10);
	var url1 = 'avicit/platform6/bpmreform/bpmdomain/myDraft.jsp?nodeId='+nodeId+'&nodeType='+nodeType+'&pdId='+pdId;
	var url2 = 'avicit/platform6/bpmreform/bpmdomain/myStartedProcess.jsp?nodeId='+nodeId+'&nodeType='+nodeType+'&pdId='+pdId;
	var url3 = 'avicit/platform6/bpmreform/bpmdomain/myDoneProcess.jsp?nodeId='+nodeId+'&nodeType='+nodeType+'&pdId='+pdId;
