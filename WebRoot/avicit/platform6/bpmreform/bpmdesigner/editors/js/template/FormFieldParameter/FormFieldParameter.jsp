...
<script>
	...
	$(function() {
		...
		var subDeploymentId = parentObj.subDeploymentId;
		...
		getProcessFormFields(mainProcessFormId,subProcessKey,"","",subDeploymentId);
	...
	function getProcessFormFields(mainProcessFormId,subProcessKey,parentProcessDataSourceId,subProcessDataSourceId,subDeploymentId){
		avicAjax.ajax({
            url: "platform/bpm/designer/getProcessFormFields",
            data: "mainProcessFormId=" + mainProcessFormId+"&subProcessKey="+subProcessKey+"&subDeploymentId="+subDeploymentId
