...
ConnectTypeTree.prototype.init = function () {
    ...
    var setting = {
        async: {
            enable: true,
            url: "platform/connectcenter/connectCenterController/getWebserviceAndRestfulTree",//异步请求树子节点url
            autoParam: ["id"]//父节点id
        },
        data: {
            simpleData: {
    ...
    //手动请求根节点数据
    $.ajax({
        url: "platform/connectcenter/connectCenterController/getWebserviceAndRestfulTree",
        data: "id=-1",
        type: "post",
        async: false,
        dataType: "json",
