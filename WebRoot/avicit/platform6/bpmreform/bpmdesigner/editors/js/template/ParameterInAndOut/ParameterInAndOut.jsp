	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form' enctype="multipart/form-data">
			<table class="form_commonTable">
				<tr>
					<th width="15%" style="word-break: break-all; word-warp: break-word;"><label for="varName">输出参数:</label></th>
					<td width="34%"><input title="输出参数" class="form-control input-sm" type="text" name="varName" id="varName" /></td>
					<th width="15%" style="word-break: break-all; word-warp: break-word;"><label for="varInit">输入参数:</label></th>
					<td width="34%"><input title="输入参数" class="form-control input-sm" type="text" name="varInit" id="varInit" /></td>
				</tr>
			</table>
