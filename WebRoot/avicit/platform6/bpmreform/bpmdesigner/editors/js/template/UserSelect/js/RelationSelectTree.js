                ...
                if (treeNode) {
                    ...
                    if(id == "alluser" || id == "allorguser" || id == "draftuser" || id == "currentusergroup") {
                        ...
                        layer.open({
                            ...
                            content: "avicit/platform6/bpmreform/bpmdesigner/editors/js/template/UserSelect/deptPositionSelectTree.jsp?id="+treeNode.id+"&name="+encodeURI(encodeURI(treeNode.text)) + "&showRoles=1" ,
                            btn: ['确定', '关闭'],
                        ...
                        layer.open({
                            ...
                            shade:   0.3,
                            maxmin: false, //开启最大化最小化按钮
                            content: "avicit/platform6/bpmreform/bpmdesigner/editors/js/template/UserSelect/TaskNodeSelect.jsp?id="+treeNode.id+"&name="+encodeURI(encodeURI(treeNode.text)) ,
                            btn: ['确定', '关闭'],
                            yes: function(index, layero){
                                var iframeWin = layero.find('iframe')[0].contentWindow;
                        ...
                        layer.open({
                            ...
                            shade:   0.3,
                            maxmin: false, //开启最大化最小化按钮
                            content: "avicit/platform6/bpmreform/bpmdesigner/editors/js/template/UserSelect/customFunctionSelect.jsp?id="+treeNode.id+"&name="+encodeURI(encodeURI(treeNode.text)),
                            btn: ['确定', '关闭'],
                            yes: function(index, layero){
                                var iframeWin = layero.find('iframe')[0].contentWindow;
