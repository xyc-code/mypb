	...
	<div data-options="region:'center',split:true,border:false">
		<form id='form' enctype="multipart/form-data">
			<table class="form_commonTable">
				<tr>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="varAlias">参数名:</label></th>
					<td width="39%"><input title="名称" class="form-control input-sm" type="text" name="varAlias" id="varAlias" /></td>
					<th width="10%" style="word-break: break-all; word-warp: break-word;"><label for="varName">参数:</label></th>
	...
	<script type="text/javascript">
		$(function() {
			...
			if(typeof act != 'undefined' && act == "edit") {
				...
				$("#varAlias").val(selectedData.varAlias);
