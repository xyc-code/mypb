function IntersectionSelect(option) {
	...
	this.template = option.template || "avicit/platform6/bpmreform/bpmdesigner/editors/js/template/UserSelect/intersection/IntersectionSelect.jsp?processId="+this.processId+"&pid="+option.id+"&pname="+encodeURI(encodeURI(option.name));
	this.init.call(this);
	return this;
};
