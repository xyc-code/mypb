function ProcessVariable (option) {
	...
	this.template = "avicit/platform6/bpmreform/bpmdesigner/editors/js/template/UserSelect/ProcessVariableForSelectUser.jsp?processId="+option.processId+"&pid="+option.id+"&pname="+encodeURI(encodeURI(option.name));
	this.init();
}
