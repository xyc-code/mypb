function TextTracks(datagrid, url, formSub, dataGridColModel, searchDialogSub,searchSubNames, textTracks_KeyWord) {
    ...
    this._keyWordId = "#" + textTracks_KeyWord;
...
;
//初始化操作
TextTracks.prototype.init = function(pid,nodeType) {
    var _self = this;
    $(_self._datagridId).jqGrid({
        ...
        height : $(window).height() - 100 - 17, //120:顶部工具栏高+表头高+底部翻页模块高，17：顶部toolbar的内边距高度
...
//重载数据
TextTracks.prototype.reLoad = function(pid,nodeType,pdId) {
    if (pid != undefined) {
        this.pid = pid;
    }
...
//关闭对话框
TextTracks.prototype.closeDialog = function(id) {
    if (id == "insert") {
...
//打开高级查询框
TextTracks.prototype.openSearchForm = function(searchDiv, par) {
    var _self = this;
    par = null;
    //if(!par) par = $(window);
...
//高级查询
TextTracks.prototype.searchData = function() {
    var searchdata = {
        keyWord : null,
...
//关键字段查询
TextTracks.prototype.searchByKeyWord = function() {
...
//隐藏查询框
TextTracks.prototype.hideSearchForm = function() {
    layer.close(searchDialogindex);
};
/*清空查询条件*/
TextTracks.prototype.clearData = function() {
