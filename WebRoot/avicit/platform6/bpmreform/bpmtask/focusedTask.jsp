...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var url = "bpm/task/searchFocusedTaskByPage";
		bpmTask = new BpmTask('bpmTask', url, "formSub", bpmTaskGridColModel, 'searchDialogSub', nodeId, nodeType, searchSubNames, "bpmTask_keyWord",pdId,'','',true);
		...
		function formatterOpt(value, options, rowObject) {
			var html = '';
	    	html += '<a href="javascript:void(0)" name="btn-flow-variable-reject" onclick="flowUtils.attTask(\''+rowObject.dbid+'\')">取消关注</a>';
	    	return html;
		};
		...
		$('#bpmTask_button_clean').bind('click', function() {
			bpmTask.cleanAll();
		});
