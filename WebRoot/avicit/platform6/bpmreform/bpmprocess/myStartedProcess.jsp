...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var url = "bpm/process/searchHistProcessByPage?type=1";
		bpmProcInst = new BpmProcInst('bpmProcInst', url, "formSub", bpmProcInstGridColModel, 'searchDialogSub', nodeId, nodeType, searchSubNames, "bpmProcInst_keyWord",pdId,'tab2','我的申请');
