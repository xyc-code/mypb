...
<script type="text/javascript">
	...
	function selectSearchType(obj){
		...
		if('title'==selectVal){
			...
			var cumtomHtml = '<div class="dropdown">'
		        +'<a id="queryStartDateName" class="btn btn-primary form-tool-btn btn-sm form-control" style="text-align:center;align:center;width:120px;" role="button"  href="javascript:void(0);" data-toggle="dropdown" id="dropdownMenu">时间不限 <span class="caret"></span></a>'
	...
	$(document).ready(function() {
		...
		bpmProcInst = new BpmProcInst('bpmProcInst', url, "formSub", bpmProcInstGridColModel, 'searchDialogSub', nodeId, nodeType, searchSubNames, "bpmProcInst_keyWord",pdId,'tab3','我的经办');
