...
<!-- ControllerPath = "platform6/msecure/mobileserviceinfo/MobileServiceInfoController/operation/Edit/id" -->
<title>修改</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			parent.mobileServiceInfo.save(serializeObject($('#form')), "#edit");
		}
	</script>
</body>
</html>