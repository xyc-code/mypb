 ...
 * 
 */
function MobileDevice(datagrid,url,searchD,form){
...
//打开查询框
MobileDevice.prototype.openSearchForm =function(){
...
MobileDevice.prototype.formate=function(value){
	if(value){
		return new Date(value).format("yyyy-MM-dd");
	}
	return '';
};
MobileDevice.prototype.formateDateTime=function(value){
	if(value){
...
//返回主表的id
MobileDevice.prototype.getSelectID=function(){
	return this._selectId;
};
MobileDevice.prototype.searchDataBySfn =function(conditions){
    this._datagrid.datagrid('uncheckAll').datagrid('unselectAll').datagrid('clearSelections');
