		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					<th width="10%">登陆名:</th>
					<td width="40%">
							<input class="easyui-validatebox" name="userId" id="userId" value='<c:out  value='${mobileUseDeviceBindDTO.userId}'/>' style="width:179px;" required="true" />
					</td>
					<th width="10%">应用名称:</th>
					<td width="40%"><select class="easyui-combobox" name="appId" id="appId" editable="false" data-options="panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
					...
					<tr>
					<th width="10%">状态：</th>
					<td width="40%"><select class="easyui-combobox" name="bindStatus" id="bindStatus"   editable="false"  data-options="panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
