...
<!-- ControllerPath = "platform6/msecure/mobileapp/MobileAppController/operation/Edit/id" -->
<title>修改</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			<input type="hidden" name="id" value='${mobileAppDTO.id}' />
			<table class="form_commonTable">
				<tr>
					<th width="10%">应用名称:</th>
					<td width="40%"><input title="应用名称" class="inputbox easyui-validatebox" data-options="required:true,validType:'maxLength[50]'" style="width: 180px;" type="text" name="appName" id="appName" value='<c:out value='${mobileAppDTO.appName}'/>' /></td>
					<th width="10%">应用状态：</th>
				...
				<tr>
					...
					<th width="10%">应用描述:</th>
					<td width="40%"><input title="应用描述" class="inputbox easyui-validatebox" data-options="validType:'maxLength[255]'" style="width: 180px;" type="text" name="descript" id="descript" value='<c:out value='${mobileAppDTO.descript}'/>' /></td>
				</tr>
				<tr>
				</tr>
			</table>
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			parent.mobileApp.save(serializeObject($('#form')), "#edit");
		}

		$(document).ready(function() {
			$("#appBindChose").val("false");
		});
	</script>
</body>
</html>