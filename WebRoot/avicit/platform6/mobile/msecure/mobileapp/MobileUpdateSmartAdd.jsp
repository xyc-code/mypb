...
<!-- ControllerPath = "ee/mobileupdatesmart/MobileUpdateSmartController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="40%"><input title="SMART_VERSION"
						...
						style="width: 180px;"
						type="text" name="smartVersion" id="smartVersion" /></td>
	...
	function closeForm(){
		parent.mobileUpdateSmart.closeDialog("#insert");
	}
	function saveForm(){
