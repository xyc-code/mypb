...
<!-- ControllerPath = "platform6/msecure/mobiledevelopproduct/MobileDevelopProductController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<th width="10%">设备系统:</th>
					<td width="40%">
						<pt6:syslookup name="platform" lookupCode="PLATFORM_MOBILE_PLATFORM" dataOptions="onShowPanel:comboboxOnShowPanel,editable:false,panelHeight:'auto'">
						</pt6:syslookup> 
					</td>
				...
				<tr>
					<th>证书类型:</th>
					<td>
						<pt6:syslookup name="developProductId" lookupCode="PLATFORM_MOBILE_CERT_TYPE" isNull="true" dataOptions="onShowPanel:comboboxOnShowPanel,editable:false,panelHeight:'auto'">
						</pt6:syslookup> 
					</td>
					<th>证书密码:</th>
	...
	function closeForm(){
		parent.mobileDevelopProduct.closeDialog("#insert");
	}
	function saveForm(){
