function MobileUserLog(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//添加页面
MobileUserLog.prototype.insert=function(){
...
//编辑页面
MobileUserLog.prototype.modify=function(){
...
//打开高级查询框
MobileUserLog.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
MobileUserLog.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   					userId:{
						maxlength: 50
...
//保存功能
MobileUserLog.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//删除
MobileUserLog.prototype.del=function(){
...
//关键字段查询
MobileUserLog.prototype.searchByKeyWord =function(){
