...
<html>
<head>
<!-- ControllerPath = "ims/portal/stat/mobilecommandextend/mobileCommandExtendController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr style="display: none">
					<th width="10%"><label for="commandId">COMMAND_ID:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="commandId" id="commandId" /></td>
					<th width="10%"><label for="methodName">METHOD_NAME:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="methodName" id="methodName" /></td>
				</tr>
				<tr>
					<th width="5%"><label for="className">类名:</label></th>
					<td width="39%"><input class="form-control input-sm"
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			$("#commandId").val(parent.mobileCommandExtend.pid);
			//限制保存按钮多次点击
			$('#mobileCommandExtend_saveForm').addClass('disabled');
			parent.mobileCommandExtend.save($('#form'), "insert");
		}
