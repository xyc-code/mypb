 ...
 * 
 */
function MobileServiceInfo(datagrid, url, searchForm, dataGridColModel,
...
MobileServiceInfo.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			serviceName : {
				required:true,
...
//打开高级查询框
MobileServiceInfo.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
	var contentWidth = 400; //(par.width()*.6 >= 600)?600:par.width()*.6;
...
//关键字段查询
MobileServiceInfo.prototype.searchByKeyWord = function() {
