function MobileServiceHeaders(datagrid, url,  dataGridColModel, pid, demoSubUser_KeyWord){
...
MobileServiceHeaders.prototype.init=function(pid){
	...
	$(_self._datagridId).jqGrid({
    	url: this.getUrl()+'getMobileServiceHeaders',
...
MobileServiceHeaders.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  		     			    				   				   serviceId:{
						required:true,
...
//重载数据
MobileServiceHeaders.prototype.reLoad=function(pid){
	if(pid != undefined){
		this.pid = pid;
	}
...
//打开高级查询框
/*MobileServiceHeaders.prototype.openSearchForm = function(searchDiv,par){
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
/*MobileServiceHeaders.prototype.searchData =function(){
	var searchdata = {
		keyWord: null,
		pid:this.pid,
...
//关键字段查询
/*MobileServiceHeaders.prototype.searchByKeyWord =function(){
...
//隐藏查询框
/*MobileServiceHeaders.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};*/
/*清空查询条件*/
/*MobileServiceHeaders.prototype.clearData =function(){
