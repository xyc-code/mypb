...
<html>
<head>
<!-- ControllerPath = "ims/portal/stat/mobileserviceinfo/mobileServiceInfoController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					<th width="10%"><label for="serviceName">服务名称:</label></th>
					<td width="39%"><input class="form-control input-sm"
						type="text" name="serviceName" id="serviceName" /></td>
					<th width="10%"><label for="serviceBaseurl">服务基本地址:</label></th>
					<td width="39%"><input class="form-control input-sm"
	...
	<script type="text/javascript">
		...
		function saveForm() {
			...
			parent.mobileServiceInfo.save($('#form'), "insert");
		}
