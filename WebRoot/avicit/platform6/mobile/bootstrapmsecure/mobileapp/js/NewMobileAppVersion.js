function MobileAppVersion(datagrid, url, formSub, dataGridColModel,
...
MobileAppVersion.prototype.init = function(pid) {
	...
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getMobileAppVersion',
		postData : {
			pid : _self.pid
		},
		mtype : 'POST',
...
MobileAppVersion.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			appId : {
				required : true,
...
//重载数据
MobileAppVersion.prototype.reLoad = function(pid) {
	if (pid != undefined) {
		this.pid = pid;
	}
	var searchdata = {
...
//打开高级查询框
MobileAppVersion.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
MobileAppVersion.prototype.searchData = function() {
	var searchdata = {
		keyWord : null,
		pid : this.pid,
...
//关键字段查询
MobileAppVersion.prototype.searchByKeyWord = function() {
...
//隐藏查询框
MobileAppVersion.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
MobileAppVersion.prototype.clearData = function() {
