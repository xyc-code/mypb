 ...
 * 
 */
function MobileApp(datagrid, url, searchForm, dataGridColModel, searchDialog,
		afterInit, clickRowLoad, searchMainNames, demoMainDept_KeyWord) {
...
MobileApp.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			appName : {
				required : true,
...
//打开高级查询框
MobileApp.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//关键字段查询
MobileApp.prototype.searchByKeyWord = function() {
