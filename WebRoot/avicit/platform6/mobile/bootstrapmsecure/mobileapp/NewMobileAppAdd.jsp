...
<html>
<head>
<!-- ControllerPath = "platform6/bootstrapmsecure/mobileapp/NewmobileAppController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="form_commonTable">
				<tr>
					...
					<td width="39%"><input class="form-control input-sm"
						type="text" name="appName" id="appName" /></td>
					<th width="10%"><label for="appStatus">应用状态:</label></th>
					<td width="39%"><select
				...
				<tr>
					<th width="10%"><label for="appBindChose">应用是否需要绑定：</label></th>
					<td width="39%"><select
	...
	<script type="text/javascript">
		...
		function saveForm(){
			...
			parent.mobileApp.save($('#form'),"insert");
		}
