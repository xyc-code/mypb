...
var _bpm_baseurl = "<%=ViewUtil.getRequestPath(request)%>";
	...
	<body>
		<div class="monitor content_box"  style="bottom: 5px;">
			<div class="content_inner monitor_box" style="height: 310px;">
				<img src="avicit/platform6/h5demo/potal/demo_index3/image/chartsThree.png" alt="" />
			</div>
		</div>
	</body>
