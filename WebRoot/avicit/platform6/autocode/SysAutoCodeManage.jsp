...
<body>
	<div id="tableToolbar" class="toolbar">
		<div class="toolbar-left">
			...
			<sec:accesscontrollist hasPermission="3" domainObject="formdialog_sysAutoCode_button_import" permissionDes="导入">
				<a id="sysAutoCode_import" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="导入"><i class="icon icon-daoru"></i> 导入</a>
			</sec:accesscontrollist>
			<sec:accesscontrollist hasPermission="3" domainObject="formdialog_sysAutoCode_button_export" permissionDes="导出">
				<a id="sysAutoCode_export" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="导出"><i class="icon icon-daochu"></i> 导出</a>
			</sec:accesscontrollist>
		</div>
...
<script type="text/javascript">
	...
	$(document).ready(
			function() {
				...
				//导入
				$('#sysAutoCode_import').bind('click', function () {
					sysAutoCode.importData();
				});
				//导出
				$('#sysAutoCode_export').bind('click', function () {
					sysAutoCode.exportData();
				});
