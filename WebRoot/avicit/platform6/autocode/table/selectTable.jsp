            ...
            <div id="tableToolbar" class="toolbar">
                <div class="toolbar-right">
                    <div class="input-group form-tool-search">
                        ...
                        <%--<label id="table_searchPartClear" class="icon iconfont icon-guanbi2" style="position:absolute;right:25px;top:3px;"></label>--%>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $("#table_searchPartClear").on('click', function (e) {
    	$("#table_keyWord").val("");
    	$("#table_keyWord").attr("placeholder","请输入表名查询");
    	searchByKeyWord();
    });
