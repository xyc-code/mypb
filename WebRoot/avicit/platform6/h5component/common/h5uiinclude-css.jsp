...
<link rel="stylesheet" type="text/css" href="static/h5/mydate97/skin/WdatePicker.css?v=${jsversion}"/>
<link rel="stylesheet" type="text/css" href="static/h5/mydate97/skin/whyGreen/datepicker.css?v=${jsversion}"/>
<link rel="stylesheet" type="text/css" href="static/h5/mydate97/skin/default/datepicker.css?v=${jsversion}"/>
<%
}
...
%>
<%--此处判断是为了解决附件table无法展示的问题，当表单页面只引用common，未引用table时 引入jqgrid的css--%>
<link rel="stylesheet" type="text/css" href="static/h5/jqGrid-5.2.0/css/ui.jqgrid-bootstrap.css?v=${jsversion}" />
<%
}
