...
%>
<script>
	// var bssbsrc= "static/h5/bootstrap/3.3.4/css_default/bootstrap-fixie8-fonticon.css";
</script>
<link rel="stylesheet" id="bssb" type="text/css" href="static/h5/bootstrap/3.3.4/css_default/bootstrap-fixie8-fonticon.css?v=${jsversion}"/>
<style>
	@font-face {
	...
	@font-face {
    	font-family: 'Glyphicons Halflings<%=flag %>';
    	src: url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.eot');
    	src: url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.woff2') format('woff2'), url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.woff') format('woff'), url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('static/h5/bootstrap/3.3.4/fonts/glyphicons-halflings-regular.svg#glyphicons_halflingsregular') format('svg')
	}
	.glyphicon {
		font-family: 'Glyphicons Halflings<%=flag %>';
	}
