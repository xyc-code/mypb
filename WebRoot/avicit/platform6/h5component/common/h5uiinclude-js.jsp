...
int commonPosition=Arrays.binarySearch(libs, "common");
if(All_LIB_FLG || positon >= 0){
%>
...
<%
}else if(commonPosition>=0){
%>
<%--此处判断是为了解决附件table无法展示的问题，当表单页面只引用common，未引用table时 引入jqgrid的js--%>
<script type="text/javascript" src="static/h5/jqGrid-5.2.0/js/i18n/grid.locale-cn.js?v=${jsversion}"></script>
<script type="text/javascript" src="static/h5/jqGrid-5.2.0/js/jquery.jqGrid.custom.js?v=${jsversion}"></script>
<%
}
...
<script type="text/javascript" src="static/h5/mydate97/WdatePicker.js?v=${jsversion}"></script>
<script type="text/javascript" src="static/h5/mydate97/lang/en.js?v=${jsversion}"></script>
<script type="text/javascript" src="static/h5/mydate97/lang/zh-cn.js?v=${jsversion}"></script>
<script type="text/javascript" src="static/h5/mydate97/lang/zh-tw.js?v=${jsversion}"></script>
...
<script type="text/javascript" src="static/h5/common-ext/h5-customselect.js?v=${jsversion}"></script>
<%
}
positon = Arrays.binarySearch(libs, "fileupload");
if(All_LIB_FLG || positon >= 0){
%>
<%-- <script type="text/javascript" src="static/h5/uploader-ext/swfobject.js?v="></script> --%>
