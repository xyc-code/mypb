		...
		<div class="content">
			...
			<div class="avic-tab">
				...
				<div class="btn-bar on">
					...
					<!-- <div class="ac-btn bpm_self_class" id="test_but" style="display:none;">自定义按钮</div> -->
				</div>
				<div class="tab-panel">
					...
					<%-- <div class="panel-body">
						<%@ include file="/avicit/platform6/bpmreform/bpmbusiness/include/processship.jsp"%>
					</div> --%>
				</div>
			</div>
			<!-- 简单tab End -->
