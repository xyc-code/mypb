 ...
 * 
 */
function DynDemoProduct(datagrid, url, searchD, form, keyWordId, searchNames,
		dataGridColModel) {
...
//初始化操作
DynDemoProduct.prototype.init = function() {
	var _self = this;
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getDynDemoProductsByPage.json',
		mtype : 'POST',
		datatype : "json",
		toolbar : [ true, 'top' ],
...
//添加页面
DynDemoProduct.prototype.insert = function() {
...
//编辑页面
DynDemoProduct.prototype.modify = function() {
...
//详细页
DynDemoProduct.prototype.detail = function(id) {
...
//打开高级查询框
DynDemoProduct.prototype.openSearchForm = function(searchDiv) {
	var _self = this;
...
DynDemoProduct.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			name : {
				required : true,
...
//保存功能
DynDemoProduct.prototype.save = function(form, id) {
	var _self = this;
	avicAjax.ajax({
...
//删除
DynDemoProduct.prototype.del = function() {
...
//重载数据
DynDemoProduct.prototype.reLoad = function() {
	var searchdata = {
...
//关闭对话框
DynDemoProduct.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//高级查询
DynDemoProduct.prototype.searchData = function() {
...
//关键字段查询
DynDemoProduct.prototype.searchByKeyWord = function() {
...
//隐藏查询框
DynDemoProduct.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
DynDemoProduct.prototype.clearData = function() {
