 ...
 * 
 */
function DynDemoOrder(datagrid, url, searchForm, dataGridColModel,
...
//初始化操作
DynDemoOrder.prototype.init = function() {
	var _self = this;
	var issubinit = false;
	$(_self._datagridId).jqGrid(
			{
				url : this.getUrl() + 'getDynDemoOrdersByPage.json',
				mtype : 'POST',
				multiselect : true,
				datatype : "json",
				toolbar : [ true, 'top' ],
...
//添加页面
DynDemoOrder.prototype.insert = function() {
...
//编辑页面
DynDemoOrder.prototype.modify = function() {
...
//详细页
DynDemoOrder.prototype.detail = function(id) {
...
DynDemoOrder.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			orderDate : {
				required : true,
...
//保存功能
DynDemoOrder.prototype.save = function(form, id) {
	var _self = this;
	avicAjax.ajax({
...
//删除
DynDemoOrder.prototype.del = function() {
...
//重载数据
DynDemoOrder.prototype.reLoad = function() {
	var searchdata = {
...
//关闭对话框
DynDemoOrder.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
DynDemoOrder.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
DynDemoOrder.prototype.searchData = function() {
...
//关键字段查询
DynDemoOrder.prototype.searchByKeyWord = function() {
...
//隐藏查询框
DynDemoOrder.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
DynDemoOrder.prototype.clearData = function() {
	clearFormData(this.searchForm);
	this.searchData();
};
/*返回主表id*/
DynDemoOrder.prototype.getSelectID = function() {
	var rows = $(this._datagridId).jqGrid('getGridParam', 'selarrrow');
	var l = rows.length;
	if (l == 0) {
		this._selectId = "null";
