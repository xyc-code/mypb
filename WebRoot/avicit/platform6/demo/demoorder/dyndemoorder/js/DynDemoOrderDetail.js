function DynDemoOrderDetail(datagrid, url, formSub, dataGridColModel,
...
//初始化操作
DynDemoOrderDetail.prototype.init = function(pid) {
	var _self = this;
	$(_self._datagridId).jqGrid({
		url : this.getUrl() + 'getDynDemoOrderDetail',
		postData : {
			pid : _self.pid
		},
		mtype : 'POST',
...
//添加页面
DynDemoOrderDetail.prototype.insert = function(pid) {
...
//修改页面
DynDemoOrderDetail.prototype.modify = function() {
...
//详细页
DynDemoOrderDetail.prototype.detail = function(id) {
...
DynDemoOrderDetail.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			productId : {
				required : true,
...
//保存功能
DynDemoOrderDetail.prototype.save = function(form, id) {
	var _self = this;
	avicAjax.ajax({
...
//删除
DynDemoOrderDetail.prototype.del = function() {
...
//重载数据
DynDemoOrderDetail.prototype.reLoad = function(pid) {
	if (pid != undefined) {
		this.pid = pid;
	}
	var searchdata = {
...
//关闭对话框
DynDemoOrderDetail.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
DynDemoOrderDetail.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
DynDemoOrderDetail.prototype.searchData = function() {
...
//关键字段查询
DynDemoOrderDetail.prototype.searchByKeyWord = function() {
...
//隐藏查询框
DynDemoOrderDetail.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
DynDemoOrderDetail.prototype.clearData = function() {
