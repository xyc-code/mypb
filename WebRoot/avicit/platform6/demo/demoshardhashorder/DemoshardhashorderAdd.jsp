...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<td width="40%"><input title="订单创建时间" class="easyui-datebox" editable="false" style="width: 182px;" type="text" name="orderCreateTime" id="orderCreateTime" /></td>
				</tr>
				<tr>
				</tr>
			</table>
	...
	<script type="text/javascript">
		...
		function closeForm() {
			parent.demoshardhashorder.closeDialog("#insert");
		}
		function saveForm() {
			if ($('#form').form('validate') == false) {
				return;
			}
			parent.demoshardhashorder.save(serializeObject($('#form')), "#insert");
		}
	</script>
</body>
</html>