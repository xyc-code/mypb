...
<div data-options="region:'center',split:true,border:false;overflow-x:auto;">
    <form id='queryForm'>
        <table class="form_commonTable" id="condition" style="display: ${displayConditionArea}">
            <tr>
                ...
                <td width="20%" style="word-break: break-all; word-warp: break-word;">
...
<script type="text/javascript">
    ...
    for(var i = 0 ; i < detailGridColModelJson.length ; i++){
        ...
        if(detailGridColModel){
            ...
            obj.hidden = detailGridColModel.hidden;
            ...
            if(isEmpty(detailGridColModel.appearance)){
                ...
                //有配置值
                if(detailGridColModel.appearance != null && !isEmpty(JSON.parse(detailGridColModel.appearance).columnWidth)){
                ...
                obj.cellattr =  function addCellAttr(rowId, val, rawObject, cm, rdata) {
                    ...
                    var styleStr = "";
                    if(appearanceColModel !=null && (!isEmpty(appearanceColModel.fontSize)||!isEmpty(appearanceColModel.bgColor)||!isEmpty(appearanceColModel.frontColor))){
                        styleStr+="style='";
                ...
                if( detailGridColModel.appearance != null && JSON.parse(detailGridColModel.appearance).allowWrapDisplay=="1"){
                    //1允许换行
    ...
    $(function() {
        ...
        executeCrossGrid = new DiggerExecuteCrossGrid('executeCrossGrid','${url}',diggerExecuteDetailGridModel,'${diggerId}',${rownumbers},${page},escape(condition));
    });
