...
<div data-options="region:'center',split:true,border:false">
    <form id='editForm'>
        <input type="hidden" id="id" name="id" value="${diggerComponent.id}">
        <input type="hidden" id="diggerTypeId" name="diggerTypeId" value="${diggerComponent.diggerTypeId}">
            ...
            <tr>
                ...
                <td width="35%">
                    <input title="名称" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="componentName" id="componentName" value="${diggerComponent.componentName}"/>
                </td>
                <th width="15%" style="word-break: break-all; word-warp: break-word;">
                ...
                <td width="35%">
                    <input title="排序" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="orderBy" id="orderBy" value="${diggerComponent.orderBy}"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="3" width="85%">
                    <textarea title="描述" rows="3" class="form-control input-sm" type="text" style="width: 99%;" type="text"
                           name="componentDesc" id="componentDesc">${diggerComponent.componentDesc}</textarea>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    document.ready = function () {
        ...
        parent.diggerComponent.formValidate($('#editForm'));
        $('#saveForm').bind('click', function () {
            parent.diggerComponent.subEdit($("#editForm"));
        });
        $('#closeForm').bind('click', function () {
            parent.diggerComponent.closeDialog("edit");
        });
    };
</script>
</body>
