function DiggerFormViewModel(datagrid, url, formSub, dataGridColModel, searchDialogSub, nodeId, nodeType,searchSubNames, bpmHistProcinst_KeyWord) {
...
//初始化操作
DiggerFormViewModel.prototype.init = function() {
	var _self = this;
...
DiggerFormViewModel.prototype.formValidate = function(form) {
	form.validate({
		rules : {
...
//重载数据
DiggerFormViewModel.prototype.reLoad = function(nodeId) {
	if (nodeId != undefined) {
		this.nodeId = nodeId;
	}
...
//关闭对话框
DiggerFormViewModel.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
DiggerFormViewModel.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
DiggerFormViewModel.prototype.searchData = function() {
	//解决jqGrid查询累加问题
...
//关键字段查询
DiggerFormViewModel.prototype.searchByKeyWord = function() {
...
//隐藏查询框
DiggerFormViewModel.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
DiggerFormViewModel.prototype.clearData = function() {
