function DiggerComponentModel(datagrid, url, formSub, dataGridColModel, searchDialogSub, nodeId, nodeType,searchSubNames, bpmHistProcinst_KeyWord) {
...
//初始化操作
DiggerComponentModel.prototype.init = function() {
	var _self = this;
...
DiggerComponentModel.prototype.formValidate = function(form) {
	form.validate({
		rules : {
...
//重载数据
DiggerComponentModel.prototype.reLoad = function(nodeId) {
	if (nodeId != undefined) {
		this.nodeId = nodeId;
	}
...
//关闭对话框
DiggerComponentModel.prototype.closeDialog = function(id) {
	if (id == "insert") {
...
//打开高级查询框
DiggerComponentModel.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	//if(!par) par = $(window);
...
//高级查询
DiggerComponentModel.prototype.searchData = function() {
	var searchdata = {
		keyWord :'',
		nodeId : this.nodeId,
...
//关键字段查询
DiggerComponentModel.prototype.searchByKeyWord = function() {
...
//隐藏查询框
DiggerComponentModel.prototype.hideSearchForm = function() {
	layer.close(searchDialogindex);
};
/*清空查询条件*/
DiggerComponentModel.prototype.clearData = function() {
