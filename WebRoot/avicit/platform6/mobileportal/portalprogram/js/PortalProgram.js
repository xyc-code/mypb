 ...
 * 
 */
function PortalProgram(datagrid, url, searchForm, dataGridColModel,
...
PortalProgram.prototype.formValidate = function(form) {
	form.validate({
		rules : {
			programName : {
				required : true,
...
// 删除
PortalProgram.prototype.del = function() {
...
// 打开高级查询框
PortalProgram.prototype.openSearchForm = function(searchDiv, par) {
	var _self = this;
	par = null;
	// if(!par) par = $(window);
...
// 关键字段查询
PortalProgram.prototype.searchByKeyWord = function() {
...
/* 禁用按钮 */
PortalProgram.prototype.stop = function() {
	var ids = $(this._datagridId).jqGrid('getGridParam','selarrrow');
	var _self = this;
	var l =ids.length;
	if (l> 0) {
...
// 启动按钮 
PortalProgram.prototype.start = function() {
	var ids = $(this._datagridId).jqGrid('getGridParam','selarrrow');
	var _self = this;
	var l =ids.length;
	if (l> 0) {
