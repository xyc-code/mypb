		...
		$('#idea').datagrid({
			...
			**/
				...
				handler:function(){
					...
					ajaxRequest("POST","trackJson="+trackstr+"&processInstanceId="+processInstanceId,"platform/bpm/clientbpmdisplayaction/dotrack","json","trackback");
				}
			},'-',{
				text:'撤销',
				iconCls:'icon-undo',
			...
			columns:[[
				...
				//{field:'preActiveLabel',title:'上一节点',width:40,align:'left',sortable:true},//意义不大，用户可通过流程跟踪查看上一节点
				...
				{field:'opType',title:'处理类型',width:30,align:'left'},
