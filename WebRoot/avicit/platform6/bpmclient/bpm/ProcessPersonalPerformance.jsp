...
<script type="text/javascript">
	...
	function openProcessDetailPage(key) {
		if (key == "Start") {
			...
			top.addTab("我的流程",url,"static/images/platform/index/images/icons.gif","MyProcessInstanceList"," -180px -140px");
		} else {
			var url = "avicit/platform6/bpmclient/bpm/ProcessWork.jsp?tab="+key+"&startDate=<%=startDate%>&endDate=<%=endDate%>";
			top.addTab("我的工作",url,"static/images/platform/index/images/icons.gif","MyProcessInstanceList"," -180px -140px");
		}
	}
</script>
