 ...
 */
function LeagueMember(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
LeagueMember.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getLeagueMembersByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
LeagueMember.prototype.insert=function(){
 ...
 * 编辑页面
 */
LeagueMember.prototype.modify=function(){
 ...
 * 详情页面
 */
LeagueMember.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
LeagueMember.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
LeagueMember.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userIdAlias:{
				required:true
 ...
 * 保存方法
 */
LeagueMember.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
LeagueMember.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
LeagueMember.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
LeagueMember.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
LeagueMember.prototype.searchData =function(){
 ...
 * 快速查询
 */
LeagueMember.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
LeagueMember.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
LeagueMember.prototype.clearData =function(){
