...
<html>
<head>
<!-- ControllerPath = "avicit/lc/member/leagueMember/leagueMemberController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
    			...
    			<tr>
					...
					<th>
						<label for="inpartyDate">入党时间:</label>
					</th>
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="inpartyDate" id="inpartyDate" />
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
						</div>
   					</td>
    			...
    			<tr>
					...
					<th>
						<label for="incompanylcDate">转入公司团组织时间:</label>
					</th>
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="incompanylcDate" id="incompanylcDate" />
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
						</div>
   					</td>
    			...
    			<tr>
					<th>
						<label for="indeptlcDate">转入当前单位团组织时间:</label>
					</th>
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="indeptlcDate" id="indeptlcDate" />
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
						</div>
   					</td>
    			...
    			<tr>
					<th>
						<label for="inleagueDate">入团时间:</label>
					</th>
					<td>
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="inleagueDate" id="inleagueDate" />
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
							<span class="input-group-addon"  onclick="clearCommonSelectValue(this)"><i class="fa fa-close"></i></span>
						</div>
   					</td>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.leagueMember.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.leagueMember.save($('#form'),"insert");
		}
		//清空日期值
