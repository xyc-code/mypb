 ...
 */
function LeagueCadres(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
LeagueCadres.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getLeagueCadressByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
LeagueCadres.prototype.insert=function(){
 ...
 * 编辑页面
 */
LeagueCadres.prototype.modify=function(){
 ...
 * 详情页面
 */
LeagueCadres.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
LeagueCadres.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
LeagueCadres.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userIdAlias:{
				required:true
 ...
 * 保存方法
 */
LeagueCadres.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
LeagueCadres.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
LeagueCadres.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
LeagueCadres.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
LeagueCadres.prototype.searchData =function(){
 ...
 * 快速查询
 */
LeagueCadres.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
LeagueCadres.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
LeagueCadres.prototype.clearData =function(){
