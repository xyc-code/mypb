...
<!-- ControllerPath = "platform/avicit/lc/organize/leagueOrganization/leagueOrganizationController/toLeagueOrganizationManageSelect" -->
<title>管理</title>
...
<body>
	...
	<!-- 模块js -->
	<script src="avicit/lc/organize/leagueorganization/js/LeagueOrganizationSelect.js" type="text/javascript"></script>
	...
	$(document).ready(function(){
		leagueOrganization = new LeagueOrganization('_ztree','${url}','form','txt','searchbtn');
	    leagueOrganization.init();
	...
	function getSelectedNode(){
		return leagueOrganization.getSelectedNode();
	}
</script>
</body>
</html>
