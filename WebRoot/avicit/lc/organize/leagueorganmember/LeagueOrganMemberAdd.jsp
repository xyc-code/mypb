...
<html>
<head>
<!-- ControllerPath = "avicit/lc/organize/leagueOrganMember/leagueOrganMemberController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<input type="hidden" name="leagueId" id="leagueId" value="${pid}" />
			<table class="form_commonTable">
				<tr>
					<th width="15%">
						<label for="userIdAlias">员工姓名:</label>
					</th>
					<td width="34%">
					...
					<th width="15%">
						<label for="deptIdAlias">所在部门:</label>
					</th>
					<td width="34%">
						<div class="input-group input-group-sm">
							<input type="hidden"  id="deptId" name="deptId">
							<input class="form-control" placeholder="请选择部门" type="text" id="deptIdAlias" name="deptIdAlias" readonly="readonly">
							<span class="input-group-addon">
				...
				<tr>
					<th>
						<label for="userPost">所在支部职务:</label>
					</th>
					<td>
						<pt6:h5select css_class="form-control input-sm" name="userPost" id="userPost" title="" isNull="true" lookupCode="LC_ORGAN_POST" />
   					</td>
				</tr>
			</table>
		</form>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.leagueOrganMember.closeDialog("insert");
		}
		...
		function saveForm(){
	        ...
	        $("#leagueId").val(parent.leagueOrganMember.pid);
	        //限制保存按钮多次点击
  		 	$('#leagueOrganMember_saveForm').addClass('disabled').unbind("click");	
			parent.leagueOrganMember.save($('#form'),"insert");
		}
