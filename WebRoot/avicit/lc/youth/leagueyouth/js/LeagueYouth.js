 ...
 */
function LeagueYouth(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
LeagueYouth.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getLeagueYouthsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
LeagueYouth.prototype.insert=function(){
 ...
 * 编辑页面
 */
LeagueYouth.prototype.modify=function(){
 ...
 * 详情页面
 */
LeagueYouth.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
LeagueYouth.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
LeagueYouth.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userIdAlias:{
				required:true
 ...
 * 保存方法
 */
LeagueYouth.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
LeagueYouth.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
LeagueYouth.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
LeagueYouth.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
LeagueYouth.prototype.searchData =function(){
 ...
 * 快速查询
 */
LeagueYouth.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
LeagueYouth.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
LeagueYouth.prototype.clearData =function(){
