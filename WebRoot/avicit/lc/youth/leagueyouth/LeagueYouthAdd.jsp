...
<html>
<head>
<!-- ControllerPath = "avicit/lc/youth/leagueYouth/leagueYouthController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.leagueYouth.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.leagueYouth.save($('#form'),"insert");
		}
		//清空日期值
