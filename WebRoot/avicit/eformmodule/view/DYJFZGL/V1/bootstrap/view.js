...
tablecmtable3cb0e75fa3419b461948150b19b840339f17.push({label: '日期', formatter:format, hidden:false, name: 'INTEGRAL_DATE',align:'center',  width: '150px'});
...
tablecmtable3cb0e75fa3419b461948150b19b840339f17.push({label: '创建时间', formatter:format, hidden:true, name: 'CREATION_DATE',align:'center',  width: '150px'});
	var searchNamestable3cb0e75fa3419b461948150b19b840339f17 = []; 
searchNamestable3cb0e75fa3419b461948150b19b840339f17.push('DATA_1');
$('#keyWordtable3cb0e75fa3419b461948150b19b840339f17').attr('placeholder', '请输入姓名查询');
function searchDataKeyWordtable3cb0e75fa3419b461948150b19b840339f17(){
	var keyWord = $.trim($("#keyWordtable3cb0e75fa3419b461948150b19b840339f17").val()); 
 if($('#keyWordtable3cb0e75fa3419b461948150b19b840339f17').attr('placeholder') == keyWord){
 keyWord = '';} 
	var param = {}; 
	for(var i=0;i<searchNamestable3cb0e75fa3419b461948150b19b840339f17.length;i++){ 
		var name = searchNamestable3cb0e75fa3419b461948150b19b840339f17[i]; 
		param[name] = keyWord; 
	} 
	var searchdata = {
...
table3cb0e75fa3419b461948150b19b840339f17KeyWordIn=JSON.stringify(param);
table3cb0e75fa3419b461948150b19b840339f17ParamIn="";
	$('#table3cb0e75fa3419b461948150b19b840339f17').jqGrid('setGridParam',{datatype: 'json',postData: searchdata}).trigger("reloadGrid");
};
$('#keyWordtable3cb0e75fa3419b461948150b19b840339f17').on('keydown',function(e){
	if(e.keyCode == '13'){
		searchDataKeyWordtable3cb0e75fa3419b461948150b19b840339f17();
	}
});
$('#keyWordBttable3cb0e75fa3419b461948150b19b840339f17').bind('click', function() {
		searchDataKeyWordtable3cb0e75fa3419b461948150b19b840339f17();
});
...
tablecmtable8044c90df21ddf41f489be57e0db29b5f07d.push({label: '申请人党支部',hidden:false, name: 'PARTY_NAME',align:'left',  width: '150px'});
tablecmtable8044c90df21ddf41f489be57e0db29b5f07d.push({ label: '拟稿人部门',hidden:true, name: 'DEPT_ID',align:'center',  width: '150px'});
tablecmtable8044c90df21ddf41f489be57e0db29b5f07d.push({ label: '拟稿人部门',hidden:true, name: 'DEPT_IDName',align:'center',  width: '150px'});
...
$("#t_table3cb0e75fa3419b461948150b19b840339f17").append($("#tableToolbartable3cb0e75fa3419b461948150b19b840339f17"));
$('#tableToolbarButton0e57707a77b4c348133afab0a6f50e877278').bind('click',function() {                           
	layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var colModels =$('#table3cb0e75fa3419b461948150b19b840339f17').jqGrid('getGridParam','colModel');   
	        ...
	        expSearchParams.keyWord = table3cb0e75fa3419b461948150b19b840339f17KeyWordIn;                          
	        expSearchParams.param = table3cb0e75fa3419b461948150b19b840339f17ParamIn;                              
	        expSearchParams.hasRowNum = false;                                       
	        expSearchParams.sheetName = 'sheet1';                                    
	        expSearchParams.unContainFields = blockFields.toString();                
	        expSearchParams.fileName='党员积分子表';                             
	        expSearchParams.viewid='2c9419a9899a619d01899b1550f60349';                                   
	        expSearchParams.pid=compRefe029180d17e44d4bfdf8bd31f82baf6e2f8f;                                   
	        expSearchParams.tableid='table3cb0e75fa3419b461948150b19b840339f17';                                 
...
table8044c90df21ddf41f489be57e0db29b5f07dLoadComplete.addEvent(function(data){$("#tableToolbarButtonb390c45823581a488e1b2966a196b28d8b9b").css("display","");
$("#tableToolbarButton28d30d84eb412d49725a6c916c18838a07c9").css("display","");});
$("#table8044c90df21ddf41f489be57e0db29b5f07d").jqGrid({ 
...
$("#tableToolbarButtonb390c45823581a488e1b2966a196b28d8b9b").bind('click',function() {                                                                                       
	var ids = $('#table8044c90df21ddf41f489be57e0db29b5f07d').jqGrid('getGridParam', 'selarrrow');                            
	if (ids.length == 0) {                                                                          
		layer.alert('请选择数据！', {                                                               
			icon: 7,                                                                                
			area: ['400px', ''],                                                                    
	...
	var rowData = $('#table8044c90df21ddf41f489be57e0db29b5f07d').jqGrid('getRowData', ids[0]);									
	layer.open({																					
        type: 2,																					
        area: ['100%', '100%'],																	
        title: '编辑',																				
        skin: 'bs-modal',																			
        maxmin: false,																				
        content: 'platform/eform/bpmsCRUDClient/toformJsp?formInfoId=948e83e38d3ec30a018d4433b0b340ea&id=' + rowData.ID+'&grid=table8044c90df21ddf41f489be57e0db29b5f07d',  
		 cancel: function (index, layero) {                                             
		 	var iframeWin = layero.find('iframe')[0].contentWindow;                     
...
$("#tableToolbarButton28d30d84eb412d49725a6c916c18838a07c9").hide();
$("#tableToolbarButtoneee028327d36714b7428455c8f490c664a29").bind('click',function(event){var bpmsDeleteRows = $('#table8044c90df21ddf41f489be57e0db29b5f07d').jqGrid('getGridParam', 'selarrrow');
if(bpmsDeleteRows .length == 0){
 window.open("avicit/pb/scoring/integral/integralController/erportsExcel?fileName=dynPoints.xlsx")
}else{
 window.open("avicit/pb/scoring/integral/integralController/erportsExcel?fileName=dynPoints.xlsx&ids="+bpmsDeleteRows)
}});
$("#tableToolbarButton8501ea51ff99cd49f389de69839c25dc6c1f").bind('click',function(event){layer.open({
	    type: 2,
		area: ['1000px', '600px'],
	    title: '统计考核',
	    skin: 'bs-modal', // bootstrap 风格皮肤 需加载skin
        maxmin: true, //开启最大化最小化按钮
	    content: 'platform/eform/bpmsCRUDClient/toViewJsp/dyjfzView' 
	});});
$("#tableToolbarButton572c894477149543a1c8cbe23d5f112df10c").bind('click',function(event){var bpmsDeleteRows = $('#table8044c90df21ddf41f489be57e0db29b5f07d').jqGrid('getGridParam', 'selarrrow');
if(bpmsDeleteRows .length == 0){
layer.alert('请选择！' , {									    
							icon: 7,															
							area: ['400px', ''],												
...
var rowData = $('#table8044c90df21ddf41f489be57e0db29b5f07d').jqGrid('getRowData', bpmsDeleteRows[0]);
layer.open({
	    type: 2,
		area: ['1000px', '600px'],
	    title: '统计考核',
	    skin: 'bs-modal', // bootstrap 风格皮肤 需加载skin
        maxmin: true, //开启最大化最小化按钮
	    content: 'avicit/pb/scoring/integral/integralController/toIntegralManage?partyId='+ rowData .PARTY_ID
	});});
;});	 
