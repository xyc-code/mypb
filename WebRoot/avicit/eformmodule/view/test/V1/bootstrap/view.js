...
$("#tablea1c6efb7a1ceb2428e3979b106ec2cb320db").jqGrid({ 
    	   url: './eform/bpmsEformDataOptionsController/dataOperating/selectTableComponentData/402811817e66b721017e66fb3de001f7/tablea1c6efb7a1ceb2428e3979b106ec2cb320db/Y/V1',
        mtype: 'POST', 
        datatype: "local", 
        postData: { 
                     a:'',
...
$("#tableToolbarButton9f8c4f4f7898bd4a9bca22262fb90e727838").bind('click',function() {                                                                       
	layer.open({                                                                     
		...
		skin: 'bs-modal',                                                            
		maxmin: false,                                                               
		content: 'platform/eform/bpmsCRUDClient/toformJsp?formInfoId=402811817e438190017e43856fc00150&grid=tablea1c6efb7a1ceb2428e3979b106ec2cb320db'     
	});                                                                              
}                                                                                  
);
	...
	if (l > 0) {																				
       ...
       ;                                                                     
		layer.confirm('确定要删除该数据吗?', {													    
			...
			avicAjax.ajax({																		
				url: 'platform/eform/bpmsCRUDClient/deleteTableRow.json?tableName=DYN_TEST&isbpm=Y&dbid=402811817e51063f017e53db6feb0307', 
