...
function redraw948e83e3881da2180188279574e76caa(oriWidth){
	if (oriWidth == 0){
		...
		$('#948e83e3881da2180188279574e76caa').layout('panel', 'center').panel('resize',{width:win_width*1.0,height:win_height*1.0});
...
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '申请编号',hidden:false, name: 'APPLICATION_NUMBER',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ label: '申请单位',hidden:true, name: 'APPLICATION_UNIT',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ label: '申请单位',hidden:false, name: 'APPLICATION_UNITName',align:'left',  width: '150px'});
...
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '突击队队长', formatter:function(cellvalue, options, rowObject){return fomrt(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_CAPTAINS',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '突击队队员', formatter:function(cellvalue, options, rowObject){return fomrtName(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_TEAM_NAME',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '突击队队员单位', formatter:function(cellvalue, options, rowObject){return fomrtDept(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_TEAM_DEPT',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '突击队队员年龄', formatter:function(cellvalue, options, rowObject){return fomrtAge(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_TEAM_AGE',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '突击队队员负责任务', formatter:function(cellvalue, options, rowObject){return fomrtTask(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_TEAM_TASK',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '队员人数', formatter:function(cellvalue, options, rowObject){return fomrtConut(cellvalue, options, rowObject);}, hidden:false, name: 'COMMANDOES_TEAM_COUNT',align:'left',  width: '150px'});
...
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '预期收益',hidden:false, name: 'EXPECTED_INCOME',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({label: '主题',hidden:false, name: 'COMMANDOES_THEME',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ label: '突击队类型',hidden:true, name: 'COMMANDOES_TYPE',align:'left',  width: '150px'});
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ label: '突击队类型',hidden:false, name: 'COMMANDOES_TYPEName',align:'left',  width: '150px'});
...
tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ sortable:false,label: '流程运转', formatter:bpmFormatter, hidden:false, name: 'tableVirColumn2175772b8b91404e473b49be2a251520b814',align:'left',  width: '150px'});tablecmtable278e1440a4fff84014ab785f7e8034d55b77.push({ sortable:false,label: '流程状态', formatter:bpmStatusFormatter, hidden:false, name: 'BUSINESSSTATE_',align:'left',  width: '150px'});	var searchNamestable278e1440a4fff84014ab785f7e8034d55b77 = []; 
...
table278e1440a4fff84014ab785f7e8034d55b77LoadComplete.addEvent(function(data){$.ajax({
    ...
    success: function (r) {
    	if(r.flag=="error"){
    		$("#tableToolbarButton994cfd5d74db8c464118d21209cc2610ee53").css("display","none")
    	}
    }
})});
$("#table278e1440a4fff84014ab785f7e8034d55b77").jqGrid({ 
