...
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({ label: '选举类型',hidden:true, name: 'PARTY_TYPE',align:'left',  width: '150px'});
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({ label: '选举类型',hidden:false, name: 'PARTY_TYPEName',align:'left',  width: '150px'});
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({label: '申请人所在党支部',hidden:true, name: 'PARTY_NAME',align:'left',  width: '150px'});
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({label: '申请人所在单位',hidden:true, name: 'DEPT_NAME',align:'left',  width: '150px'});
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({label: '党支部ID',hidden:true, name: 'PARTY_ID',align:'left',  width: '150px'});
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({label: '选举党组织名称',hidden:false, name: 'PARTY_NAME_NEW',align:'left',  width: '150px'});
...
tablecmtablea77d329821be034257e8ff70a5eebf51d9c7.push({label: '申请人电话',hidden:false, name: 'USER_TEL',align:'left',  width: '150px'});
...
tablea77d329821be034257e8ff70a5eebf51d9c7LoadComplete.addEvent(function(data){$("#tableToolbarButtonc7ba400ca5ba384460d8e0d70562fda86cfc").css("display","");});
