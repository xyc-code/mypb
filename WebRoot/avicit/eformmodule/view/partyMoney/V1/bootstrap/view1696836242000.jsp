...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButtonf919056a7886d247ceebb791c787357bc298" permissionDes="删除"><a id="tableToolbarButtonf919056a7886d247ceebb791c787357bc298" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="删除"><i class=""></i> 删除</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/partyMoney/V1/bootstrap/view1696836242000.js?_=1702604505953"></script>
</html> 
