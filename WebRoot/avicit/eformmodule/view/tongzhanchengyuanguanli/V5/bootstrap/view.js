...
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '性别',hidden:true, name: 'GENDER',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '性别',hidden:false, name: 'GENDERName',align:'left',  width: '120px'});
...
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '全日制学历',hidden:true, name: 'FUL_EDUCATION',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '全日制学历',hidden:false, name: 'FUL_EDUCATIONName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '非全日制学历',hidden:true, name: 'PART_EDUCATION',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '非全日制学历',hidden:false, name: 'PART_EDUCATIONName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '政治面貌',hidden:true, name: 'POLITICAL_OUTLOOK',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '政治面貌',hidden:false, name: 'POLITICAL_OUTLOOKName',align:'left',  width: '120px'});
...
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否香港、澳门同胞',hidden:true, name: 'HO_COMPATRIOTS',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否香港、澳门同胞',hidden:false, name: 'HO_COMPATRIOTSName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否香港、澳门眷属',hidden:true, name: 'HO_DEPENDENTS',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否香港、澳门眷属',hidden:false, name: 'HO_DEPENDENTSName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否台湾同胞',hidden:true, name: 'TAIWAN_COMPATRIOTS',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否台湾同胞',hidden:false, name: 'TAIWAN_COMPATRIOTSName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否台湾同胞在大陆亲属',hidden:true, name: 'TAIWAN_RELATIVES',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否台湾同胞在大陆亲属',hidden:false, name: 'TAIWAN_RELATIVESName',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否华侨、归侨、侨眷',hidden:true, name: 'RO_CHINESE',align:'left',  width: '120px'});
tablecmtable9251737cc88840449ae92e9b1e5dfeab72ba.push({ label: '是否华侨、归侨、侨眷',hidden:false, name: 'RO_CHINESEName',align:'left',  width: '120px'});
...
$("#table9251737cc88840449ae92e9b1e5dfeab72ba").jqGrid({ 
    	   url: './eform/bpmsEformDataOptionsController/dataOperating/selectTableComponentData/2c908c5a894821f6018948be75880b98/table9251737cc88840449ae92e9b1e5dfeab72ba/N/V5',
        mtype: 'POST', 
        datatype: "local", 
        postData: { 
                     a:'',
...
$("#tableToolbarButton305395b8274cc549e3f9adef65777a0e2a1c").bind('click',function(event){var row = $('#table9251737cc88840449ae92e9b1e5dfeab72ba').jqGrid('getRowData');
if(row.length==0){
layer.alert('无数据！', {
			  icon: 7,
			  area: ['400px', ''], //宽高
...
window.open('platform/avicit/pb/milepost/dynYouthRecord/dynYouthRecordController/download?json='+encodeURIComponent(JSON.stringify(row)))});

$('#tableToolbarButton3451562cacc3d04c40983db684e8d34b9f5a').bind('click',function() {                           
	layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var url = 'platform/eform/bpmsEformDataOptionsController/dataOperating/exportServerData/V5'; 
