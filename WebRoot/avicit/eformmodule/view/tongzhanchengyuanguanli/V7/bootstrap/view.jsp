...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton1a3b77fe0f24b546a2f82883507801ef15bf" permissionDes="导出"><a id="tableToolbarButton1a3b77fe0f24b546a2f82883507801ef15bf" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出"><i class=""></i> 导出</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/tongzhanchengyuanguanli/V7/bootstrap/view.js?_=1689298401187"></script>
</html> 
