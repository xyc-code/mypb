...
$("#table9251737cc88840449ae92e9b1e5dfeab72ba").jqGrid({ 
    	   url: './eform/bpmsEformDataOptionsController/dataOperating/selectTableComponentData/2c908c5a894821f6018948be75880b98/table9251737cc88840449ae92e9b1e5dfeab72ba/N/V7',
        mtype: 'POST', 
        datatype: "local", 
        postData: { 
                     a:'',
...
$('#tableToolbarButton1a3b77fe0f24b546a2f82883507801ef15bf').bind('click',function() {                           
	layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var url = 'platform/eform/bpmsEformDataOptionsController/dataOperating/exportServerData/V7'; 
