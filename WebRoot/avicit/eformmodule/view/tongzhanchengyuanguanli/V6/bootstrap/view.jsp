...
</div><div class="toolbar-left" ><sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton53daa85eac9b514970d94d07b9a01c8e84eb" permissionDes="导入"><a id="tableToolbarButton53daa85eac9b514970d94d07b9a01c8e84eb" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导入"><i class="fa fa-fw fa-arrows-v"></i> 导入</a></sec:accesscontrollist>
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton305395b8274cc549e3f9adef65777a0e2a1c" permissionDes="导出"><a id="tableToolbarButton305395b8274cc549e3f9adef65777a0e2a1c" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出"><i class="fa fa-fw fa-arrows-h"></i> 导出</a></sec:accesscontrollist>
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton3451562cacc3d04c40983db684e8d34b9f5a" permissionDes="导出2"><a id="tableToolbarButton3451562cacc3d04c40983db684e8d34b9f5a" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出2"><i class="fa fa-fw fa-arrows-h"></i> 导出2</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/tongzhanchengyuanguanli/V6/bootstrap/view.js?_=1689298496168"></script>
</html> 
