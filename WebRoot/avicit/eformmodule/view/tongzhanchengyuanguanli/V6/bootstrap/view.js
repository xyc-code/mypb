...
$("#table9251737cc88840449ae92e9b1e5dfeab72ba").jqGrid({ 
    	   url: './eform/bpmsEformDataOptionsController/dataOperating/selectTableComponentData/2c908c5a894821f6018948be75880b98/table9251737cc88840449ae92e9b1e5dfeab72ba/N/V6',
        mtype: 'POST', 
        datatype: "local", 
        postData: { 
                     a:'',
...
window.open('avicit/pb/member/dynUfmInfo/dynUfmInfoController/download?json='+encodeURIComponent(JSON.stringify(row)))});
...
$('#tableToolbarButton3451562cacc3d04c40983db684e8d34b9f5a').bind('click',function() {                           
	layer.open({                         
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var url = 'platform/eform/bpmsEformDataOptionsController/dataOperating/exportServerData/V6'; 
