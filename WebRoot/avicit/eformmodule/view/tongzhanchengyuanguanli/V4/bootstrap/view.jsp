...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton3408d059b8d730497deb42ba6e048278b09d" permissionDes="导出0"><a id="tableToolbarButton3408d059b8d730497deb42ba6e048278b09d" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出0"><i class="fa fa-fw fa-arrows-h"></i> 导出0</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/tongzhanchengyuanguanli/V4/bootstrap/view.js?_=1689298530565"></script>
</html> 
