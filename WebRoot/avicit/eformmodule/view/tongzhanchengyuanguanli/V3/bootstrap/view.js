...
$("#table9251737cc88840449ae92e9b1e5dfeab72ba").jqGrid({ 
    	   url: './eform/bpmsEformDataOptionsController/dataOperating/selectTableComponentData/2c908c5a894821f6018948be75880b98/table9251737cc88840449ae92e9b1e5dfeab72ba/N/V3',
        mtype: 'POST', 
        datatype: "local", 
        postData: { 
                     a:'',
...
$('#tableToolbarButtona97710226343c0463a68491375befd6e7133').bind('click',function() {                           
	layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
