...
function table8db1474c11953e4cfa9bae3e00d562569cf1searchWF(){
   if ($("#searchformtable8db1474c11953e4cfa9bae3e00d562569cf1").length>0){
	...
	var searchNamestable8db1474c11953e4cfa9bae3e00d562569cf1 = []; 
searchNamestable8db1474c11953e4cfa9bae3e00d562569cf1.push('AUTO_CODE');
searchNamestable8db1474c11953e4cfa9bae3e00d562569cf1.push('USER_NAME');
$('#keyWordtable8db1474c11953e4cfa9bae3e00d562569cf1').attr('placeholder', '请输入表单编号、申请人查询');
function searchDataKeyWordtable8db1474c11953e4cfa9bae3e00d562569cf1(){
	var keyWord = $.trim($("#keyWordtable8db1474c11953e4cfa9bae3e00d562569cf1").val()); 
 if($('#keyWordtable8db1474c11953e4cfa9bae3e00d562569cf1').attr('placeholder') == keyWord){
 keyWord = '';} 
	var param = {}; 
	for(var i=0;i<searchNamestable8db1474c11953e4cfa9bae3e00d562569cf1.length;i++){ 
		var name = searchNamestable8db1474c11953e4cfa9bae3e00d562569cf1[i]; 
		param[name] = keyWord; 
	} 
if ($("#table8db1474c11953e4cfa9bae3e00d562569cf1workFlowSelect").length>0){param.bpmState=$('#table8db1474c11953e4cfa9bae3e00d562569cf1workFlowSelect').val()}
	var searchdata = {
		keyWord:  JSON.stringify(param),
		param: null 
	};
table8db1474c11953e4cfa9bae3e00d562569cf1KeyWordIn=JSON.stringify(param);
table8db1474c11953e4cfa9bae3e00d562569cf1ParamIn="";
	$('#table8db1474c11953e4cfa9bae3e00d562569cf1').jqGrid('setGridParam',{datatype: 'json',postData: searchdata}).trigger("reloadGrid");
};
$('#keyWordtable8db1474c11953e4cfa9bae3e00d562569cf1').on('keydown',function(e){
	if(e.keyCode == '13'){
		searchDataKeyWordtable8db1474c11953e4cfa9bae3e00d562569cf1();
	}
});
$('#keyWordBttable8db1474c11953e4cfa9bae3e00d562569cf1').bind('click', function() {
		searchDataKeyWordtable8db1474c11953e4cfa9bae3e00d562569cf1();
});
...
function searchDatatable8db1474c11953e4cfa9bae3e00d562569cf1(){
 var para = serializeObjectForEform($("#searchformtable8db1474c11953e4cfa9bae3e00d562569cf1"));
 para.bpmState = $('#table8db1474c11953e4cfa9bae3e00d562569cf1workFlowSelect').val();
	var searchdata = {
		keyWord: null,
		param:JSON.stringify(para)
	};
table8db1474c11953e4cfa9bae3e00d562569cf1KeyWordIn="";
table8db1474c11953e4cfa9bae3e00d562569cf1ParamIn=JSON.stringify(para);
	$('#table8db1474c11953e4cfa9bae3e00d562569cf1').jqGrid('setGridParam',{datatype: 'json',postData: searchdata}).trigger("reloadGrid");
};
$("#searchformtable8db1474c11953e4cfa9bae3e00d562569cf1").on('keydown', function (e) {
		if (e.keyCode == '13') {
			return false;
		}
	});
$('#searchAlltable8db1474c11953e4cfa9bae3e00d562569cf1').bind('click',function(){
...
'200px'],
	...
	shadeClose: true,
	btn: ['查询', '清空', '取消'],
	content: $('#searchDialogtable8db1474c11953e4cfa9bae3e00d562569cf1'),
	...
	yes: function(index, layero){
		searchDatatable8db1474c11953e4cfa9bae3e00d562569cf1(); layer.close(index);
	},
	btn2: function(index, layero){
		clearFormData($("#searchformtable8db1474c11953e4cfa9bae3e00d562569cf1")); searchDatatable8db1474c11953e4cfa9bae3e00d562569cf1(); layer.close(index); return false;
	},
