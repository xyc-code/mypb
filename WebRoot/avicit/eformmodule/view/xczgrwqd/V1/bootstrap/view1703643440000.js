...
tablecmtable27dadc6724db894b7a08358c021c94d53c2f.push({label: '预留字段',hidden:true, name: 'ATTRIBUTE_05',align:'left',  width: '80px'});
...
tablecmtable27dadc6724db894b7a08358c021c94d53c2f.push({label: '下发时间', formatter:format, hidden:false, name: 'DATE_MANIFEST',align:'left',  width: '80px'});
...
tablecmtable27dadc6724db894b7a08358c021c94d53c2f.push({label: '流程详细', formatter:function(cellvalue, options, rowObject){return function(cellvalue, options, rowObject){return bpmFormatter(cellvalue, options, rowObject);}(cellvalue, options, rowObject);}, hidden:false, name: 'ATTRIBUTE_12',align:'center',  width: '80px'});
...
$('#keyWordtable27dadc6724db894b7a08358c021c94d53c2f').attr('placeholder', '请输入巡察问题序号查询');
...
if(rowData.ATTRIBUTE_01Name != "未发放" ){
layer.alert('该清单已发放！' , {									    
							icon: 7,															
							area: ['400px', ''],												
							closeBtn: 0         												
...
$("#tableToolbarButton532448143573084fea6a75eca86386397c63").bind('click',function(event){var bpmsDeleteRows = $('#table27dadc6724db894b7a08358c021c94d53c2f').jqGrid('getGridParam', 'selarrrow');
if(bpmsDeleteRows .length == 0){
layer.alert('请选择！' , {									    
							icon: 7,															
							area: ['400px', ''],												
