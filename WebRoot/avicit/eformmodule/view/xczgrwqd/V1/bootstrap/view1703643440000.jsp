...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButton2c250c1d4255b2464a58c10c84c0ddcd54f0" permissionDes="流程取消"><a id="tableToolbarButton2c250c1d4255b2464a58c10c84c0ddcd54f0" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="流程取消"><i class="fa fa-fw fa-trash-o"></i> 流程取消</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/xczgrwqd/V1/bootstrap/view1703643440000.js?_=1704248615216"></script>
