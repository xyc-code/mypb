...
<body>
<div class="easyui-layout" fit="true" id="2c908c1d8a62d88d018a6319232c08e3"> <div data-options="region:'center',disabled:false ,width:fixwidth(1.0,e),height:fixheight(1.0,e),onResize:function(a){$('#table5c236e59576f4c431e285913ecaab2448a21').setGridHeight(getJgridTableHeight($('#table5c236e59576f4c431e285913ecaab2448a21_div')));$('#table5c236e59576f4c431e285913ecaab2448a21').jqGrid('resizeGrid');} " style="background: #ffffff; height: 0px; padding: 0px; overflow: hidden;" id="table5c236e59576f4c431e285913ecaab2448a21_div"><div style="overflow:auto"> <div id="tableToolbartable5c236e59576f4c431e285913ecaab2448a21" class="toolbar" style="height:38px;"><div class="toolbar-right"><div class="input-group form-tool-search"  style="width:200px;"> <input type="text" name="keyWordtable5c236e59576f4c431e285913ecaab2448a21" id="keyWordtable5c236e59576f4c431e285913ecaab2448a21" style="width:238px;" class="form-control input-sm" placeholder="请输入查询条件"><label id="keyWordBttable5c236e59576f4c431e285913ecaab2448a21" class="icon icon-search form-tool-searchicon"></label>
</div>
<div class="input-group-btn form-tool-searchbtn"><a id="searchAlltable5c236e59576f4c431e285913ecaab2448a21" href="javascript:void(0)" class="btn btn-defaul btn-sm" role="button" title="高级查询">高级查询 <span class="caret"></span></a>
</div>
...
<script src="avicit/eformmodule/view/youthInfo/V1/bootstrap/view1696830790000.js?_=1700102436230"></script>
</html> 
