...
tablecmtableb06e704b67ff874d17190eedf7c930f9430c.push({label: '是否发送党支部',hidden:false, name: 'IS_YN_ISSUE',align:'left',  width: '150px'});
...
tablecmtableb06e704b67ff874d17190eedf7c930f9430c.push({label: '发送支部',hidden:false, name: 'SEL_USER',align:'left',  width: '150px'});
...
$("#tableToolbarButtona3186a272bdb614a94b8256ac3264fc8e8e1").css('display','inline-block');
}else{
$("#tableToolbarButtona3186a272bdb614a94b8256ac3264fc8e8e1").hide();
}
...
$("#tableToolbarButtona3186a272bdb614a94b8256ac3264fc8e8e1").bind('click',function() {   																				
	var bpmsDeleteRows = $('#tableb06e704b67ff874d17190eedf7c930f9430c').jqGrid('getGridParam', 'selarrrow');             
	var bpmsDeleteIds = [];  																				
	var l = bpmsDeleteRows.length; 																		
	if (l > 0) {																				
		for (; l--;) {																		
			if (bpmsDeleteRows[l].indexOf("new_row")!=-1){								
				$('#tableb06e704b67ff874d17190eedf7c930f9430c').jqGrid("delRowData", bpmsDeleteRows[l]);  				
			}else{																			
       ...
       ;                                                                     
		layer.confirm('确定要删除该数据吗?', {													    
			...
			avicAjax.ajax({																		
				url: 'platform/eform/bpmsCRUDClient/deleteTableRow.json?tableName=DYN_PB_NOTICE&isbpm=Y&dbid=948e83e381eaacfc0181faa7fdd4400b', 
				data: {ids : bpmsDeleteIds.join(','),viewid:'948e83e381eaacfc01820fdd7c010f4f',deleteclass:''},								
				type: 'post',																	
				dataType: 'json',																
				success: function(r) {															
					if (r.flag == 'success') {$('#tableb06e704b67ff874d17190eedf7c930f9430c').trigger('reloadGrid');layer.msg('删除成功！');;} else {	
