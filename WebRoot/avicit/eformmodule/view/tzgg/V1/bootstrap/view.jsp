...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButtona3186a272bdb614a94b8256ac3264fc8e8e1" permissionDes="删除"><a id="tableToolbarButtona3186a272bdb614a94b8256ac3264fc8e8e1" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="删除"><i class=""></i> 删除</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/tzgg/V1/bootstrap/view1721202983000.js?_=1721203037150"></script>
</html> 
