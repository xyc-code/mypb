...
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '性别',hidden:true, name: 'XB',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '性别',hidden:false, name: 'XBName',align:'left',  width: '150px'});
...
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '一级部门',hidden:true, name: 'YJBM',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '一级部门',hidden:true, name: 'YJBMName',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '所在部门',hidden:true, name: 'SZBM',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '所在部门',hidden:true, name: 'SZBMName',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '所在岗位',hidden:true, name: 'SZGW',align:'left',  width: '150px'});
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({ label: '所在岗位',hidden:true, name: 'SZGWName',align:'left',  width: '150px'});
...
tablecmtablebf313346187ebb45927957bef29d8ffbeca2.push({label: '是否启用',hidden:true, name: 'SFQY',align:'left',  width: '150px'});
