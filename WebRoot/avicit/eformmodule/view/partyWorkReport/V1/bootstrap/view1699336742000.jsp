...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButtonb56ca7b89f85984ead888331f2eafaf44967" permissionDes="删除"><a id="tableToolbarButtonb56ca7b89f85984ead888331f2eafaf44967" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="删除"><i class=""></i> 删除</a></sec:accesscontrollist>
</div><div class="toolbar-right"><select id="table4e901df056a243487b98bddc79b062904f97workFlowSelect" class="form-control input-sm workflow-select"><option value="all" >全部</option><option value="nostart" >未发起</option><option value="start" >拟稿中</option><option value="active" >流转中</option><option value="ended" >已完成</option></select></div></div><div id="Pagertable4e901df056a243487b98bddc79b062904f97"></div><table id="table4e901df056a243487b98bddc79b062904f97" datapermission="table4e901df056a243487b98bddc79b062904f97" class="eform_component" ></table></div></div></div></body>
...
<script src="avicit/eformmodule/view/partyWorkReport/V1/bootstrap/view1699336742000.js?_=1699519086124"></script>
</html> 
