...
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ label: '性别',hidden:true, name: 'YXTYTJ_SEX',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ label: '性别',hidden:false, name: 'YXTYTJ_SEXName',align:'left',  width: '150px'});
...
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ label: '工作单位',hidden:true, name: 'LEAGUE_ID',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ label: '工作单位',hidden:false, name: 'LEAGUE_IDName',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '表单编号',hidden:false, name: 'YXTYTJ_BDBH',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '所在团支部',hidden:false, name: 'LEAGUE_NAME',align:'left',  width: '150px'});
...
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '字段_24',hidden:true, name: 'EAGUEBRANCH_ID',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '字段_25',hidden:true, name: 'DATA_25',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '字段_26',hidden:true, name: 'DATA_26',align:'left',  width: '150px'});
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({label: '字段_27',hidden:true, name: 'DATA_27',align:'left',  width: '150px'});
...
tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ sortable:false,label: '流程状态', formatter:bpmStatusFormatter, hidden:false, name: 'BUSINESSSTATE_',align:'left',  width: '150px'});tablecmtable3bc6e958a9f76e4c1d799e6ce8dedf51f49a.push({ sortable:false,label: '流程详细', formatter:bpmFormatter, hidden:false, name: 'tableVirColumn14be42c3da3867461878dce79028b351fd1d',align:'left',  width: '150px'});function table3bc6e958a9f76e4c1d799e6ce8dedf51f49ainitWorkFlow(status){
