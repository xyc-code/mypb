...
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({ label: '选举类型',hidden:true, name: 'PARTY_TYPE',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({ label: '选举类型',hidden:false, name: 'PARTY_TYPEName',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({label: '选举党组织名称',hidden:false, name: 'PARTY_NAME_NEW',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({label: '申请人所在党支部',hidden:true, name: 'PARTY_NAME',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({label: '申请人所在单位',hidden:true, name: 'DEPT_NAME',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({label: '党支部ID',hidden:true, name: 'PARTY_ID',align:'left',  width: '150px'});
tablecmtable3215bd1dd3d79c4115ca9132e549bb918ebf.push({label: '召开党员大会时间', formatter:format, hidden:true, name: 'ELECTION_TIME',align:'center',  width: '150px'});
...
table3215bd1dd3d79c4115ca9132e549bb918ebfLoadComplete.addEvent(function(data){$("#tableToolbarButtonfac5ffe50e49fc4154e84d562156b51cc962").css("display","");});
