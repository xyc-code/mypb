...
tablecmtabled0598a703899cd4c45c8ff7af3c6f4d23c10.push({label: '突击队任务完成情况及取得成效',hidden:true, name: 'EXPECTED_INCOME',align:'left',  width: '150px'});
...
tablecmtabled0598a703899cd4c45c8ff7af3c6f4d23c10.push({ sortable:false,label: '流程运转', formatter:bpmStatusFormatter, hidden:false, name: 'BUSINESSSTATE_',align:'left',  width: '150px'});tablecmtabled0598a703899cd4c45c8ff7af3c6f4d23c10.push({ sortable:false,label: '流程当前处理人',hidden:false, name: 'ASSIGNEENAMES_',align:'left',  width: '150px'});tablecmtabled0598a703899cd4c45c8ff7af3c6f4d23c10.push({ sortable:false,label: '流程详细', formatter:bpmFormatter, hidden:false, name: 'tableVirColumn86cf0c493f958d46e0fb70f7122f4b53fa85',align:'left',  width: '150px'});	var searchNamestabled0598a703899cd4c45c8ff7af3c6f4d23c10 = []; 
...
$("#tableToolbarButton844ebdf0c954c04b38583e0f3785882be4d4").bind('click',function(event){var row = $('#tabled0598a703899cd4c45c8ff7af3c6f4d23c10').jqGrid('getDataIDs');
if(row.length==0){
layer.alert('无数据！', {
			  icon: 7,
			  area: ['400px', ''], //宽高
...
$('#tableToolbarButton5c4b4f8351ddc846327813f8ae0421801633').bind('click',function() {                           
	layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var colModels =$('#tabled0598a703899cd4c45c8ff7af3c6f4d23c10').jqGrid('getGridParam','colModel');   
	        ...
	        expSearchParams.keyWord = tabled0598a703899cd4c45c8ff7af3c6f4d23c10KeyWordIn;                          
	        expSearchParams.param = tabled0598a703899cd4c45c8ff7af3c6f4d23c10ParamIn;                              
	        expSearchParams.hasRowNum = false;                                       
	        expSearchParams.sheetName = 'sheet1';                                    
	        expSearchParams.unContainFields = blockFields.toString();                
	        expSearchParams.fileName='青年申报表';                             
	        expSearchParams.viewid='948e83e3881da2180188278d70666c6e';                                   
	        expSearchParams.tableid='tabled0598a703899cd4c45c8ff7af3c6f4d23c10';                                 
