...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButtoncf9e58e114e611496368e8d8bc5e984c9c86" permissionDes="导出"><a id="tableToolbarButtoncf9e58e114e611496368e8d8bc5e984c9c86" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出"><i class=""></i> 导出</a></sec:accesscontrollist>
...
<div class="col-xs-6 formcell">
<div class="col-xs-3 celllabel" title="拟稿人">拟稿人</div><div class="input-group-sm col-xs-9 cellcontrol"><input type="text" value="" id="DEMOCRACY_USER" name="DEMOCRACY_USER"
	class="form-control input-sm cellinput">
</div></div>
<div class="col-xs-6 formcell">
<div class="col-xs-3 celllabel" title="召开日期">召开日期</div>
...
<div class="col-xs-6 formcell">
<div class="col-xs-3 celllabel" title="召开日期">至</div>
<div class="input-group input-group-sm col-xs-9 cellcontrol ">
...
<script src="avicit/eformmodule/view/gsldgbmzshh/V1/bootstrap/view1717549672000.js?_=1718152021939"></script>
</html> 
