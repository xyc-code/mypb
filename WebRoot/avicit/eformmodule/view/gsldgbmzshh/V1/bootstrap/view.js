...
tablecc1d3123e0feb64706383d3b0eecf01fcec1Reload(window.tablecc1d3123e0feb64706383d3b0eecf01fcec1Pid);
	...
	var searchNamestablecc1d3123e0feb64706383d3b0eecf01fcec1 = []; 
searchNamestablecc1d3123e0feb64706383d3b0eecf01fcec1.push('DEMOCRACY_USER');
$('#keyWordtablecc1d3123e0feb64706383d3b0eecf01fcec1').attr('placeholder', '请输入拟稿人查询');
...
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({label: '拟稿人',hidden:false, name: 'DEMOCRACY_USER',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '单位',hidden:true, name: 'DEMOCRACY_DEPT',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '单位',hidden:false, name: 'DEMOCRACY_DEPTName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '主管公司领导是否参加',hidden:true, name: 'LEAD_JOIN',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '主管公司领导是否参加',hidden:false, name: 'LEAD_JOINName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '公司领导姓名',hidden:true, name: 'LEAD_NAME',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '公司领导姓名',hidden:false, name: 'LEAD_NAMEName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({label: '召开日期', formatter:format, hidden:false, name: 'DEMOCRACY_DATE',align:'center',  width: '150px'});
...
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '纪检/人力参会人员是否参加',hidden:true, name: 'JW_JOIN',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '纪检/人力参会人员是否参加',hidden:false, name: 'JW_JOINName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '纪检/人力参会人员',hidden:true, name: 'JW_NAME',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '纪检/人力参会人员',hidden:false, name: 'JW_NAMEName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({label: '联系电话',hidden:false, name: 'DEMOCRACY_TEL',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({label: '召开地点',hidden:false, name: 'DEMOCRACY_WZ',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '公司领导最终是否参会',hidden:true, name: 'LEAD_YN',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ label: '公司领导最终是否参会',hidden:false, name: 'LEAD_YNName',align:'left',  width: '150px'});
tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ sortable:false,label: '流程当前步骤',hidden:false, name: 'ACTIVITYALIAS_',align:'left',  width: '150px'});tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ sortable:false,label: '流程状态', formatter:bpmStatusFormatter, hidden:false, name: 'BUSINESSSTATE_',align:'left',  width: '150px'});tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ sortable:false,label: '流程当前处理人',hidden:false, name: 'ASSIGNEENAMES_',align:'left',  width: '150px'});tablecmtablecc1d3123e0feb64706383d3b0eecf01fcec1.push({ sortable:false,label: '流程详细', formatter:bpmFormatter, hidden:false, name: 'flowdetail',align:'left',  width: '150px'});;$(document).ready(function(){ 

tablecc1d3123e0feb64706383d3b0eecf01fcec1GridComplete.addEvent(function(){$("#tableToolbarButton654d3a13915bc946e0dbb5da04a93e983565").css("display","");});
...
$("#tableToolbarButton654d3a13915bc946e0dbb5da04a93e983565").hide();
$("#tableToolbarButtoncf9e58e114e611496368e8d8bc5e984c9c86").bind('click',function(event){layer.open({                         
	    type : 2,                        
	    area : ['400px', '300px'],       
	    title: '导出',                   
	    skin: 'bs-modal',                
	    ...
	    yes:function(index, layero){                                                 
	        ...
	        var colModels =$('#tablecc1d3123e0feb64706383d3b0eecf01fcec1').jqGrid('getGridParam','colModel');   
	        ...
	        expSearchParams.keyWord = tablecc1d3123e0feb64706383d3b0eecf01fcec1KeyWordIn;                          
	        expSearchParams.param = tablecc1d3123e0feb64706383d3b0eecf01fcec1ParamIn;                              
	        expSearchParams.hasRowNum = false;                                       
	        expSearchParams.sheetName = '公司领导干部民主生活会';                                    
	        expSearchParams.unContainFields = blockFields.toString();                
	        expSearchParams.fileName='民主大会表';                             
	        expSearchParams.viewid='2c908c1d89cef9c70189cf10be7d06be';                                   
	        expSearchParams.tableid='tablecc1d3123e0feb64706383d3b0eecf01fcec1';                                 
	        expSearchParams.isbpm='Y';                                     
	        expSearchParams.comparameter=JSON.stringify(filterParams);               
	        var showCols = JSON.stringify(showColModels);                            
	        expSearchParams.layout = layout;                                         
	        expSearchParams.showCols = showCols;                                     
	        var url = 'avicit/lc/youth/dynDemocracy/dynDemocracyController/dataOperating/exportServerData/createWord'; 
