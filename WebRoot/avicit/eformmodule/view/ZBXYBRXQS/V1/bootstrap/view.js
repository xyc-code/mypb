...
tablecmtable97d79ef56e1e414ad9f932a3f30bfaed2136.push({label: '选举党组织名称',hidden:false, name: 'PARTY_NAME_NEW',align:'left',  width: '150px'});
tablecmtable97d79ef56e1e414ad9f932a3f30bfaed2136.push({label: '申请人所在党支部',hidden:true, name: 'PARTY_NAME',align:'left',  width: '150px'});
tablecmtable97d79ef56e1e414ad9f932a3f30bfaed2136.push({label: '申请人所在单位',hidden:true, name: 'DEPT_NAME',align:'left',  width: '150px'});
...
table97d79ef56e1e414ad9f932a3f30bfaed2136LoadComplete.addEvent(function(data){$("#tableToolbarButton5963ac33ccce4f461ea8b8d11cccfd236340").css("display","")});
