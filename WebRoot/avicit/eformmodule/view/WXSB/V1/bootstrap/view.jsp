...
<sec:accesscontrollist hasPermission="3" domainObject="tableToolbarButtond13156663bedc74870caf48a16478eacb914" permissionDes="导出测试"><a id="tableToolbarButtond13156663bedc74870caf48a16478eacb914" href="javascript:void(0)" style="float:left;" class="btn btn-primary form-tool-btn btn-sm " role="button" title="导出测试"><i class=""></i> 导出测试</a></sec:accesscontrollist>
...
<script src="avicit/eformmodule/view/WXSB/V1/bootstrap/view1721805675000.js?_=1721806820603"></script>
<script src="avicit/pb/milepost/dynfiveof/js/DynFiveOf.js"></script>
</html> 
