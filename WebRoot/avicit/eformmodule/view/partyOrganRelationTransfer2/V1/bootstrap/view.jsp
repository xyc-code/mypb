...
<div class="col-xs-3 celllabel" title="转出类别">转出类别</div>
<div class="input-group-sm col-xs-9 cellcontrol">
 <pt6:h5select css_class="form-control input-sm cellinput" defaultValue="" id="P_TRANSFER_TYPE" name="P_TRANSFER_TYPE" title="转出类别" isNull="true" lookupCode="PARTY_ORG_TRANSFER_TYPE" />
</div></div>
</form></div>
</blockdom>
...
<script src="avicit/eformmodule/view/partyOrganRelationTransfer2/V1/bootstrap/view1717378994000.js?_=1731288035868"></script>
</html> 
