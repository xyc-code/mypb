 ...
 * formcode
 */
EformFlow.prototype.formcode = "HJXJYBRXQS";
...
layer.close(maskId);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=948e83e3828f72f301828ffcb103358e&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
EformFlow.prototype.save = function(callback) {
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=948e83e3828f72f301828ffcb103358e&tableId='+tableId+'&id='+pageParams.id;
