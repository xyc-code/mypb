 ...
 * formcode
 */
EformFlow.prototype.formcode = "dyjfzkhv2";
...
layer.close(maskId);
    ...
    if(pageParams.isInsert) {
        var obj ={INTEGRAL:$("#INTEGRAL").jqGrid('getRowData')}
jsonData.subTableData = JSON.stringify(obj);
var row =encodeURIComponent(JSON.stringify($("#INTEGRAL").jqGrid('getRowData')));
var quary = parseInt($("#QUARTER").val());
var flag = false;
var msg = "";
		 $.ajax({
			   url:'platform/avicit/pb/scoring/integral/integralController/ave/'+quary+"?id="+row+"&lcid="+pageParams.id,
			   type:"POST",
			   dataType:"JSON",
           async:false,
...
jsonData.subTableData = JSON.stringify(obj);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=2c9419a9899b211701899b2cbc0c0349&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
jsonData.subTableData = JSON.stringify(obj);
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=2c9419a9899b211701899b2cbc0c0349&tableId='+tableId+'&id='+pageParams.id;
