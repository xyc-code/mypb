...
jsonData.subTableData = JSON.stringify(obj);
    ...
    var processDef = new FlowListEditorBySec("dyjfzkhv2",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=2c9419a9899b211701899b2cbc0c0349&tableId='+tableId+'&defineId='+pdId+'&formcode=dyjfzkhv2';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
