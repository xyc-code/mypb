...
<div data-options="region:'center',split:true,border:false" style="padding: 8px 0;">
    <input id="tableId" value="DYN_TEST" type="hidden"/>
 ...
 <table style="" id="fAKW425ZygPjqD8HF12LF7cMJAfgwpjV" class="form_commonTable1"> 
  <tbody> 
   <tr> 
    <td style="width:6%; text-align: right;"><label for="DATA_1" class=" " style=";" id="jfaaRsOez3guVeFkVgPCF78w7gTth2JT"> DATA_1： </label> </td> 
    <td style="width:19%;"> 
     <div class="input-group-sm "> 
      <input type="text" class="form-control input-sm" style=" ; " id="DATA_1" name="DATA_1" title="DATA_1" maxlength="255" value="<c:out  value='${map["DATA_1"]}'/>"> 
     </div></td> 
    <td style="width:25%;"> 
     <div class="input-group-sm "> 
      <input type="text" class="form-control input-sm" style=";" id="DATA_2" name="DATA_2" readonly title="字段_2" maxlength="1000" value="<c:out  value='${map["DATA_2"]}'/>"> 
     </div></td> 
...
<script src="avicit/eformmodule/form/test/V1/bootstrap/detail-layout1642404590000.js?_=1642404591465" type="text/javascript"></script>
    ...
    var formInfoId = "402811817e438190017e43856fc00150";
    var datasourceId = "${datasourceId}";
    var pgrid = "${grid}";
    var fkcol = "${fkcol}";
    var fkvalue = "${fkvalue}";
    var tableName = "DYN_TEST";
    var entryId = '${entryId}';
    var type = "${type}";
    var idmap = "${idmap}";
