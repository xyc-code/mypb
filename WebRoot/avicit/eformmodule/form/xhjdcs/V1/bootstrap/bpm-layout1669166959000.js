 ...
 * formcode
 */
EformFlow.prototype.formcode = "xhjdcs";
...
layer.close(maskId);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=40281181845b53840184a219b35e02f3&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
EformFlow.prototype.save = function(callback) {
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=40281181845b53840184a219b35e02f3&tableId='+tableId+'&id='+pageParams.id;
