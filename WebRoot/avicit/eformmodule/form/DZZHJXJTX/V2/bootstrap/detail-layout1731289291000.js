...
//$("td").eq(27).css('line-height','20px');
	...
	$('.time-picker').on('keydown',nullInput);
		                             ...
		                             $("#948e83e3930ad05e019318e2034a3981").click(function(){
        
        window.open(_eform_base_url+"platform/eform/bpmsCRUDClient/toPrint?formInfoId=948e83e3828ad2be01828c031c280fd5&id="+id+"&type=print","_blank");
