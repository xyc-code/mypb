...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("DZZHJXJTX",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=948e83e3828ad2be01828c031c280fd5&tableId='+tableId+'&defineId='+pdId+'&formcode=DZZHJXJTX';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
