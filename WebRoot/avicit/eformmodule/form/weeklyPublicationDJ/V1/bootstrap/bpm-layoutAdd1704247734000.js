...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("weeklyPublicationDJ",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=4028819987207ca4018720c5de1a0524&tableId='+tableId+'&defineId='+pdId+'&formcode=weeklyPublicationDJ';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
