 ...
 * formcode
 */
EformFlow.prototype.formcode = "weeklyPublicationDJ";
...
layer.close(maskId);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=4028819987207ca4018720c5de1a0524&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
EformFlow.prototype.save = function(callback) {
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=4028819987207ca4018720c5de1a0524&tableId='+tableId+'&id='+pageParams.id;
