 ...
 * formcode
 */
EformFlow.prototype.formcode = "qntjdsb";
...
jsonData.subTableData = JSON.stringify(obj);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=2c908c1d894ded3801894e090c780ae1&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
jsonData.subTableData = JSON.stringify(obj);
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=2c908c1d894ded3801894e090c780ae1&tableId='+tableId+'&id='+pageParams.id;
