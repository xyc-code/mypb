...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("fixedAssetsDbTable",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=82808081966773a0019667a48a000e0b&tableId='+tableId+'&defineId='+pdId+'&formcode=fixedAssetsDbTable';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
