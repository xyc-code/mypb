...
<div data-options="region:'center',split:true,border:false" style="padding: 8px 0;">
    <input id="tableId" value="DYN_RELA_ATTACH" type="hidden"/>
...
<script src="avicit/eformmodule/form/downLoadAttach/V1/bootstrap/detail-layout1666839158000.js?_=1699598022507" type="text/javascript"></script>
