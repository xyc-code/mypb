 ...
 * formcode
 */
EformFlow.prototype.formcode = "partyMoney";
...
*/
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=402811817f19a849017f1b0124000a56&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
*/
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=402811817f19a849017f1b0124000a56&tableId='+tableId+'&id='+pageParams.id;
...
if (typeof addBeforeSaveEvent!='undefined'){
	...
	$('.time-picker').on('keydown',nullInput);
        ...
        workflowControlForAccess.addcontrolFunc(function(tagId, operability){
				if (tagId != "948e83e3843b68c401845105381a72f4"){
					return true;
				}
				
				if(!operability){
					$("#948e83e3843b68c401845105381a72f4").hide();
				}else{
					$("#948e83e3843b68c401845105381a72f4").show();
				}
			});
                        $("#948e83e3843b68c401845105381a72f4").click(function(){
                
                  window.open(_eform_base_url+"platform/print/sysPrintClientController/toPrint?printId=948e83e3843b68c401844fc7f6ff67b1&id="+id+"&entryId="+entryId+"&type=print","_blank");
