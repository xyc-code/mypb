...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("weeklyPolling",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=40288199873000540187300f12a80282&tableId='+tableId+'&defineId='+pdId+'&formcode=weeklyPolling';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
