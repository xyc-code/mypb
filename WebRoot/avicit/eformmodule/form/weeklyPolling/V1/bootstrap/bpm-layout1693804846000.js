 ...
 * formcode
 */
EformFlow.prototype.formcode = "weeklyPolling";
...
layer.close(maskId);
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=40288199873000540187300f12a80282&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
EformFlow.prototype.save = function(callback) {
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=40288199873000540187300f12a80282&tableId='+tableId+'&id='+pageParams.id;
