 ...
 * formcode
 */
EformFlow.prototype.formcode = "partyActivityMoney";
...
if (typeof addBeforeSaveEvent!='undefined'){
	...
	$('.time-picker').on('keydown',nullInput);
        ...
        workflowControlForAccess.addcontrolFunc(function(tagId, operability){
				if (tagId != "948e83e3843b68c4018454fdf44c7bf3"){
					return true;
				}
				
				if(!operability){
					$("#948e83e3843b68c4018454fdf44c7bf3").hide();
				}else{
					$("#948e83e3843b68c4018454fdf44c7bf3").show();
				}
			});
                        $("#948e83e3843b68c4018454fdf44c7bf3").click(function(){
                
                  window.open(_eform_base_url+"platform/eform/bpmsCRUDClient/toPrint?formInfoId=402811817f19a849017f1f1222c41c07&id="+id+"&entryId="+entryId+"&type=print","_blank");
