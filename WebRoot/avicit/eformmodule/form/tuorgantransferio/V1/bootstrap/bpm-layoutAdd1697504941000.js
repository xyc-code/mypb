...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("tuorgantransferio",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=402881a789ae865d0189ae9b3b91033a&tableId='+tableId+'&defineId='+pdId+'&formcode=tuorgantransferio';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
