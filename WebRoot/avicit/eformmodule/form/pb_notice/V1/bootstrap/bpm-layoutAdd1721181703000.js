...
//console.log(issYN);
 ...
 if(issYNSave == '0'){
    ...
    var processDef = new FlowListEditorBySec("pb_notice",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=948e83e381eaacfc0181faa42aa84007&tableId='+tableId+'&defineId='+pdId+'&formcode=pb_notice';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
