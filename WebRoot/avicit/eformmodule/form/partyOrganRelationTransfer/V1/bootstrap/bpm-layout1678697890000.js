 ...
 * formcode
 */
EformFlow.prototype.formcode = "partyOrganRelationTransfer";
...
if(pInDeptIds == ''){
 ...
 var P_IN_PARTY_ORG = $('#P_IN_PARTY_ORG').val();
   ...
   layer.msg("目的部门不能为空！！！");
    ...
    var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=402811817f241b5d017f24306e180254&tableId='+tableId+'&defineId='+defineId+'&formcode='+ _self.formcode;
...
if(pInDeptIds == ''){
 ...
 var P_IN_PARTY_ORG = $('#P_IN_PARTY_ORG').val();
   ...
   layer.msg("目的部门不能为空！！！");
    ...
    jsonData["idmap"] = idmap;
    var tableId = $('#tableId').val();
    var url = 'platform/eform/bpmsCRUDClient/bpm?formInfoId=402811817f241b5d017f24306e180254&tableId='+tableId+'&id='+pageParams.id;
...
avicAjax.ajax({
 ...
 $("#PARTY_ID").val(r.PARTY_ID);
	...
	$('.time-picker').on('keydown',nullInput);
        ...
        workflowControlForAccess.addcontrolFunc(function(tagId, operability){
				if (tagId != "948e83e3843b68c4018454e167967b48"){
					return true;
				}
				
				if(!operability){
					$("#948e83e3843b68c4018454e167967b48").hide();
				}else{
					$("#948e83e3843b68c4018454e167967b48").show();
				}
			});
                        $("#948e83e3843b68c4018454e167967b48").click(function(){
                
                  window.open(_eform_base_url+"platform/eform/bpmsCRUDClient/toPrint?formInfoId=402811817f241b5d017f24306e180254&id="+id+"&entryId="+entryId+"&type=print","_blank");
