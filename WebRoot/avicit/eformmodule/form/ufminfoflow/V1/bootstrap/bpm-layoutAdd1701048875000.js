...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("ufminfoflow",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=2c908c5a896175160189618a328a0662&tableId='+tableId+'&defineId='+pdId+'&formcode=ufminfoflow';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
