...
$("#OUT_DEPT_NAME").show(); 
 var OUT_DEPT_NAME = $("#OUT_DEPT_NAME").val(); 
  if(OUT_DEPT_NAME == ''){
    ...
    var processDef = new FlowListEditorBySec("partyActivistRelationTransfer",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'platform/eform/bpmsCRUDClient/addbpm?formInfoId=402811817f4eb25b017f61f97c0e0dbe&tableId='+tableId+'&defineId='+pdId+'&formcode=partyActivistRelationTransfer';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
