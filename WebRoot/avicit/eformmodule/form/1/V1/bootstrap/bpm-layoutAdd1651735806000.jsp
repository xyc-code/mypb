...
<div data-options="region:'center',split:true,border:false" style="padding: 8px 0;">
    <input id="tableId" value="DYN_2" type="hidden"/>
...
<script src="avicit/eformmodule/form/1/V1/bootstrap/bpm-layoutAdd1651735806000.js?_=1651735970858" type="text/javascript"></script>
