 ...
 * 
 */
function RollingPlan(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
//初始化操作
RollingPlan.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: this.getUrl()+'getRollingPlansByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
...
//添加页面
RollingPlan.prototype.insert=function(){
...
//编辑页面
RollingPlan.prototype.modify=function(){
...
//详细页
RollingPlan.prototype.detail=function(id){
...
//打开高级查询框
RollingPlan.prototype.openSearchForm = function(searchDiv){
	var _self = this;
...
RollingPlan.prototype.formValidate=function(form){
	form.validate({
		rules: {
						  		     			 		  				  				  				  		     			    				   					fkSubColId:{
						maxlength: 50
...
//保存功能
RollingPlan.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
...
//删除
RollingPlan.prototype.del=function(){
...
//重载数据
RollingPlan.prototype.reLoad=function(){
...
//关闭对话框
RollingPlan.prototype.closeDialog=function(id){
	if(id == "insert"){
...
//高级查询
RollingPlan.prototype.searchData =function(){
	var searchdata = {
			keyWord: null,
...
//关键字段查询
RollingPlan.prototype.searchByKeyWord =function(){
...
//隐藏查询框
RollingPlan.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/*清空查询条件*/
RollingPlan.prototype.clearData =function(){
