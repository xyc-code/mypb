...
PartyMember.prototype.init = function() {
	var _self = this;
	var searchdata = JSON.stringify(serializeObject($("#type")))
	var postData = {
		keyWord:null,
		param:searchdata
	}
...
PartyMember.prototype.searchData = function() {
	...
	var fromData = serializeObject($(this._formId));
	fromData["attribute14"] = $("#attribute14").val();
	var searchdata = {
		keyWord : null,
...
PartyMember.prototype.searchByKeyWord = function() {
	...
	param["attribute14"] = $("#attribute14").val();
	var searchdata = {
