...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/pb-modern/jushoubaogao/jushoubaogao.css?v=20260831-2">
...
<main id="pb-jushoubaogao" class="pb-modern-page pb-jushoubaogao-page" data-statistics-url="<%=request.getContextPath()%>/platform/avicit/pb/jushoubaogao/juShouBaoGaoController/statistics">
    ...
    <div class="jbg-quality" role="status">
        <span><span class="jbg-flow-coverage-label">流程覆盖率</span> <strong class="jbg-flow-coverage">0%</strong></span>
        <span><span class="jbg-flow-unlinked-label">无流程实例</span> <strong class="jbg-flow-unlinked">0</strong></span>
        <span>单位信息缺失 <strong class="jbg-unit-missing">0</strong></span>
        <span>类型信息缺失 <strong class="jbg-type-missing">0</strong></span>
        <span>匿名字段异常 <strong class="jbg-anonymous-invalid">0</strong></span>
    </div>
    <div class="jbg-kpis">
        <section class="jbg-kpi"><div class="jbg-kpi-label">年度报告总数量</div><div class="jbg-kpi-value jbg-total">0</div><div class="jbg-kpi-note">按报告发生时间统计</div></section>
    ...
    <div class="jbg-main">
        ...
        <section class="jbg-panel jbg-analysis-panel"><div class="jbg-panel-heading"><h2 class="jbg-panel-title">月度报告趋势</h2><span class="jbg-panel-tag">发生时间</span></div><div class="jbg-type-tabs" role="tablist" aria-label="月度趋势报告类型"><button type="button" role="tab" class="jbg-type-tab is-active" data-report-type="总体" aria-selected="true">总体</button><button type="button" role="tab" class="jbg-type-tab" data-report-type="质量" aria-selected="false">质量</button><button type="button" role="tab" class="jbg-type-tab" data-report-type="安全" aria-selected="false">安全</button><button type="button" role="tab" class="jbg-type-tab" data-report-type="生产" aria-selected="false">生产</button><button type="button" role="tab" class="jbg-type-tab" data-report-type="技术" aria-selected="false">技术</button><button type="button" role="tab" class="jbg-type-tab" data-report-type="其他" aria-selected="false">其他</button></div><p class="jbg-panel-summary jbg-monthly-summary">正在读取统计数据...</p><div id="jbgMonthlyChart" class="jbg-chart jbg-monthly-chart"></div></section>
...
<script src="<%=request.getContextPath()%>/static/pb-modern/jushoubaogao/jushoubaogao.js?v=20260831-7"></script>
</body>
</html>
