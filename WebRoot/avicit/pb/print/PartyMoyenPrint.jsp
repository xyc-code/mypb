    ...
    <div class="mce-content-body">
        ...
        <table style="border: 1px solid;width: 650px" id="partyActivityMoney" border="1"
                                                    ...
                                                    <div class="ui-jqgrid-view table-responsive"
                                                        ...
                                                        <div class="ui-jqgrid-bdiv"
                                                            ...
                                                            <div style="position: relative;">
                                                                ...
                                                                <table id="DYN_PA_CD"
                                                                       class="datatable ui-jqgrid-btable ui-common-table table table-bordered"
                                                                       datapermission="eform_data_DYN_PA_CD"
                                                                       tabindex="0"
                                                    ...
                                                    <div class="ui-jqgrid-view table-responsive"
                                                        ...
                                                        <div class="ui-jqgrid-bdiv"
                                                            ...
                                                            <div style="position: relative;">
                                                                ...
                                                                <table id="DYN_PA_BZ"
                                                                       class="datatable ui-jqgrid-btable ui-common-table table table-bordered"
                                                                       datapermission="eform_data_DYN_PA_BZ"
                                                                       tabindex="0"
                                                                       role="presentation" aria-multiselectable="false"
                                                                       aria-labelledby="gbox_DYN_PA_BZ"
                                                                       style="width: 500px;">
            ...
            <tr style="height: 58px;">
                ...
                <td
                    ...
                    <table style="margin: 0; width: 100%;"
                                        ...
                                        <td>
                                            <div title="DYN_PA_BZ" id="DYN_PA_BZ_control"
                                                ...
                                                <div class="ui-jqgrid " id="gbox_DYN_PA_BZ" dir="ltr"
                                                    ...
                                                    <div class="ui-jqgrid-resize-mark">&nbsp;</div>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td style="width: 25%;"><label for="QT_TOTAL_PRICE">其他总计金额：</label></td>
                            <td style="width: 25%;">
                                <div class="">
													<textarea id="QT_TOTAL_PRICE" name="QT_TOTAL_PRICE"
                                                              style="" class="form-control" readonly="" rows="1"
                                                              title="其他总计金额"
                                                              data-precision="2">${dto.QT_TOTAL_PRICE }</textarea>
                                </div>
                            </td>
                        </tr>
                        </tbody>
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党支部审批：</strong></td>
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党委（总支）审批:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党建工作室审核:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党建工作室审批:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党群工作部书记审批:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
                    <div id="YHTauAyws0nxa5dOCex5Rbxi8C2I15gK" class="bpm_self_class " title="">
                    </div>
                </td>
            </tr>
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党群工作部部长审批:</strong>
                </td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>公司领导审批:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
            ...
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党委书记审批:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
                    <div id="VKdkng852YzVgXVNWIRcJkyn2UxmycY6" class="bpm_self_class " title="">
                    </div>
                </td>
            </tr>
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>拟稿人确认:</strong></td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
                    <div id="vVzK8ODsFqLJr4SM9HYP7f1olswZa5eq" class="bpm_self_class " title="">
                    </div>
                </td>
            </tr>
            <tr style="height: 82px;">
                <td style="width:9%; text-align: left; border: 1px solid; height: 82px;"><strong>党建工作室报销审核:</strong>
                </td>
                <td style="width:55%; text-align: left; border: 1px solid; height: 82px;" colspan="3">
                    <div id="rNU0kJeBjyVXtoc4sGVyuPFW5QmgpNkr" class="bpm_self_class " title="">
                    </div>
                </td>
            </tr>
            </tbody>
...
<script type="text/javascript">
        ...
        switch (name) {
            case "DYN_PA_XXZL1":
                ...
                html += '<td role="gridcell" style="height: 0px; width: 153px;">'
                    + item.XXZL_NUM + '</td>'
                html += '<td role="gridcell" style="height: 0px; width: 153px;">'
                    + item.XXZL_UNION_PRICE + '</td>'
                html += '<td role="gridcell" style="height: 0px; width: 153px;">'
                    + item.XXZL_TOTAL_PRICE + '</td>'
                return html;
            case "DYN_PA_GB":
                html += '<td role="gridcell" style="height: 0px; width: 153px;">'
                    + item.GB_NAME + '</td>'
    ...
    $.ajax({
        url: "avicit/pb/print/PartyMoneyPrint/list",
        dataType: "JSON",
        type: "GET",
        async: false,
        data: {
        ...
        success: function (e) {
            ...
            listFor(e.DYN_PM_QT, "DYN_PM_QT");
            $("#tAbmG7HM5ivyFo8i6Yq0m4aAiCJ9YMgu").append(yjFor(e.task3));
            $("#sDIYEWi4cHFkuAnCTsCoN2x3vLBEbaLT").append(yjFor(e.task4));
            $("#yXE1ibSD48CHpxuQTYtNcCCHZJq3MIWh").append(yjFor(e.task5));
            $("#z6OG8t0tVus3Ng7kxgJ4fSwkLjHQdMJB").append(yjFor(e.task2));
            $("#lvDLHzyRs7lVVfYC3Z9aYJ4lykacJA81").append(yjFor(e.task6));
            $("#YHTauAyws0nxa5dOCex5Rbxi8C2I15gb").append(yjFor(e.task7));
            $("#GQbdTfpJFtOJd0GX8pKDT8ovk7q1DxN6").append(yjFor(e.task8));
            $("#VKdkng852YzVgXVNWIRcJkyn2UxmycY6").append(yjFor(e.task9));
            $("#vVzK8ODsFqLJr4SM9HYP7f1olswZa5eq").append(yjFor(e.task10));
            $("#rNU0kJeBjyVXtoc4sGVyuPFW5QmgpNkr").append(yjFor(e.task11));
            $("#YHTauAyws0nxa5dOCex5Rbxi8C2I15gK").append(yjFor(e.task12));
            setTimeout(function () {
                getPrint();
            }, 500)
