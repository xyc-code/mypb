 ...
 */
function DynFiveOf(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynFiveOf.prototype.init=function(){
	var _self = this;
	//初始化流程帮助类
	flowListEditor = new FlowListEditor(this._formCode);
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynFiveOfsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynFiveOf.prototype.insert=function(){
	flowListEditor.addFlow();
};
/**
 * 编辑页面
 */
DynFiveOf.prototype.modify=function(){
 ...
 * 详情页面
 */
DynFiveOf.prototype.detail=function(id,value){
	flowUtils.detail(id); 
};
/**
 * 打开高级查询框
 */
DynFiveOf.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynFiveOf.prototype.formValidate=function(form){
	form.validate({
		rules: {
			fiveDate:{
				dateISO:true
 ...
 * 删除方法
 */
DynFiveOf.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynFiveOf.prototype.reLoad=function(){
	var searchdata = {
		keyWord: null,
 ...
 * 关闭对话框
 */
DynFiveOf.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynFiveOf.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynFiveOf.prototype.searchByKeyWord =function(){
 ...
 * 根据流程状态查询
 */
DynFiveOf.prototype.initWorkFlow = function(status){
	$('#bpmState').val(status);
	if(status == "start"){
		$("#dynFiveOf_modify").show();
		$("#dynFiveOf_del").show();
	}else{
		$("#dynFiveOf_modify").hide();
		$("#dynFiveOf_del").hide();
	}
	this.searchData();
};
 ...
 * 隐藏查询框
 */
DynFiveOf.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynFiveOf.prototype.clearData =function(){
...
function fomrt(id,c,s){
	...
	$.ajax({
		url:"platform/avicit/pb/milepost/dynFiveOf/dynFiveOfController/fomrt?id="+s.ID,
		dataType:"json",
		type:"GET",
		async:false,
		success: function (r) {
	...
	if(obj.ATTR1 == null || obj.ATTR1 == undefined){
		return "";
	}
	return obj.ATTR1;
}
//部门
function fomrtDept(){
	if(obj.ATTR2 == null || obj.ATTR2 == undefined){
		return "";
	}
	return obj.ATTR2;
}
//职务
function fomrtTask(){
	if(obj.ATTR3 == null || obj.ATTR3 == undefined){
		return "";
	}
	return obj.ATTR3;
}
