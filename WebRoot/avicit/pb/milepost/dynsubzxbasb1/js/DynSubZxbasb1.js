 ...
 */
function DynSubZxbasb1(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynSubZxbasb1.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynSubZxbasb1sByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynSubZxbasb1.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynSubZxbasb1.prototype.modify=function(){
 ...
 * 详情页面
 */
DynSubZxbasb1.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynSubZxbasb1.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynSubZxbasb1.prototype.formValidate=function(form){
	form.validate({
		rules: {
			fkSubColId:{
                maxlength: 50
 ...
 * 保存方法
 */
DynSubZxbasb1.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynSubZxbasb1.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynSubZxbasb1.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynSubZxbasb1.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynSubZxbasb1.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynSubZxbasb1.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynSubZxbasb1.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynSubZxbasb1.prototype.clearData =function(){
