 ...
 */
function PartyMilepost(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 添加页面
 */
PartyMilepost.prototype.insert=function(){
 ...
 * 详情页面
 */
PartyMilepost.prototype.detail=function(id,value){
 ...
 * 重载数据
 */
PartyMilepost.prototype.reLoad=function(){
	var searchdata = {
		keyWord: null,
 ...
 * 根据流程状态查询
 */
PartyMilepost.prototype.initWorkFlow = function(status){
	$('#bpmState').val(status);
	if(status == "start"){
		//$("#partyMilepost_modify").show();
		//$("#partyMilepost_del").show();
	}else{
		//$("#partyMilepost_modify").show();
		//$("#partyMilepost_del").show();
	}
