...
<body>
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					...
					<th width="15%">
						<label for="expectedIncome">突击队任务完成情况及取得成效:</label></th>
					<td width="34%">
    			...
    			<tr>
					<th>
						<label for="commandoesContent">备案情况:</label></th>
					<td>
						<input class="form-control input-sm" type="text" name="commandoesContent"  id="commandoesContent">
					</td>
					<th>
    			...
    			<tr>
					...
					<th>
						<label for="commandoesPosenTel">联系人电话:</label></th>
					<td>
						<input class="form-control input-sm" type="text" name="commandoesPosenTel"  id="commandoesPosenTel">
					</td>
				</tr>
    			<tr>
					<th>
					...
					<th>
						<label for="commandoesPxqk">评选情况:</label></th>
					<td>
						<input class="form-control input-sm" type="text" name="commandoesPxqk"  id="commandoesPxqk">
					</td>
				</tr>
    			<tr>
					<th>
    			...
    			<tr>
					<th>
						<label for="commandoesPosen">联系人姓名:</label></th>
					<td>
						<input class="form-control input-sm" type="text" name="commandoesPosen"  id="commandoesPosen">
					</td>
				</tr>
			</table>
		</form>
	...
	<!-- 业务js -->
	<script src="avicit/pb/milepost/dynyouthdeclaration/js/DynYouthDeclarationDetail.js" type="text/javascript"></script>
	<script type="text/javascript">
		...
		$(document).ready(function (){
			var dynYouthDeclarationDetail = new DynYouthDeclarationDetail('form');
			var flowEditor = new FlowEditor(dynYouthDeclarationDetail);
			flowEditor.init();
			initDateSelect();
			//绑定表单验证规则
			dynYouthDeclarationDetail.formValidate($('#form'));
