 ...
 */
function DynYouthDeclaration(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
    ...
    this._formCode = "dynYouthDeclaration";
 ...
 * 初始化操作
 */
DynYouthDeclaration.prototype.init=function(){
	var _self = this;
	//初始化流程帮助类
	flowListEditor = new FlowListEditor(this._formCode);
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynYouthDeclarationsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynYouthDeclaration.prototype.insert=function(){
	flowListEditor.addFlow();
};
/**
 * 编辑页面
 */
DynYouthDeclaration.prototype.modify=function(){
 ...
 * 详情页面
 */
DynYouthDeclaration.prototype.detail=function(id,value){
	flowUtils.detail(id); 
};
/**
 * 打开高级查询框
 */
DynYouthDeclaration.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynYouthDeclaration.prototype.formValidate=function(form){
	form.validate({
		rules: {
			commandoesType:{
                maxlength: 50
 ...
 * 删除方法
 */
DynYouthDeclaration.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynYouthDeclaration.prototype.reLoad=function(){
	var searchdata = {
		keyWord: null,
 ...
 * 关闭对话框
 */
DynYouthDeclaration.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynYouthDeclaration.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynYouthDeclaration.prototype.searchByKeyWord =function(){
 ...
 * 根据流程状态查询
 */
DynYouthDeclaration.prototype.initWorkFlow = function(status){
	$('#bpmState').val(status);
	if(status == "start"){
		$("#dynYouthDeclaration_modify").show();
		$("#dynYouthDeclaration_del").show();
	}else{
		$("#dynYouthDeclaration_modify").hide();
		$("#dynYouthDeclaration_del").hide();
	}
	this.searchData();
};
/**
 * 隐藏查询框
 */
DynYouthDeclaration.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynYouthDeclaration.prototype.clearData =function(){
