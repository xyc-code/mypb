 ...
 */
function DynXfgChird(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynXfgChird.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynXfgChirdsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynXfgChird.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynXfgChird.prototype.modify=function(){
 ...
 * 详情页面
 */
DynXfgChird.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynXfgChird.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynXfgChird.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userPost:{
                maxlength: 50
 ...
 * 保存方法
 */
DynXfgChird.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynXfgChird.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynXfgChird.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynXfgChird.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynXfgChird.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynXfgChird.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynXfgChird.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynXfgChird.prototype.clearData =function(){
