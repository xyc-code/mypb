...
<body class="easyui-layout" fit="true">
			...
			<table class="tableForm" style="border:0;cellspacing:1;width:100%">
				<tr>
					<td width="50%" style="padding-right:4%;" align="right">
						<a href="javascript:void(0)" class="btn btn-primary form-tool-btn typeb btn-sm" role="button" title="保存" id="dynXfgFq_saveForm">保存</a>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynXfgFq.closeDialog("edit");
		}
		function saveForm(){
			...
			parent.dynXfgFq.save($('#form'),"edit");
		}
		//清空日期值
		...
		$(document).ready(function () {
			initDateSelect();
			parent.dynXfgFq.formValidate($('#form'));
			//保存按钮绑定事件
