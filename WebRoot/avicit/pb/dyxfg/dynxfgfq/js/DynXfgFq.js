 ...
 */
function DynXfgFq(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynXfgFq.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynXfgFqsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynXfgFq.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynXfgFq.prototype.modify=function(){
 ...
 * 详情页面
 */
DynXfgFq.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynXfgFq.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynXfgFq.prototype.formValidate=function(form){
	form.validate({
		rules: {
			fqCrerDateBegin:{
				dateISO:true
 ...
 * 保存方法
 */
DynXfgFq.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynXfgFq.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynXfgFq.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynXfgFq.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynXfgFq.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynXfgFq.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynXfgFq.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynXfgFq.prototype.clearData =function(){
