 ...
 */
function DynPartyXfg(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynPartyXfg.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynPartyXfgsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynPartyXfg.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynPartyXfg.prototype.modify=function(){
 ...
 * 详情页面
 */
DynPartyXfg.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynPartyXfg.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynPartyXfg.prototype.formValidate=function(form){
	form.validate({
		rules: {
			xfgGssjBegin:{
				dateISO:true
 ...
 * 保存方法
 */
DynPartyXfg.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynPartyXfg.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynPartyXfg.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynPartyXfg.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynPartyXfg.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynPartyXfg.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynPartyXfg.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynPartyXfg.prototype.clearData =function(){
