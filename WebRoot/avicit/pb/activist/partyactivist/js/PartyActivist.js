 ...
 */
function PartyActivist(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
PartyActivist.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getPartyActivistsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
        ...
        pager: "#partyActivistJqGridPager"
    });
    $(_self._jqgridToolbar).append($("#partyActivistTableToolbar"));
 ...
 * 添加页面
 */
PartyActivist.prototype.insert=function(){
 ...
 * 编辑页面
 */
PartyActivist.prototype.modify=function(){
 ...
 * 详情页面
 */
PartyActivist.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
PartyActivist.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
PartyActivist.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userIdAlias:{
				required:true
 ...
 * 保存方法
 */
PartyActivist.prototype.save=function(form,id,updateSubData,removeSubIds,updateSubDataExtr,removeSubIdsExtr){
	var _self = this;
	avicAjax.ajax({
		 ...
		 data : {
			...
			removeSubIds : removeSubIds,
			updateSubDataExtr : updateSubDataExtr,
			removeSubIdsExtr : removeSubIdsExtr
		 },
		 type : 'post',
		 dataType : 'json',
		 success : function(r){
 ...
 * 删除方法
 */
PartyActivist.prototype.del=function(){
	var _self = this;
	var rows = $(_self._datagridId).jqGrid('getGridParam','selarrrow');
	var ids = [];
	var l =rows.length;
 ...
 * 重载数据
 */
PartyActivist.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
PartyActivist.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
PartyActivist.prototype.searchData =function(){
 ...
 * 快速查询
 */
PartyActivist.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
PartyActivist.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
PartyActivist.prototype.clearData =function(){
 ...
 * 返回主表id
 */
PartyActivist.prototype.getSelectID=function(){
