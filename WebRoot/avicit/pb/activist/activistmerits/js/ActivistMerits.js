 ...
 */
function ActivistMerits(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel,pid){
 ...
 * 初始化操作
 */
ActivistMerits.prototype.init=function(){
	//console.log($(window).width());
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getActivistMeritssByPage.json',
    	postData : {
        	pid :_self._pid
        },
        mtype: 'POST',
        ...
        pager: "#activistMeritsJqGridPager"
    });
    $(_self._jqgridToolbar).append($("#activistMeritsTableToolbar"));
 ...
 * 根据外键ID加载数据
 */
ActivistMerits.prototype.loadByPid=function(pid){
	var _self = this;
	//将外键值放入高级查询form中
	$("#paId").val(pid);
	_self.reLoad(pid);
 ...
 * 添加页面
 */
ActivistMerits.prototype.insert=function(pid){
 ...
 * 编辑页面
 */
ActivistMerits.prototype.modify=function(){
 ...
 * 详情页面
 */
ActivistMerits.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
ActivistMerits.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
ActivistMerits.prototype.formValidate=function(form){
	form.validate({
		rules: {
			year:{
				dateISO:true
 ...
 * 保存方法
 */
ActivistMerits.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
ActivistMerits.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
ActivistMerits.prototype.reLoad=function(pid){
    if(pid != undefined){
        this._pid = pid;
    }
 ...
 * 关闭对话框
 */
ActivistMerits.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
ActivistMerits.prototype.searchData =function(){
 ...
 * 快速查询
 */
ActivistMerits.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
ActivistMerits.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
ActivistMerits.prototype.clearData =function(){
 ...
 * 返回主表id
 */
ActivistMerits.prototype.getSelectID=function(){
