 ...
 */
function ActivistAchievement(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel,pid){
 ...
 * 初始化操作
 */
ActivistAchievement.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getActivistAchievementsByPage.json',
    	postData : {
        	pid :_self._pid
        },
        mtype: 'POST',
        ...
        pager: "#activistAchievementJqGridPager"
    });
    $(_self._jqgridToolbar).append($("#activistAchievementTableToolbar"));
 ...
 * 根据外键ID加载数据
 */
ActivistAchievement.prototype.loadByPid=function(pid){
	var _self = this;
	//将外键值放入高级查询form中
	$("#paId").val(pid);
	_self.reLoad(pid);
 ...
 * 添加页面
 */
ActivistAchievement.prototype.insert=function(pid){
 ...
 * 编辑页面
 */
ActivistAchievement.prototype.modify=function(){
 ...
 * 详情页面
 */
ActivistAchievement.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
ActivistAchievement.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
ActivistAchievement.prototype.formValidate=function(form){
	form.validate({
		rules: {
			year:{
				dateISO:true
 ...
 * 保存方法
 */
ActivistAchievement.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
ActivistAchievement.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
ActivistAchievement.prototype.reLoad=function(pid){
    if(pid != undefined){
        this._pid = pid;
    }
 ...
 * 关闭对话框
 */
ActivistAchievement.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
ActivistAchievement.prototype.searchData =function(){
 ...
 * 快速查询
 */
ActivistAchievement.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
ActivistAchievement.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
ActivistAchievement.prototype.clearData =function(){
 ...
 * 返回主表id
 */
ActivistAchievement.prototype.getSelectID=function(){
