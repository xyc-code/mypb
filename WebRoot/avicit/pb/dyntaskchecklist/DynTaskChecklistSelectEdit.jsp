...
<body class="easyui-layout" fit="true" style="visibility: hidden;">
		...
		<form id='form'>
			...
			<table class="form_commonTable">
				...
				<tr>
					...
					<th width="10%"
						style="word-break: break-all; word-warp: break-word;">任务状态:</th>
					<td width="39%">
						<pt6:h5select css_class="easyui-combobox"  name="attribute01" id="attribute01" title="${dynTaskChecklistDTO.attribute01} "
		   isNull="true" lookupCode="ATTRIBUTE_01"  />
					</td>
				</tr>
				<%-- <tr>
					<th width="10%"
	...
	<script>
	var var1;
	$("#attribute01").val('${dynTaskChecklistDTO.attribute01}')
	</script>
</body>
</html>