...
<body class="easyui-layout" fit="true">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="numberVotes" id="numberVotes" data-min="-99999999999999999999999999999999999999" data-max="99999999999999999999999999999999999999" data-step="1" data-precision="0" value="<c:out value='${dynSubHjxjdydh3DTO.numberVotes}'/>">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynSubHjxjdydh3.closeDialog("edit");
		}
		function saveForm(){
			...
			parent.dynSubHjxjdydh3.save($('#form'),"edit");
		}
		//清空日期值
