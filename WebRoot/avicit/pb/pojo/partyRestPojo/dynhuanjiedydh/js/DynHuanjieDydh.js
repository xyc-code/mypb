 ...
 */
function DynHuanjieDydh(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynHuanjieDydh.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynHuanjieDydhsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynHuanjieDydh.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynHuanjieDydh.prototype.modify=function(){
 ...
 * 详情页面
 */
DynHuanjieDydh.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynHuanjieDydh.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynHuanjieDydh.prototype.formValidate=function(form){
	form.validate({
		rules: {
			deptName:{
                maxlength: 1000
 ...
 * 保存方法
 */
DynHuanjieDydh.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynHuanjieDydh.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynHuanjieDydh.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynHuanjieDydh.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynHuanjieDydh.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynHuanjieDydh.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynHuanjieDydh.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynHuanjieDydh.prototype.clearData =function(){
