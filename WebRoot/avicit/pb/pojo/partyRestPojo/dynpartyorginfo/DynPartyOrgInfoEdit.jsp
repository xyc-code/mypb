...
<body class="easyui-layout" fit="true">
    			...
    			<tr>
					...
					<td>
						<div class="input-group input-group-sm spinner" data-trigger="spinner">
							<input  class="form-control"  type="text" name="sessionId" id="sessionId" data-min="-99999" data-max="99999" data-step="1" data-precision="0" value="<c:out value='${dynPartyOrgInfoDTO.sessionId}'/>">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynPartyOrgInfo.closeDialog("edit");
		}
		function saveForm(){
			...
			parent.dynPartyOrgInfo.save($('#form'),"edit");
		}
		//清空日期值
