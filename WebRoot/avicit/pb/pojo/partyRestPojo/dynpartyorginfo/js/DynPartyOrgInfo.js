 ...
 */
function DynPartyOrgInfo(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynPartyOrgInfo.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynPartyOrgInfosByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynPartyOrgInfo.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynPartyOrgInfo.prototype.modify=function(){
 ...
 * 详情页面
 */
DynPartyOrgInfo.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynPartyOrgInfo.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynPartyOrgInfo.prototype.formValidate=function(form){
	form.validate({
		rules: {
			sessionName:{
                maxlength: 225
 ...
 * 保存方法
 */
DynPartyOrgInfo.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynPartyOrgInfo.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynPartyOrgInfo.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynPartyOrgInfo.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynPartyOrgInfo.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynPartyOrgInfo.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynPartyOrgInfo.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynPartyOrgInfo.prototype.clearData =function(){
