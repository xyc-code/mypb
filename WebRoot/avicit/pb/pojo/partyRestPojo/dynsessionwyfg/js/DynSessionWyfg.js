 ...
 */
function DynSessionWyfg(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynSessionWyfg.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynSessionWyfgsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynSessionWyfg.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynSessionWyfg.prototype.modify=function(){
 ...
 * 详情页面
 */
DynSessionWyfg.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynSessionWyfg.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynSessionWyfg.prototype.formValidate=function(form){
	form.validate({
		rules: {
			userPost:{
                maxlength: 50
 ...
 * 保存方法
 */
DynSessionWyfg.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynSessionWyfg.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynSessionWyfg.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynSessionWyfg.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynSessionWyfg.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynSessionWyfg.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynSessionWyfg.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynSessionWyfg.prototype.clearData =function(){
