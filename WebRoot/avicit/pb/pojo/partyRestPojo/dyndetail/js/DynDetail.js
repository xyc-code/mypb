 ...
 */
function DynDetail(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynDetail.prototype.init=function(){
	var _self = this;
	var postData = {param:JSON.stringify({fkSubId:skId})}
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynDetailsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynDetail.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynDetail.prototype.modify=function(){
 ...
 * 详情页面
 */
DynDetail.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynDetail.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynDetail.prototype.formValidate=function(form){
	form.validate({
		rules: {
			fkSubId:{
                maxlength: 50
 ...
 * 保存方法
 */
DynDetail.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynDetail.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynDetail.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynDetail.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynDetail.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynDetail.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynDetail.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynDetail.prototype.clearData =function(){
