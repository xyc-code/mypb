...
<html>
<head>
<!-- ControllerPath = "avicit/pb/pojo/partyRestPojo/dynDetail/dynDetailController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynDetail.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.dynDetail.save($('#form'),"insert");
		}
		//清空日期值
