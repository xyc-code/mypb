 ...
 */
function DynJwDydhzb(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynJwDydhzb.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynJwDydhzbsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynJwDydhzb.prototype.insert=function(){
 ...
 * 编辑页面
 */
DynJwDydhzb.prototype.modify=function(){
 ...
 * 详情页面
 */
DynJwDydhzb.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
DynJwDydhzb.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynJwDydhzb.prototype.formValidate=function(form){
	form.validate({
		rules: {
			post:{
                maxlength: 255
 ...
 * 保存方法
 */
DynJwDydhzb.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynJwDydhzb.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynJwDydhzb.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynJwDydhzb.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynJwDydhzb.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynJwDydhzb.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynJwDydhzb.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynJwDydhzb.prototype.clearData =function(){
