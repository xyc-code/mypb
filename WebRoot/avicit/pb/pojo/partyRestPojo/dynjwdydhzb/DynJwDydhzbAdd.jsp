...
<html>
<head>
<!-- ControllerPath = "avicit/pb/pojo/partyRestPojo/dynJwDydhzb/dynJwDydhzbController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
			...
			<table class="tableForm" style="border:0;cellspacing:1;width:100%">
				<tr>
					<td width="50%" style="padding-right:4%;" align="right">
						<a href="javascript:void(0)" class="btn btn-primary form-tool-btn typeb btn-sm" role="button" title="保存" id="dynJwDydhzb_saveForm">保存</a>
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynJwDydhzb.closeDialog("insert");
		}
		...
		function saveForm(){
	        ...
	        //限制保存按钮多次点击
  		 	$('#dynJwDydhzb_saveForm').addClass('disabled').unbind("click");	
			parent.dynJwDydhzb.save($('#form'),"insert");
		}
		//清空日期值
		...
		$(document).ready(function () {
			initDateSelect();
			parent.dynJwDydhzb.formValidate($('#form'));
			//保存按钮绑定事件
			$('#dynJwDydhzb_saveForm').bind('click', function(){
				saveForm();
			}); 
