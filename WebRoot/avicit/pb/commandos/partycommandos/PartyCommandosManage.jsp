...
<%--				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_partyCommandos_button_modify" permissionDes="编辑">--%>
<%--					<a id="partyCommandos_modify" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="编辑"><i class="icon icon-daochu"></i> 编辑</a>--%>
<%--				</sec:accesscontrollist>--%>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_partyCommandos_button_edit" permissionDes="编辑">
					<a id="partyCommandos_modify" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="编辑"><i class="fa fa-file-text-o"></i> 编辑</a>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_partyCommandos_button_tj" permissionDes="统计">
					<a id="partyCommandos_tj" href="javascript:void(0)" class="btn btn-primary form-tool-btn btn-sm" role="button" title="统计"><i class="icon icon-daochu"></i> 统计</a>
				</sec:accesscontrollist>
			</div>
...
function formatValue(cellvalue, options, rowObject) {
		return '<a href="javascript:void(0);" onclick="partyCommandos.detail(\''+rowObject.id+'\');">'+cellvalue+'</a>';
 }
...
$(document).ready(function () {
	var partyMilepostDataGridColModel =  [
		...
		{ label : '上报人', name : 'userIdAlias',formatter:formatValuePartyMilepost,width: 150,align: 'right'},
		...
		{ label : '上报人所在党支部', name : 'partyId',width: 150,align: 'left'},
	...
	var dataGridColModel =  [
		{ label : 'id', name : 'id', key : true, width : 75, hidden : true},
		{ label : '申请人', name : 'userIdAlias',formatter:formatValue,width: 150,align: 'right'},
		{ label : '申请部门', name : 'deptIdAlias',width: 150,align: 'right'},
		...
		{ label : '攻关任务简介', name : 'keyProblems',width: 150,align: 'left'},
	...
	//实例化主表对象
	partyCommandos = new PartyCommandos('partyCommandosJqGrid','${url}','searchDialog','form','partyCommandos_keyWord',searchNames,dataGridColModel);
	...
	//查询统计绑定事件
	$('#partyCommandos_tj').bind('click', function(){
		partyCommandos.tj();
	});
	//打开高级查询框
