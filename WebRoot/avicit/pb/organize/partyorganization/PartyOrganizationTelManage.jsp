...
<html>
<head>
<!-- ControllerPath = "platform/avicit/pb/organize/partyOrganization/partyOrganizationController/toPartyOrganizationTelManage" -->
<title>管理</title>
...
<div id="partyOrganMemberSearchDialog"
	...
	<form id="partyOrganMemberForm" style="padding: 10px;">
		...
		<table class="form_commonTable">
			...
			<th width="10%"><label for="attribute10">联系电话:</label>
				</th>
				<td width="39%">	
...
<script
	src="avicit/pb/organize/partyorganization/js/PartyOrganizationTel.js?v=${jsversion}"
	type="text/javascript"></script>
<script
	src="avicit/pb/organize/partyorganmember/js/PartyOrganMemberTel.js?v=${jsversion}"
	type="text/javascript"></script>
<script type="text/javascript">
	...
	function formatValuePartyOrganMemberEdit(cellvalue, options, rowObject) {
		var gridUserId = rowObject.userId;
		if(userId == gridUserId || userId == '1'){
			return '<a href="javascript:void(0);" onclick="partyOrganMember.modify(\''
			+ rowObject.id + '\');">编辑</a>';
		}else{
			return '';
		}
	...
	$(document)
			.ready(
					function() {
						...
						{
							label : '编辑',
							formatter : formatValuePartyOrganMemberEdit,
							width : 150,
							align : 'center'
						}, 
