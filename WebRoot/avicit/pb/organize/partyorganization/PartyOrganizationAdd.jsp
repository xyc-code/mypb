...
<html>
<head>
<!-- ControllerPath = "avicit/pb/organize/partyOrganization/partyOrganizationController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<table class="form_commonTable" width="100%">
				<tr>
				<th width="15%">
					<label for="partyCode">党组织编号:</label>
				</th>
				<td width="34%">
					<input class="form-control input-sm" type="text" name="partyCode"  id="partyCode" />
				</td>
				<th width="15%">
				...
				<tr>
				<th>
					<label for="parentId">上级党组织:</label>
				</th>
				<td>
					<input type="hidden" name="parentId" id="parentId" value="<c:out  value='${parentId}'/>" />
					<input class="form-control" type="text" id="parentPartyName" name="parentPartyName" readonly="readonly" value="<c:out  value='${parentPartyName}'/>"/>
				</td>
				<th>
				...
				<td>
							<pt6:h5radio css_class="radio-inline"  name="attribute01"  title=""  canUse="0" lookupCode="PARTY_ORG_TYPE" defaultValue="1" />
				</td>
				<th width="15%"><label for="userDeptAlias">关联部门:</label></th>
		 <td width="34%">
			 <div class="input-group  input-group-sm">
				<input type="hidden"  id="attribute02" name="attribute02" >
				<input class="form-control" placeholder="请选择部门"  type="text" id="attribute03" name="attribute03" >
	...
	var deptInfoAll = {
		...
		function closeForm(){
			parent.partyOrganization.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.partyOrganization.save($('#form'),"insert");
		}
