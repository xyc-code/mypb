...
<html>
<head>
<!-- ControllerPath = "avicit/pb/organize/partyOrganMember/partyOrganMemberController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<input type="hidden" name="partyId" id="partyId" value="${pid}" />
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.partyOrganMember.closeDialog("insert");
		}
		...
		function saveForm(){
	        ...
	        $("#partyId").val(parent.partyOrganMember.pid);
	        //限制保存按钮多次点击
  		 	$('#partyOrganMember_saveForm').addClass('disabled').unbind("click");	
			parent.partyOrganMember.save($('#form'),"insert");
		}
