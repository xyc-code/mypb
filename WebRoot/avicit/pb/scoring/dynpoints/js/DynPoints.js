 ...
 */
function DynPoints(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
 ...
 * 初始化操作
 */
DynPoints.prototype.init=function(){
	var _self = this;
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getDynPointssByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
 ...
 * 添加页面
 */
DynPoints.prototype.insert=function(){
	this.insertIndex = layer.open({
	    ...
	    content: 'platform/avicit/pb/scoring/dynPoints/dynPointsController/toMyChart' 
	});
};
/**
 * 编辑页面
 */
DynPoints.prototype.modify=function(){
 ...
 * 详情页面
 */
DynPoints.prototype.detail=function(id){
	this.detailIndex = layer.open({
	    ...
	    skin: 'bs-modal', // bootstrap 风格皮肤 需加载skin
        maxmin: false, //开启最大化最小化按钮
	    content: "avicit/pb/scoring/integral/integralController/toIntegralManage?id="+id
	}); 
};
/**
 * 打开高级查询框
 */
DynPoints.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
DynPoints.prototype.formValidate=function(form){
	form.validate({
		rules: {
			draftsmanAlias:{
			},
 ...
 * 保存方法
 */
DynPoints.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 删除方法
 */
DynPoints.prototype.del=function(){
	var _self = this;
 ...
 * 重载数据
 */
DynPoints.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
DynPoints.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
DynPoints.prototype.searchData =function(){
 ...
 * 快速查询
 */
DynPoints.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
DynPoints.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
DynPoints.prototype.clearData =function(){
