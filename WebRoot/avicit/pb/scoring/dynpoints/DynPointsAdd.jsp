...
<html>
<head>
<!-- ControllerPath = "avicit/pb/scoring/dynPoints/dynPointsController/operation/Add/null" -->
<title>添加</title>
...
<body class="easyui-layout" fit="true">
	<div data-options="region:'center',split:true,border:false">
		<form id='form'>
			...
			<table class="form_commonTable">
				<tr>
					<th width="15%">
						<label for="draftsmanAlias">拟稿人:</label>
					</th>
					<td width="34%">
						<div class="input-group input-group-sm">
							<input type="hidden"  id="draftsman" name="draftsman">
							<input class="form-control" placeholder="请选择用户" type="text" id="draftsmanAlias" name="draftsmanAlias">
					...
					<th width="15%">
						<label for="draftingTime">拟稿时间:</label>
					</th>
					<td width="34%">
						<div class="input-group input-group-sm">
							<input class="form-control date-picker" type="text" name="draftingTime" id="draftingTime" />
	...
	<script type="text/javascript">
		...
		function closeForm(){
			parent.dynPoints.closeDialog("insert");
		}
		...
		function saveForm(){
			...
			parent.dynPoints.save($('#form'),"insert");
		}
		//清空日期值
