 ...
 */
function IntegralEdit(datagrid,url,dataGridColModel,pid){
 ...
 * 初始化操作
 */
IntegralEdit.prototype.init=function(){
	var _self = this;
	...
	_self.lengthValidFiled.push('punishContent');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('惩处减分备注');
	_self.lengthValidFiled.push('foundationsContent');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('基础分扣分备注');
	_self.lengthValidFiled.push('personalContent');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('履职分备注');
	_self.lengthValidFiled.push('rewardContent');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('奖励加分备注');
	_self.lengthValidFiled.push('data1');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('姓名');
	_self.lengthValidFiled.push('userId');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('用户id');
	_self.lengthValidFiled.push('sex');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('性别');
	_self.lengthValidFiled.push('partyId');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('党支部id');
	_self.lengthValidFiled.push('partyName');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('党支部名称');
	_self.lengthValidFiled.push('idNumber');
	_self.lengthValidFiledSize.push(255);
	_self.lengthValidFiledComment.push('身份证号');
};
/**
 * 添加页面
 */
...
IntegralEdit.prototype.insert=function(){
	//去除暂无数据的图片
	$("#subEmptyRecords").hide();
	var _self = this;
 ...
 * @param 
 */
IntegralEdit.prototype.nullvalid = function(data,item,nullfiled,notnullFiledComment){
	var msg = "";
 ...
 * @param 
 */
IntegralEdit.prototype.lengthvalid = function(data,item,lengthValidFiled,lengthValidFiledComment,lengthValidFiledSize){
	var msg = "";
	$.each(data,function(i,dataitem){
 ...
 * 删除
 */
IntegralEdit.prototype.del = function(){
	var _self = this;
 ...
 * 重载数据
 */
IntegralEdit.prototype.reLoad = function(pid){
	if(pid != undefined){
		this._pid = pid;
	}
 ...
 *  子表校验
 */
IntegralEdit.prototype.dataValidte = function(){
	var _self = this;
	var $info = $(_self._datagridId).jqGrid('endEditCell');
	if($info[0].flag){
	   layer.alert("非法含有JS脚本完整标签");
 ...
 *  获取编辑表格数据
 */
IntegralEdit.prototype.getEditData = function(){
	var _self = this;
	var data = $(_self._datagridId).jqGrid('getChangedCells');
