...
<div id="tableToolbar" class="toolbar">
    ...
    <div class="toolbar-right">
	    ...
	    <div class="input-group form-tool-search">
     		<input type="text" name="integral_keyWord" id="integral_keyWord" style="width:240px;" class="form-control input-sm" placeholder="请输入查询条件">
...
$(document).ready(function () {
	var dataGridColModel =  [
		...
		{ label : '党支部名称', name : 'partyName', width: 150, align: 'left'},
		{ label : '部门', name : 'map.userDeptName' ,width:150,align:'left',hidden : true },
		{ label : '姓名', name : 'data1', width: 150, align: 'left'},
		{ label : '用户id', name : 'userId', width: 150, align: 'left', hidden : true},
		{ label : '性别', name : 'sex',hidden : true, width: 150, align: 'left'},
		{ label : '员工编号 ',hidden : true, name : 'map.userNO' ,width:150,align:'left' },
		{ label : '一季度基础分扣分', hidden : true,name : 'map.oneFoundations' ,width:150,align:'left' },
		{ label : '一季度基础分备注',hidden : true, name : 'map.oneFoundationsContent' ,width:150,align:'left' },
		{ label : '一季度履职分', hidden : true,name : 'map.onePersonal' ,width:150,align:'left' },
		{ label : '一季度履职分备注',hidden : true, name : 'map.onePersonalContent' ,width:150,align:'left' },
		{ label : '一季度奖励加分',hidden : true, name : 'map.oneReward' ,width:150,align:'left' },
		{ label : '一季度奖励加分备注',hidden : true, name : 'map.oneRewardContent' ,width:150,align:'left' },
		{ label : '一季度惩处减分',hidden : true, name : 'map.onePunish' ,width:150,align:'left' },
		{ label : '一季度惩处减分备注',hidden : true, name : 'map.onePunishContent' ,width:150,align:'left' },
		{ label : '一季度合计得分', formatter:formatDateForHref, name : 'map.oneContent' ,width:150,align:'left' },
		{ label : '二季度基础分扣分',hidden : true, name : 'map.twoFoundations' ,width:150,align:'left' },
		{ label : '二季度基础分扣分',hidden : true, name : 'map.twoFoundationsContent' ,width:150,align:'left' },
		{ label : '二季度履职分',hidden : true, name : 'map.twoPersonal' ,width:150,align:'left' },
		{ label : '二季度履职分',hidden : true, name : 'map.twoPersonalContent' ,width:150,align:'left' },
		{ label : '二季度奖励加分',hidden : true, name : 'map.twoReward' ,width:150,align:'left' },
		{ label : '二季度奖励加分', hidden : true,name : 'map.twoRewardContent' ,width:150,align:'left' },
		{ label : '二季度惩处减分',hidden : true, name : 'map.twoPunish' ,width:150,align:'left' },
		{ label : '二季度惩处减分',hidden : true, name : 'map.twoPunishContent' ,width:150,align:'left' },
		{ label : '二季度合计得分',formatter:formatDateForHref, name : 'map.twoContent' ,width:150,align:'left' },
		{ label : '三季度基础分扣分',hidden : true, name : 'map.threeFoundations' ,width:150,align:'left' },
		{ label : '三季度基础分扣分',hidden : true, name : 'map.threeFoundationsContent' ,width:150,align:'left' },
		{ label : '三季度履职分', hidden : true,name : 'map.threePersonal' ,width:150,align:'left' },
		{ label : '三季度履职分',hidden : true, name : 'map.threePersonalContent' ,width:150,align:'left' },
		{ label : '三季度奖励加分',hidden : true, name : 'map.threeReward' ,width:150,align:'left' },
		{ label : '三季度奖励加分',hidden : true, name : 'map.threeRewardContent' ,width:150,align:'left' },
		{ label : '三季度惩处减分',hidden : true, name : 'map.threePunish' ,width:150,align:'left' },
		{ label : '三季度惩处减分', hidden : true,name : 'map.threePunishContent' ,width:150,align:'left' },
		{ label : '三季度合计得分',formatter:formatDateForHref, name : 'map.threeContent' ,width:150,align:'left' },
		{ label : '四季度基础分扣分',hidden : true, name : 'map.fourFoundations' ,width:150,align:'left' },
		{ label : '四季度基础分扣分',hidden : true, name : 'map.fourFoundationsContent' ,width:150,align:'left' },
		{ label : '四季度履职分',hidden : true, name : 'map.fourPersonal' ,width:150,align:'left' },
		{ label : '四季度履职分',hidden : true, name : 'map.fourPersonalContent' ,width:150,align:'left' },
		{ label : '四季度奖励加分',hidden : true, name : 'map.fourReward' ,width:150,align:'left' },
		{ label : '四季度奖励加分',hidden : true, name : 'map.fourRewardContent' ,width:150,align:'left' },
		{ label : '四季度惩处减分',hidden : true, name : 'map.fourPunish' ,width:150,align:'left' },
		{ label : '四季度惩处减分',hidden : true, name : 'map.fourPunishContent' ,width:150,align:'left' },
		{ label : '四季度合计得分',formatter:formatDateForHref, name : 'map.fourContent' ,width:150,align:'left' },
