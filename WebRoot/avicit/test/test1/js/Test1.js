 ...
 */
function Test1(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel,pid){
...
Test1.prototype.init=function(){
	...
	$(_self._datagridId).jqGrid({
        ...
        pager: "#test1JqGridPager"
    });
    $(_self._jqgridToolbar).append($("#test1TableToolbar"));
 ...
 * 根据外键ID加载数据
 */
Test1.prototype.loadByPid=function(pid){
	var _self = this;
	//将外键值放入高级查询form中
	$("#testId").val(pid);
	_self.reLoad(pid);
 ...
 * 添加页面
 */
Test1.prototype.insert=function(pid){
 ...
 * 编辑页面
 */
Test1.prototype.modify=function(){
 ...
 * 详情页面
 */
Test1.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
Test1.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
Test1.prototype.formValidate=function(form){
	form.validate({
		rules: {
			test2:{
                maxlength: 50
 ...
 * 保存方法
 */
Test1.prototype.save=function(form,id){
	var _self = this;
	avicAjax.ajax({
 ...
 * 重载数据
 */
Test1.prototype.reLoad=function(pid){
    if(pid != undefined){
        this._pid = pid;
    }
 ...
 * 关闭对话框
 */
Test1.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
Test1.prototype.searchData =function(){
 ...
 * 快速查询
 */
Test1.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
Test1.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
Test1.prototype.clearData =function(){
 ...
 * 返回主表id
 */
Test1.prototype.getSelectID=function(){
