...
function saveForm(aftercallback) {
    ...
    var processDef = new FlowListEditorBySec("test3Test",JSON.stringify(jsonData));
    ...
    if(saveFlag){
        FlowListEditorBySec.prototype.doStart = function(pdId){
            ...
            var url = 'avicit/test/Test3TestController/insertBpmTest3Test?formInfoId=402811817e438190017e43856fc00150&tableId='+tableId+'&defineId='+pdId+'&formcode=test3Test';
            avicAjax.ajax({
                url: url,
                data : jsonData,
                type : 'post',
