...
<body class="easyui-layout" fit="true">
	...
	<script type="text/javascript">
		...
		function saveForm(){
			...
			parent.test.save($('#form'), "edit", test1Data, JSON.stringify(test1Edit.removeSubIds));
		}
		...
		$(document).ready(function () {
			...
			test1Edit= new Test1Edit('test1EditJqGrid','${test1EditUrl}',test1DataEditGridColModel,'${testDTO.id}');
