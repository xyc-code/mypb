 ...
 */
function Test(datagrid,url,searchD,form,keyWordId,searchNames,dataGridColModel){
...
Test.prototype.init=function(){
	...
	$(_self._datagridId).jqGrid({
    	url: _self.getUrl()+'getTestsByPage.json',
        mtype: 'POST',
        datatype: "json",
        toolbar: [true,'top'],
        ...
        pager: "#testJqGridPager"
    });
    $(_self._jqgridToolbar).append($("#testTableToolbar"));
 ...
 * 详情页面
 */
Test.prototype.detail=function(id){
 ...
 * 打开高级查询框
 */
Test.prototype.openSearchForm = function(searchDiv){
	var _self = this;
 ...
 */
Test.prototype.formValidate=function(form){
	form.validate({
		rules: {
			test1:{
                maxlength: 50
 ...
 * 保存方法
 */
Test.prototype.save=function(form,id,updateSubData,removeSubIds){
	var _self = this;
	avicAjax.ajax({
 ...
 * 重载数据
 */
Test.prototype.reLoad=function(){
 ...
 * 关闭对话框
 */
Test.prototype.closeDialog=function(id){
	if(id == "insert"){
 ...
 * 后台查询	
 */
Test.prototype.searchData =function(){
 ...
 * 快速查询
 */
Test.prototype.searchByKeyWord =function(){
 ...
 * 隐藏查询框
 */
Test.prototype.hideSearchForm =function(){
	layer.close(searchDialogindex);
};
/**
 * 清空查询条件
 */
Test.prototype.clearData =function(){
 ...
 * 返回主表id
 */
Test.prototype.getSelectID=function(){
