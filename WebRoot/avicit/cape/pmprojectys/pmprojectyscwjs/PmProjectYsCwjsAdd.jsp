...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyscwjs/pmProjectYsCwjsController/operation/Add/null" -->
<title>添加</title>
			...
			<input type="hidden" id="id" name="id" />
				<table class="form_commonTable">
					<tr>
								...
								审计时间:</th>
								 								   								    <td width="39%">
								   								 																											<input title="审计时间" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="sjDate" id="sjDate"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
								...
								批复文件名称:</th>
								 								   								    <td width="39%">
								   								 																											<input title="批复文件名称" class="inputbox easyui-validatebox" data-options="validType:'maxLength[2000]'" style="width: 99%;" type="text" name="pfFileName" id="pfFileName"/>
																									</td>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
																
								批复时间:</th>
								 								   								    <td width="39%">
								   								 																									  		<input title="批复时间" class="easyui-datetimebox"  editable="false" style="width: 99%;" type="text" name="pfDate" id="pfDate"/>
								  																	</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
								...
								批复文号:</th>
								 								   								    <td width="39%">
								   								 																											<input title="批复文号" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="pfNo" id="pfNo"/>
																									</td>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
																
								参与单位:</th>
								 								   								    <td width="39%">
								   								 																											<input title="参与单位" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="compDept" id="compDept"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
								...
								参与人员:</th>
								 								   								    <td width="39%">
								   								 																											<input title="参与人员" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="compUser" id="compUser"/>
																									</td>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
																
								审计结果:</th>
								 								   								    <td width="39%">
								   								 														 		     <textarea title="审计结果"  name="sjResult"   id="sjResult" class="textareabox"  style="width:99%;" data-size="2000"></textarea>
...
<script type="text/javascript">
	...
	function closeForm(){
		parent.pmProjectYsCwjs.closeDialog("#insert");
	}
	...
	function callback(id){
		...
		if(flag == 0){
			if(issubmitflow){
				parent.pmProjectYsCwjs.saveFormAndStartFlow(serializeObject($('#form')), "#insert");
			}else{
				//parent.pmProjectYsCwjs.HidMask();
			}
		}
	}
