...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyscwjs/pmProjectYsCwjsController/operation/Detail/id" -->
<title>详情</title>
...
<div data-options="region:'center',split:true,border:false">
				...
				<table class="form_commonTable">
					<tr>
									  																...
									  																密级:</label></th>
														 			 									  ...
														 			 									  <pt6:syslookup name="secretLevel"  title="密级" isNull="true" id ="secretLevel"  lookupCode="PLATFORM_FILE_SECRET_LEVEL" defaultValue='${pmProjectYsCwjsDTO.secretLevel}' dataOptions="disabled:true,editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
									  </pt6:syslookup> 
									...
									<tr>
									  																...
									  																审计时间:</label></th>
																											...
																											<input title="审计时间"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="sjDate" id="sjDate"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									...
									<tr>
																	   ...
																	   <textarea title="审计结果" name="sjResult"   id="sjResult"  disabled  class="textareabox" style="width:99%;" data-size="2000">${pmProjectYsCwjsDTO.sjResult}</textarea>		 
																</td>
																	</tr>
									<tr>
															   							   							   													 					  											  											  											  											  											  											  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
	...
	<script type="text/javascript">
		...
		$(function() {
	                    ...
	                    $('#pfDate').datetimebox('setValue', parserColumnTime("${pmProjectYsCwjsDTO.pfDate}").format("yyyy-MM-dd hh:MM:ss"));
	                }
	            	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	        	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        			//初始化页面值
			$.ajax({
				url : 'platform/cape/pmprojectys/pmprojectyscwjs/pmProjectYsCwjsController/operation/toDetailJsp.json',
				data : {
					id : formId
				},
				type : 'post',
		...
		if (textareaElement.length > 0) {
		   ...
		   var textareaId = "";
			...
			$.ajax({
				url : "platform/cape/pmprojectys/pmprojectyscwjs/pmProjectYsCwjsController/operation/save",
				data : {
					data : dataVo
				},
				type : 'post',
