...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyscwjs/pmProjectYsCwjsController/toPmProjectYsCwjsManage" -->
<title>管理</title>
<base href="<%=ViewUtil.getRequestPath(request)%>">
<jsp:include page="/avicit/platform6/component/common/BpmJsInclude.jsp"></jsp:include>
<jsp:include page="/avicit/platform6/modules/system/commonpopup/commonSelectionHead.jsp"></jsp:include>
<script src="avicit/cape/pmprojectys/pmprojectyscwjs/js/PmProjectYsCwjs.js" type="text/javascript"></script>
<script src="static/js/platform/component/sfn/SelfDefiningQuery.js" type="text/javascript"></script>
<script type="text/javascript">
		var pmProjectYsCwjs;
		$(function(){
						pmProjectYsCwjs= new PmProjectYsCwjs('dgPmProjectYsCwjs','${url}','searchDialog','pmProjectYsCwjs');
			pmProjectYsCwjs.init();
		...
		var array=[];
			...
			pmProjectYsCwjs.searchDataBySfn(param);
			});
		function formatDate(value,row,index){
			return pmProjectYsCwjs.format(value);
		}
		function formatDateTime(value,row,index){
			return pmProjectYsCwjs.formatDateTime(value);
		}
		
		function formatDateForHref(value,row,index){
		    var thisDate = pmProjectYsCwjs.format(value);
			return "<a href='javascript:void(0);' onclick='pmProjectYsCwjs.detail(\""+row.id+"\",\""+thisDate+"\");'>"+thisDate+"</a>";
		}
		function formatTimeForHref(value,row,index){
			var thisTime = pmProjectYsCwjs.formatDateTime(value);
			return "<a href='javascript:void(0);' onclick='pmProjectYsCwjs.detail(\""+row.id+"\",\""+thisTime+"\");'>"+thisTime+"</a>";
		}
		
		function formatHref(value,row,inde){
			return "<a href='javascript:void(0);' onclick='pmProjectYsCwjs.detail(\""+row.id+"\",\""+value+"\");'>"+value+"</a>";
		}
							 					 			  		       function formatTyForHref(value,row,index){
		          var thisTongY = Platform6.fn.lookup.formatLookupType(value, pmProjectYsCwjs.secretLevel);
			      return "<a href='javascript:void(0);' onclick='pmProjectYsCwjs.detail(\""+row.id+"\",\""+thisTongY+"\");'>"+thisTongY+"</a>";
		       }
...
<body class="easyui-layout" fit="true" style="visibility:hidden;">
	...
	<div data-options="region:'center'" style="background:#ffffff;">
		<div id="toolbarPmProjectYsCwjs" class="datagrid-toolbar">
		    		 	<table>
		 		<tr>
		 		<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_bpmAll" permissionDes="全部文件">
					<td width="120px;">
						...
						<div id="allmm" style="width:105px;">
							<div id='all_start' name="bpm_all_start" onclick="pmProjectYsCwjs.initWorkFlow('start','all')">拟稿中</div>
							<div id='all_active' name="bpm_all_active" onclick="pmProjectYsCwjs.initWorkFlow('active','all')">流转中</div>
							<div id='all_ended' name="bpm_all_ended" onclick="pmProjectYsCwjs.initWorkFlow('ended','all')">已完成</div>
							<div id='all_all' name="bpm_all_all" onclick="pmProjectYsCwjs.initWorkFlow('all','all')">全部文件</div>
						</div>
					</td>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_bpmMyFile" permissionDes="我的文件">
					<td width="120px;">
						...
						<div id="mymm" style="width:105px;">
							<div id='my_start' name="bpm_my_start"  onclick="pmProjectYsCwjs.initWorkFlow('start','my')">我的拟稿</div>
							<div id='my_active' name="bpm_my_active" onclick="pmProjectYsCwjs.initWorkFlow('active','my')">我的流转</div>
							<div id='my_ended' name="bpm_my_ended" onclick="pmProjectYsCwjs.initWorkFlow('ended','my')">我的完成</div>
							<div id='my_all' name="bpm_my_all" onclick="pmProjectYsCwjs.initWorkFlow('all','my')">我的全部</div>
						</div>
					</td>
				</sec:accesscontrollist>
								<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_add" permissionDes="添加">
					<td><a class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="pmProjectYsCwjs.insert();" href="javascript:void(0);">添加</a></td>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_edit" permissionDes="编辑">
					<td id="tool_edit_td"><a class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="pmProjectYsCwjs.modify();" href="javascript:void(0);">编辑</a></td>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_delete" permissionDes="删除">
					<td id="tool_del_td"><a class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="pmProjectYsCwjs.del();" href="javascript:void(0);">删除</a></td>
				</sec:accesscontrollist>
								<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_query" permissionDes="查询">
					<td><a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="pmProjectYsCwjs.openSearchForm();" href="javascript:void(0);">查询</a></td>
				</sec:accesscontrollist>
				<sec:accesscontrollist hasPermission="3" domainObject="formdialog_pmProjectYsCwjs_button_seniorquery" permissionDes="高级查询">
					<td><a class="easyui-linkbutton" iconCls="icon-search" plain="true" onclick="selfDefQury.show();" href="javascript:void(0);">高级查询</a></td> 
				</sec:accesscontrollist>		
				</tr>
		 	</table>
		 			 		 	</div>
	 	<table id="dgPmProjectYsCwjs"
			data-options="
				fit: true,
				border: false,
				rownumbers: true,
				...
				fitColumns: true,
				autoRowHeight: false,
				toolbar:'#toolbarPmProjectYsCwjs',
				idField :'id',
				singleSelect: true,
				checkOnSelect: true,
				selectOnCheck: false,
				...
				<tr>
																																		<th data-options="field:'id', halign:'center',checkbox:true" width="220">主键</th>
																																																																			<th data-options="field:'secretLevel', halign:'center',formatter:formatTyForHref" width="220">密级</th>
																																																																											...
																																																																											<th data-options="field:'sjDate', halign:'center'" width="220">审计时间</th>
																																																																											...
																																																																											<th data-options="field:'compUser', halign:'center'" width="220">参与人员</th>
																																																																	 										...
																																																																	 										<th data-options="field:'sjResult',align:'center'" width="220">审计结果</th>		
		...
		<form id="pmProjectYsCwjs">
					...
					<tr>
									...
									<tr>
										    								 ...
										    								 <td width="39%"><input class="easyui-validatebox"  style="width: 99%;" type="text"  title="任务名称" name="taskName"/></td>
																								   							  						 						   																							  						  															<th width="10%" style="word-break:break-all;word-warp:break-word;">审计时间:</th>
										    								 <td width="39%"><input class="easyui-validatebox"  style="width: 99%;" type="text"  title="审计时间" name="sjDate"/></td>
																										</tr>
									<tr>
									...
									<tr>
															   							  						 						   																							  						  															<th width="10%" style="word-break:break-all;word-warp:break-word;">审计结果:</th>
															               <td width="39%">
						                  <textarea title="sjResult" name="sjResult" id="sjResult" class="textareabox" style="width: 99%;"></textarea>
						               </td>
		 ...
		 <div id="searchBtns" class="datagrid-toolbar foot-formopera" style="padding-bottom: 6px;">
			<table class="tableForm" border="0" cellspacing="1" width='100%'>
				<tr>
					<td align="right">
						<a class="easyui-linkbutton primary-btn" iconCls="" plain="false" onclick="pmProjectYsCwjs.searchData();" href="javascript:void(0);">查询</a>
						<a class="easyui-linkbutton" iconCls="" plain="false" onclick="pmProjectYsCwjs.clearData();" href="javascript:void(0);">清空</a>
						<a class="easyui-linkbutton" iconCls="" plain="false" onclick="pmProjectYsCwjs.hideSearchForm();" href="javascript:void(0);">返回</a>
					</td>
				</tr>
			</table>
		</div>
...
<script type="text/javascript">
	function bpm_operator_refresh() { pmProjectYsCwjs.reLoad(); } 
</script>
</html>