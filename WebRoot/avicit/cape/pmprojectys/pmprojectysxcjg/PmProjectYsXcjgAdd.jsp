...
<!-- ControllerPath = "cape/pmprojectys/pmprojectysxcjg/pmProjectYsXcjgController/operation/Add/null" -->
<title>添加</title>
			...
			<input type="hidden" id="id" name="id" />
				<table class="form_commonTable">
					<tr>
								...
								竣工验收时间:</th>
								 								   								    <td width="39%">
								   								 																											<input title="竣工验收时间" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="jgysDate" id="jgysDate"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
...
<script type="text/javascript">
	...
	function closeForm(){
		parent.pmProjectYsXcjg.closeDialog("#insert");
	}
	...
	function callback(id){
		...
		if(flag == 0){
			if(issubmitflow){
				parent.pmProjectYsXcjg.saveFormAndStartFlow(serializeObject($('#form')), "#insert");
			}else{
				//parent.pmProjectYsXcjg.HidMask();
			}
		}
	}
