...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyszjbg/pmProjectYsZjbgController/operation/Add/null" -->
<title>添加</title>
			...
			<input type="hidden" id="id" name="id" />
				<table class="form_commonTable">
					<tr>
								...
								标题:</th>
								 								   								    <td width="39%">
								   								 																											<input title="标题" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="title" id="title"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
								...
								内容:</th>
								 								   								    <td width="39%">
								   								 																											<input title="内容" class="inputbox easyui-validatebox" data-options="validType:'maxLength[4000]'" style="width: 99%;" type="text" name="content" id="content"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																																																																																							     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
...
<script type="text/javascript">
	...
	function closeForm(){
		parent.pmProjectYsZjbg.closeDialog("#insert");
	}
	...
	function callback(id){
		...
		if(flag == 0){
			if(issubmitflow){
				parent.pmProjectYsZjbg.saveFormAndStartFlow(serializeObject($('#form')), "#insert");
			}else{
				//parent.pmProjectYsZjbg.HidMask();
			}
		}
	}
