...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyszjbg/pmProjectYsZjbgController/operation/Detail/id" -->
<title>详情</title>
...
<div data-options="region:'center',split:true,border:false">
				...
				<table class="form_commonTable">
					<tr>
									  																...
									  																密级:</label></th>
														 			 									  ...
														 			 									  <pt6:syslookup name="secretLevel"  title="密级" isNull="true" id ="secretLevel"  lookupCode="PLATFORM_FILE_SECRET_LEVEL" defaultValue='${pmProjectYsZjbgDTO.secretLevel}' dataOptions="disabled:true,editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
									  </pt6:syslookup> 
									...
									<tr>
									  																...
									  																所属项目:</label></th>
																											...
																											<input title="所属项目"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="projectName" id="projectName"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="taskId">
									  																任务id:</label></th>
									...
									<tr>
									  																...
									  																标题:</label></th>
																											...
																											<input title="标题"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="title" id="title"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																类型:</label></th>
														 			 									  ...
														 			 									  <pt6:syslookup name="zjType"  title="类型" isNull="true" id ="zjType"  lookupCode="PM_YS_ZJBG_TYPE" defaultValue='${pmProjectYsZjbgDTO.zjType}' dataOptions="disabled:true,editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
									  </pt6:syslookup> 
									  																...
									  																内容:</label></th>
																											...
																											<input title="内容"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[4000]'" style="width: 99%;" type="text" name="content" id="content"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  											  											  											  											  											  											  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
	...
	<script type="text/javascript">
		...
		$(function() {
		                            	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	        	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        			//初始化页面值
			$.ajax({
				url : 'platform/cape/pmprojectys/pmprojectyszjbg/pmProjectYsZjbgController/operation/toDetailJsp.json',
				data : {
					id : formId
				},
				type : 'post',
		...
		if (textareaElement.length > 0) {
		   ...
		   var textareaId = "";
			...
			$.ajax({
				url : "platform/cape/pmprojectys/pmprojectyszjbg/pmProjectYsZjbgController/operation/save",
				data : {
					data : dataVo
				},
				type : 'post',
