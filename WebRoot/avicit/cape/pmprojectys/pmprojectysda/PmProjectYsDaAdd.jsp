...
<!-- ControllerPath = "cape/pmprojectys/pmprojectysda/pmProjectYsDaController/operation/Add/null" -->
<title>添加</title>
			...
			<input type="hidden" id="id" name="id" />
				<table class="form_commonTable">
					<tr>
								...
								验收时间:</th>
								 								   								    <td width="39%">
								   								 																											<input title="验收时间" class="inputbox easyui-validatebox" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="ysDate" id="ysDate"/>
																									</td>
																	</tr>
									<tr>
															  							       							       																																					     							       							   <th width="10%" style="word-break:break-all;word-warp:break-word;">
								...
								验收意见:</th>
								 								   								    <td width="39%">
								   								 														 		     <textarea title="验收意见"  name="ysIdea"   id="ysIdea" class="textareabox"  style="width:99%;" data-size="2000"></textarea>
...
<script type="text/javascript">
	...
	function closeForm(){
		parent.pmProjectYsDa.closeDialog("#insert");
	}
	...
	function callback(id){
		...
		if(flag == 0){
			if(issubmitflow){
				parent.pmProjectYsDa.saveFormAndStartFlow(serializeObject($('#form')), "#insert");
			}else{
				//parent.pmProjectYsDa.HidMask();
			}
		}
	}
