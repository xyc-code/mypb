...
<!-- ControllerPath = "cape/pmprojectys/pmprojectyssts/pmProjectYsStsController/operation/Detail/id" -->
<title>详情</title>
...
<div data-options="region:'center',split:true,border:false">
				...
				<table class="form_commonTable">
					<tr>
									  																...
									  																密级:</label></th>
														 			 									  ...
														 			 									  <pt6:syslookup name="secretLevel"  title="密级" isNull="true" id ="secretLevel"  lookupCode="PLATFORM_FILE_SECRET_LEVEL" defaultValue='${pmProjectYsStsDTO.secretLevel}' dataOptions="disabled:true,editable:false,panelHeight:'auto',onShowPanel:comboboxOnShowPanel">
									  </pt6:syslookup> 
									...
									<tr>
									  																...
									  																任务名称:</label></th>
																											...
																											<input title="任务名称"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="taskName" id="taskName"/>
															   							   							   													 					  																				 							   							  	...
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="zyjkYsDate">
									  																职业健康-验收时间:</label></th>
																											<td class="disabled" width="39%">
																									
																											<input title="职业健康-验收时间"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="zyjkYsDate" id="zyjkYsDate"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="zyjkName">
									  																职业健康-批复文件名称:</label></th>
																											<td class="disabled" width="39%">
																									
																											<input title="职业健康-批复文件名称"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[2000]'" style="width: 99%;" type="text" name="zyjkName" id="zyjkName"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="zyjkDate">
									  																职业健康-批复时间:</label></th>
																											<td class="disabled" width="39%">
																									  		...
																									  		<input title="职业健康-批复时间"  disabled class="easyui-datetimebox disabled pt6-disabled"  editable="false" style="width: 99%;" type="text" name="zyjkDate" id="zyjkDate"/>
								  																	</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																职业健康-批复文号:</label></th>
																											...
																											<input title="职业健康-批复文号"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="zyjkNo" id="zyjkNo"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="hbYsDate">
									  																环保-验收时间:</label></th>
																											...
																											<input title="环保-验收时间"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="hbYsDate" id="hbYsDate"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																环保-批复文件名称:</label></th>
																											...
																											<input title="环保-批复文件名称"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[2000]'" style="width: 99%;" type="text" name="hbName" id="hbName"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="hbDate">
									  																环保-批复时间:</label></th>
																											<td class="disabled" width="39%">
																									  		...
																									  		<input title="环保-批复时间"  disabled class="easyui-datetimebox disabled pt6-disabled"  editable="false" style="width: 99%;" type="text" name="hbDate" id="hbDate"/>
								  																	</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																环保-批复文号:</label></th>
																											...
																											<input title="环保-批复文号"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="hbNo" id="hbNo"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="aqYsDate">
									  																安全-验收时间:</label></th>
																											...
																											<input title="安全-验收时间"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="aqYsDate" id="aqYsDate"/>
																									</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																安全-批复文件名称:</label></th>
																											...
																											<input title="安全-批复文件名称"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[2000]'" style="width: 99%;" type="text" name="aqName" id="aqName"/>
																									</td>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
																	  									  	<label for="aqDate">
									  																安全-批复时间:</label></th>
																											<td class="disabled" width="39%">
																									  		...
																									  		<input title="安全-批复时间"  disabled class="easyui-datetimebox disabled pt6-disabled"  editable="false" style="width: 99%;" type="text" name="aqDate" id="aqDate"/>
								  																	</td>
																	</tr>
									<tr>
															   							   							   													 					  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
									  																...
									  																安全-批复文号:</label></th>
																											...
																											<input title="安全-批复文号"  class="inputbox easyui-validatebox disabled pt6-disabled" data-options="validType:'maxLength[500]'" style="width: 99%;" type="text" name="aqNo" id="aqNo"/>
																									</td>
															   							   							   													 					  											  											  											  											  											  											  																				 							   							  	<th width="10%" style="word-break:break-all;word-warp:break-word;">
	...
	<script type="text/javascript">
		...
		$(function() {
	                    ...
	                    $('#zyjkDate').datetimebox('setValue', parserColumnTime("${pmProjectYsStsDTO.zyjkDate}").format("yyyy-MM-dd hh:MM:ss"));
	                }
	            	                    	                    	                    	                    	                if(!"${pmProjectYsStsDTO.hbDate}"==""){
	                    $('#hbDate').datetimebox('setValue', parserColumnTime("${pmProjectYsStsDTO.hbDate}").format("yyyy-MM-dd hh:MM:ss"));
	                }
	            	                    	                    	                    	                    	                if(!"${pmProjectYsStsDTO.aqDate}"==""){
	                    $('#aqDate').datetimebox('setValue', parserColumnTime("${pmProjectYsStsDTO.aqDate}").format("yyyy-MM-dd hh:MM:ss"));
	                }
	            	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	                    	        	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	                	                	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        	            	        			//初始化页面值
			$.ajax({
				url : 'platform/cape/pmprojectys/pmprojectyssts/pmProjectYsStsController/operation/toDetailJsp.json',
				data : {
					id : formId
				},
				type : 'post',
				...
				success : function(result) {
					if (result.flag == "success") {
					                                                   					                            					                            					                            					                            					                            					                            					                            					                                                       result.datas.zyjkDate = formatDateTimebox(result.datas.zyjkDate);
						 					                            					                            					                            					                                                       result.datas.hbDate = formatDateTimebox(result.datas.hbDate);
						 					                            					                            					                            					                                                       result.datas.aqDate = formatDateTimebox(result.datas.aqDate);
		...
		if (textareaElement.length > 0) {
		   ...
		   var textareaId = "";
			...
			$.ajax({
				url : "platform/cape/pmprojectys/pmprojectyssts/pmProjectYsStsController/operation/save",
				data : {
					data : dataVo
				},
				type : 'post',
