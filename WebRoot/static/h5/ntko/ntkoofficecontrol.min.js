...
//32位控件包的路径
var codebase="ofctnewclsid.cab#version=6.0.1.0";
//64位控件包的路径
var codebase64="ofctnewclsidx64.cab#version=6.0.1.0";
//设置高度
var height=window.screen.height-70+"";
//设置宽度
var width="100%";
//买断授权密钥如果不是买断可以不用写
var MakerCaption="金航数码科技有限责任公司";
//买断授权密钥如果不是买断可以不用写
var MakerKey="C2B7A69180DB8373B3A311AF76F6452EF0B7BC17";
//密钥
var ProductCaption="文件预览开发测试专用";
//密钥
var ProductKey="AF234B97A6445B5AE3BEE3A197E01852B178705F";
//解除时间密钥
var NoExpireKey="";
