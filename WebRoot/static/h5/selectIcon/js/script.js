$(function(){
	$('li.dib,.bs-glyphicons-list li,i.fa,i.icon').on('click',function(){
...
function getIconInfo(dom){
	...
	var iconI = (icon.attr('class') == null || icon.attr('class') =='' || icon.attr('class') ==undefined) ? dom.attr('class') : icon.attr('class');
