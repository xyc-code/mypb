...
t.attr("id",_71.id||"");
// 为了支持多个span，扩展了两个span，并且与之前写的样式要兼容。刘伟修改20140114
// 18701132336
t.html("<span class=\"l-btn-left\"><span class=\""+_71.iconCls+"\"></span>"+"<span class=\"l-btn-text\"></span>"+"</span>");
//t.html("<span class=\"l-btn-left\"><span style=\"background: url('avicit/platform6/component/js/jQuery/jquery-easyui-1.3.5/themes/default/images/icons.gif') no-repeat -120px 0px; display:inline-block; width:20px; height:20px;\"></span>"+"<span class=\"l-btn-text\"></span>"+"</span>");
if(_71.text){
//	alert(_71.text);
...
//  t.find(".l-btn-text").addClass(_71.iconAlign=="left"?"l-btn-icon-left":"l-btn-icon-right");
}
}else{
...
function _201(_202,_203){
	// modify by liuwei tab页签关闭报错
	if($.data(_202,"panel") != null){
...
function _271(_272,_273,_274,appendIframe){
...
setTimeout(function(){
if(appendIframe==true){win.window("window").find("iframe[name='kill_activex']").remove();}
win.window("destroy");
},100);
}});
win.window("window").addClass("messager-window");
if(appendIframe==true){win.window("window").append("<iframe name=\"kill_activex\" frameborder=\"0\" class=\"popup-activex-iframe\"></iframe>");}
win.children("div.messager-button").children("a:first").focus();
return win;
};
$.messager={show:function(_276){
return _26f(_276);
},alert:function(_277,msg,icon,fn,appendIframe){
...
var win=_271(_277,_278,_279,appendIframe);
return win;
},confirm:function(_27a,msg,fn,appendIframe){
...
var win=_271(_27a,_27b,_27c,appendIframe);
return win;
},prompt:function(_27d,msg,fn,appendIframe){
...
var win=_271(_27d,_27e,_27f,appendIframe);
...
var frame=$('iframe', tab);  // contentItem = tab   jframe = frame   frame = iframe
if(frame.length > 0){
	 try{
		 var iframe = frame[0];
...
var _7fc=$("<div class=\"combo-panel\"><iframe name=\"kill_activex\" frameborder=\"0\" class=\"popup-activex-iframe\"></iframe></div>").appendTo("body");
