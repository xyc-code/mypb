 ...
 */
CommonSelector = function(selectType,dialogDivId,targetIdEleId,targetNameEleId,userDeptIdEleId,userDeptNameEleId,extParameter,singleSelect,splitChar,dialogTitle,dialogWidth,dialogHeight, showTabsList){
	this.imageObj = null;
	/**
	 ...
	 *multipleOrg 是否显示多个组织根节点 可选：1或不设置 代表当前登录人所在组织 2代码包含兼职部 n代表多组织门
	...
	this.isRequired=function(){
		if(!$$require_[dialogDivId]){
			$$require_[dialogDivId]=true;
		}
	};
	...
	this.init = function(isInitIcon,callBackFunc,multipleOrg,afterCloseCallFun,displaySubDeptUser){
		...
		if(typeof(showTabsList)=='undefined' || showTabsList==null || showTabsList==""){
  			showTabsList = {"dept":"true", "role":"true", "position":"true", "group":"true", "groupPerson":"true"};
  			showTabsList = JSON.stringify(showTabsList);
  		}else if(typeof(showTabsList)!='string'){
  			showTabsList = JSON.stringify(showTabsList);
  		}
    		...
    		if (hiddenEle.attr("disabled")!="disabled"){
	    		imageObj.on("click",function(){
	    			if(selectType=='user'){
	    				...
	    				selectUser2(dialogDivId,targetIdEleId,targetNameEleId,userDeptIdEleId,userDeptNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg,displaySubDeptUser, showTabsList);
	    			}else if(selectType=='dept'){
...
function selectUser(dialogDivId,userIdEleId,userNameEleId,deptIdEleId,deptNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg,displaySubDeptUser){
	    ...
	    var queryParam='?singleSelect='+singleSelect +"&selectType=user&historyId="+historyUserId+"&extParameter="+encodeURI(extParameter) ;
...
function selectUser2(dialogDivId,userIdEleId,userNameEleId,deptIdEleId,deptNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg,displaySubDeptUser, showTabsList){
    var historyUserId = "";
    if(userIdEleId!=null && typeof(userIdEleId)!='undefined'){
	   historyUserId = document.getElementById(userIdEleId).value;
    }
    var queryParam='?singleSelect='+singleSelect +"&selectType=user2&historyId="+historyUserId+"&extParameter="+encodeURI(extParameter) ;
    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
    if(displaySubDeptUser != null && typeof(displaySubDeptUser) != 'undefined'){
	...
	queryParam += "&showTabsList="+encodeURI(showTabsList) ;
    var reqUrl=getPath2() + '/platform/commonSelection/commonSelectionController/getOrg'+queryParam;
    if(afterCloseCallFun != null && typeof(afterCloseCallFun) != 'undefined'){
    	afterCloseCallFun = afterCloseCallFun+"()";
    }
...
function selectDept(dialogDivId,deptIdEleId,deptNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg,displaySubDeptUser){
	    ...
	    var queryParam='?singleSelect='+singleSelect +"&selectType=dept&historyId="+historyDeptId+"&extParameter="+encodeURI(extParameter) ;
	    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
	    	queryParam += "&multipleOrg="+multipleOrg ;
	    }
 	...
 	function selectOrg(dialogDivId,orgEleId,orgNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg){
 		    ...
 		    var queryParam='?singleSelect='+singleSelect +"&selectType=org&historyId="+historyOrgId+"&extParameter="+encodeURI(extParameter) ;
 		    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
 		    	queryParam += "&multipleOrg="+multipleOrg ;
 		    }
...
function selectRole(dialogDivId,roleIdEleId,roleNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg){
	 ...
	 var queryParam='?singleSelect='+singleSelect +"&dialogId="+dialogDivId+"&historyId="+historyRoleId+"&extParameter="+encodeURI(extParameter) ;
	 if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
	    	queryParam += "&multipleOrg="+multipleOrg ;
	 }
...
function selectGroup(dialogDivId,groupIdEleId,groupNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg){
	...
	var queryParam='?singleSelect='+singleSelect +"&dialogId="+dialogDivId+"&historyId="+historyGroupId+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
...
function selectPosition(dialogDivId,positionIdEleId,positionNameEleId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,callBackFunc,afterCloseCallFun,multipleOrg){
	...
	var queryParam='?singleSelect='+singleSelect+"&dialogId="+dialogDivId+"&historyId="+historyPositionId+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	...
	var positionCommonDialog = new CommonSelectorDialog(dialogDivId,dialogWidth,dialogHeight,positionUrl,dialogTitle,afterCloseCallFun);
		var buttons = [{
 			...
 			handler:function(){
 				...
 				var resultData = frm.getSelectedResultDataJson();
 				//选择数据提交前控制
 				if(!submitLimitCheck(singleSelect,resultData.length,"position",dialogDivId)){
 					return ;
 				}
 				var funRetValue = null;
 				if(callBackFunc!=null && callBackFunc!='undefined'){
...
function selectDataComprehensively(targetNameEleId,callBackFun,dialogDivId,selectedDataMappingConfig,dialogTitle,dialogWidth,dialogHeight,extParameter,splitChar,multipleOrg,afterCloseCallFun,displaySubDeptUser){
	...
	var queryParam="?extParameter="+encodeURI(extParameter)+"&showTab="+mappingConfigObjId ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	if(displaySubDeptUser != null && typeof(displaySubDeptUser) != 'undefined'){
 ...
 * @param singleSelect                可选     默认值 true  可填写值：true/false/-1/数字  当填写false/-1  表示选择多少项不受限制 当填写数字时将限定选择数量不大于填写的数字
 * @param splitChar                   可选     返回值分割符 默认逗号（,）
 * @param multipleOrg                 是否显示多个组织根节点 可选：1或不设置 代表当前登录人所在组织 2代表 多个组织应用 n代表多组织 显示几个组织由项目开发人员在java代码中控制
 ...
 */
GridCommonSelector = function(selectType,dataGridId,rowIndex,selectDialogShowFieldName,filedMappingConfig,callBackFun,extParameter,dialogWidth,dialogHeight,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser, showTabsList){
	      this.init = function(rowData){
	    	...
	    	if(dataGridId != null && rowIndex!=null && selectDialogShowFieldName!=null){
	                    	...
	                    	if(selectType=='user'){
	                    	   ...
	                    	   gridSelectUser2(rowIndex,dataGridId,filedMappingConfig,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser, showTabsList);
	            			}else if(selectType=='dept'){
...
function gridSelectUser(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser){
	    ...
	    var queryParam='?singleSelect='+singleSelect +"&selectType=user&historyId="+rowUserIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
	    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
	    	queryParam += "&multipleOrg="+multipleOrg ;
	    }
	    if(displaySubDeptUser != null && typeof(displaySubDeptUser) != 'undefined'){
...
function gridSelectUser2(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser, showTabsList){
    var fieldMapingJson = fieldMapping;
    var rowUserIdProperty = fieldMapingJson.targetId;
    var rowUserIdPropertyValue ="";
    if(null !=rowData && typeof(rowData)!='undefined'){
    ...
    var queryParam='?singleSelect='+singleSelect +"&selectType=user2&historyId="+rowUserIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
    if(displaySubDeptUser != null && typeof(displaySubDeptUser) != 'undefined'){
...
function gridSelectDept(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser){
	    ...
	    var queryParam='?singleSelect='+singleSelect +"&selectType=dept&historyId="+rowDeptIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
	    if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
	    	queryParam += "&multipleOrg="+multipleOrg ;
	    }
	    var deptUrl=getPath2() + '/platform/commonSelection/commonSelectionController/getOrg'+queryParam;
	 				...
	 				for(var i=0 ; i<resultData.length;i++){
	 					var userDept = resultData[i];
	  					if(deptIdProperty != null && typeof(deptIdProperty) != 'undefined'){
	  						...
	  						orgIdentity = userDept.orgIdentity;
	  					}
	 				}
	 				var retValue = {
    						"deptId":deptId,
...
function gridSelectRole(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg){
	...
	var queryParam='?singleSelect='+singleSelect +"&historyId="+rowRoleIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	var roleUrl=getPath2() + '/avicit/platform6/modules/system/commonpopup/RoleSelect.jsp'+queryParam;
...
function gridSelectGroup(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg){
	...
	var queryParam='?singleSelect='+singleSelect +"&historyId="+rowGroupIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	var groupUrl=getPath2() + '/avicit/platform6/modules/system/commonpopup/GroupSelect.jsp'+queryParam;
...
function gridSelectPosition(rowIndex,dataGridId,fieldMapping,rowData,callBackFun,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg){
	...
	var queryParam='?singleSelect='+singleSelect+"&historyId="+rowPositionIdPropertyValue+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	var positionUrl=getPath2() + '/avicit/platform6/modules/system/commonpopup/PositionSelect.jsp'+queryParam;
...
function selectComprehensiveData(rowIndex,dataGridId,callBackFun,rowData,dialogDivId,dialogTitle,dialogWidth,dialogHeight,extParameter,singleSelect,splitChar,afterCloseCallFun,multipleOrg,displaySubDeptUser,displaySubDeptUser){
	var queryParam='?singleSelect='+singleSelect+"&extParameter="+encodeURI(extParameter) ;
	if(multipleOrg != null && typeof(multipleOrg) != 'undefined'){
    	queryParam += "&multipleOrg="+multipleOrg ;
    }
	if(displaySubDeptUser != null && typeof(displaySubDeptUser) != 'undefined'){
 ...
 */
function submitLimitCheck(singleSelect,selectDataCount,selectType,required){
	var defaultTitle = "数据" ;
	if(selectType=='user'){
		defaultTitle = "用户" ;
	}else if(selectType=='user2'){
	...
	if($$require_[required] &&selectDataCount===0){
		jQuery.messager.alert("操作提示", "请至少选择1个"+defaultTitle+"！","info");
		return false;
	}
	...
	if(singleSelect!=true && singleSelect!=false && !isNaN(singleSelect)){
		...
		if(selectDataCount>singleSelect){
