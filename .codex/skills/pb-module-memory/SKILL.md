...
- Before creating, changing, reviewing, or debugging any Excel import in the PB project, read and enforce `references/pb-excel-import-guardrails.md`. These rules apply to every existing and future module.
