package avicit.cape.pmprojectys.pmprojectysda.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table = "pm_project_ys_da", object = "PmProjectYsDaDTO", name = "项目验收管理-档案验收")
public class PmProjectYsDaDTO extends BeanDTO {
	...
	@FieldRemark(column = "ys_date", field = "ysDate", name = "验收时间")
	/*
	 *验收时间
	 */
	private java.lang.String ysDate;
	...
	public java.lang.String getYsDate() {
		return ysDate;
	}

	public void setYsDate(java.lang.String ysDate) {
		this.ysDate = ysDate;
	}
