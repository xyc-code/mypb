package avicit.cape.pmprojectys.pmprojectyscwjs.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table = "pm_project_ys_cwjs", object = "PmProjectYsCwjsDTO", name = "项目验收管理-财务决算审计")
public class PmProjectYsCwjsDTO extends BeanDTO {
	...
	@FieldRemark(column = "sj_date", field = "sjDate", name = "审计时间")
	/*
	 *审计时间
	 */
	private java.lang.String sjDate;
	...
	@FieldRemark(column = "sj_result", field = "sjResult", name = "审计结果")
	/*
	 *审计结果
	 */
	private java.lang.String sjResult;
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
	/*
	 *创建时间开始时间
	 */
	...
	public java.lang.String getSjDate() {
		return sjDate;
	}

	public void setSjDate(java.lang.String sjDate) {
		this.sjDate = sjDate;
	}
	...
	public java.lang.String getSjResult() {
		return sjResult;
	}

	public void setSjResult(java.lang.String sjResult) {
