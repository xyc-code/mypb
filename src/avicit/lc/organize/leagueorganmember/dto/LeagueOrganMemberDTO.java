package avicit.lc.organize.leagueorganmember.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table="LEAGUE_ORGAN_MEMBER", object="LeagueOrganMemberDTO", name="团组织人员信息表")
public class LeagueOrganMemberDTO extends BeanDTO{
