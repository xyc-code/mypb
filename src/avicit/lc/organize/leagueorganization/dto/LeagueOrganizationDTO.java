package avicit.lc.organize.leagueorganization.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table="LEAGUE_ORGANIZATION", object="LeagueOrganizationDTO", name="团组织信息表")
public class LeagueOrganizationDTO extends BaseTreeDTO{
	 ...
	 * 团支部编号
	 */
	@NotBlank(message = "团支部编号不能为空")
	@FieldRemark(column="LEAGUE_CODE", field="leagueCode", name="团支部编号")
	...
	@FieldRemark(column="LEAGUE_NAME", field="leagueName", name="团支部名称")
