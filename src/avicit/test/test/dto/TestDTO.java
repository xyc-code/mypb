 ...
 * @修改记录：
 */
@PojoRemark(table="TEST", object="TestDTO", name="测试1")
public class TestDTO extends BeanDTO{
	 ...
	 * TEST1
	 */
	@FieldRemark(column="TEST1", field="test1", name="TEST1")
