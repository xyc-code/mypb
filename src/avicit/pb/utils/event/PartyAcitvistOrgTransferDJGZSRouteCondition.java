...
public class PartyAcitvistOrgTransferDJGZSRouteCondition implements RouteConditionInterface {
	...
	public boolean evaluate(OpenExecution execution) {
		...
		List<Map<String, Object>> list_out_party_org_id_ = jdbcTemplate
				.queryForList("select t.out_party_org_id from DYN_AOT_MEMBER t where t.fk_sub_col_id = '" + id + "'");
