...
public class PartyActivistOrgTransferSelectUserMDDZZ extends UserSelect implements LoaderConstant {
		...
		String pInPartyOrgId = (String)data.get("P_IN_PARTY_ORG_ID");
			if (StringUtils.isNotEmpty(pInPartyOrgId)) {
				...
				List<Map<String, Object>> list_tree_parent_id = jdbcTemplate.queryForList(
						"select t.parent_id from PARTY_ORGANIZATION t where t.id = '"+pInPartyOrgId+"'");
