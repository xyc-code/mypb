...
public class PartyInfoZGRWSBRouteCondition implements RouteConditionInterface{
	...
	public boolean evaluate(OpenExecution execution) {
		String avicit_bpm_start_id = (String) execution.getVariable("avicit_bpm_start_id");
