...
public class PartyReminderGeneralElectionToDZZRouteCondition implements RouteConditionInterface{
			...
			if (StringUtils.isNotEmpty(partyId)) {
				...
				if (list_yn_zz != null && list_yn_zz.size() > 0) {
					...
					if (StringUtils.isNotEmpty(yn_zz)) {
						...
						if (StringUtils.equals(yn_zz, "2")) {
							return true;	
						}else if(StringUtils.equals(yn_zz, "1")){
							if(getYNDZZByPartyId(partyId)){
								return true;
							}else{
								return false;
							}
