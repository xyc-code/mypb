...
public class PartyOrgTransferSelectUserDZZ extends UserSelect implements LoaderConstant {
	...
	public Actors getActors(String processInstanceId, String executionId, String activityName, String startFormId,
		...
		List<Map<String, Object>> list = jdbcTemplate.queryForList("select t.out_party_org_id from DYN_POT_MEMBER t where t.fk_sub_col_id = '"+startFormId+"'");
