...
public class PartyInfoSelectUsersDZZ extends UserSelect implements LoaderConstant{
...
//		String AvuserId = (String) map.get("avicit_bpm_start_id");
		String avicit_bpm_start_id = (String)map.get("SEL_USER_ID");
