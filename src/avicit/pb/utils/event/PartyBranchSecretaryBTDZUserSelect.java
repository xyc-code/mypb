...
// 通用的党支部书记
public class PartyBranchSecretaryBTDZUserSelect extends UserSelect implements LoaderConstant {
    ...
    public Actors getActors(String processInstanceId, String executionId, String activityName, String startFormId,
        ...
        List<Map<String, Object>> partyOrgslists = jdbcTemplate.queryForList("select PARTY_NAME from DYN_FIVE_OF_USER  where FIVE_OF_ID = '" + startFormId + "'");
        String userDeptId = partyOrgslists.get(0).get("PARTY_NAME").toString();
