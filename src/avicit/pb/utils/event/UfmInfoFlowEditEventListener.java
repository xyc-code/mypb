...
public class UfmInfoFlowEditEventListener implements EventListener, LoaderConstant {
	...
	private static final Logger logger = LoggerFactory.getLogger(UfmInfoFlowEditEventListener.class);
	...
	public void notify(EventListenerExecution execution) throws Exception {
		...
		tableColDatamust1.setColValue(id);
