package avicit.pb.commandos.partymilepost.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table="PARTY_MILEPOST", object="PartyMilepostDTO", name="里程碑计划")
public class PartyMilepostDTO extends BeanDTO{
	 ...
	 * 上报人
	 */
	@FieldRemark(column="USER_ID", field="userId", name="上报人", dataType="user")
	 ...
	 * 上报人所在党支部
	 */
	@FieldRemark(column="PARTY_ID", field="partyId", name="上报人所在党支部")
	...
	public java.lang.String getAssigneenames_() {
		return assigneenames_;
	}

	public void setAssigneenames_(java.lang.String assigneenames_) {
