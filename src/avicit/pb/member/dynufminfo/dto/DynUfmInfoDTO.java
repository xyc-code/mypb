package avicit.pb.member.dynufminfo.dto;
...
* @修改记录：
*/
@PojoRemark(table="DYN_UFM_INFO", object="DynUfmInfoDTO", name="DYN_UFM_INFO")
public class DynUfmInfoDTO extends BeanDTO{
	...
	* 是否香港、澳门同胞
	*/
	@FieldRemark(column="HO_COMPATRIOTS", field="hoCompatriots", name="是否香港、澳门同胞")
