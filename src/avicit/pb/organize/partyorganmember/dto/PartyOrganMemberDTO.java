package avicit.pb.organize.partyorganmember.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table="PARTY_ORGAN_MEMBER", object="PartyOrganMemberDTO", name="党组织人员信息表")
public class PartyOrganMemberDTO extends BeanDTO{
	...
	@FieldRemark(column="USER_ID", field="userId", name="员工姓名", dataType="user")
	 ...
	 * USER_NAME
	 */
	@FieldRemark(column="USER_NAME", field="userName", name="USER_NAME")
	 ...
	 * DEPT_NAME
	 */
	@FieldRemark(column="DEPT_NAME", field="deptName", name="DEPT_NAME")
	private java.lang.String deptName;

	/**
	 * 党组织职务
	 */
	@NotBlank(message = "党组织职务不能为空")
	@FieldRemark(column="USER_POST", field="userPost", name="党组织职务", dataType="lookup", lookupType="PARTY_POST")
	 ...
	 * PARTY_ID
	 */
	@FieldRemark(column="PARTY_ID", field="partyId", name="PARTY_ID")
