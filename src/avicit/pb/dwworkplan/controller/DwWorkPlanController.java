package avicit.pb.dwworkplan.controller;

import avicit.pb.dwworkplan.service.DwWorkPlanService;
...
@Controller
@Scope("prototype")
@RequestMapping("avicit/pb/dwworkplan/dwWorkPlanController")
public class DwWorkPlanController {
    @Autowired
    private DwWorkPlanService dwWorkPlanService;

    @RequestMapping(value = "toWorkbench")
    public ModelAndView toWorkbench() {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("avicit/pb/dwworkplan/workbench");
        return mav;
    }

    @RequestMapping(value = "toStats")
    public ModelAndView toStats() {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("avicit/pb/dwworkplan/stats");
        return mav;
    }

    @RequestMapping(value = "toPersonTree")
    public ModelAndView toPersonTree() {
        ModelAndView mav = new ModelAndView();
        mav.setViewName("avicit/pb/dwworkplan/personTree");
        return mav;
    }
