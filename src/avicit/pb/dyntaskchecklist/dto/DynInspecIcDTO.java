 ...
 * @金航数码科技有限责任公司
 * @作者：请填写
 * @邮箱：请填写 @创建时间： 2023-06-13 15:18
 * @类说明：DYN_INSPEC_IC @修改记录：
 */
@PojoRemark(table = "dyn_inspec_ic", object = "DynInspecIcDTO", name = "DYN_INSPEC_IC")
public class DynInspecIcDTO extends BeanDTO {
	...
	@FieldRemark(column = "attribute_11", field = "attribute11", name = "主表id")
	/*
	 * 主表id
	 */
	private java.lang.String attribute11;

	@FieldRemark(column = "attribute_10", field = "attribute10", name = "第几次的循环")
	/*
	 * 第几次的循环
	 */
	...
	@FieldRemark(column = "attribute_03", field = "attribute03", name = "清单id")
	/*
	 * 清单id
	 */
	private java.lang.String attribute03;

	@FieldRemark(column = "attribute_02", field = "attribute02", name = "文件名字")
	/*
	 * 文件名字
	 */
	...
	@FieldRemark(column = "attribute_05", field = "attribute05", name = "是否推送")
	/*
	 * 是否推送
	 */
