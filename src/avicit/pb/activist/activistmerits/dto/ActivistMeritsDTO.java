package avicit.pb.activist.activistmerits.dto;
 ...
 * @修改记录：
 */
@PojoRemark(table="ACTIVIST_MERITS", object="ActivistMeritsDTO", name="积极分子绩效考核成绩")
public class ActivistMeritsDTO extends BeanDTO{
	 ...
	 * 绩效
	 */
	@FieldRemark(column="MERITS", field="merits", name="绩效", dataType="lookup", lookupType="PA_MERITS")
	private java.lang.String merits;
	private java.lang.String meritsName;

	/**
	 * 类别
	 */
	@FieldRemark(column="TYPE", field="type", name="类别", dataType="lookup", lookupType="PA_PARTY_TYPE")
	 ...
	 * 排名
	 */
	@FieldRemark(column="POSITION", field="position", name="排名")
	...
	public java.lang.String getMeritsName(){
		return meritsName;
	}

	public void setMeritsName(java.lang.String meritsName){
		this.meritsName = meritsName;
	}
