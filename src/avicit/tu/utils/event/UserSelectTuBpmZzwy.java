...
/**
 * 
 * 根据当前流程的工会id查询该工会的组织委员
 * 表单内工会ID字段必须为GH_ID
 */
public class UserSelectTuBpmZzwy extends UserSelect{
	...
	public Actors getActors(String processInstanceId, String executionId, String activityName, String startFormId,String loginUserId) {
		...
		if(tableList != null && tableList.size() > 0){
			...
			String userPost = "2";//组织委员
			String sql = "select * from dyn_tu_organ_member t1 where t1.LEAGUE_ID = (select t.gh_id from DYN_GUILD_HJTX t where t.id = '"
