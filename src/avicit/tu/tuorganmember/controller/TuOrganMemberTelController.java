...
@Controller
@Scope("prototype")
@RequestMapping("avicit/tu/tuorganmember/TuOrganMemberTelController")
public class TuOrganMemberTelController implements LoaderConstant {
	private static final Logger LOGGER = LoggerFactory.getLogger(TuOrganMemberTelController.class);
	...
	public ModelAndView toLeagueOrganMemberManage() {
		...
		mav.setViewName("avicit/tu/tuorganmember/LeagueOrganMemberTelManage");
		mav.addObject("url", "platform/avicit/tu/tuorganmember/TuOrganMemberTelController/operation/");
		return mav;
	}
