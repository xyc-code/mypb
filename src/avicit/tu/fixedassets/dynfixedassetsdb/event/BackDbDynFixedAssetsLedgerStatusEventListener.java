 ...
 *
 */
public class BackDbDynFixedAssetsLedgerStatusEventListener implements EventListener{
	...
	public void notify(EventListenerExecution eventListenerExecution) throws Exception {
		...
		String sql = "update dyn_fixed_assets_ledger t set t.data_status = 'Y' where t.id "
				+ "= (select t1.asset_ledger_id from dyn_fixed_assets_db t1 where t1.id = '" + formId + "')";
