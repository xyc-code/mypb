...
/**
 * 
 * 根据当前流程的调出工会id（资产信息上的工会id）查询该工会的主席
 */
public class UserSelectTuOutZhuxi extends UserSelect{
	...
	public Actors getActors(String processInstanceId, String executionId, String activityName, String startFormId,String loginUserId) {
		...
		if(tableList != null && tableList.size() > 0){
			...
			String sql = "select * from dyn_tu_organ_member t1 where t1.LEAGUE_ID = (select t.asset_guild_id from DYN_FIXED_ASSETS_DB t where t.id = '"
