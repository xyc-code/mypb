...
@Controller
@Scope("prototype")
@RequestMapping("avicit/tu/tuorganization/TradeUnionOrganizationTelController")
public class TradeUnionOrganizationTelController implements LoaderConstant {
	private static final Logger LOGGER = LoggerFactory.getLogger(TradeUnionOrganizationTelController.class);
	 ...
	 * @return ModelAndView
	 */
	@RequestMapping(value = "toLeagueOrganizationTelManage")
	public ModelAndView toLeagueOrganizationManage() {
		ModelAndView mav = new ModelAndView();
		String url = "platform/avicit/tu/tuorganization/TradeUnionOrganizationTelController";
		mav.setViewName("avicit/tu/tuorganization/LeagueOrganizationTelManage");
		mav.addObject("url",url);
		mav.addObject("leagueOrganMemberUrl", "platform/avicit/tu/tuorganmember/TuOrganMemberTelController/operation/");
		return mav;
	}
